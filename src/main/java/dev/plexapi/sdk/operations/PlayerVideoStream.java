...
public class PlayerVideoStream {
    ...
    public static class Sync extends Base
            implements RequestOperation<PlayerVideoStreamRequest, PlayerVideoStreamResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(PlayerVideoStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlayerVideoStreamRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlayerVideoStreamRequest request) {
        ...
        @Override
        public PlayerVideoStreamResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlayerVideoStreamResponse.Builder resBuilder =
            ...
            PlayerVideoStreamResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlayerVideoStreamRequest, dev.plexapi.sdk.models.operations.async.PlayerVideoStreamResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(PlayerVideoStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlayerVideoStreamRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlayerVideoStreamRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.PlayerVideoStreamResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.PlayerVideoStreamResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.PlayerVideoStreamResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            dev.plexapi.sdk.models.operations.async.PlayerVideoStreamResponse res = resBuilder.build();
