...
public class DetectVoiceActivityRequest {
    ...
    public DetectVoiceActivityRequest(
            ...
            Optional<? extends BoolInt> manual) {
    ...
    public Optional<BoolInt> manual() {
        return (Optional<BoolInt>) manual;
    }
     ...
     * Indicates the client accepts the indicated media types
     */
    public DetectVoiceActivityRequest withAccepts(Accepts accepts) {
        Utils.checkNotNull(accepts, "accepts");
     ...
     * Indicates the client accepts the indicated media types
     */
    public DetectVoiceActivityRequest withAccepts(Optional<? extends Accepts> accepts) {
        Utils.checkNotNull(accepts, "accepts");
        this.accepts = accepts;
        return this;
    }
     ...
     * An opaque identifier unique to the client
     */
    public DetectVoiceActivityRequest withClientIdentifier(String clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
     ...
     * An opaque identifier unique to the client
     */
    public DetectVoiceActivityRequest withClientIdentifier(Optional<String> clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
        this.clientIdentifier = clientIdentifier;
        return this;
    }
     ...
     * The name of the client product
     */
    public DetectVoiceActivityRequest withProduct(String product) {
        Utils.checkNotNull(product, "product");
     ...
     * The name of the client product
     */
    public DetectVoiceActivityRequest withProduct(Optional<String> product) {
        Utils.checkNotNull(product, "product");
        this.product = product;
        return this;
    }
     ...
     * The version of the client application
     */
    public DetectVoiceActivityRequest withVersion(String version) {
        Utils.checkNotNull(version, "version");
     ...
     * The version of the client application
     */
    public DetectVoiceActivityRequest withVersion(Optional<String> version) {
        Utils.checkNotNull(version, "version");
        this.version = version;
        return this;
    }
     ...
     * The platform of the client
     */
    public DetectVoiceActivityRequest withPlatform(String platform) {
        Utils.checkNotNull(platform, "platform");
     ...
     * The platform of the client
     */
    public DetectVoiceActivityRequest withPlatform(Optional<String> platform) {
        Utils.checkNotNull(platform, "platform");
        this.platform = platform;
        return this;
    }
     ...
     * The version of the platform
     */
    public DetectVoiceActivityRequest withPlatformVersion(String platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
     ...
     * The version of the platform
     */
    public DetectVoiceActivityRequest withPlatformVersion(Optional<String> platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
        this.platformVersion = platformVersion;
        return this;
    }
     ...
     * A relatively friendly name for the client device
     */
    public DetectVoiceActivityRequest withDevice(String device) {
        Utils.checkNotNull(device, "device");
     ...
     * A relatively friendly name for the client device
     */
    public DetectVoiceActivityRequest withDevice(Optional<String> device) {
        Utils.checkNotNull(device, "device");
        this.device = device;
        return this;
    }
     ...
     * A potentially less friendly identifier for the device model
     */
    public DetectVoiceActivityRequest withModel(String model) {
        Utils.checkNotNull(model, "model");
     ...
     * A potentially less friendly identifier for the device model
     */
    public DetectVoiceActivityRequest withModel(Optional<String> model) {
        Utils.checkNotNull(model, "model");
        this.model = model;
        return this;
    }
     ...
     * The device vendor
     */
    public DetectVoiceActivityRequest withDeviceVendor(String deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
     ...
     * The device vendor
     */
    public DetectVoiceActivityRequest withDeviceVendor(Optional<String> deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
        this.deviceVendor = deviceVendor;
        return this;
    }
     ...
     * A friendly name for the client
     */
    public DetectVoiceActivityRequest withDeviceName(String deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
     ...
     * A friendly name for the client
     */
    public DetectVoiceActivityRequest withDeviceName(Optional<String> deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
        this.deviceName = deviceName;
        return this;
    }
     ...
     * The marketplace on which the client application is distributed
     */
    public DetectVoiceActivityRequest withMarketplace(String marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
     ...
     * The marketplace on which the client application is distributed
     */
    public DetectVoiceActivityRequest withMarketplace(Optional<String> marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
        this.marketplace = marketplace;
        return this;
    }
     ...
     * Comma-separated list of IDs
     */
    public DetectVoiceActivityRequest withIds(String ids) {
        Utils.checkNotNull(ids, "ids");
        this.ids = ids;
        return this;
    }
     ...
     * Indicate whether detection should be re-run
     */
    public DetectVoiceActivityRequest withForce(BoolInt force) {
        Utils.checkNotNull(force, "force");
     ...
     * Indicate whether detection should be re-run
     */
    public DetectVoiceActivityRequest withForce(Optional<? extends BoolInt> force) {
        Utils.checkNotNull(force, "force");
        this.force = force;
        return this;
    }
     ...
     * Indicate whether detection is manually run
     */
    public DetectVoiceActivityRequest withManual(BoolInt manual) {
        Utils.checkNotNull(manual, "manual");
     ...
     * Indicate whether detection is manually run
     */
    public DetectVoiceActivityRequest withManual(Optional<? extends BoolInt> manual) {
        Utils.checkNotNull(manual, "manual");
        this.manual = manual;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DetectVoiceActivityRequest other = (DetectVoiceActivityRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DetectVoiceActivityRequest.class,
                "accepts", accepts,
    ...
    public final static class Builder {
        ...
        public DetectVoiceActivityRequest build() {
            if (accepts == null) {
