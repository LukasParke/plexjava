...
public class ListTopUsers {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(ListTopUsersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTopUsersRequest.class);
        ...
        public ListTopUsersResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListTopUsersResponse.Builder resBuilder =
            ...
            ListTopUsersResponse res = resBuilder.build();
    ...
    public static class Async extends Base
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.ListTopUsersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.ListTopUsersResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.ListTopUsersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.ListTopUsersResponse res = resBuilder.build();
