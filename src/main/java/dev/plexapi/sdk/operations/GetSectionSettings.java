...
public class GetSectionSettings {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/library/sections/{sectionId}/settings",
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSectionSettingsRequest, GetSectionSettingsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetSectionSettingsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSectionSettingsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSectionSettingsRequest request) {
        ...
        @Override
        public GetSectionSettingsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSectionSettingsResponse.Builder resBuilder =
            ...
            GetSectionSettingsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSectionSettingsRequest, dev.plexapi.sdk.models.operations.async.GetSectionSettingsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSectionSettingsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSectionSettingsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSectionSettingsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetSectionSettingsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetSectionSettingsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetSectionSettingsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetSectionSettingsResponse res = resBuilder.build();
