...
public class CheckForSystemUpdates {
    ...
    public static class Sync extends Base
            implements RequestOperation<CheckForSystemUpdatesRequest, CheckForSystemUpdatesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CheckForSystemUpdatesRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CheckForSystemUpdatesRequest request) {
        ...
        @Override
        public CheckForSystemUpdatesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CheckForSystemUpdatesResponse.Builder resBuilder =
            ...
            CheckForSystemUpdatesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CheckForSystemUpdatesRequest, dev.plexapi.sdk.models.operations.async.CheckForSystemUpdatesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CheckForSystemUpdatesRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CheckForSystemUpdatesRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.CheckForSystemUpdatesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.CheckForSystemUpdatesResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.CheckForSystemUpdatesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.CheckForSystemUpdatesResponse res = resBuilder.build();
