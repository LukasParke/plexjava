...
import dev.plexapi.sdk.models.operations.RemoveDeviceFromDVRResponseBody;
...
public class RemoveDeviceFromDVR {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveDeviceFromDVRRequest, RemoveDeviceFromDVRResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(RemoveDeviceFromDVRRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveDeviceFromDVRRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveDeviceFromDVRRequest request) {
        ...
        @Override
        public RemoveDeviceFromDVRResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveDeviceFromDVRResponse.Builder resBuilder =
            ...
            RemoveDeviceFromDVRResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<RemoveDeviceFromDVRResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveDeviceFromDVRRequest, dev.plexapi.sdk.models.operations.async.RemoveDeviceFromDVRResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(RemoveDeviceFromDVRRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveDeviceFromDVRRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveDeviceFromDVRRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.RemoveDeviceFromDVRResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.RemoveDeviceFromDVRResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.RemoveDeviceFromDVRResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.RemoveDeviceFromDVRResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<RemoveDeviceFromDVRResponseBody>() {})
