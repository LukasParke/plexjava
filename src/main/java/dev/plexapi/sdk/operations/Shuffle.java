...
public class Shuffle {
    ...
    public static class Sync extends Base
            implements RequestOperation<ShuffleRequest, ShuffleResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ShuffleRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ShuffleRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ShuffleRequest request) {
        ...
        @Override
        public ShuffleResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ShuffleResponse.Builder resBuilder =
                    ShuffleResponse
                            .builder()
            ...
            ShuffleResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ShuffleRequest, dev.plexapi.sdk.models.operations.async.ShuffleResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ShuffleRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ShuffleRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ShuffleRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.ShuffleResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.ShuffleResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.ShuffleResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.ShuffleResponse res = resBuilder.build();
