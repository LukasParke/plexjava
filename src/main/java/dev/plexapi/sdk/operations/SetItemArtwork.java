...
public class SetItemArtwork {
    ...
    public static class Sync extends Base
            implements RequestOperation<SetItemArtworkRequest, SetItemArtworkResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(SetItemArtworkRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SetItemArtworkRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(SetItemArtworkRequest request) {
        ...
        @Override
        public SetItemArtworkResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            SetItemArtworkResponse.Builder resBuilder =
            ...
            SetItemArtworkResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SetItemArtworkRequest, dev.plexapi.sdk.models.operations.async.SetItemArtworkResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(SetItemArtworkRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SetItemArtworkRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(SetItemArtworkRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.SetItemArtworkResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.SetItemArtworkResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.SetItemArtworkResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.SetItemArtworkResponse res = resBuilder.build();
