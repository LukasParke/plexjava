...
public class DeleteSubscription {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteSubscriptionRequest, DeleteSubscriptionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeleteSubscriptionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteSubscriptionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteSubscriptionRequest request) {
        ...
        @Override
        public DeleteSubscriptionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteSubscriptionResponse.Builder resBuilder =
            ...
            DeleteSubscriptionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteSubscriptionRequest, dev.plexapi.sdk.models.operations.async.DeleteSubscriptionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeleteSubscriptionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteSubscriptionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteSubscriptionRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.DeleteSubscriptionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.DeleteSubscriptionResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.DeleteSubscriptionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.DeleteSubscriptionResponse res = resBuilder.build();
