...
public class MarkPlayed {
    ...
    public static class Sync extends Base
            implements RequestOperation<MarkPlayedRequest, MarkPlayedResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(MarkPlayedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MarkPlayedRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MarkPlayedRequest request) {
        ...
        @Override
        public MarkPlayedResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            MarkPlayedResponse.Builder resBuilder =
                    MarkPlayedResponse
                            .builder()
            ...
            MarkPlayedResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MarkPlayedRequest, dev.plexapi.sdk.models.operations.async.MarkPlayedResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(MarkPlayedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MarkPlayedRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(MarkPlayedRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.MarkPlayedResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.MarkPlayedResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.MarkPlayedResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.MarkPlayedResponse res = resBuilder.build();
