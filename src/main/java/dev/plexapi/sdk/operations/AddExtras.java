...
public class AddExtras {
    ...
    public static class Sync extends Base
            implements RequestOperation<AddExtrasRequest, AddExtrasResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AddExtrasRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddExtrasRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddExtrasRequest request) {
        ...
        @Override
        public AddExtrasResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AddExtrasResponse.Builder resBuilder =
                    AddExtrasResponse
                            .builder()
            ...
            AddExtrasResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AddExtrasRequest, dev.plexapi.sdk.models.operations.async.AddExtrasResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AddExtrasRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddExtrasRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AddExtrasRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.AddExtrasResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.AddExtrasResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.AddExtrasResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.AddExtrasResponse res = resBuilder.build();
