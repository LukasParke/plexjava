...
public class AddPlaylistItems {
    ...
    public static class Sync extends Base
            implements RequestOperation<AddPlaylistItemsRequest, AddPlaylistItemsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AddPlaylistItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddPlaylistItemsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddPlaylistItemsRequest request) {
        ...
        @Override
        public AddPlaylistItemsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AddPlaylistItemsResponse.Builder resBuilder =
            ...
            AddPlaylistItemsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AddPlaylistItemsRequest, dev.plexapi.sdk.models.operations.async.AddPlaylistItemsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AddPlaylistItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddPlaylistItemsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AddPlaylistItemsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.AddPlaylistItemsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.AddPlaylistItemsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.AddPlaylistItemsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.AddPlaylistItemsResponse res = resBuilder.build();
