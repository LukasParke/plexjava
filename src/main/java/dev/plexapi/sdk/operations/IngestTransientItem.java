...
public class IngestTransientItem {
    ...
    public static class Sync extends Base
            implements RequestOperation<IngestTransientItemRequest, IngestTransientItemResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(IngestTransientItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, IngestTransientItemRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(IngestTransientItemRequest request) {
        ...
        @Override
        public IngestTransientItemResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            IngestTransientItemResponse.Builder resBuilder =
            ...
            IngestTransientItemResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<IngestTransientItemRequest, dev.plexapi.sdk.models.operations.async.IngestTransientItemResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(IngestTransientItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, IngestTransientItemRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(IngestTransientItemRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.IngestTransientItemResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.IngestTransientItemResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.IngestTransientItemResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.IngestTransientItemResponse res = resBuilder.build();
