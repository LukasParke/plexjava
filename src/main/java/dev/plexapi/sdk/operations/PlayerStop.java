...
public class PlayerStop {
    ...
    public static class Sync extends Base
            implements RequestOperation<PlayerStopRequest, PlayerStopResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(PlayerStopRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlayerStopRequest request) {
        ...
        @Override
        public PlayerStopResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlayerStopResponse.Builder resBuilder =
                    PlayerStopResponse
                            .builder()
            ...
            PlayerStopResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlayerStopRequest, dev.plexapi.sdk.models.operations.async.PlayerStopResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(PlayerStopRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlayerStopRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.PlayerStopResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.PlayerStopResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.PlayerStopResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.PlayerStopResponse res = resBuilder.build();
