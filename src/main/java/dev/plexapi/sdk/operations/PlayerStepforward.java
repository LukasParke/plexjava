...
public class PlayerStepforward {
    ...
    public static class Sync extends Base
            implements RequestOperation<PlayerStepforwardRequest, PlayerStepforwardResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(PlayerStepforwardRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlayerStepforwardRequest request) {
        ...
        @Override
        public PlayerStepforwardResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlayerStepforwardResponse.Builder resBuilder =
            ...
            PlayerStepforwardResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlayerStepforwardRequest, dev.plexapi.sdk.models.operations.async.PlayerStepforwardResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(PlayerStepforwardRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlayerStepforwardRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.PlayerStepforwardResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.PlayerStepforwardResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.PlayerStepforwardResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.PlayerStepforwardResponse res = resBuilder.build();
