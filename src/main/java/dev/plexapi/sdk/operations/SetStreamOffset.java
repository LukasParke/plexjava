...
public class SetStreamOffset {
    ...
    public static class Sync extends Base
            implements RequestOperation<SetStreamOffsetRequest, SetStreamOffsetResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(SetStreamOffsetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SetStreamOffsetRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(SetStreamOffsetRequest request) {
        ...
        @Override
        public SetStreamOffsetResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            SetStreamOffsetResponse.Builder resBuilder =
            ...
            SetStreamOffsetResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SetStreamOffsetRequest, dev.plexapi.sdk.models.operations.async.SetStreamOffsetResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(SetStreamOffsetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SetStreamOffsetRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(SetStreamOffsetRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.SetStreamOffsetResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.SetStreamOffsetResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.SetStreamOffsetResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            dev.plexapi.sdk.models.operations.async.SetStreamOffsetResponse res = resBuilder.build();
