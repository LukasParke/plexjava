...
public class GetSectionEdit {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSectionEditRequest, GetSectionEditResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetSectionEditRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSectionEditRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSectionEditRequest request) {
        ...
        @Override
        public GetSectionEditResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSectionEditResponse.Builder resBuilder =
            ...
            GetSectionEditResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSectionEditRequest, dev.plexapi.sdk.models.operations.async.GetSectionEditResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSectionEditRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSectionEditRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSectionEditRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetSectionEditResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetSectionEditResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetSectionEditResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetSectionEditResponse res = resBuilder.build();
