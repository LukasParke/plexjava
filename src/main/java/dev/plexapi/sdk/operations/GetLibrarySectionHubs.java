...
public class GetLibrarySectionHubs {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/library/sections/{sectionId}/hubs",
    ...
    public static class Sync extends Base
            implements RequestOperation<GetLibrarySectionHubsRequest, GetLibrarySectionHubsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetLibrarySectionHubsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLibrarySectionHubsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetLibrarySectionHubsRequest request) {
        ...
        @Override
        public GetLibrarySectionHubsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetLibrarySectionHubsResponse.Builder resBuilder =
            ...
            GetLibrarySectionHubsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMediaContainerWithHubs(Utils.unmarshal(response, new TypeReference<MediaContainerWithHubs>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetLibrarySectionHubsRequest, dev.plexapi.sdk.models.operations.async.GetLibrarySectionHubsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetLibrarySectionHubsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLibrarySectionHubsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetLibrarySectionHubsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetLibrarySectionHubsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetLibrarySectionHubsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetLibrarySectionHubsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetLibrarySectionHubsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MediaContainerWithHubs>() {})
                            .thenApply(res::withMediaContainerWithHubs);
                } else {
