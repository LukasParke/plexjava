...
public class GetMetadataHubsResponse implements Response {
    /**
    ...
    @JsonCreator
    public GetMetadataHubsResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public GetMetadataHubsResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetMetadataHubsResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetMetadataHubsResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public GetMetadataHubsResponse withHeaders(Map<String, List<String>> headers) {
        Utils.checkNotNull(headers, "headers");
        this.headers = headers;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetMetadataHubsResponse other = (GetMetadataHubsResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetMetadataHubsResponse.class,
    ...
    public final static class Builder {
        ...
        public GetMetadataHubsResponse build() {

            return new GetMetadataHubsResponse(
                contentType, statusCode, rawResponse,
                mediaContainerWithHubs, headers);
        }
