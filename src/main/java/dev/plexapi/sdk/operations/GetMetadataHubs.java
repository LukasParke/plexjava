...
public class GetMetadataHubs {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetMetadataHubsRequest, GetMetadataHubsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetMetadataHubsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMetadataHubsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetMetadataHubsRequest request) {
        ...
        @Override
        public GetMetadataHubsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetMetadataHubsResponse.Builder resBuilder =
            ...
            GetMetadataHubsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetMetadataHubsRequest, dev.plexapi.sdk.models.operations.async.GetMetadataHubsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetMetadataHubsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMetadataHubsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetMetadataHubsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetMetadataHubsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetMetadataHubsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetMetadataHubsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetMetadataHubsResponse res = resBuilder.build();
