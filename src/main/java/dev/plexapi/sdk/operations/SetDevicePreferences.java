...
public class SetDevicePreferences {
    ...
    public static class Sync extends Base
            implements RequestOperation<SetDevicePreferencesRequest, SetDevicePreferencesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(SetDevicePreferencesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SetDevicePreferencesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(SetDevicePreferencesRequest request) {
        ...
        @Override
        public SetDevicePreferencesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            SetDevicePreferencesResponse.Builder resBuilder =
            ...
            SetDevicePreferencesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SetDevicePreferencesRequest, dev.plexapi.sdk.models.operations.async.SetDevicePreferencesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(SetDevicePreferencesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SetDevicePreferencesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(SetDevicePreferencesRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.SetDevicePreferencesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.SetDevicePreferencesResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.SetDevicePreferencesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.SetDevicePreferencesResponse res = resBuilder.build();
