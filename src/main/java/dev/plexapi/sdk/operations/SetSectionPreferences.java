...
public class SetSectionPreferences {
    ...
    public static class Sync extends Base
            implements RequestOperation<SetSectionPreferencesRequest, SetSectionPreferencesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(SetSectionPreferencesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SetSectionPreferencesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(SetSectionPreferencesRequest request) {
        ...
        @Override
        public SetSectionPreferencesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            SetSectionPreferencesResponse.Builder resBuilder =
            ...
            SetSectionPreferencesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SetSectionPreferencesRequest, dev.plexapi.sdk.models.operations.async.SetSectionPreferencesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(SetSectionPreferencesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SetSectionPreferencesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(SetSectionPreferencesRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.SetSectionPreferencesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.SetSectionPreferencesResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.SetSectionPreferencesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.SetSectionPreferencesResponse res = resBuilder.build();
