...
public class GetSessionSegment {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSessionSegmentRequest, GetSessionSegmentResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetSessionSegmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSessionSegmentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSessionSegmentRequest request) {
        ...
        @Override
        public GetSessionSegmentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSessionSegmentResponse.Builder resBuilder =
            ...
            GetSessionSegmentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSessionSegmentRequest, dev.plexapi.sdk.models.operations.async.GetSessionSegmentResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSessionSegmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSessionSegmentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSessionSegmentRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetSessionSegmentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetSessionSegmentResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetSessionSegmentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            dev.plexapi.sdk.models.operations.async.GetSessionSegmentResponse res = resBuilder.build();
