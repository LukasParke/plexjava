...
public class Scan {
    ...
    public static class Sync extends Base
            implements RequestOperation<ScanRequest, ScanResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ScanRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ScanRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ScanRequest request) {
        ...
        @Override
        public ScanResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ScanResponse.Builder resBuilder =
                    ScanResponse
                            .builder()
            ...
            ScanResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ScanRequest, dev.plexapi.sdk.models.operations.async.ScanResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ScanRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ScanRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ScanRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.ScanResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.ScanResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.ScanResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.ScanResponse res = resBuilder.build();
