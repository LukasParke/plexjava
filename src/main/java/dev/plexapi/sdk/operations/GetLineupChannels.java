...
import dev.plexapi.sdk.models.operations.GetLineupChannelsResponseBody;
...
public class GetLineupChannels {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetLineupChannelsRequest, GetLineupChannelsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetLineupChannelsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLineupChannelsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetLineupChannelsRequest request) {
        ...
        @Override
        public GetLineupChannelsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetLineupChannelsResponse.Builder resBuilder =
            ...
            GetLineupChannelsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<GetLineupChannelsResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetLineupChannelsRequest, dev.plexapi.sdk.models.operations.async.GetLineupChannelsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetLineupChannelsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLineupChannelsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetLineupChannelsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetLineupChannelsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetLineupChannelsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetLineupChannelsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetLineupChannelsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetLineupChannelsResponseBody>() {})
