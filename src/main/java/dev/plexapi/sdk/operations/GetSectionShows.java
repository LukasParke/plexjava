...
public class GetSectionShows {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/library/sections/{sectionId}/shows",
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSectionShowsRequest, GetSectionShowsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetSectionShowsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSectionShowsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSectionShowsRequest request) {
        ...
        @Override
        public GetSectionShowsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSectionShowsResponse.Builder resBuilder =
            ...
            GetSectionShowsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSectionShowsRequest, dev.plexapi.sdk.models.operations.async.GetSectionShowsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSectionShowsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSectionShowsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSectionShowsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetSectionShowsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetSectionShowsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetSectionShowsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetSectionShowsResponse res = resBuilder.build();
