...
public class OptimizeLibrary {
    ...
    public static class Sync extends Base
            implements RequestOperation<OptimizeLibraryRequest, OptimizeLibraryResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(OptimizeLibraryRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(OptimizeLibraryRequest request) {
        ...
        @Override
        public OptimizeLibraryResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            OptimizeLibraryResponse.Builder resBuilder =
            ...
            OptimizeLibraryResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<OptimizeLibraryRequest, dev.plexapi.sdk.models.operations.async.OptimizeLibraryResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(OptimizeLibraryRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(OptimizeLibraryRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.OptimizeLibraryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.OptimizeLibraryResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.OptimizeLibraryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.OptimizeLibraryResponse res = resBuilder.build();
