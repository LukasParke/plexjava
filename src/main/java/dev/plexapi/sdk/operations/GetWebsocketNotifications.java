...
public class GetWebsocketNotifications {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetWebsocketNotificationsRequest, GetWebsocketNotificationsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetWebsocketNotificationsRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetWebsocketNotificationsRequest request) {
        ...
        @Override
        public GetWebsocketNotificationsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetWebsocketNotificationsResponse.Builder resBuilder =
            ...
            GetWebsocketNotificationsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "101")) {
                // no content
                return res;
            }
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetWebsocketNotificationsRequest, dev.plexapi.sdk.models.operations.async.GetWebsocketNotificationsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetWebsocketNotificationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetWebsocketNotificationsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetWebsocketNotificationsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetWebsocketNotificationsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetWebsocketNotificationsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetWebsocketNotificationsResponse res = resBuilder.build();
