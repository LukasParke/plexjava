...
public class TranscodeMusic {
    ...
    public static class Sync extends Base
            implements RequestOperation<TranscodeMusicRequest, TranscodeMusicResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(TranscodeMusicRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TranscodeMusicRequest request) {
        ...
        @Override
        public TranscodeMusicResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            TranscodeMusicResponse.Builder resBuilder =
            ...
            TranscodeMusicResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<TranscodeMusicRequest, dev.plexapi.sdk.models.operations.async.TranscodeMusicResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(TranscodeMusicRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(TranscodeMusicRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.TranscodeMusicResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.TranscodeMusicResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.TranscodeMusicResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.TranscodeMusicResponse res = resBuilder.build();
