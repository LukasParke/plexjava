...
public class GetBandwidthStatistics {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetBandwidthStatisticsRequest, GetBandwidthStatisticsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetBandwidthStatisticsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBandwidthStatisticsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetBandwidthStatisticsRequest request) {
        ...
        @Override
        public GetBandwidthStatisticsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetBandwidthStatisticsResponse.Builder resBuilder =
            ...
            GetBandwidthStatisticsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetBandwidthStatisticsRequest, dev.plexapi.sdk.models.operations.async.GetBandwidthStatisticsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetBandwidthStatisticsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBandwidthStatisticsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetBandwidthStatisticsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetBandwidthStatisticsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetBandwidthStatisticsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetBandwidthStatisticsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetBandwidthStatisticsResponse res = resBuilder.build();
