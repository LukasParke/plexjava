...
public class GetCollectionItems {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCollectionItemsRequest, GetCollectionItemsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetCollectionItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCollectionItemsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCollectionItemsRequest request) {
        ...
        @Override
        public GetCollectionItemsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCollectionItemsResponse.Builder resBuilder =
            ...
            GetCollectionItemsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCollectionItemsRequest, dev.plexapi.sdk.models.operations.async.GetCollectionItemsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetCollectionItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCollectionItemsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCollectionItemsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetCollectionItemsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetCollectionItemsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetCollectionItemsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetCollectionItemsResponse res = resBuilder.build();
