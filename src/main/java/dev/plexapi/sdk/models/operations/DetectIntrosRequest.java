...
public class DetectIntrosRequest {
     ...
     * Indicates the client accepts the indicated media types
     */
    public DetectIntrosRequest withAccepts(Accepts accepts) {
        Utils.checkNotNull(accepts, "accepts");
     ...
     * Indicates the client accepts the indicated media types
     */
    public DetectIntrosRequest withAccepts(Optional<? extends Accepts> accepts) {
        Utils.checkNotNull(accepts, "accepts");
        this.accepts = accepts;
        return this;
    }
     ...
     * An opaque identifier unique to the client
     */
    public DetectIntrosRequest withClientIdentifier(String clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
     ...
     * An opaque identifier unique to the client
     */
    public DetectIntrosRequest withClientIdentifier(Optional<String> clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
        this.clientIdentifier = clientIdentifier;
        return this;
    }
     ...
     * The name of the client product
     */
    public DetectIntrosRequest withProduct(Optional<String> product) {
        Utils.checkNotNull(product, "product");
        this.product = product;
        return this;
    }
     ...
     * The version of the client application
     */
    public DetectIntrosRequest withVersion(String version) {
        Utils.checkNotNull(version, "version");
     ...
     * The version of the client application
     */
    public DetectIntrosRequest withVersion(Optional<String> version) {
        Utils.checkNotNull(version, "version");
        this.version = version;
        return this;
    }
     ...
     * The platform of the client
     */
    public DetectIntrosRequest withPlatform(String platform) {
        Utils.checkNotNull(platform, "platform");
     ...
     * The platform of the client
     */
    public DetectIntrosRequest withPlatform(Optional<String> platform) {
        Utils.checkNotNull(platform, "platform");
        this.platform = platform;
        return this;
    }
     ...
     * The version of the platform
     */
    public DetectIntrosRequest withPlatformVersion(String platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
     ...
     * The version of the platform
     */
    public DetectIntrosRequest withPlatformVersion(Optional<String> platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
        this.platformVersion = platformVersion;
        return this;
    }
     ...
     * A relatively friendly name for the client device
     */
    public DetectIntrosRequest withDevice(String device) {
        Utils.checkNotNull(device, "device");
     ...
     * A relatively friendly name for the client device
     */
    public DetectIntrosRequest withDevice(Optional<String> device) {
        Utils.checkNotNull(device, "device");
        this.device = device;
        return this;
    }
     ...
     * A potentially less friendly identifier for the device model
     */
    public DetectIntrosRequest withModel(String model) {
        Utils.checkNotNull(model, "model");
     ...
     * A potentially less friendly identifier for the device model
     */
    public DetectIntrosRequest withModel(Optional<String> model) {
        Utils.checkNotNull(model, "model");
        this.model = model;
        return this;
    }
     ...
     * The device vendor
     */
    public DetectIntrosRequest withDeviceVendor(String deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
     ...
     * The device vendor
     */
    public DetectIntrosRequest withDeviceVendor(Optional<String> deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
        this.deviceVendor = deviceVendor;
        return this;
    }
     ...
     * A friendly name for the client
     */
    public DetectIntrosRequest withDeviceName(String deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
     ...
     * A friendly name for the client
     */
    public DetectIntrosRequest withDeviceName(Optional<String> deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
        this.deviceName = deviceName;
        return this;
    }
     ...
     * The marketplace on which the client application is distributed
     */
    public DetectIntrosRequest withMarketplace(String marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
     ...
     * The marketplace on which the client application is distributed
     */
    public DetectIntrosRequest withMarketplace(Optional<String> marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
        this.marketplace = marketplace;
        return this;
    }
     ...
     * Comma-separated list of IDs
     */
    public DetectIntrosRequest withIds(String ids) {
        Utils.checkNotNull(ids, "ids");
        this.ids = ids;
        return this;
    }
     ...
     * Indicate whether detection should be re-run
     */
    public DetectIntrosRequest withForce(BoolInt force) {
        Utils.checkNotNull(force, "force");
     ...
     * Indicate whether detection should be re-run
     */
    public DetectIntrosRequest withForce(Optional<? extends BoolInt> force) {
        Utils.checkNotNull(force, "force");
        this.force = force;
        return this;
    }
     ...
     * The threshold for determining if content is an intro or not
     */
    public DetectIntrosRequest withThreshold(double threshold) {
        Utils.checkNotNull(threshold, "threshold");
     ...
     * The threshold for determining if content is an intro or not
     */
    public DetectIntrosRequest withThreshold(Optional<Double> threshold) {
        Utils.checkNotNull(threshold, "threshold");
        this.threshold = threshold;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DetectIntrosRequest other = (DetectIntrosRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DetectIntrosRequest.class,
                "accepts", accepts,
    ...
    public final static class Builder {
        ...
        public DetectIntrosRequest build() {
            if (accepts == null) {
