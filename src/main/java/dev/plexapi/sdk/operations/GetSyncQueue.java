...
public class GetSyncQueue {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSyncQueueRequest, GetSyncQueueResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetSyncQueueRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSyncQueueRequest request) {
        ...
        @Override
        public GetSyncQueueResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSyncQueueResponse.Builder resBuilder =
            ...
            GetSyncQueueResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSyncQueueRequest, dev.plexapi.sdk.models.operations.async.GetSyncQueueResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSyncQueueRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSyncQueueRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetSyncQueueResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetSyncQueueResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetSyncQueueResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetSyncQueueResponse res = resBuilder.build();
