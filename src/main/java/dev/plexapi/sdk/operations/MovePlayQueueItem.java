...
public class MovePlayQueueItem {
    ...
    public static class Sync extends Base
            implements RequestOperation<MovePlayQueueItemRequest, MovePlayQueueItemResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(MovePlayQueueItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MovePlayQueueItemRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MovePlayQueueItemRequest request) {
        ...
        @Override
        public MovePlayQueueItemResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            MovePlayQueueItemResponse.Builder resBuilder =
            ...
            MovePlayQueueItemResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MovePlayQueueItemRequest, dev.plexapi.sdk.models.operations.async.MovePlayQueueItemResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(MovePlayQueueItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MovePlayQueueItemRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(MovePlayQueueItemRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.MovePlayQueueItemResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.MovePlayQueueItemResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.MovePlayQueueItemResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.MovePlayQueueItemResponse res = resBuilder.build();
