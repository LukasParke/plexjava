...
public class GetDownloadQueue {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetDownloadQueueRequest, GetDownloadQueueResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetDownloadQueueRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDownloadQueueRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetDownloadQueueRequest request) {
        ...
        @Override
        public GetDownloadQueueResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetDownloadQueueResponse.Builder resBuilder =
            ...
            GetDownloadQueueResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<GetDownloadQueueResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetDownloadQueueRequest, dev.plexapi.sdk.models.operations.async.GetDownloadQueueResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetDownloadQueueRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDownloadQueueRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetDownloadQueueRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetDownloadQueueResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetDownloadQueueResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetDownloadQueueResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetDownloadQueueResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetDownloadQueueResponseBody>() {})
