...
import dev.plexapi.sdk.models.operations.GetFirstCharactersResponseBody;
...
public class GetFirstCharacters {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetFirstCharactersRequest, GetFirstCharactersResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetFirstCharactersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetFirstCharactersRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetFirstCharactersRequest request) {
        ...
        @Override
        public GetFirstCharactersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetFirstCharactersResponse.Builder resBuilder =
            ...
            GetFirstCharactersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<GetFirstCharactersResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetFirstCharactersRequest, dev.plexapi.sdk.models.operations.async.GetFirstCharactersResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetFirstCharactersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetFirstCharactersRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetFirstCharactersRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetFirstCharactersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetFirstCharactersResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetFirstCharactersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetFirstCharactersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetFirstCharactersResponseBody>() {})
