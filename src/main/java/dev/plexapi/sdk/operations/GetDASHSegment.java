...
public class GetDASHSegment {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            ...
            req.addHeader("Accept", "video/mp4")
    ...
    public static class Sync extends Base
            implements RequestOperation<GetDASHSegmentRequest, GetDASHSegmentResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetDASHSegmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDASHSegmentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetDASHSegmentRequest request) {
        ...
        @Override
        public GetDASHSegmentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetDASHSegmentResponse.Builder resBuilder =
            ...
            GetDASHSegmentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetDASHSegmentRequest, dev.plexapi.sdk.models.operations.async.GetDASHSegmentResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetDASHSegmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDASHSegmentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetDASHSegmentRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetDASHSegmentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetDASHSegmentResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetDASHSegmentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            dev.plexapi.sdk.models.operations.async.GetDASHSegmentResponse res = resBuilder.build();
