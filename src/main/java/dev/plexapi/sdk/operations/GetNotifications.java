...
public class GetNotifications {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetNotificationsRequest, GetNotificationsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetNotificationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetNotificationsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetNotificationsRequest request) {
        ...
        @Override
        public GetNotificationsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetNotificationsResponse.Builder resBuilder =
            ...
            GetNotificationsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetNotificationsRequest, dev.plexapi.sdk.models.operations.async.GetNotificationsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetNotificationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetNotificationsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetNotificationsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetNotificationsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetNotificationsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetNotificationsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            dev.plexapi.sdk.models.operations.async.GetNotificationsResponse res = resBuilder.build();
