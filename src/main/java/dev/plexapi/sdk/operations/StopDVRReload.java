...
public class StopDVRReload {
    ...
    public static class Sync extends Base
            implements RequestOperation<StopDVRReloadRequest, StopDVRReloadResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(StopDVRReloadRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StopDVRReloadRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(StopDVRReloadRequest request) {
        ...
        @Override
        public StopDVRReloadResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            StopDVRReloadResponse.Builder resBuilder =
            ...
            StopDVRReloadResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<StopDVRReloadRequest, dev.plexapi.sdk.models.operations.async.StopDVRReloadResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(StopDVRReloadRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StopDVRReloadRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(StopDVRReloadRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.StopDVRReloadResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.StopDVRReloadResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.StopDVRReloadResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.StopDVRReloadResponse res = resBuilder.build();
