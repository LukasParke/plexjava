...
public class BrowseFilesystemRequest {
    ...
    private Optional<? extends BoolInt> includeFiles;

    @JsonCreator
    public BrowseFilesystemRequest(
            ...
            Optional<? extends BoolInt> includeFiles) {
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<BoolInt> includeFiles() {
        return (Optional<BoolInt>) includeFiles;
    }
     ...
     * Indicates the client accepts the indicated media types
     */
    public BrowseFilesystemRequest withAccepts(Accepts accepts) {
        Utils.checkNotNull(accepts, "accepts");
     ...
     * Indicates the client accepts the indicated media types
     */
    public BrowseFilesystemRequest withAccepts(Optional<? extends Accepts> accepts) {
        Utils.checkNotNull(accepts, "accepts");
        this.accepts = accepts;
        return this;
    }
     ...
     * An opaque identifier unique to the client
     */
    public BrowseFilesystemRequest withClientIdentifier(String clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
     ...
     * An opaque identifier unique to the client
     */
    public BrowseFilesystemRequest withClientIdentifier(Optional<String> clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
        this.clientIdentifier = clientIdentifier;
        return this;
    }
     ...
     * The name of the client product
     */
    public BrowseFilesystemRequest withProduct(String product) {
        Utils.checkNotNull(product, "product");
     ...
     * The name of the client product
     */
    public BrowseFilesystemRequest withProduct(Optional<String> product) {
        Utils.checkNotNull(product, "product");
        this.product = product;
        return this;
    }
     ...
     * The version of the client application
     */
    public BrowseFilesystemRequest withVersion(String version) {
        Utils.checkNotNull(version, "version");
     ...
     * The version of the client application
     */
    public BrowseFilesystemRequest withVersion(Optional<String> version) {
        Utils.checkNotNull(version, "version");
        this.version = version;
        return this;
    }
     ...
     * The platform of the client
     */
    public BrowseFilesystemRequest withPlatform(String platform) {
        Utils.checkNotNull(platform, "platform");
     ...
     * The platform of the client
     */
    public BrowseFilesystemRequest withPlatform(Optional<String> platform) {
        Utils.checkNotNull(platform, "platform");
        this.platform = platform;
        return this;
    }
     ...
     * The version of the platform
     */
    public BrowseFilesystemRequest withPlatformVersion(String platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
     ...
     * The version of the platform
     */
    public BrowseFilesystemRequest withPlatformVersion(Optional<String> platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
        this.platformVersion = platformVersion;
        return this;
    }
     ...
     * A relatively friendly name for the client device
     */
    public BrowseFilesystemRequest withDevice(String device) {
        Utils.checkNotNull(device, "device");
     ...
     * A relatively friendly name for the client device
     */
    public BrowseFilesystemRequest withDevice(Optional<String> device) {
        Utils.checkNotNull(device, "device");
        this.device = device;
        return this;
    }
     ...
     * A potentially less friendly identifier for the device model
     */
    public BrowseFilesystemRequest withModel(String model) {
        Utils.checkNotNull(model, "model");
     ...
     * A potentially less friendly identifier for the device model
     */
    public BrowseFilesystemRequest withModel(Optional<String> model) {
        Utils.checkNotNull(model, "model");
        this.model = model;
        return this;
    }
     ...
     * The device vendor
     */
    public BrowseFilesystemRequest withDeviceVendor(String deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
     ...
     * The device vendor
     */
    public BrowseFilesystemRequest withDeviceVendor(Optional<String> deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
        this.deviceVendor = deviceVendor;
        return this;
    }
     ...
     * A friendly name for the client
     */
    public BrowseFilesystemRequest withDeviceName(String deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
     ...
     * A friendly name for the client
     */
    public BrowseFilesystemRequest withDeviceName(Optional<String> deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
        this.deviceName = deviceName;
        return this;
    }
     ...
     * The marketplace on which the client application is distributed
     */
    public BrowseFilesystemRequest withMarketplace(String marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
     ...
     * The marketplace on which the client application is distributed
     */
    public BrowseFilesystemRequest withMarketplace(Optional<String> marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
        this.marketplace = marketplace;
        return this;
    }
     ...
     * Include files in browse results
     */
    public BrowseFilesystemRequest withIncludeFiles(BoolInt includeFiles) {
        Utils.checkNotNull(includeFiles, "includeFiles");
     ...
     * Include files in browse results
     */
    public BrowseFilesystemRequest withIncludeFiles(Optional<? extends BoolInt> includeFiles) {
        Utils.checkNotNull(includeFiles, "includeFiles");
        this.includeFiles = includeFiles;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        BrowseFilesystemRequest other = (BrowseFilesystemRequest) o;
        return 
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            deviceName, marketplace, includeFiles);
    }
    
    @Override
    public String toString() {
        return Utils.toString(BrowseFilesystemRequest.class,
                "accepts", accepts,
    ...
    public final static class Builder {
         ...
         * Include files in browse results
         */
        public Builder includeFiles(BoolInt includeFiles) {
            Utils.checkNotNull(includeFiles, "includeFiles");
            this.includeFiles = Optional.ofNullable(includeFiles);
            return this;
        }
         ...
         * Include files in browse results
         */
        public Builder includeFiles(Optional<? extends BoolInt> includeFiles) {
            Utils.checkNotNull(includeFiles, "includeFiles");
            this.includeFiles = includeFiles;
            return this;
        }

        public BrowseFilesystemRequest build() {
            if (accepts == null) {
                accepts = _SINGLETON_VALUE_Accepts.value();
            }
            if (includeFiles == null) {
                includeFiles = _SINGLETON_VALUE_IncludeFiles.value();
            }

            return new BrowseFilesystemRequest(
                accepts, clientIdentifier, product,
                version, platform, platformVersion,
                device, model, deviceVendor,
                deviceName, marketplace, includeFiles);
        ...
        private static final LazySingletonValue<Optional<? extends BoolInt>> _SINGLETON_VALUE_IncludeFiles =
                new LazySingletonValue<>(
                        "includeFiles",
                        "0",
