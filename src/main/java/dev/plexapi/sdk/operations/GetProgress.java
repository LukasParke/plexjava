...
import dev.plexapi.sdk.models.shared.ProgressResponse;
...
public class GetProgress {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetProgressRequest, GetProgressResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetProgressRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetProgressRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetProgressRequest request) {
        ...
        @Override
        public GetProgressResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetProgressResponse.Builder resBuilder =
                    GetProgressResponse
                            .builder()
            ...
            GetProgressResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withProgressResponse(Utils.unmarshal(response, new TypeReference<ProgressResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetProgressRequest, dev.plexapi.sdk.models.operations.async.GetProgressResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetProgressRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetProgressRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetProgressRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetProgressResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetProgressResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetProgressResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetProgressResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ProgressResponse>() {})
                            .thenApply(res::withProgressResponse);
                } else {
