...
public class GetFile {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetFileRequest, dev.plexapi.sdk.models.operations.async.GetFileResponse> {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetFileResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetFileResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetFileResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            dev.plexapi.sdk.models.operations.async.GetFileResponse res = resBuilder.build();
