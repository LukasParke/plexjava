...
public class DeleteLiveTVSession {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteLiveTVSessionRequest, DeleteLiveTVSessionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeleteLiveTVSessionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteLiveTVSessionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteLiveTVSessionRequest request) {
        ...
        @Override
        public DeleteLiveTVSessionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteLiveTVSessionResponse.Builder resBuilder =
            ...
            DeleteLiveTVSessionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteLiveTVSessionRequest, dev.plexapi.sdk.models.operations.async.DeleteLiveTVSessionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeleteLiveTVSessionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteLiveTVSessionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteLiveTVSessionRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.DeleteLiveTVSessionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.DeleteLiveTVSessionResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.DeleteLiveTVSessionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.DeleteLiveTVSessionResponse res = resBuilder.build();
