...
public class GetByDecade {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/library/sections/{sectionId}/byDecade",
    ...
    public static class Sync extends Base
            implements RequestOperation<GetByDecadeRequest, GetByDecadeResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetByDecadeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetByDecadeRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetByDecadeRequest request) {
        ...
        @Override
        public GetByDecadeResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetByDecadeResponse.Builder resBuilder =
                    GetByDecadeResponse
                            .builder()
            ...
            GetByDecadeResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetByDecadeRequest, dev.plexapi.sdk.models.operations.async.GetByDecadeResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetByDecadeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetByDecadeRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetByDecadeRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetByDecadeResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetByDecadeResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetByDecadeResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetByDecadeResponse res = resBuilder.build();
