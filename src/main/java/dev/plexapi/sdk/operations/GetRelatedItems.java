...
public class GetRelatedItems {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetRelatedItemsRequest, GetRelatedItemsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetRelatedItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRelatedItemsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetRelatedItemsRequest request) {
        ...
        @Override
        public GetRelatedItemsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetRelatedItemsResponse.Builder resBuilder =
            ...
            GetRelatedItemsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetRelatedItemsRequest, dev.plexapi.sdk.models.operations.async.GetRelatedItemsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetRelatedItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRelatedItemsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetRelatedItemsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetRelatedItemsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetRelatedItemsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetRelatedItemsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetRelatedItemsResponse res = resBuilder.build();
