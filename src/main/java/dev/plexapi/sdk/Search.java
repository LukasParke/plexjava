...
public class Search {
     ...
     */
    public SearchHubsResponse searchHubs(SearchHubsRequest request) {
     ...
     * @throws RuntimeException subclass if the API call fails
     */
    public SearchHubsResponse searchHubs(SearchHubsRequest request, Optional<Options> options) {
        RequestOperation<SearchHubsRequest, SearchHubsResponse> operation
              = new SearchHubs.Sync(sdkConfiguration, options, _headers);
     ...
     * @throws RuntimeException subclass if the API call fails
     */
    public VoiceSearchHubsResponse voiceSearchHubs(VoiceSearchHubsRequest request) {
     ...
     * @throws RuntimeException subclass if the API call fails
     */
    public VoiceSearchHubsResponse voiceSearchHubs(VoiceSearchHubsRequest request, Optional<Options> options) {
        RequestOperation<VoiceSearchHubsRequest, VoiceSearchHubsResponse> operation
              = new VoiceSearchHubs.Sync(sdkConfiguration, options, _headers);
        return operation.handleResponse(operation.doRequest(request));
    }
