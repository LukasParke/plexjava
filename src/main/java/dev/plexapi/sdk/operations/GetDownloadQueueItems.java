...
import dev.plexapi.sdk.models.operations.GetDownloadQueueItemsResponseBody;
...
public class GetDownloadQueueItems {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetDownloadQueueItemsRequest, GetDownloadQueueItemsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetDownloadQueueItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDownloadQueueItemsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetDownloadQueueItemsRequest request) {
        ...
        @Override
        public GetDownloadQueueItemsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetDownloadQueueItemsResponse.Builder resBuilder =
            ...
            GetDownloadQueueItemsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<GetDownloadQueueItemsResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetDownloadQueueItemsRequest, dev.plexapi.sdk.models.operations.async.GetDownloadQueueItemsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetDownloadQueueItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDownloadQueueItemsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetDownloadQueueItemsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetDownloadQueueItemsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetDownloadQueueItemsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetDownloadQueueItemsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetDownloadQueueItemsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetDownloadQueueItemsResponseBody>() {})
