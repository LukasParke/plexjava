...
public class PlayerSetTextStream {
    ...
    public static class Sync extends Base
            implements RequestOperation<PlayerSetTextStreamRequest, PlayerSetTextStreamResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(PlayerSetTextStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlayerSetTextStreamRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlayerSetTextStreamRequest request) {
        ...
        @Override
        public PlayerSetTextStreamResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlayerSetTextStreamResponse.Builder resBuilder =
            ...
            PlayerSetTextStreamResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlayerSetTextStreamRequest, dev.plexapi.sdk.models.operations.async.PlayerSetTextStreamResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(PlayerSetTextStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlayerSetTextStreamRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlayerSetTextStreamRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.PlayerSetTextStreamResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.PlayerSetTextStreamResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.PlayerSetTextStreamResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            dev.plexapi.sdk.models.operations.async.PlayerSetTextStreamResponse res = resBuilder.build();
