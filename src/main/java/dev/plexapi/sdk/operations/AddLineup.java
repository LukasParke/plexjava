...
public class AddLineup {
    ...
    public static class Sync extends Base
            implements RequestOperation<AddLineupRequest, AddLineupResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AddLineupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddLineupRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddLineupRequest request) {
        ...
        @Override
        public AddLineupResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AddLineupResponse.Builder resBuilder =
                    AddLineupResponse
                            .builder()
            ...
            AddLineupResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AddLineupRequest, dev.plexapi.sdk.models.operations.async.AddLineupResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AddLineupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddLineupRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AddLineupRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.AddLineupResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.AddLineupResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.AddLineupResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.AddLineupResponse res = resBuilder.build();
