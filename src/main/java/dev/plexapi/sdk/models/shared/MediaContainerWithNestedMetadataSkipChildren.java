...
public class MediaContainerWithNestedMetadataSkipChildren {
     ...
     * <ul>
     * <li>{@code boolean}</li>
     * <li>{@code dev.plexapi.sdk.models.shared.MediaContainerWithNestedMetadataSkipChildren2}</li>
     * </ul>
     * 
    ...
    public static final class _Deserializer extends OneOfDeserializer<MediaContainerWithNestedMetadataSkipChildren> {
