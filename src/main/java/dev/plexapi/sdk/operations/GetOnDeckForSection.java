...
public class GetOnDeckForSection {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetOnDeckForSectionRequest, GetOnDeckForSectionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetOnDeckForSectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetOnDeckForSectionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetOnDeckForSectionRequest request) {
        ...
        @Override
        public GetOnDeckForSectionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetOnDeckForSectionResponse.Builder resBuilder =
            ...
            GetOnDeckForSectionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetOnDeckForSectionRequest, dev.plexapi.sdk.models.operations.async.GetOnDeckForSectionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetOnDeckForSectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetOnDeckForSectionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetOnDeckForSectionRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetOnDeckForSectionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetOnDeckForSectionResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetOnDeckForSectionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetOnDeckForSectionResponse res = resBuilder.build();
