...
public class GetUserServerResponse implements Response {
    /**
     ...
     * HTTP response content type for this operation
     */
    public GetUserServerResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetUserServerResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetUserServerResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public GetUserServerResponse withConnectionInfo(ConnectionInfo connectionInfo) {
        Utils.checkNotNull(connectionInfo, "connectionInfo");
     ...
     * OK
     */
    public GetUserServerResponse withConnectionInfo(Optional<? extends ConnectionInfo> connectionInfo) {
        Utils.checkNotNull(connectionInfo, "connectionInfo");
        this.connectionInfo = connectionInfo;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetUserServerResponse other = (GetUserServerResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetUserServerResponse.class,
    ...
    public final static class Builder {
        ...
        public GetUserServerResponse build() {

            return new GetUserServerResponse(
                contentType, statusCode, rawResponse,
                connectionInfo);
        }
