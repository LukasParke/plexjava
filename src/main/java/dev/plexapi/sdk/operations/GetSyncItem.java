...
public class GetSyncItem {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSyncItemRequest, GetSyncItemResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetSyncItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSyncItemRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSyncItemRequest request) {
        ...
        @Override
        public GetSyncItemResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSyncItemResponse.Builder resBuilder =
                    GetSyncItemResponse
                            .builder()
            ...
            GetSyncItemResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSyncItemRequest, dev.plexapi.sdk.models.operations.async.GetSyncItemResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSyncItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSyncItemRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSyncItemRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetSyncItemResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetSyncItemResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetSyncItemResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetSyncItemResponse res = resBuilder.build();
