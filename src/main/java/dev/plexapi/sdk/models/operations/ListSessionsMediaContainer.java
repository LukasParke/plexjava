...
public class ListSessionsMediaContainer {
    ...
    @JsonCreator
    public ListSessionsMediaContainer(
    ...
    public ListSessionsMediaContainer withIdentifier(String identifier) {
        Utils.checkNotNull(identifier, "identifier");
    ...
    public ListSessionsMediaContainer withIdentifier(Optional<String> identifier) {
        Utils.checkNotNull(identifier, "identifier");
        this.identifier = identifier;
        return this;
    }
     ...
     * the `X-Plex-Container-Start` header.
     */
    public ListSessionsMediaContainer withOffset(long offset) {
        Utils.checkNotNull(offset, "offset");
     ...
     * the `X-Plex-Container-Start` header.
     */
    public ListSessionsMediaContainer withOffset(Optional<Long> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }

    public ListSessionsMediaContainer withSize(long size) {
        Utils.checkNotNull(size, "size");
    ...
    public ListSessionsMediaContainer withSize(Optional<Long> size) {
        Utils.checkNotNull(size, "size");
        this.size = size;
        return this;
    }
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public ListSessionsMediaContainer withTotalSize(long totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public ListSessionsMediaContainer withTotalSize(Optional<Long> totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
        this.totalSize = totalSize;
        return this;
    }

    public ListSessionsMediaContainer withMetadata(List<Metadata> metadata) {
        Utils.checkNotNull(metadata, "metadata");
    ...
    public ListSessionsMediaContainer withMetadata(Optional<? extends List<Metadata>> metadata) {
        Utils.checkNotNull(metadata, "metadata");
        this.metadata = metadata;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListSessionsMediaContainer other = (ListSessionsMediaContainer) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListSessionsMediaContainer.class,
    ...
    public final static class Builder {
        ...
        public ListSessionsMediaContainer build() {

            return new ListSessionsMediaContainer(
                identifier, offset, size,
                totalSize, metadata);
        }
