...
public class EditSection {
    ...
    public static class Sync extends Base
            implements RequestOperation<EditSectionRequest, EditSectionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(EditSectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EditSectionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(EditSectionRequest request) {
        ...
        @Override
        public EditSectionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            EditSectionResponse.Builder resBuilder =
                    EditSectionResponse
                            .builder()
            ...
            EditSectionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<EditSectionRequest, dev.plexapi.sdk.models.operations.async.EditSectionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(EditSectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EditSectionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(EditSectionRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.EditSectionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.EditSectionResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.EditSectionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.EditSectionResponse res = resBuilder.build();
