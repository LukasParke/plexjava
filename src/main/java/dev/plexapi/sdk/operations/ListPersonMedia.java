...
public class ListPersonMedia {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListPersonMediaRequest, ListPersonMediaResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListPersonMediaRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPersonMediaRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListPersonMediaRequest request) {
        ...
        @Override
        public ListPersonMediaResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListPersonMediaResponse.Builder resBuilder =
            ...
            ListPersonMediaResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListPersonMediaRequest, dev.plexapi.sdk.models.operations.async.ListPersonMediaResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListPersonMediaRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPersonMediaRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListPersonMediaRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.ListPersonMediaResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.ListPersonMediaResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.ListPersonMediaResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.ListPersonMediaResponse res = resBuilder.build();
