...
public class GetRandomArtwork {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetRandomArtworkRequest, GetRandomArtworkResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetRandomArtworkRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRandomArtworkRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetRandomArtworkRequest request) {
        ...
        @Override
        public GetRandomArtworkResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetRandomArtworkResponse.Builder resBuilder =
            ...
            GetRandomArtworkResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMediaContainerWithArtwork(Utils.unmarshal(response, new TypeReference<MediaContainerWithArtwork>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetRandomArtworkRequest, dev.plexapi.sdk.models.operations.async.GetRandomArtworkResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetRandomArtworkRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRandomArtworkRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetRandomArtworkRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetRandomArtworkResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetRandomArtworkResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetRandomArtworkResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetRandomArtworkResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MediaContainerWithArtwork>() {})
                            .thenApply(res::withMediaContainerWithArtwork);
                } else {
