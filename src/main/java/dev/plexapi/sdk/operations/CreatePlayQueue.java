...
public class CreatePlayQueue {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreatePlayQueueRequest, CreatePlayQueueResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CreatePlayQueueRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreatePlayQueueRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreatePlayQueueRequest request) {
        ...
        @Override
        public CreatePlayQueueResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreatePlayQueueResponse.Builder resBuilder =
            ...
            CreatePlayQueueResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreatePlayQueueRequest, dev.plexapi.sdk.models.operations.async.CreatePlayQueueResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CreatePlayQueueRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreatePlayQueueRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreatePlayQueueRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.CreatePlayQueueResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.CreatePlayQueueResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.CreatePlayQueueResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.CreatePlayQueueResponse res = resBuilder.build();
