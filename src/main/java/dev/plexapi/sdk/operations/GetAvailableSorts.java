...
public class GetAvailableSorts {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAvailableSortsRequest, GetAvailableSortsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetAvailableSortsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAvailableSortsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAvailableSortsRequest request) {
        ...
        @Override
        public GetAvailableSortsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAvailableSortsResponse.Builder resBuilder =
            ...
            GetAvailableSortsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMediaContainerWithSorts(Utils.unmarshal(response, new TypeReference<MediaContainerWithSorts>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAvailableSortsRequest, dev.plexapi.sdk.models.operations.async.GetAvailableSortsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetAvailableSortsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAvailableSortsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAvailableSortsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetAvailableSortsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetAvailableSortsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetAvailableSortsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetAvailableSortsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MediaContainerWithSorts>() {})
                            .thenApply(res::withMediaContainerWithSorts);
                } else {
