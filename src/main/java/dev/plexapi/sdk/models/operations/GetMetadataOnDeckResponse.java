...
public class GetMetadataOnDeckResponse implements Response {
    /**
    ...
    @JsonCreator
    public GetMetadataOnDeckResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public GetMetadataOnDeckResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetMetadataOnDeckResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetMetadataOnDeckResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public GetMetadataOnDeckResponse withMediaContainerWithMetadata(MediaContainerWithMetadata mediaContainerWithMetadata) {
        Utils.checkNotNull(mediaContainerWithMetadata, "mediaContainerWithMetadata");
     ...
     * OK
     */
    public GetMetadataOnDeckResponse withMediaContainerWithMetadata(Optional<? extends MediaContainerWithMetadata> mediaContainerWithMetadata) {
        Utils.checkNotNull(mediaContainerWithMetadata, "mediaContainerWithMetadata");
        this.mediaContainerWithMetadata = mediaContainerWithMetadata;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetMetadataOnDeckResponse other = (GetMetadataOnDeckResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetMetadataOnDeckResponse.class,
    ...
    public final static class Builder {
        ...
        public GetMetadataOnDeckResponse build() {

            return new GetMetadataOnDeckResponse(
                contentType, statusCode, rawResponse,
                mediaContainerWithMetadata);
        }
