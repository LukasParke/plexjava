...
public class GetLineupChannelsMediaContainer {
    ...
    @JsonCreator
    public GetLineupChannelsMediaContainer(
    ...
    public GetLineupChannelsMediaContainer withIdentifier(String identifier) {
        Utils.checkNotNull(identifier, "identifier");
    ...
    public GetLineupChannelsMediaContainer withIdentifier(Optional<String> identifier) {
        Utils.checkNotNull(identifier, "identifier");
        this.identifier = identifier;
        return this;
    }
     ...
     * the `X-Plex-Container-Start` header.
     */
    public GetLineupChannelsMediaContainer withOffset(long offset) {
        Utils.checkNotNull(offset, "offset");
     ...
     * the `X-Plex-Container-Start` header.
     */
    public GetLineupChannelsMediaContainer withOffset(Optional<Long> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }

    public GetLineupChannelsMediaContainer withSize(long size) {
        Utils.checkNotNull(size, "size");
    ...
    public GetLineupChannelsMediaContainer withSize(Optional<Long> size) {
        Utils.checkNotNull(size, "size");
        this.size = size;
        return this;
    }
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public GetLineupChannelsMediaContainer withTotalSize(long totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public GetLineupChannelsMediaContainer withTotalSize(Optional<Long> totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
        this.totalSize = totalSize;
        return this;
    }

    public GetLineupChannelsMediaContainer withLineup(List<Lineup> lineup) {
        Utils.checkNotNull(lineup, "lineup");
    ...
    public GetLineupChannelsMediaContainer withLineup(Optional<? extends List<Lineup>> lineup) {
        Utils.checkNotNull(lineup, "lineup");
        this.lineup = lineup;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetLineupChannelsMediaContainer other = (GetLineupChannelsMediaContainer) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetLineupChannelsMediaContainer.class,
    ...
    public final static class Builder {
        ...
        public GetLineupChannelsMediaContainer build() {

            return new GetLineupChannelsMediaContainer(
                identifier, offset, size,
                totalSize, lineup);
        }
