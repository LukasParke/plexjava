...
public class GetNearestMetadataRequest {
    ...
    @JsonCreator
    public GetNearestMetadataRequest(
     ...
     * Indicates the client accepts the indicated media types
     */
    public GetNearestMetadataRequest withAccepts(Accepts accepts) {
        Utils.checkNotNull(accepts, "accepts");
     ...
     * Indicates the client accepts the indicated media types
     */
    public GetNearestMetadataRequest withAccepts(Optional<? extends Accepts> accepts) {
        Utils.checkNotNull(accepts, "accepts");
        this.accepts = accepts;
        return this;
    }
     ...
     * An opaque identifier unique to the client
     */
    public GetNearestMetadataRequest withClientIdentifier(String clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
     ...
     * An opaque identifier unique to the client
     */
    public GetNearestMetadataRequest withClientIdentifier(Optional<String> clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
        this.clientIdentifier = clientIdentifier;
        return this;
    }
     ...
     * The name of the client product
     */
    public GetNearestMetadataRequest withProduct(String product) {
        Utils.checkNotNull(product, "product");
     ...
     * The name of the client product
     */
    public GetNearestMetadataRequest withProduct(Optional<String> product) {
        Utils.checkNotNull(product, "product");
        this.product = product;
        return this;
    }
     ...
     * The version of the client application
     */
    public GetNearestMetadataRequest withVersion(String version) {
        Utils.checkNotNull(version, "version");
     ...
     * The version of the client application
     */
    public GetNearestMetadataRequest withVersion(Optional<String> version) {
        Utils.checkNotNull(version, "version");
        this.version = version;
        return this;
    }
     ...
     * The platform of the client
     */
    public GetNearestMetadataRequest withPlatform(String platform) {
        Utils.checkNotNull(platform, "platform");
     ...
     * The platform of the client
     */
    public GetNearestMetadataRequest withPlatform(Optional<String> platform) {
        Utils.checkNotNull(platform, "platform");
        this.platform = platform;
        return this;
    }
     ...
     * The version of the platform
     */
    public GetNearestMetadataRequest withPlatformVersion(String platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
     ...
     * The version of the platform
     */
    public GetNearestMetadataRequest withPlatformVersion(Optional<String> platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
        this.platformVersion = platformVersion;
        return this;
    }
     ...
     * A relatively friendly name for the client device
     */
    public GetNearestMetadataRequest withDevice(String device) {
        Utils.checkNotNull(device, "device");
     ...
     * A relatively friendly name for the client device
     */
    public GetNearestMetadataRequest withDevice(Optional<String> device) {
        Utils.checkNotNull(device, "device");
        this.device = device;
        return this;
    }
     ...
     * A potentially less friendly identifier for the device model
     */
    public GetNearestMetadataRequest withModel(String model) {
        Utils.checkNotNull(model, "model");
     ...
     * A potentially less friendly identifier for the device model
     */
    public GetNearestMetadataRequest withModel(Optional<String> model) {
        Utils.checkNotNull(model, "model");
        this.model = model;
        return this;
    }
     ...
     * The device vendor
     */
    public GetNearestMetadataRequest withDeviceVendor(String deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
     ...
     * The device vendor
     */
    public GetNearestMetadataRequest withDeviceVendor(Optional<String> deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
        this.deviceVendor = deviceVendor;
        return this;
    }
     ...
     * A friendly name for the client
     */
    public GetNearestMetadataRequest withDeviceName(String deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
     ...
     * A friendly name for the client
     */
    public GetNearestMetadataRequest withDeviceName(Optional<String> deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
        this.deviceName = deviceName;
        return this;
    }
     ...
     * The marketplace on which the client application is distributed
     */
    public GetNearestMetadataRequest withMarketplace(String marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
     ...
     * The marketplace on which the client application is distributed
     */
    public GetNearestMetadataRequest withMarketplace(Optional<String> marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
        this.marketplace = marketplace;
        return this;
    }
     ...
     * The unique identifier of the item
     */
    public GetNearestMetadataRequest withId(long id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * The unique identifier of the excludeparent
     */
    public GetNearestMetadataRequest withExcludeParentID(long excludeParentID) {
        Utils.checkNotNull(excludeParentID, "excludeParentID");
     ...
     * The unique identifier of the excludeparent
     */
    public GetNearestMetadataRequest withExcludeParentID(Optional<Long> excludeParentID) {
        Utils.checkNotNull(excludeParentID, "excludeParentID");
        this.excludeParentID = excludeParentID;
        return this;
    }
     ...
     * The unique identifier of the excludegrandparent
     */
    public GetNearestMetadataRequest withExcludeGrandparentID(long excludeGrandparentID) {
        Utils.checkNotNull(excludeGrandparentID, "excludeGrandparentID");
     ...
     * The unique identifier of the excludegrandparent
     */
    public GetNearestMetadataRequest withExcludeGrandparentID(Optional<Long> excludeGrandparentID) {
        Utils.checkNotNull(excludeGrandparentID, "excludeGrandparentID");
        this.excludeGrandparentID = excludeGrandparentID;
        return this;
    }
     ...
     * Maximum number of items to return
     */
    public GetNearestMetadataRequest withLimit(long limit) {
        Utils.checkNotNull(limit, "limit");
     ...
     * Maximum number of items to return
     */
    public GetNearestMetadataRequest withLimit(Optional<Long> limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = limit;
        return this;
    }
     ...
     * The maxDistance
     */
    public GetNearestMetadataRequest withMaxDistance(double maxDistance) {
        Utils.checkNotNull(maxDistance, "maxDistance");
     ...
     * The maxDistance
     */
    public GetNearestMetadataRequest withMaxDistance(Optional<Double> maxDistance) {
        Utils.checkNotNull(maxDistance, "maxDistance");
        this.maxDistance = maxDistance;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetNearestMetadataRequest other = (GetNearestMetadataRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetNearestMetadataRequest.class,
                "accepts", accepts,
    ...
    public final static class Builder {
        ...
        public GetNearestMetadataRequest build() {
            if (accepts == null) {
                accepts = _SINGLETON_VALUE_Accepts.value();
            }

            return new GetNearestMetadataRequest(
                accepts, clientIdentifier, product,
                version, platform, platformVersion,
                device, model, deviceVendor,
                deviceName, marketplace, id,
