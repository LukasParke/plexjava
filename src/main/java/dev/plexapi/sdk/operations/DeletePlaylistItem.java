...
public class DeletePlaylistItem {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeletePlaylistItemRequest, DeletePlaylistItemResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeletePlaylistItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeletePlaylistItemRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeletePlaylistItemRequest request) {
        ...
        @Override
        public DeletePlaylistItemResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeletePlaylistItemResponse.Builder resBuilder =
            ...
            DeletePlaylistItemResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeletePlaylistItemRequest, dev.plexapi.sdk.models.operations.async.DeletePlaylistItemResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeletePlaylistItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeletePlaylistItemRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeletePlaylistItemRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.DeletePlaylistItemResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.DeletePlaylistItemResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.DeletePlaylistItemResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.DeletePlaylistItemResponse res = resBuilder.build();
