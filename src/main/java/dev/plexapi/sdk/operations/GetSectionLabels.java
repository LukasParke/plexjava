...
public class GetSectionLabels {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSectionLabelsRequest, GetSectionLabelsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetSectionLabelsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSectionLabelsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSectionLabelsRequest request) {
        ...
        @Override
        public GetSectionLabelsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSectionLabelsResponse.Builder resBuilder =
            ...
            GetSectionLabelsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMediaContainerWithTags(Utils.unmarshal(response, new TypeReference<MediaContainerWithTags>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSectionLabelsRequest, dev.plexapi.sdk.models.operations.async.GetSectionLabelsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSectionLabelsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSectionLabelsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSectionLabelsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetSectionLabelsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetSectionLabelsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetSectionLabelsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetSectionLabelsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MediaContainerWithTags>() {})
                            .thenApply(res::withMediaContainerWithTags);
                } else {
