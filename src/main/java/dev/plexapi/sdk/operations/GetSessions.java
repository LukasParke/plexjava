...
public class GetSessions {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSessionsRequest, GetSessionsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetSessionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSessionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSessionsRequest request) {
        ...
        @Override
        public GetSessionsResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSessionsRequest, dev.plexapi.sdk.models.operations.async.GetSessionsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSessionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSessionsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSessionsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetSessionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetSessionsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetSessionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
