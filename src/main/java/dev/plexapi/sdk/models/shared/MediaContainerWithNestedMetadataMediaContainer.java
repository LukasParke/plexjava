...
public class MediaContainerWithNestedMetadataMediaContainer {
    ...
    private Optional<? extends List<MetadataItem>> metadataItem;
    ...
    public MediaContainerWithNestedMetadataMediaContainer(
            ...
            @JsonProperty("MetadataItem") Optional<? extends List<MetadataItem>> metadataItem) {
    ...
    @JsonIgnore
    public Optional<List<MetadataItem>> metadataItem() {
        return (Optional<List<MetadataItem>>) metadataItem;
    }
    ...
    public MediaContainerWithNestedMetadataMediaContainer withIdentifier(String identifier) {
        Utils.checkNotNull(identifier, "identifier");
    ...
    public MediaContainerWithNestedMetadataMediaContainer withIdentifier(Optional<String> identifier) {
        Utils.checkNotNull(identifier, "identifier");
        this.identifier = identifier;
        return this;
    }
     ...
     * the `X-Plex-Container-Start` header.
     */
    public MediaContainerWithNestedMetadataMediaContainer withOffset(long offset) {
        Utils.checkNotNull(offset, "offset");
     ...
     * the `X-Plex-Container-Start` header.
     */
    public MediaContainerWithNestedMetadataMediaContainer withOffset(Optional<Long> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }

    public MediaContainerWithNestedMetadataMediaContainer withSize(long size) {
        Utils.checkNotNull(size, "size");
    ...
    public MediaContainerWithNestedMetadataMediaContainer withSize(Optional<Long> size) {
        Utils.checkNotNull(size, "size");
        this.size = size;
        return this;
    }
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public MediaContainerWithNestedMetadataMediaContainer withTotalSize(long totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public MediaContainerWithNestedMetadataMediaContainer withTotalSize(Optional<Long> totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
        this.totalSize = totalSize;
        return this;
    }

    public MediaContainerWithNestedMetadataMediaContainer withMetadataItem(List<MetadataItem> metadataItem) {
        Utils.checkNotNull(metadataItem, "metadataItem");
    ...
    public MediaContainerWithNestedMetadataMediaContainer withMetadataItem(Optional<? extends List<MetadataItem>> metadataItem) {
        Utils.checkNotNull(metadataItem, "metadataItem");
        this.metadataItem = metadataItem;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        MediaContainerWithNestedMetadataMediaContainer other = (MediaContainerWithNestedMetadataMediaContainer) o;
        return 
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            totalSize, metadataItem);
    }
    
    @Override
    public String toString() {
        return Utils.toString(MediaContainerWithNestedMetadataMediaContainer.class,
    ...
    public final static class Builder {
        ...
        private Optional<? extends List<MetadataItem>> metadataItem = Optional.empty();
        ...
        public Builder metadataItem(List<MetadataItem> metadataItem) {
            Utils.checkNotNull(metadataItem, "metadataItem");
            this.metadataItem = Optional.ofNullable(metadataItem);
            return this;
        }

        public Builder metadataItem(Optional<? extends List<MetadataItem>> metadataItem) {
            Utils.checkNotNull(metadataItem, "metadataItem");
            this.metadataItem = metadataItem;
            return this;
        }

        public MediaContainerWithNestedMetadataMediaContainer build() {

            return new MediaContainerWithNestedMetadataMediaContainer(
                identifier, offset, size,
                totalSize, metadataItem);
        }
