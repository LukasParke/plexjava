...
public class SplitItem {
    ...
    public static class Sync extends Base
            implements RequestOperation<SplitItemRequest, SplitItemResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(SplitItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SplitItemRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(SplitItemRequest request) {
        ...
        @Override
        public SplitItemResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            SplitItemResponse.Builder resBuilder =
                    SplitItemResponse
                            .builder()
            ...
            SplitItemResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SplitItemRequest, dev.plexapi.sdk.models.operations.async.SplitItemResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(SplitItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SplitItemRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(SplitItemRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.SplitItemResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.SplitItemResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.SplitItemResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.SplitItemResponse res = resBuilder.build();
