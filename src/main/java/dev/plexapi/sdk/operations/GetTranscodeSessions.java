...
public class GetTranscodeSessions {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<GetTranscodeSessionsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        @Override
        public GetTranscodeSessionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetTranscodeSessionsResponse.Builder resBuilder =
            ...
            GetTranscodeSessionsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<dev.plexapi.sdk.models.operations.async.GetTranscodeSessionsResponse> {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetTranscodeSessionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetTranscodeSessionsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetTranscodeSessionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetTranscodeSessionsResponse res = resBuilder.build();
