...
import dev.plexapi.sdk.models.operations.GetPlaylistGeneratorItemsResponseBody;
...
public class GetPlaylistGeneratorItems {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPlaylistGeneratorItemsRequest, GetPlaylistGeneratorItemsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetPlaylistGeneratorItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPlaylistGeneratorItemsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPlaylistGeneratorItemsRequest request) {
        ...
        @Override
        public GetPlaylistGeneratorItemsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetPlaylistGeneratorItemsResponse.Builder resBuilder =
            ...
            GetPlaylistGeneratorItemsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<GetPlaylistGeneratorItemsResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetPlaylistGeneratorItemsRequest, dev.plexapi.sdk.models.operations.async.GetPlaylistGeneratorItemsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetPlaylistGeneratorItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPlaylistGeneratorItemsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetPlaylistGeneratorItemsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetPlaylistGeneratorItemsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetPlaylistGeneratorItemsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetPlaylistGeneratorItemsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetPlaylistGeneratorItemsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetPlaylistGeneratorItemsResponseBody>() {})
