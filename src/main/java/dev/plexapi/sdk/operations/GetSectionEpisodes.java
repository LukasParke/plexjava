...
public class GetSectionEpisodes {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/library/sections/{sectionId}/episodes",
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSectionEpisodesRequest, GetSectionEpisodesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetSectionEpisodesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSectionEpisodesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSectionEpisodesRequest request) {
        ...
        @Override
        public GetSectionEpisodesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSectionEpisodesResponse.Builder resBuilder =
            ...
            GetSectionEpisodesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSectionEpisodesRequest, dev.plexapi.sdk.models.operations.async.GetSectionEpisodesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSectionEpisodesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSectionEpisodesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSectionEpisodesRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetSectionEpisodesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetSectionEpisodesResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetSectionEpisodesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetSectionEpisodesResponse res = resBuilder.build();
