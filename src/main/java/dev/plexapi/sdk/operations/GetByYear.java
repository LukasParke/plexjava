...
public class GetByYear {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/library/sections/{sectionId}/byYear",
    ...
    public static class Sync extends Base
            implements RequestOperation<GetByYearRequest, GetByYearResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetByYearRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetByYearRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetByYearRequest request) {
        ...
        @Override
        public GetByYearResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetByYearResponse.Builder resBuilder =
                    GetByYearResponse
                            .builder()
            ...
            GetByYearResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetByYearRequest, dev.plexapi.sdk.models.operations.async.GetByYearResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetByYearRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetByYearRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetByYearRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetByYearResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetByYearResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetByYearResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetByYearResponse res = resBuilder.build();
