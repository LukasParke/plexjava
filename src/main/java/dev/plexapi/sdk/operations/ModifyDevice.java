...
import dev.plexapi.sdk.models.operations.ModifyDeviceResponseBody;
...
public class ModifyDevice {
    ...
    public static class Sync extends Base
            implements RequestOperation<ModifyDeviceRequest, ModifyDeviceResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ModifyDeviceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ModifyDeviceRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ModifyDeviceRequest request) {
        ...
        @Override
        public ModifyDeviceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ModifyDeviceResponse.Builder resBuilder =
            ...
            ModifyDeviceResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<ModifyDeviceResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ModifyDeviceRequest, dev.plexapi.sdk.models.operations.async.ModifyDeviceResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ModifyDeviceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ModifyDeviceRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ModifyDeviceRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.ModifyDeviceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.ModifyDeviceResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.ModifyDeviceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.ModifyDeviceResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ModifyDeviceResponseBody>() {})
