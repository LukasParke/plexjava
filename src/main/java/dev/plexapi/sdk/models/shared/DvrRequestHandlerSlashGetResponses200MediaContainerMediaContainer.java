...
public class DvrRequestHandlerSlashGetResponses200MediaContainerMediaContainer {
    ...
    @JsonCreator
    public DvrRequestHandlerSlashGetResponses200MediaContainerMediaContainer(
    ...
    public DvrRequestHandlerSlashGetResponses200MediaContainerMediaContainer withIdentifier(String identifier) {
        Utils.checkNotNull(identifier, "identifier");
    ...
    public DvrRequestHandlerSlashGetResponses200MediaContainerMediaContainer withIdentifier(Optional<String> identifier) {
        Utils.checkNotNull(identifier, "identifier");
        this.identifier = identifier;
        return this;
    }
     ...
     * the `X-Plex-Container-Start` header.
     */
    public DvrRequestHandlerSlashGetResponses200MediaContainerMediaContainer withOffset(long offset) {
        Utils.checkNotNull(offset, "offset");
     ...
     * the `X-Plex-Container-Start` header.
     */
    public DvrRequestHandlerSlashGetResponses200MediaContainerMediaContainer withOffset(Optional<Long> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }

    public DvrRequestHandlerSlashGetResponses200MediaContainerMediaContainer withSize(long size) {
        Utils.checkNotNull(size, "size");
    ...
    public DvrRequestHandlerSlashGetResponses200MediaContainerMediaContainer withSize(Optional<Long> size) {
        Utils.checkNotNull(size, "size");
        this.size = size;
        return this;
    }
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public DvrRequestHandlerSlashGetResponses200MediaContainerMediaContainer withTotalSize(long totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public DvrRequestHandlerSlashGetResponses200MediaContainerMediaContainer withTotalSize(Optional<Long> totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
        this.totalSize = totalSize;
        return this;
    }
     ...
     * A status indicator. If present and non-zero, indicates an error
     */
    public DvrRequestHandlerSlashGetResponses200MediaContainerMediaContainer withStatus(long status) {
        Utils.checkNotNull(status, "status");
     ...
     * A status indicator. If present and non-zero, indicates an error
     */
    public DvrRequestHandlerSlashGetResponses200MediaContainerMediaContainer withStatus(Optional<Long> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DvrRequestHandlerSlashGetResponses200MediaContainerMediaContainer other = (DvrRequestHandlerSlashGetResponses200MediaContainerMediaContainer) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DvrRequestHandlerSlashGetResponses200MediaContainerMediaContainer.class,
    ...
    public final static class Builder {
        ...
        public DvrRequestHandlerSlashGetResponses200MediaContainerMediaContainer build() {

            return new DvrRequestHandlerSlashGetResponses200MediaContainerMediaContainer(
                identifier, offset, size,
                totalSize, status);
        }
