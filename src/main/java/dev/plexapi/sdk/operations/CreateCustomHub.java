...
public class CreateCustomHub {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCustomHubRequest, CreateCustomHubResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CreateCustomHubRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCustomHubRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCustomHubRequest request) {
        ...
        @Override
        public CreateCustomHubResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCustomHubResponse.Builder resBuilder =
            ...
            CreateCustomHubResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCustomHubRequest, dev.plexapi.sdk.models.operations.async.CreateCustomHubResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CreateCustomHubRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCustomHubRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCustomHubRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.CreateCustomHubResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.CreateCustomHubResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.CreateCustomHubResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.CreateCustomHubResponse res = resBuilder.build();
