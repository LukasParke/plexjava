...
public class MediaContainerWithSortsMediaContainer {
    ...
    private Optional<? extends List<Sort>> directory;

    @JsonCreator
    public MediaContainerWithSortsMediaContainer(
            ...
            @JsonProperty("Directory") Optional<? extends List<Sort>> directory) {
    ...
    @JsonIgnore
    public Optional<List<Sort>> directory() {
        return (Optional<List<Sort>>) directory;
    }
    ...
    public MediaContainerWithSortsMediaContainer withIdentifier(String identifier) {
        Utils.checkNotNull(identifier, "identifier");
    ...
    public MediaContainerWithSortsMediaContainer withIdentifier(Optional<String> identifier) {
        Utils.checkNotNull(identifier, "identifier");
        this.identifier = identifier;
        return this;
    }
     ...
     * the `X-Plex-Container-Start` header.
     */
    public MediaContainerWithSortsMediaContainer withOffset(long offset) {
        Utils.checkNotNull(offset, "offset");
     ...
     * the `X-Plex-Container-Start` header.
     */
    public MediaContainerWithSortsMediaContainer withOffset(Optional<Long> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }

    public MediaContainerWithSortsMediaContainer withSize(long size) {
        Utils.checkNotNull(size, "size");
    ...
    public MediaContainerWithSortsMediaContainer withSize(Optional<Long> size) {
        Utils.checkNotNull(size, "size");
        this.size = size;
        return this;
    }
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public MediaContainerWithSortsMediaContainer withTotalSize(long totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public MediaContainerWithSortsMediaContainer withTotalSize(Optional<Long> totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
        this.totalSize = totalSize;
        return this;
    }

    public MediaContainerWithSortsMediaContainer withDirectory(List<Sort> directory) {
        Utils.checkNotNull(directory, "directory");
    ...
    public MediaContainerWithSortsMediaContainer withDirectory(Optional<? extends List<Sort>> directory) {
        Utils.checkNotNull(directory, "directory");
        this.directory = directory;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        MediaContainerWithSortsMediaContainer other = (MediaContainerWithSortsMediaContainer) o;
        return 
    ...
    public String toString() {
        return Utils.toString(MediaContainerWithSortsMediaContainer.class,
    ...
    public final static class Builder {
        ...
        private Optional<? extends List<Sort>> directory = Optional.empty();
        ...
        public Builder directory(List<Sort> directory) {
            Utils.checkNotNull(directory, "directory");
            this.directory = Optional.ofNullable(directory);
            return this;
        }

        public Builder directory(Optional<? extends List<Sort>> directory) {
            Utils.checkNotNull(directory, "directory");
            this.directory = directory;
            return this;
        }

        public MediaContainerWithSortsMediaContainer build() {

            return new MediaContainerWithSortsMediaContainer(
                identifier, offset, size,
                totalSize, directory);
        }
