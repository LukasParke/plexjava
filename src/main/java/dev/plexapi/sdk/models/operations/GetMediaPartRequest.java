...
public class GetMediaPartRequest {
    ...
    public GetMediaPartRequest(
            ...
            long changestamp,
            String filename,
            Optional<? extends BoolInt> download) {
    ...
    public GetMediaPartRequest(
        ...
        this(Optional.empty(), Optional.empty(), Optional.empty(),
            ...
            changestamp, filename, Optional.empty());
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<BoolInt> download() {
        return (Optional<BoolInt>) download;
    }
     ...
     * Indicates the client accepts the indicated media types
     */
    public GetMediaPartRequest withAccepts(Accepts accepts) {
        Utils.checkNotNull(accepts, "accepts");
     ...
     * Indicates the client accepts the indicated media types
     */
    public GetMediaPartRequest withAccepts(Optional<? extends Accepts> accepts) {
        Utils.checkNotNull(accepts, "accepts");
        this.accepts = accepts;
        return this;
    }
     ...
     * An opaque identifier unique to the client
     */
    public GetMediaPartRequest withClientIdentifier(String clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
     ...
     * An opaque identifier unique to the client
     */
    public GetMediaPartRequest withClientIdentifier(Optional<String> clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
        this.clientIdentifier = clientIdentifier;
        return this;
    }
     ...
     * The name of the client product
     */
    public GetMediaPartRequest withProduct(String product) {
        Utils.checkNotNull(product, "product");
     ...
     * The name of the client product
     */
    public GetMediaPartRequest withProduct(Optional<String> product) {
        Utils.checkNotNull(product, "product");
        this.product = product;
        return this;
    }
     ...
     * The version of the client application
     */
    public GetMediaPartRequest withVersion(String version) {
        Utils.checkNotNull(version, "version");
     ...
     * The version of the client application
     */
    public GetMediaPartRequest withVersion(Optional<String> version) {
        Utils.checkNotNull(version, "version");
        this.version = version;
        return this;
    }
     ...
     * The platform of the client
     */
    public GetMediaPartRequest withPlatform(String platform) {
        Utils.checkNotNull(platform, "platform");
     ...
     * The platform of the client
     */
    public GetMediaPartRequest withPlatform(Optional<String> platform) {
        Utils.checkNotNull(platform, "platform");
        this.platform = platform;
        return this;
    }
     ...
     * The version of the platform
     */
    public GetMediaPartRequest withPlatformVersion(String platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
     ...
     * The version of the platform
     */
    public GetMediaPartRequest withPlatformVersion(Optional<String> platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
        this.platformVersion = platformVersion;
        return this;
    }
     ...
     * A relatively friendly name for the client device
     */
    public GetMediaPartRequest withDevice(String device) {
        Utils.checkNotNull(device, "device");
     ...
     * A relatively friendly name for the client device
     */
    public GetMediaPartRequest withDevice(Optional<String> device) {
        Utils.checkNotNull(device, "device");
        this.device = device;
        return this;
    }
     ...
     * A potentially less friendly identifier for the device model
     */
    public GetMediaPartRequest withModel(String model) {
        Utils.checkNotNull(model, "model");
     ...
     * A potentially less friendly identifier for the device model
     */
    public GetMediaPartRequest withModel(Optional<String> model) {
        Utils.checkNotNull(model, "model");
        this.model = model;
        return this;
    }
     ...
     * The device vendor
     */
    public GetMediaPartRequest withDeviceVendor(String deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
     ...
     * The device vendor
     */
    public GetMediaPartRequest withDeviceVendor(Optional<String> deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
        this.deviceVendor = deviceVendor;
        return this;
    }
     ...
     * A friendly name for the client
     */
    public GetMediaPartRequest withDeviceName(String deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
     ...
     * A friendly name for the client
     */
    public GetMediaPartRequest withDeviceName(Optional<String> deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
        this.deviceName = deviceName;
        return this;
    }
     ...
     * The marketplace on which the client application is distributed
     */
    public GetMediaPartRequest withMarketplace(String marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
     ...
     * The marketplace on which the client application is distributed
     */
    public GetMediaPartRequest withMarketplace(Optional<String> marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
        this.marketplace = marketplace;
        return this;
    }
     ...
     * The part id who's index is to be fetched
     */
    public GetMediaPartRequest withPartId(long partId) {
        Utils.checkNotNull(partId, "partId");
        this.partId = partId;
        return this;
    }
     ...
     * Whether this is a file download
     */
    public GetMediaPartRequest withDownload(BoolInt download) {
        Utils.checkNotNull(download, "download");
     ...
     * Whether this is a file download
     */
    public GetMediaPartRequest withDownload(Optional<? extends BoolInt> download) {
        Utils.checkNotNull(download, "download");
        this.download = download;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetMediaPartRequest other = (GetMediaPartRequest) o;
        return 
            ...
            Utils.enhancedDeepEquals(this.changestamp, other.changestamp) &&
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            changestamp, filename, download);
    }
    
    @Override
    public String toString() {
        return Utils.toString(GetMediaPartRequest.class,
                "accepts", accepts,
    ...
    public final static class Builder {
         ...
         * Whether this is a file download
         */
        public Builder download(BoolInt download) {
            Utils.checkNotNull(download, "download");
            this.download = Optional.ofNullable(download);
            return this;
        }
         ...
         * Whether this is a file download
         */
        public Builder download(Optional<? extends BoolInt> download) {
            Utils.checkNotNull(download, "download");
            this.download = download;
            return this;
        }

        public GetMediaPartRequest build() {
            if (accepts == null) {
