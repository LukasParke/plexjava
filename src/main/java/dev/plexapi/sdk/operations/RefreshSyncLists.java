...
public class RefreshSyncLists {
    ...
    public static class Sync extends Base
            implements RequestOperation<RefreshSyncListsRequest, RefreshSyncListsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(RefreshSyncListsRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RefreshSyncListsRequest request) {
        ...
        @Override
        public RefreshSyncListsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RefreshSyncListsResponse.Builder resBuilder =
            ...
            RefreshSyncListsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RefreshSyncListsRequest, dev.plexapi.sdk.models.operations.async.RefreshSyncListsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(RefreshSyncListsRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RefreshSyncListsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.RefreshSyncListsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.RefreshSyncListsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.RefreshSyncListsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.RefreshSyncListsResponse res = resBuilder.build();
