...
public class GetPostplayHubs {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPostplayHubsRequest, GetPostplayHubsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetPostplayHubsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPostplayHubsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPostplayHubsRequest request) {
        ...
        @Override
        public GetPostplayHubsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetPostplayHubsResponse.Builder resBuilder =
            ...
            GetPostplayHubsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetPostplayHubsRequest, dev.plexapi.sdk.models.operations.async.GetPostplayHubsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetPostplayHubsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPostplayHubsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetPostplayHubsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetPostplayHubsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetPostplayHubsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetPostplayHubsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetPostplayHubsResponse res = resBuilder.build();
