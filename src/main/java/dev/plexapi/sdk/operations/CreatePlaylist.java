...
public class CreatePlaylist {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreatePlaylistRequest, CreatePlaylistResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CreatePlaylistRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreatePlaylistRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreatePlaylistRequest request) {
        ...
        @Override
        public CreatePlaylistResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreatePlaylistResponse.Builder resBuilder =
            ...
            CreatePlaylistResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreatePlaylistRequest, dev.plexapi.sdk.models.operations.async.CreatePlaylistResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CreatePlaylistRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreatePlaylistRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreatePlaylistRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.CreatePlaylistResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.CreatePlaylistResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.CreatePlaylistResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.CreatePlaylistResponse res = resBuilder.build();
