...
public class GetMyPlexAccount {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<GetMyPlexAccountResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        @Override
        public GetMyPlexAccountResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetMyPlexAccountResponse.Builder resBuilder =
            ...
            GetMyPlexAccountResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<dev.plexapi.sdk.models.operations.async.GetMyPlexAccountResponse> {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetMyPlexAccountResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetMyPlexAccountResponse.Builder resBuilder =
            ...
            dev.plexapi.sdk.models.operations.async.GetMyPlexAccountResponse res = resBuilder.build();
