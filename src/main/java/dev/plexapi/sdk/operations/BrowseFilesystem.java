...
public class BrowseFilesystem {
    ...
    public static class Sync extends Base
            implements RequestOperation<BrowseFilesystemRequest, BrowseFilesystemResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(BrowseFilesystemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, BrowseFilesystemRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(BrowseFilesystemRequest request) {
        ...
        @Override
        public BrowseFilesystemResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            BrowseFilesystemResponse.Builder resBuilder =
            ...
            BrowseFilesystemResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<BrowseFilesystemRequest, dev.plexapi.sdk.models.operations.async.BrowseFilesystemResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(BrowseFilesystemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, BrowseFilesystemRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(BrowseFilesystemRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.BrowseFilesystemResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.BrowseFilesystemResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.BrowseFilesystemResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.BrowseFilesystemResponse res = resBuilder.build();
