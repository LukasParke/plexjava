...
public class GetRootLibraryResponse implements Response {
    /**
     ...
     * HTTP response content type for this operation
     */
    public GetRootLibraryResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetRootLibraryResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetRootLibraryResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public GetRootLibraryResponse withMediaContainerWithDirectory(MediaContainerWithDirectory mediaContainerWithDirectory) {
        Utils.checkNotNull(mediaContainerWithDirectory, "mediaContainerWithDirectory");
     ...
     * OK
     */
    public GetRootLibraryResponse withMediaContainerWithDirectory(Optional<? extends MediaContainerWithDirectory> mediaContainerWithDirectory) {
        Utils.checkNotNull(mediaContainerWithDirectory, "mediaContainerWithDirectory");
        this.mediaContainerWithDirectory = mediaContainerWithDirectory;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetRootLibraryResponse other = (GetRootLibraryResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetRootLibraryResponse.class,
    ...
    public final static class Builder {
        ...
        public GetRootLibraryResponse build() {

            return new GetRootLibraryResponse(
                contentType, statusCode, rawResponse,
                mediaContainerWithDirectory);
        }
