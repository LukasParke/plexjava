...
public class Release {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("state")
    private Optional<? extends ReleaseState> state;
    ...
    public Release(
            ...
            @JsonProperty("state") Optional<? extends ReleaseState> state,
    ...
    @JsonIgnore
    public Optional<ReleaseState> state() {
        return (Optional<ReleaseState>) state;
    }
     ...
     * - done - This release is complete
     */
    public Release withState(ReleaseState state) {
        Utils.checkNotNull(state, "state");
     ...
     * - done - This release is complete
     */
    public Release withState(Optional<? extends ReleaseState> state) {
        Utils.checkNotNull(state, "state");
        this.state = state;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends ReleaseState> state = Optional.empty();
         ...
         * - done - This release is complete
         */
        public Builder state(ReleaseState state) {
            Utils.checkNotNull(state, "state");
            this.state = Optional.ofNullable(state);
            return this;
        }
         ...
         * - done - This release is complete
         */
        public Builder state(Optional<? extends ReleaseState> state) {
            Utils.checkNotNull(state, "state");
            this.state = state;
            return this;
        }
