...
public class SetStreamSelection {
    ...
    public static class Sync extends Base
            implements RequestOperation<SetStreamSelectionRequest, SetStreamSelectionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(SetStreamSelectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SetStreamSelectionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(SetStreamSelectionRequest request) {
        ...
        @Override
        public SetStreamSelectionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            SetStreamSelectionResponse.Builder resBuilder =
            ...
            SetStreamSelectionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SetStreamSelectionRequest, dev.plexapi.sdk.models.operations.async.SetStreamSelectionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(SetStreamSelectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SetStreamSelectionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(SetStreamSelectionRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.SetStreamSelectionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.SetStreamSelectionResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.SetStreamSelectionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.SetStreamSelectionResponse res = resBuilder.build();
