...
public class GetStream {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(GetStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetStreamRequest.class);
        ...
        public GetStreamResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetStreamResponse.Builder resBuilder =
                    GetStreamResponse
                            .builder()
    ...
    public static class Async extends Base
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetStreamResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetStreamResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetStreamResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
