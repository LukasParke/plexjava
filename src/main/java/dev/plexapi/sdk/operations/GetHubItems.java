...
import dev.plexapi.sdk.models.operations.GetHubItemsResponseBody;
...
public class GetHubItems {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetHubItemsRequest, GetHubItemsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetHubItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHubItemsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetHubItemsRequest request) {
        ...
        @Override
        public GetHubItemsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetHubItemsResponse.Builder resBuilder =
                    GetHubItemsResponse
                            .builder()
            ...
            GetHubItemsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<GetHubItemsResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetHubItemsRequest, dev.plexapi.sdk.models.operations.async.GetHubItemsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetHubItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHubItemsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetHubItemsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetHubItemsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetHubItemsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetHubItemsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetHubItemsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetHubItemsResponseBody>() {})
