...
public class ProcessSubscriptions {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<ProcessSubscriptionsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        @Override
        public ProcessSubscriptionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ProcessSubscriptionsResponse.Builder resBuilder =
            ...
            ProcessSubscriptionsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<dev.plexapi.sdk.models.operations.async.ProcessSubscriptionsResponse> {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.ProcessSubscriptionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.ProcessSubscriptionsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.ProcessSubscriptionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.ProcessSubscriptionsResponse res = resBuilder.build();
