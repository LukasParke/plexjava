...
public class GetPreference {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPreferenceRequest, GetPreferenceResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetPreferenceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPreferenceRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPreferenceRequest request) {
        ...
        @Override
        public GetPreferenceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetPreferenceResponse.Builder resBuilder =
            ...
            GetPreferenceResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetPreferenceRequest, dev.plexapi.sdk.models.operations.async.GetPreferenceResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetPreferenceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPreferenceRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetPreferenceRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetPreferenceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetPreferenceResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetPreferenceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetPreferenceResponse res = resBuilder.build();
