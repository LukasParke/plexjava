...
public class Unscrobble {
    ...
    public static class Sync extends Base
            implements RequestOperation<UnscrobbleRequest, UnscrobbleResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UnscrobbleRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UnscrobbleRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UnscrobbleRequest request) {
        ...
        @Override
        public UnscrobbleResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UnscrobbleResponse.Builder resBuilder =
                    UnscrobbleResponse
                            .builder()
            ...
            UnscrobbleResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UnscrobbleRequest, dev.plexapi.sdk.models.operations.async.UnscrobbleResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UnscrobbleRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UnscrobbleRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UnscrobbleRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.UnscrobbleResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.UnscrobbleResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.UnscrobbleResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.UnscrobbleResponse res = resBuilder.build();
