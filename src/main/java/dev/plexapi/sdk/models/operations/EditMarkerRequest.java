...
public class EditMarkerRequest {
    ...
    private Optional<? extends QueryParamAttributes> attributes;
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<QueryParamAttributes> attributes() {
        return (Optional<QueryParamAttributes>) attributes;
    }
     ...
     * Indicates the client accepts the indicated media types
     */
    public EditMarkerRequest withAccepts(Accepts accepts) {
        Utils.checkNotNull(accepts, "accepts");
     ...
     * Indicates the client accepts the indicated media types
     */
    public EditMarkerRequest withAccepts(Optional<? extends Accepts> accepts) {
        Utils.checkNotNull(accepts, "accepts");
        this.accepts = accepts;
        return this;
    }
     ...
     * An opaque identifier unique to the client
     */
    public EditMarkerRequest withClientIdentifier(String clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
     ...
     * An opaque identifier unique to the client
     */
    public EditMarkerRequest withClientIdentifier(Optional<String> clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
        this.clientIdentifier = clientIdentifier;
        return this;
    }
     ...
     * The name of the client product
     */
    public EditMarkerRequest withProduct(Optional<String> product) {
        Utils.checkNotNull(product, "product");
        this.product = product;
        return this;
    }
     ...
     * The version of the client application
     */
    public EditMarkerRequest withVersion(String version) {
        Utils.checkNotNull(version, "version");
     ...
     * The version of the client application
     */
    public EditMarkerRequest withVersion(Optional<String> version) {
        Utils.checkNotNull(version, "version");
        this.version = version;
        return this;
    }
     ...
     * The platform of the client
     */
    public EditMarkerRequest withPlatform(String platform) {
        Utils.checkNotNull(platform, "platform");
     ...
     * The platform of the client
     */
    public EditMarkerRequest withPlatform(Optional<String> platform) {
        Utils.checkNotNull(platform, "platform");
        this.platform = platform;
        return this;
    }
     ...
     * The version of the platform
     */
    public EditMarkerRequest withPlatformVersion(String platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
     ...
     * The version of the platform
     */
    public EditMarkerRequest withPlatformVersion(Optional<String> platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
        this.platformVersion = platformVersion;
        return this;
    }
     ...
     * A relatively friendly name for the client device
     */
    public EditMarkerRequest withDevice(String device) {
        Utils.checkNotNull(device, "device");
     ...
     * A relatively friendly name for the client device
     */
    public EditMarkerRequest withDevice(Optional<String> device) {
        Utils.checkNotNull(device, "device");
        this.device = device;
        return this;
    }
     ...
     * A potentially less friendly identifier for the device model
     */
    public EditMarkerRequest withModel(String model) {
        Utils.checkNotNull(model, "model");
     ...
     * A potentially less friendly identifier for the device model
     */
    public EditMarkerRequest withModel(Optional<String> model) {
        Utils.checkNotNull(model, "model");
        this.model = model;
        return this;
    }
     ...
     * The device vendor
     */
    public EditMarkerRequest withDeviceVendor(String deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
     ...
     * The device vendor
     */
    public EditMarkerRequest withDeviceVendor(Optional<String> deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
        this.deviceVendor = deviceVendor;
        return this;
    }
     ...
     * A friendly name for the client
     */
    public EditMarkerRequest withDeviceName(String deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
     ...
     * A friendly name for the client
     */
    public EditMarkerRequest withDeviceName(Optional<String> deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
        this.deviceName = deviceName;
        return this;
    }
     ...
     * The marketplace on which the client application is distributed
     */
    public EditMarkerRequest withMarketplace(String marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
     ...
     * The marketplace on which the client application is distributed
     */
    public EditMarkerRequest withMarketplace(Optional<String> marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
        this.marketplace = marketplace;
        return this;
    }
     ...
     * The id of the marker to edit
     */
    public EditMarkerRequest withMarker(String marker) {
        Utils.checkNotNull(marker, "marker");
        this.marker = marker;
        return this;
    }
     ...
     * The start time of the marker
     */
    public EditMarkerRequest withStartTimeOffset(long startTimeOffset) {
        Utils.checkNotNull(startTimeOffset, "startTimeOffset");
        this.startTimeOffset = startTimeOffset;
        return this;
    }
     ...
     * The end time of the marker
     */
    public EditMarkerRequest withEndTimeOffset(long endTimeOffset) {
        Utils.checkNotNull(endTimeOffset, "endTimeOffset");
     ...
     * The end time of the marker
     */
    public EditMarkerRequest withEndTimeOffset(Optional<Long> endTimeOffset) {
        Utils.checkNotNull(endTimeOffset, "endTimeOffset");
        this.endTimeOffset = endTimeOffset;
        return this;
    }
     ...
     * The attributes to assign to this marker
     */
    public EditMarkerRequest withAttributes(QueryParamAttributes attributes) {
        Utils.checkNotNull(attributes, "attributes");
     ...
     * The attributes to assign to this marker
     */
    public EditMarkerRequest withAttributes(Optional<? extends QueryParamAttributes> attributes) {
        Utils.checkNotNull(attributes, "attributes");
        this.attributes = attributes;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        EditMarkerRequest other = (EditMarkerRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(EditMarkerRequest.class,
                "accepts", accepts,
    ...
    public final static class Builder {
        ...
        private Optional<? extends QueryParamAttributes> attributes = Optional.empty();
         ...
         * The attributes to assign to this marker
         */
        public Builder attributes(QueryParamAttributes attributes) {
            Utils.checkNotNull(attributes, "attributes");
            this.attributes = Optional.ofNullable(attributes);
            return this;
        }
         ...
         * The attributes to assign to this marker
         */
        public Builder attributes(Optional<? extends QueryParamAttributes> attributes) {
            Utils.checkNotNull(attributes, "attributes");
            this.attributes = attributes;
            return this;
        }

        public EditMarkerRequest build() {
            if (accepts == null) {
                accepts = _SINGLETON_VALUE_Accepts.value();
            }

            return new EditMarkerRequest(
                accepts, clientIdentifier, product,
                version, platform, platformVersion,
                device, model, deviceVendor,
                deviceName, marketplace, ids,
