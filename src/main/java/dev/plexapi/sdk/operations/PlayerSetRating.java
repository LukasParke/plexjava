...
public class PlayerSetRating {
    ...
    public static class Sync extends Base
            implements RequestOperation<PlayerSetRatingRequest, PlayerSetRatingResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(PlayerSetRatingRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlayerSetRatingRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlayerSetRatingRequest request) {
        ...
        @Override
        public PlayerSetRatingResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlayerSetRatingResponse.Builder resBuilder =
            ...
            PlayerSetRatingResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlayerSetRatingRequest, dev.plexapi.sdk.models.operations.async.PlayerSetRatingResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(PlayerSetRatingRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlayerSetRatingRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlayerSetRatingRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.PlayerSetRatingResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.PlayerSetRatingResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.PlayerSetRatingResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.PlayerSetRatingResponse res = resBuilder.build();
