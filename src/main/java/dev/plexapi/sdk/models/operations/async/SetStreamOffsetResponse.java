...
public class SetStreamOffsetResponse implements AsyncResponse {
    /**
     ...
     * HTTP response content type for this operation
     */
    public SetStreamOffsetResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public SetStreamOffsetResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public SetStreamOffsetResponse withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * The stream in the requested format.
     */
    public SetStreamOffsetResponse withBinaryResponse(Blob binaryResponse) {
        Utils.checkNotNull(binaryResponse, "binaryResponse");
     ...
     * The stream in the requested format.
     */
    public SetStreamOffsetResponse withBinaryResponse(Optional<? extends Blob> binaryResponse) {
        Utils.checkNotNull(binaryResponse, "binaryResponse");
        this.binaryResponse = binaryResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SetStreamOffsetResponse other = (SetStreamOffsetResponse) o;
        return 
