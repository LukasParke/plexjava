...
public class TranscodeImage {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            ...
            req.addHeader("Accept", "image/jpeg;q=1, image/png;q=0.7, image/x-portable-pixmap;q=0")
    ...
    public static class Sync extends Base
            implements RequestOperation<TranscodeImageRequest, TranscodeImageResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(TranscodeImageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TranscodeImageRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TranscodeImageRequest request) {
        ...
        @Override
        public TranscodeImageResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            TranscodeImageResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200") && Utils.contentTypeMatches(contentType, "image/x-portable-pixmap")) {
                resBuilder.twoHundredImageXPortablePixmapResponseStream(response.body());
            }

            TranscodeImageResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "image/jpeg")) {
                    ...
                    return res;
                } else if (Utils.contentTypeMatches(contentType, "image/x-portable-pixmap")) {
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<TranscodeImageRequest, dev.plexapi.sdk.models.operations.async.TranscodeImageResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(TranscodeImageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TranscodeImageRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(TranscodeImageRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.TranscodeImageResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.TranscodeImageResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.TranscodeImageResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            dev.plexapi.sdk.models.operations.async.TranscodeImageResponse res = resBuilder.build();
