...
public class PlayerSetState {
    ...
    public static class Sync extends Base
            implements RequestOperation<PlayerSetStateRequest, PlayerSetStateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(PlayerSetStateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlayerSetStateRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlayerSetStateRequest request) {
        ...
        @Override
        public PlayerSetStateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlayerSetStateResponse.Builder resBuilder =
            ...
            PlayerSetStateResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlayerSetStateRequest, dev.plexapi.sdk.models.operations.async.PlayerSetStateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(PlayerSetStateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlayerSetStateRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlayerSetStateRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.PlayerSetStateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.PlayerSetStateResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.PlayerSetStateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.PlayerSetStateResponse res = resBuilder.build();
