...
public class SearchHubsResponse implements Response {
    /**
     ...
     * HTTP response content type for this operation
     */
    public SearchHubsResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public SearchHubsResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public SearchHubsResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public SearchHubsResponse withMediaContainerWithHubs(MediaContainerWithHubs mediaContainerWithHubs) {
        Utils.checkNotNull(mediaContainerWithHubs, "mediaContainerWithHubs");
     ...
     * OK
     */
    public SearchHubsResponse withMediaContainerWithHubs(Optional<? extends MediaContainerWithHubs> mediaContainerWithHubs) {
        Utils.checkNotNull(mediaContainerWithHubs, "mediaContainerWithHubs");
        this.mediaContainerWithHubs = mediaContainerWithHubs;
        return this;
    }

    public SearchHubsResponse withHeaders(Map<String, List<String>> headers) {
        Utils.checkNotNull(headers, "headers");
        this.headers = headers;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SearchHubsResponse other = (SearchHubsResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SearchHubsResponse.class,
    ...
    public final static class Builder {
        ...
        public SearchHubsResponse build() {

            return new SearchHubsResponse(
                contentType, statusCode, rawResponse,
                mediaContainerWithHubs, headers);
        }
