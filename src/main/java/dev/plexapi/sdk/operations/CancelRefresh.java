...
public class CancelRefresh {
    ...
    public static class Sync extends Base
            implements RequestOperation<CancelRefreshRequest, CancelRefreshResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CancelRefreshRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CancelRefreshRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CancelRefreshRequest request) {
        ...
        @Override
        public CancelRefreshResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CancelRefreshResponse.Builder resBuilder =
            ...
            CancelRefreshResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CancelRefreshRequest, dev.plexapi.sdk.models.operations.async.CancelRefreshResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CancelRefreshRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CancelRefreshRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CancelRefreshRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.CancelRefreshResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.CancelRefreshResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.CancelRefreshResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.CancelRefreshResponse res = resBuilder.build();
