...
public class RemoveDeviceMediaContainer {
    ...
    @JsonCreator
    public RemoveDeviceMediaContainer(
    ...
    public RemoveDeviceMediaContainer withIdentifier(String identifier) {
        Utils.checkNotNull(identifier, "identifier");
    ...
    public RemoveDeviceMediaContainer withIdentifier(Optional<String> identifier) {
        Utils.checkNotNull(identifier, "identifier");
        this.identifier = identifier;
        return this;
    }
     ...
     * the `X-Plex-Container-Start` header.
     */
    public RemoveDeviceMediaContainer withOffset(long offset) {
        Utils.checkNotNull(offset, "offset");
     ...
     * the `X-Plex-Container-Start` header.
     */
    public RemoveDeviceMediaContainer withOffset(Optional<Long> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }

    public RemoveDeviceMediaContainer withSize(long size) {
        Utils.checkNotNull(size, "size");
    ...
    public RemoveDeviceMediaContainer withSize(Optional<Long> size) {
        Utils.checkNotNull(size, "size");
        this.size = size;
        return this;
    }
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public RemoveDeviceMediaContainer withTotalSize(long totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public RemoveDeviceMediaContainer withTotalSize(Optional<Long> totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
        this.totalSize = totalSize;
        return this;
    }

    public RemoveDeviceMediaContainer withMessage(String message) {
        Utils.checkNotNull(message, "message");
    ...
    public RemoveDeviceMediaContainer withMessage(Optional<String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }

    public RemoveDeviceMediaContainer withStatus(long status) {
        Utils.checkNotNull(status, "status");
    ...
    public RemoveDeviceMediaContainer withStatus(Optional<Long> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        RemoveDeviceMediaContainer other = (RemoveDeviceMediaContainer) o;
        return 
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            totalSize, message, status);
    }
    
    @Override
    public String toString() {
        return Utils.toString(RemoveDeviceMediaContainer.class,
    ...
    public final static class Builder {
        ...
        public RemoveDeviceMediaContainer build() {

            return new RemoveDeviceMediaContainer(
                identifier, offset, size,
                totalSize, message, status);
        }
