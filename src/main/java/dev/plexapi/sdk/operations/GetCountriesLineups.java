...
public class GetCountriesLineups {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCountriesLineupsRequest, GetCountriesLineupsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetCountriesLineupsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCountriesLineupsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCountriesLineupsRequest request) {
        ...
        @Override
        public GetCountriesLineupsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCountriesLineupsResponse.Builder resBuilder =
            ...
            GetCountriesLineupsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMediaContainerWithLineup(Utils.unmarshal(response, new TypeReference<MediaContainerWithLineup>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCountriesLineupsRequest, dev.plexapi.sdk.models.operations.async.GetCountriesLineupsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetCountriesLineupsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCountriesLineupsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCountriesLineupsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetCountriesLineupsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetCountriesLineupsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetCountriesLineupsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetCountriesLineupsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MediaContainerWithLineup>() {})
                            .thenApply(res::withMediaContainerWithLineup);
                } else {
