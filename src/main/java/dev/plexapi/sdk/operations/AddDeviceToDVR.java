...
import dev.plexapi.sdk.models.operations.AddDeviceToDVRResponseBody;
...
public class AddDeviceToDVR {
    ...
    public static class Sync extends Base
            implements RequestOperation<AddDeviceToDVRRequest, AddDeviceToDVRResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AddDeviceToDVRRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddDeviceToDVRRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddDeviceToDVRRequest request) {
        ...
        @Override
        public AddDeviceToDVRResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AddDeviceToDVRResponse.Builder resBuilder =
            ...
            AddDeviceToDVRResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<AddDeviceToDVRResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AddDeviceToDVRRequest, dev.plexapi.sdk.models.operations.async.AddDeviceToDVRResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AddDeviceToDVRRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddDeviceToDVRRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AddDeviceToDVRRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.AddDeviceToDVRResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.AddDeviceToDVRResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.AddDeviceToDVRResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.AddDeviceToDVRResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AddDeviceToDVRResponseBody>() {})
