...
public class ResetPlayQueueResponse implements Response {
    /**
     ...
     * HTTP response content type for this operation
     */
    public ResetPlayQueueResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public ResetPlayQueueResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ResetPlayQueueResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Successfully updated reset a play queue
     */
    public ResetPlayQueueResponse withMediaContainerWithPlaylistMetadata(MediaContainerWithPlaylistMetadata mediaContainerWithPlaylistMetadata) {
        Utils.checkNotNull(mediaContainerWithPlaylistMetadata, "mediaContainerWithPlaylistMetadata");
     ...
     * Successfully updated reset a play queue
     */
    public ResetPlayQueueResponse withMediaContainerWithPlaylistMetadata(Optional<? extends MediaContainerWithPlaylistMetadata> mediaContainerWithPlaylistMetadata) {
        Utils.checkNotNull(mediaContainerWithPlaylistMetadata, "mediaContainerWithPlaylistMetadata");
        this.mediaContainerWithPlaylistMetadata = mediaContainerWithPlaylistMetadata;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ResetPlayQueueResponse other = (ResetPlayQueueResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ResetPlayQueueResponse.class,
    ...
    public final static class Builder {
        ...
        public ResetPlayQueueResponse build() {

            return new ResetPlayQueueResponse(
                contentType, statusCode, rawResponse,
                mediaContainerWithPlaylistMetadata);
        }
