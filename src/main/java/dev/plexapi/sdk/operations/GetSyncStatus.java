...
import dev.plexapi.sdk.models.shared.MediaContainerWithStatus;
...
public class GetSyncStatus {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSyncStatusRequest, GetSyncStatusResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetSyncStatusRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSyncStatusRequest request) {
        ...
        @Override
        public GetSyncStatusResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSyncStatusResponse.Builder resBuilder =
            ...
            GetSyncStatusResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMediaContainerWithStatus(Utils.unmarshal(response, new TypeReference<MediaContainerWithStatus>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSyncStatusRequest, dev.plexapi.sdk.models.operations.async.GetSyncStatusResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSyncStatusRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSyncStatusRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetSyncStatusResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetSyncStatusResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetSyncStatusResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetSyncStatusResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MediaContainerWithStatus>() {})
                            .thenApply(res::withMediaContainerWithStatus);
                } else {
