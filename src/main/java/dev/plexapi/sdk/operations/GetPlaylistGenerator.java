...
import dev.plexapi.sdk.models.operations.GetPlaylistGeneratorResponseBody;
...
public class GetPlaylistGenerator {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPlaylistGeneratorRequest, GetPlaylistGeneratorResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetPlaylistGeneratorRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPlaylistGeneratorRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPlaylistGeneratorRequest request) {
        ...
        @Override
        public GetPlaylistGeneratorResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetPlaylistGeneratorResponse.Builder resBuilder =
            ...
            GetPlaylistGeneratorResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<GetPlaylistGeneratorResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetPlaylistGeneratorRequest, dev.plexapi.sdk.models.operations.async.GetPlaylistGeneratorResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetPlaylistGeneratorRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPlaylistGeneratorRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetPlaylistGeneratorRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetPlaylistGeneratorResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetPlaylistGeneratorResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetPlaylistGeneratorResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetPlaylistGeneratorResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetPlaylistGeneratorResponseBody>() {})
