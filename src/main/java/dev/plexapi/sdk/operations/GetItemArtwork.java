...
public class GetItemArtwork {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            ...
            req.addHeader("Accept", "audio/mpeg3;q=1, image/jpeg;q=0")
    ...
    public static class Sync extends Base
            implements RequestOperation<GetItemArtworkRequest, GetItemArtworkResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetItemArtworkRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetItemArtworkRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetItemArtworkRequest request) {
        ...
        @Override
        public GetItemArtworkResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetItemArtworkResponse.Builder resBuilder =
                    GetItemArtworkResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            if (Utils.statusCodeMatches(response.statusCode(), "200") && Utils.contentTypeMatches(contentType, "audio/mpeg3")) {
                resBuilder.twoHundredAudioMpeg3ResponseStream(response.body());
            }
            ...
            GetItemArtworkResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "audio/mpeg3")) {
                    return res;
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetItemArtworkRequest, dev.plexapi.sdk.models.operations.async.GetItemArtworkResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetItemArtworkRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetItemArtworkRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetItemArtworkRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetItemArtworkResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetItemArtworkResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetItemArtworkResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            dev.plexapi.sdk.models.operations.async.GetItemArtworkResponse res = resBuilder.build();
