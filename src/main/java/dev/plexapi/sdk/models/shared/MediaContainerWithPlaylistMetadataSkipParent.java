...
public class MediaContainerWithPlaylistMetadataSkipParent {
     ...
     * <ul>
     * <li>{@code boolean}</li>
     * <li>{@code dev.plexapi.sdk.models.shared.MediaContainerWithPlaylistMetadataSkipParent2}</li>
     * </ul>
     * 
    ...
    public static final class _Deserializer extends OneOfDeserializer<MediaContainerWithPlaylistMetadataSkipParent> {
