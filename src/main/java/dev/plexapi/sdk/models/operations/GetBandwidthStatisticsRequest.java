...
public class GetBandwidthStatisticsRequest {
    ...
    private Optional<? extends BoolInt> lan;
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<BoolInt> lan() {
        return (Optional<BoolInt>) lan;
    }
     ...
     * Indicates the client accepts the indicated media types
     */
    public GetBandwidthStatisticsRequest withAccepts(Accepts accepts) {
        Utils.checkNotNull(accepts, "accepts");
     ...
     * Indicates the client accepts the indicated media types
     */
    public GetBandwidthStatisticsRequest withAccepts(Optional<? extends Accepts> accepts) {
        Utils.checkNotNull(accepts, "accepts");
        this.accepts = accepts;
        return this;
    }
     ...
     * An opaque identifier unique to the client
     */
    public GetBandwidthStatisticsRequest withClientIdentifier(String clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
     ...
     * An opaque identifier unique to the client
     */
    public GetBandwidthStatisticsRequest withClientIdentifier(Optional<String> clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
        this.clientIdentifier = clientIdentifier;
        return this;
    }
     ...
     * The name of the client product
     */
    public GetBandwidthStatisticsRequest withProduct(String product) {
        Utils.checkNotNull(product, "product");
     ...
     * The name of the client product
     */
    public GetBandwidthStatisticsRequest withProduct(Optional<String> product) {
        Utils.checkNotNull(product, "product");
        this.product = product;
        return this;
    }
     ...
     * The version of the client application
     */
    public GetBandwidthStatisticsRequest withVersion(String version) {
        Utils.checkNotNull(version, "version");
     ...
     * The version of the client application
     */
    public GetBandwidthStatisticsRequest withVersion(Optional<String> version) {
        Utils.checkNotNull(version, "version");
        this.version = version;
        return this;
    }
     ...
     * The platform of the client
     */
    public GetBandwidthStatisticsRequest withPlatform(String platform) {
        Utils.checkNotNull(platform, "platform");
     ...
     * The platform of the client
     */
    public GetBandwidthStatisticsRequest withPlatform(Optional<String> platform) {
        Utils.checkNotNull(platform, "platform");
        this.platform = platform;
        return this;
    }
     ...
     * The version of the platform
     */
    public GetBandwidthStatisticsRequest withPlatformVersion(String platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
     ...
     * The version of the platform
     */
    public GetBandwidthStatisticsRequest withPlatformVersion(Optional<String> platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
        this.platformVersion = platformVersion;
        return this;
    }
     ...
     * A relatively friendly name for the client device
     */
    public GetBandwidthStatisticsRequest withDevice(String device) {
        Utils.checkNotNull(device, "device");
     ...
     * A relatively friendly name for the client device
     */
    public GetBandwidthStatisticsRequest withDevice(Optional<String> device) {
        Utils.checkNotNull(device, "device");
        this.device = device;
        return this;
    }
     ...
     * A potentially less friendly identifier for the device model
     */
    public GetBandwidthStatisticsRequest withModel(String model) {
        Utils.checkNotNull(model, "model");
     ...
     * A potentially less friendly identifier for the device model
     */
    public GetBandwidthStatisticsRequest withModel(Optional<String> model) {
        Utils.checkNotNull(model, "model");
        this.model = model;
        return this;
    }
     ...
     * The device vendor
     */
    public GetBandwidthStatisticsRequest withDeviceVendor(String deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
     ...
     * The device vendor
     */
    public GetBandwidthStatisticsRequest withDeviceVendor(Optional<String> deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
        this.deviceVendor = deviceVendor;
        return this;
    }
     ...
     * A friendly name for the client
     */
    public GetBandwidthStatisticsRequest withDeviceName(String deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
     ...
     * A friendly name for the client
     */
    public GetBandwidthStatisticsRequest withDeviceName(Optional<String> deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
        this.deviceName = deviceName;
        return this;
    }
     ...
     * The marketplace on which the client application is distributed
     */
    public GetBandwidthStatisticsRequest withMarketplace(String marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
     ...
     * The marketplace on which the client application is distributed
     */
    public GetBandwidthStatisticsRequest withMarketplace(Optional<String> marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
        this.marketplace = marketplace;
        return this;
    }
     ...
     * Filter by account ID
     */
    public GetBandwidthStatisticsRequest withAccountID(long accountID) {
        Utils.checkNotNull(accountID, "accountID");
     ...
     * Filter by account ID
     */
    public GetBandwidthStatisticsRequest withAccountID(Optional<Long> accountID) {
        Utils.checkNotNull(accountID, "accountID");
        this.accountID = accountID;
        return this;
    }
     ...
     * Filter by device ID
     */
    public GetBandwidthStatisticsRequest withDeviceID(long deviceID) {
        Utils.checkNotNull(deviceID, "deviceID");
     ...
     * Filter by device ID
     */
    public GetBandwidthStatisticsRequest withDeviceID(Optional<Long> deviceID) {
        Utils.checkNotNull(deviceID, "deviceID");
        this.deviceID = deviceID;
        return this;
    }
     ...
     * Filter to LAN-only traffic
     */
    public GetBandwidthStatisticsRequest withLan(BoolInt lan) {
        Utils.checkNotNull(lan, "lan");
     ...
     * Filter to LAN-only traffic
     */
    public GetBandwidthStatisticsRequest withLan(Optional<? extends BoolInt> lan) {
        Utils.checkNotNull(lan, "lan");
        this.lan = lan;
        return this;
    }
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            deviceName, marketplace, timespan,
            accountID, deviceID, lan);
    }
    ...
    public final static class Builder {
         ...
         * Filter to LAN-only traffic
         */
        public Builder lan(BoolInt lan) {
            Utils.checkNotNull(lan, "lan");
            this.lan = Optional.ofNullable(lan);
            return this;
        }
         ...
         * Filter to LAN-only traffic
         */
        public Builder lan(Optional<? extends BoolInt> lan) {
            Utils.checkNotNull(lan, "lan");
            this.lan = lan;
            return this;
        }
        ...
        public GetBandwidthStatisticsRequest build() {
            ...
            if (lan == null) {
                lan = _SINGLETON_VALUE_Lan.value();
            }
        ...
        private static final LazySingletonValue<Optional<? extends BoolInt>> _SINGLETON_VALUE_Lan =
                new LazySingletonValue<>(
                        "lan",
                        "0",
