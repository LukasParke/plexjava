...
public class GetSystemAccounts {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSystemAccountsRequest, GetSystemAccountsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetSystemAccountsRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSystemAccountsRequest request) {
        ...
        @Override
        public GetSystemAccountsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSystemAccountsResponse.Builder resBuilder =
            ...
            GetSystemAccountsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSystemAccountsRequest, dev.plexapi.sdk.models.operations.async.GetSystemAccountsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSystemAccountsRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSystemAccountsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetSystemAccountsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetSystemAccountsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetSystemAccountsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetSystemAccountsResponse res = resBuilder.build();
