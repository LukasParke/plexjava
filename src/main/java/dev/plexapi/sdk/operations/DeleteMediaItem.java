...
public class DeleteMediaItem {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteMediaItemRequest, DeleteMediaItemResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeleteMediaItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteMediaItemRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteMediaItemRequest request) {
        ...
        @Override
        public DeleteMediaItemResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteMediaItemResponse.Builder resBuilder =
            ...
            DeleteMediaItemResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteMediaItemRequest, dev.plexapi.sdk.models.operations.async.DeleteMediaItemResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeleteMediaItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteMediaItemRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteMediaItemRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.DeleteMediaItemResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.DeleteMediaItemResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.DeleteMediaItemResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.DeleteMediaItemResponse res = resBuilder.build();
