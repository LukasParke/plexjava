...
public class GetRecentlyAddedForSection {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetRecentlyAddedForSectionRequest, GetRecentlyAddedForSectionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetRecentlyAddedForSectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRecentlyAddedForSectionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetRecentlyAddedForSectionRequest request) {
        ...
        @Override
        public GetRecentlyAddedForSectionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetRecentlyAddedForSectionResponse.Builder resBuilder =
            ...
            GetRecentlyAddedForSectionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMediaContainerWithMetadata(Utils.unmarshal(response, new TypeReference<MediaContainerWithMetadata>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetRecentlyAddedForSectionRequest, dev.plexapi.sdk.models.operations.async.GetRecentlyAddedForSectionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetRecentlyAddedForSectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRecentlyAddedForSectionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetRecentlyAddedForSectionRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetRecentlyAddedForSectionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetRecentlyAddedForSectionResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetRecentlyAddedForSectionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetRecentlyAddedForSectionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MediaContainerWithMetadata>() {})
                            .thenApply(res::withMediaContainerWithMetadata);
                } else {
