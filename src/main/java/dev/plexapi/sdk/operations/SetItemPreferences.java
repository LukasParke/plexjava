...
public class SetItemPreferences {
    ...
    public static class Sync extends Base
            implements RequestOperation<SetItemPreferencesRequest, SetItemPreferencesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(SetItemPreferencesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SetItemPreferencesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(SetItemPreferencesRequest request) {
        ...
        @Override
        public SetItemPreferencesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            SetItemPreferencesResponse.Builder resBuilder =
            ...
            SetItemPreferencesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SetItemPreferencesRequest, dev.plexapi.sdk.models.operations.async.SetItemPreferencesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(SetItemPreferencesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SetItemPreferencesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(SetItemPreferencesRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.SetItemPreferencesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.SetItemPreferencesResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.SetItemPreferencesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.SetItemPreferencesResponse res = resBuilder.build();
