...
public class GetSectionClips {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/library/sections/{sectionId}/clips",
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSectionClipsRequest, GetSectionClipsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetSectionClipsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSectionClipsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSectionClipsRequest request) {
        ...
        @Override
        public GetSectionClipsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSectionClipsResponse.Builder resBuilder =
            ...
            GetSectionClipsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSectionClipsRequest, dev.plexapi.sdk.models.operations.async.GetSectionClipsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSectionClipsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSectionClipsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSectionClipsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetSectionClipsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetSectionClipsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetSectionClipsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetSectionClipsResponse res = resBuilder.build();
