...
public class OptimizeLibraryResponse implements Response {
    /**
    ...
    @JsonCreator
    public OptimizeLibraryResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public OptimizeLibraryResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public OptimizeLibraryResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public OptimizeLibraryResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public OptimizeLibraryResponse withSuccessResponse(SuccessResponse successResponse) {
        Utils.checkNotNull(successResponse, "successResponse");
     ...
     * OK
     */
    public OptimizeLibraryResponse withSuccessResponse(Optional<? extends SuccessResponse> successResponse) {
        Utils.checkNotNull(successResponse, "successResponse");
        this.successResponse = successResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        OptimizeLibraryResponse other = (OptimizeLibraryResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(OptimizeLibraryResponse.class,
    ...
    public final static class Builder {
        ...
        public OptimizeLibraryResponse build() {

            return new OptimizeLibraryResponse(
                contentType, statusCode, rawResponse,
                successResponse);
        }
