...
public class ListContent {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListContentRequest, ListContentResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListContentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListContentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListContentRequest request) {
        ...
        @Override
        public ListContentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListContentResponse.Builder resBuilder =
                    ListContentResponse
                            .builder()
            ...
            ListContentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListContentRequest, dev.plexapi.sdk.models.operations.async.ListContentResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListContentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListContentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListContentRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.ListContentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.ListContentResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.ListContentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.ListContentResponse res = resBuilder.build();
