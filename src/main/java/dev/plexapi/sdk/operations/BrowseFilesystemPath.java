...
public class BrowseFilesystemPath {
    ...
    public static class Sync extends Base
            implements RequestOperation<BrowseFilesystemPathRequest, BrowseFilesystemPathResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(BrowseFilesystemPathRequest request) throws Exception {
            HttpRequest req = buildRequest(request, BrowseFilesystemPathRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(BrowseFilesystemPathRequest request) {
        ...
        @Override
        public BrowseFilesystemPathResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            BrowseFilesystemPathResponse.Builder resBuilder =
            ...
            BrowseFilesystemPathResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<BrowseFilesystemPathRequest, dev.plexapi.sdk.models.operations.async.BrowseFilesystemPathResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(BrowseFilesystemPathRequest request) throws Exception {
            HttpRequest req = buildRequest(request, BrowseFilesystemPathRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(BrowseFilesystemPathRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.BrowseFilesystemPathResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.BrowseFilesystemPathResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.BrowseFilesystemPathResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.BrowseFilesystemPathResponse res = resBuilder.build();
