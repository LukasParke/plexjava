...
public class GetPlayQueue {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPlayQueueRequest, GetPlayQueueResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetPlayQueueRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPlayQueueRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPlayQueueRequest request) {
        ...
        @Override
        public GetPlayQueueResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetPlayQueueResponse.Builder resBuilder =
            ...
            GetPlayQueueResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPlayQueueResponse(Utils.unmarshal(response, new TypeReference<PlayQueueResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetPlayQueueRequest, dev.plexapi.sdk.models.operations.async.GetPlayQueueResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetPlayQueueRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPlayQueueRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetPlayQueueRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetPlayQueueResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetPlayQueueResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetPlayQueueResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetPlayQueueResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PlayQueueResponse>() {})
                            .thenApply(res::withPlayQueueResponse);
                } else {
