...
public class GetChapterImage {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetChapterImageRequest, GetChapterImageResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetChapterImageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetChapterImageRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetChapterImageRequest request) {
        ...
        @Override
        public GetChapterImageResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetChapterImageResponse.Builder resBuilder =
            ...
            GetChapterImageResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetChapterImageRequest, dev.plexapi.sdk.models.operations.async.GetChapterImageResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetChapterImageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetChapterImageRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetChapterImageRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetChapterImageResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetChapterImageResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetChapterImageResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            dev.plexapi.sdk.models.operations.async.GetChapterImageResponse res = resBuilder.build();
