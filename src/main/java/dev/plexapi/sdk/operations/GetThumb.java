...
public class GetThumb {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            ...
            req.addHeader("Accept", "application/octet-stream;q=1, text/html;q=0")
    ...
    public static class Sync extends Base
            implements RequestOperation<GetThumbRequest, GetThumbResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetThumbRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetThumbRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetThumbRequest request) {
        ...
        @Override
        public GetThumbResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetThumbResponse.Builder resBuilder =
                    GetThumbResponse
                            .builder()
            ...
            GetThumbResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "301")) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetThumbRequest, dev.plexapi.sdk.models.operations.async.GetThumbResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetThumbRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetThumbRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetThumbRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetThumbResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetThumbResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetThumbResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            dev.plexapi.sdk.models.operations.async.GetThumbResponse res = resBuilder.build();
