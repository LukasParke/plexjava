...
public class DeleteHistory {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteHistoryRequest, DeleteHistoryResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeleteHistoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteHistoryRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteHistoryRequest request) {
        ...
        @Override
        public DeleteHistoryResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteHistoryResponse.Builder resBuilder =
            ...
            DeleteHistoryResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMediaContainer(Utils.unmarshal(response, new TypeReference<MediaContainer>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteHistoryRequest, dev.plexapi.sdk.models.operations.async.DeleteHistoryResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeleteHistoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteHistoryRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteHistoryRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.DeleteHistoryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.DeleteHistoryResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.DeleteHistoryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.DeleteHistoryResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MediaContainer>() {})
                            .thenApply(res::withMediaContainer);
                } else {
