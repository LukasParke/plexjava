...
public class PlayerStepback {
    ...
    public static class Sync extends Base
            implements RequestOperation<PlayerStepbackRequest, PlayerStepbackResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(PlayerStepbackRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlayerStepbackRequest request) {
        ...
        @Override
        public PlayerStepbackResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlayerStepbackResponse.Builder resBuilder =
            ...
            PlayerStepbackResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlayerStepbackRequest, dev.plexapi.sdk.models.operations.async.PlayerStepbackResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(PlayerStepbackRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlayerStepbackRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.PlayerStepbackResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.PlayerStepbackResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.PlayerStepbackResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.PlayerStepbackResponse res = resBuilder.build();
