...
public class GetCollections {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCollectionsRequest, GetCollectionsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetCollectionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCollectionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCollectionsRequest request) {
        ...
        @Override
        public GetCollectionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCollectionsResponse.Builder resBuilder =
            ...
            GetCollectionsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCollectionsRequest, dev.plexapi.sdk.models.operations.async.GetCollectionsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetCollectionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCollectionsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCollectionsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetCollectionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetCollectionsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetCollectionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetCollectionsResponse res = resBuilder.build();
