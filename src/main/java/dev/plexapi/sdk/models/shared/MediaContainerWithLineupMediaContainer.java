...
public class MediaContainerWithLineupMediaContainer {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("Lineup")
    private Optional<? extends List<Lineup>> lineup;
    ...
    @JsonCreator
    public MediaContainerWithLineupMediaContainer(
            ...
            @JsonProperty("Lineup") Optional<? extends List<Lineup>> lineup,
    ...
    @JsonIgnore
    public Optional<List<Lineup>> lineup() {
        return (Optional<List<Lineup>>) lineup;
    }
    ...
    public MediaContainerWithLineupMediaContainer withIdentifier(String identifier) {
        Utils.checkNotNull(identifier, "identifier");
    ...
    public MediaContainerWithLineupMediaContainer withIdentifier(Optional<String> identifier) {
        Utils.checkNotNull(identifier, "identifier");
        this.identifier = identifier;
        return this;
    }
     ...
     * the `X-Plex-Container-Start` header.
     */
    public MediaContainerWithLineupMediaContainer withOffset(long offset) {
        Utils.checkNotNull(offset, "offset");
     ...
     * the `X-Plex-Container-Start` header.
     */
    public MediaContainerWithLineupMediaContainer withOffset(Optional<Long> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }

    public MediaContainerWithLineupMediaContainer withSize(long size) {
        Utils.checkNotNull(size, "size");
    ...
    public MediaContainerWithLineupMediaContainer withSize(Optional<Long> size) {
        Utils.checkNotNull(size, "size");
        this.size = size;
        return this;
    }
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public MediaContainerWithLineupMediaContainer withTotalSize(long totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public MediaContainerWithLineupMediaContainer withTotalSize(Optional<Long> totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
        this.totalSize = totalSize;
        return this;
    }

    public MediaContainerWithLineupMediaContainer withLineup(List<Lineup> lineup) {
        Utils.checkNotNull(lineup, "lineup");
    ...
    public MediaContainerWithLineupMediaContainer withLineup(Optional<? extends List<Lineup>> lineup) {
        Utils.checkNotNull(lineup, "lineup");
        this.lineup = lineup;
        return this;
    }
     ...
     * The UUID of this set lineups
     */
    public MediaContainerWithLineupMediaContainer withUuid(String uuid) {
        Utils.checkNotNull(uuid, "uuid");
     ...
     * The UUID of this set lineups
     */
    public MediaContainerWithLineupMediaContainer withUuid(Optional<String> uuid) {
        Utils.checkNotNull(uuid, "uuid");
        this.uuid = uuid;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        MediaContainerWithLineupMediaContainer other = (MediaContainerWithLineupMediaContainer) o;
        return 
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            totalSize, lineup, uuid);
    }
    
    @Override
    public String toString() {
        return Utils.toString(MediaContainerWithLineupMediaContainer.class,
    ...
    public final static class Builder {
        ...
        private Optional<? extends List<Lineup>> lineup = Optional.empty();
        ...
        public Builder lineup(List<Lineup> lineup) {
            Utils.checkNotNull(lineup, "lineup");
            this.lineup = Optional.ofNullable(lineup);
            return this;
        }

        public Builder lineup(Optional<? extends List<Lineup>> lineup) {
            Utils.checkNotNull(lineup, "lineup");
            this.lineup = lineup;
            return this;
        }
        ...
        public MediaContainerWithLineupMediaContainer build() {

            return new MediaContainerWithLineupMediaContainer(
                identifier, offset, size,
                totalSize, lineup, uuid);
        }
