...
public class GetHLSSegmentResponse implements AsyncResponse {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetHLSSegmentResponse withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public GetHLSSegmentResponse withResponseStream(Blob responseStream) {
        Utils.checkNotNull(responseStream, "responseStream");
     ...
     * OK
     */
    public GetHLSSegmentResponse withResponseStream(Optional<? extends Blob> responseStream) {
        Utils.checkNotNull(responseStream, "responseStream");
        this.responseStream = responseStream;
        return this;
    }
