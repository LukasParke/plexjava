...
public class PlayerPlay {
    ...
    public static class Sync extends Base
            implements RequestOperation<PlayerPlayRequest, PlayerPlayResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(PlayerPlayRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlayerPlayRequest request) {
        ...
        @Override
        public PlayerPlayResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlayerPlayResponse.Builder resBuilder =
                    PlayerPlayResponse
                            .builder()
            ...
            PlayerPlayResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlayerPlayRequest, dev.plexapi.sdk.models.operations.async.PlayerPlayResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(PlayerPlayRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlayerPlayRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.PlayerPlayResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.PlayerPlayResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.PlayerPlayResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.PlayerPlayResponse res = resBuilder.build();
