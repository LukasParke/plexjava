...
public class UpdateItems {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateItemsRequest, UpdateItemsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UpdateItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateItemsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateItemsRequest request) {
        ...
        @Override
        public UpdateItemsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateItemsResponse.Builder resBuilder =
                    UpdateItemsResponse
                            .builder()
            ...
            UpdateItemsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                // no content
                return res;
            }
            if (Utils.statusCodeMatches(response.statusCode(), "400", "404", "409", "4XX")) {
                // no content
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateItemsRequest, dev.plexapi.sdk.models.operations.async.UpdateItemsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdateItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateItemsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateItemsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.UpdateItemsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.UpdateItemsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.UpdateItemsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.UpdateItemsResponse res = resBuilder.build();
