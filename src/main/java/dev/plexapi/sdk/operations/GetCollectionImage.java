...
public class GetCollectionImage {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCollectionImageRequest, GetCollectionImageResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetCollectionImageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCollectionImageRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCollectionImageRequest request) {
        ...
        @Override
        public GetCollectionImageResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCollectionImageResponse.Builder resBuilder =
            ...
            GetCollectionImageResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCollectionImageRequest, dev.plexapi.sdk.models.operations.async.GetCollectionImageResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetCollectionImageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCollectionImageRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCollectionImageRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetCollectionImageResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetCollectionImageResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetCollectionImageResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            dev.plexapi.sdk.models.operations.async.GetCollectionImageResponse res = resBuilder.build();
