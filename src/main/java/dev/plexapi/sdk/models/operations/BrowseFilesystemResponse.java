...
public class BrowseFilesystemResponse implements Response {
    /**
    ...
    @JsonCreator
    public BrowseFilesystemResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public BrowseFilesystemResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public BrowseFilesystemResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public BrowseFilesystemResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public BrowseFilesystemResponse withMediaContainerWithDirectory(MediaContainerWithDirectory mediaContainerWithDirectory) {
        Utils.checkNotNull(mediaContainerWithDirectory, "mediaContainerWithDirectory");
     ...
     * OK
     */
    public BrowseFilesystemResponse withMediaContainerWithDirectory(Optional<? extends MediaContainerWithDirectory> mediaContainerWithDirectory) {
        Utils.checkNotNull(mediaContainerWithDirectory, "mediaContainerWithDirectory");
        this.mediaContainerWithDirectory = mediaContainerWithDirectory;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        BrowseFilesystemResponse other = (BrowseFilesystemResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(BrowseFilesystemResponse.class,
    ...
    public final static class Builder {
        ...
        public BrowseFilesystemResponse build() {

            return new BrowseFilesystemResponse(
                contentType, statusCode, rawResponse,
                mediaContainerWithDirectory);
        }
