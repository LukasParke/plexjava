...
public class GetIdentity {
    ...
    public static class Sync extends Base
        ...
        public GetIdentityResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetIdentityResponse.Builder resBuilder =
                    GetIdentityResponse
                            .builder()
            ...
            GetIdentityResponse res = resBuilder.build();
    ...
    public static class Async extends Base
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetIdentityResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetIdentityResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetIdentityResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetIdentityResponse res = resBuilder.build();
