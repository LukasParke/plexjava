...
public class CreateSubscription {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateSubscriptionRequest, CreateSubscriptionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CreateSubscriptionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateSubscriptionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateSubscriptionRequest request) {
        ...
        @Override
        public CreateSubscriptionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateSubscriptionResponse.Builder resBuilder =
            ...
            CreateSubscriptionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<CreateSubscriptionResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateSubscriptionRequest, dev.plexapi.sdk.models.operations.async.CreateSubscriptionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CreateSubscriptionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateSubscriptionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateSubscriptionRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.CreateSubscriptionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.CreateSubscriptionResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.CreateSubscriptionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.CreateSubscriptionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateSubscriptionResponseBody>() {})
