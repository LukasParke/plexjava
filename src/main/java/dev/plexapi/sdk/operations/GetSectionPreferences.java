...
public class GetSectionPreferences {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSectionPreferencesRequest, GetSectionPreferencesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetSectionPreferencesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSectionPreferencesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSectionPreferencesRequest request) {
        ...
        @Override
        public GetSectionPreferencesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSectionPreferencesResponse.Builder resBuilder =
            ...
            GetSectionPreferencesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMediaContainerWithSettings(Utils.unmarshal(response, new TypeReference<MediaContainerWithSettings>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSectionPreferencesRequest, dev.plexapi.sdk.models.operations.async.GetSectionPreferencesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSectionPreferencesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSectionPreferencesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSectionPreferencesRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetSectionPreferencesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetSectionPreferencesResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetSectionPreferencesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetSectionPreferencesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MediaContainerWithSettings>() {})
                            .thenApply(res::withMediaContainerWithSettings);
                } else {
