...
public class GetImageFromBif {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetImageFromBifRequest, GetImageFromBifResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetImageFromBifRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetImageFromBifRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetImageFromBifRequest request) {
        ...
        @Override
        public GetImageFromBifResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetImageFromBifResponse.Builder resBuilder =
            ...
            GetImageFromBifResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetImageFromBifRequest, dev.plexapi.sdk.models.operations.async.GetImageFromBifResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetImageFromBifRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetImageFromBifRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetImageFromBifRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetImageFromBifResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetImageFromBifResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetImageFromBifResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            dev.plexapi.sdk.models.operations.async.GetImageFromBifResponse res = resBuilder.build();
