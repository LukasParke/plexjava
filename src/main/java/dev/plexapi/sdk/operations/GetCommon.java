...
public class GetCommon {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCommonRequest, GetCommonResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetCommonRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCommonRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCommonRequest request) {
        ...
        @Override
        public GetCommonResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCommonResponse.Builder resBuilder =
                    GetCommonResponse
                            .builder()
            ...
            GetCommonResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCommonRequest, dev.plexapi.sdk.models.operations.async.GetCommonResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetCommonRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCommonRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCommonRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetCommonResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetCommonResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetCommonResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetCommonResponse res = resBuilder.build();
