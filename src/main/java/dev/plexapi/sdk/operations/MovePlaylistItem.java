...
public class MovePlaylistItem {
    ...
    public static class Sync extends Base
            implements RequestOperation<MovePlaylistItemRequest, MovePlaylistItemResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(MovePlaylistItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MovePlaylistItemRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MovePlaylistItemRequest request) {
        ...
        @Override
        public MovePlaylistItemResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            MovePlaylistItemResponse.Builder resBuilder =
            ...
            MovePlaylistItemResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MovePlaylistItemRequest, dev.plexapi.sdk.models.operations.async.MovePlaylistItemResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(MovePlaylistItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MovePlaylistItemRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(MovePlaylistItemRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.MovePlaylistItemResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.MovePlaylistItemResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.MovePlaylistItemResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.MovePlaylistItemResponse res = resBuilder.build();
