...
public class GetStreamLoudness {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetStreamLoudnessRequest, GetStreamLoudnessResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetStreamLoudnessRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetStreamLoudnessRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetStreamLoudnessRequest request) {
        ...
        @Override
        public GetStreamLoudnessResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetStreamLoudnessResponse.Builder resBuilder =
            ...
            GetStreamLoudnessResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetStreamLoudnessRequest, dev.plexapi.sdk.models.operations.async.GetStreamLoudnessResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetStreamLoudnessRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetStreamLoudnessRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetStreamLoudnessRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetStreamLoudnessResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetStreamLoudnessResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetStreamLoudnessResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetStreamLoudnessResponse res = resBuilder.build();
