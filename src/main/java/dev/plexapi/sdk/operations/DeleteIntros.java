...
public class DeleteIntros {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteIntrosRequest, DeleteIntrosResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeleteIntrosRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteIntrosRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteIntrosRequest request) {
        ...
        @Override
        public DeleteIntrosResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteIntrosResponse.Builder resBuilder =
            ...
            DeleteIntrosResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteIntrosRequest, dev.plexapi.sdk.models.operations.async.DeleteIntrosResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeleteIntrosRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteIntrosRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteIntrosRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.DeleteIntrosResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.DeleteIntrosResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.DeleteIntrosResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.DeleteIntrosResponse res = resBuilder.build();
