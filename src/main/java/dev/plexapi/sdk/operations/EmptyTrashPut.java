...
public class EmptyTrashPut {
    ...
    public static class Sync extends Base
            implements RequestOperation<EmptyTrashPutRequest, EmptyTrashPutResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(EmptyTrashPutRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EmptyTrashPutRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(EmptyTrashPutRequest request) {
        ...
        @Override
        public EmptyTrashPutResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            EmptyTrashPutResponse.Builder resBuilder =
            ...
            EmptyTrashPutResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<EmptyTrashPutRequest, dev.plexapi.sdk.models.operations.async.EmptyTrashPutResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(EmptyTrashPutRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EmptyTrashPutRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(EmptyTrashPutRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.EmptyTrashPutResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.EmptyTrashPutResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.EmptyTrashPutResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.EmptyTrashPutResponse res = resBuilder.build();
