...
public class PlayerPause {
    ...
    public static class Sync extends Base
            implements RequestOperation<PlayerPauseRequest, PlayerPauseResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(PlayerPauseRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlayerPauseRequest request) {
        ...
        @Override
        public PlayerPauseResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlayerPauseResponse.Builder resBuilder =
                    PlayerPauseResponse
                            .builder()
            ...
            PlayerPauseResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlayerPauseRequest, dev.plexapi.sdk.models.operations.async.PlayerPauseResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(PlayerPauseRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlayerPauseRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.PlayerPauseResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.PlayerPauseResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.PlayerPauseResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.PlayerPauseResponse res = resBuilder.build();
