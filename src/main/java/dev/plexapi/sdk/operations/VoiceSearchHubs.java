...
public class VoiceSearchHubs {
    ...
    public static class Sync extends Base
            implements RequestOperation<VoiceSearchHubsRequest, VoiceSearchHubsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(VoiceSearchHubsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, VoiceSearchHubsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(VoiceSearchHubsRequest request) {
        ...
        @Override
        public VoiceSearchHubsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            VoiceSearchHubsResponse.Builder resBuilder =
            ...
            VoiceSearchHubsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<VoiceSearchHubsRequest, dev.plexapi.sdk.models.operations.async.VoiceSearchHubsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(VoiceSearchHubsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, VoiceSearchHubsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(VoiceSearchHubsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.VoiceSearchHubsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.VoiceSearchHubsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.VoiceSearchHubsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.VoiceSearchHubsResponse res = resBuilder.build();
