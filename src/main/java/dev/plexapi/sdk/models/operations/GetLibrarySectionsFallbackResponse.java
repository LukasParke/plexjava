...
public class GetLibrarySectionsFallbackResponse implements Response {
    /**
    ...
    @JsonCreator
    public GetLibrarySectionsFallbackResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public GetLibrarySectionsFallbackResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetLibrarySectionsFallbackResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetLibrarySectionsFallbackResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public GetLibrarySectionsFallbackResponse withMediaContainerWithDirectory(MediaContainerWithDirectory mediaContainerWithDirectory) {
        Utils.checkNotNull(mediaContainerWithDirectory, "mediaContainerWithDirectory");
     ...
     * OK
     */
    public GetLibrarySectionsFallbackResponse withMediaContainerWithDirectory(Optional<? extends MediaContainerWithDirectory> mediaContainerWithDirectory) {
        Utils.checkNotNull(mediaContainerWithDirectory, "mediaContainerWithDirectory");
        this.mediaContainerWithDirectory = mediaContainerWithDirectory;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetLibrarySectionsFallbackResponse other = (GetLibrarySectionsFallbackResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetLibrarySectionsFallbackResponse.class,
    ...
    public final static class Builder {
        ...
        public GetLibrarySectionsFallbackResponse build() {

            return new GetLibrarySectionsFallbackResponse(
                contentType, statusCode, rawResponse,
                mediaContainerWithDirectory);
        }
