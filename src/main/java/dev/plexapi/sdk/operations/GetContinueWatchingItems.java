...
public class GetContinueWatchingItems {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetContinueWatchingItemsRequest, GetContinueWatchingItemsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetContinueWatchingItemsRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetContinueWatchingItemsRequest request) {
        ...
        @Override
        public GetContinueWatchingItemsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetContinueWatchingItemsResponse.Builder resBuilder =
            ...
            GetContinueWatchingItemsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetContinueWatchingItemsRequest, dev.plexapi.sdk.models.operations.async.GetContinueWatchingItemsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetContinueWatchingItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetContinueWatchingItemsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetContinueWatchingItemsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetContinueWatchingItemsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetContinueWatchingItemsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetContinueWatchingItemsResponse res = resBuilder.build();
