...
public class PlayerSetParametersRequest {
    ...
    @JsonCreator
    public PlayerSetParametersRequest(
            ...
            Optional<? extends Shuffle> shuffle,
            Optional<? extends Repeat> repeat,
        ...
        Utils.checkNotNull(volume, "volume");
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<Shuffle> shuffle() {
        return (Optional<Shuffle>) shuffle;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<Repeat> repeat() {
        return (Optional<Repeat>) repeat;
    }
     ...
     * Indicates the client accepts the indicated media types
     */
    public PlayerSetParametersRequest withAccepts(Accepts accepts) {
        Utils.checkNotNull(accepts, "accepts");
     ...
     * Indicates the client accepts the indicated media types
     */
    public PlayerSetParametersRequest withAccepts(Optional<? extends Accepts> accepts) {
        Utils.checkNotNull(accepts, "accepts");
        this.accepts = accepts;
        return this;
    }
     ...
     * An opaque identifier unique to the client
     */
    public PlayerSetParametersRequest withClientIdentifier(String clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
     ...
     * An opaque identifier unique to the client
     */
    public PlayerSetParametersRequest withClientIdentifier(Optional<String> clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
        this.clientIdentifier = clientIdentifier;
        return this;
    }
     ...
     * The name of the client product
     */
    public PlayerSetParametersRequest withProduct(String product) {
        Utils.checkNotNull(product, "product");
     ...
     * The name of the client product
     */
    public PlayerSetParametersRequest withProduct(Optional<String> product) {
        Utils.checkNotNull(product, "product");
        this.product = product;
        return this;
    }
     ...
     * The version of the client application
     */
    public PlayerSetParametersRequest withVersion(String version) {
        Utils.checkNotNull(version, "version");
     ...
     * The version of the client application
     */
    public PlayerSetParametersRequest withVersion(Optional<String> version) {
        Utils.checkNotNull(version, "version");
        this.version = version;
        return this;
    }
     ...
     * The platform of the client
     */
    public PlayerSetParametersRequest withPlatform(String platform) {
        Utils.checkNotNull(platform, "platform");
     ...
     * The platform of the client
     */
    public PlayerSetParametersRequest withPlatform(Optional<String> platform) {
        Utils.checkNotNull(platform, "platform");
        this.platform = platform;
        return this;
    }
     ...
     * The version of the platform
     */
    public PlayerSetParametersRequest withPlatformVersion(String platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
     ...
     * The version of the platform
     */
    public PlayerSetParametersRequest withPlatformVersion(Optional<String> platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
        this.platformVersion = platformVersion;
        return this;
    }
     ...
     * A relatively friendly name for the client device
     */
    public PlayerSetParametersRequest withDevice(String device) {
        Utils.checkNotNull(device, "device");
     ...
     * A relatively friendly name for the client device
     */
    public PlayerSetParametersRequest withDevice(Optional<String> device) {
        Utils.checkNotNull(device, "device");
        this.device = device;
        return this;
    }
     ...
     * A potentially less friendly identifier for the device model
     */
    public PlayerSetParametersRequest withModel(String model) {
        Utils.checkNotNull(model, "model");
     ...
     * A potentially less friendly identifier for the device model
     */
    public PlayerSetParametersRequest withModel(Optional<String> model) {
        Utils.checkNotNull(model, "model");
        this.model = model;
        return this;
    }
     ...
     * The device vendor
     */
    public PlayerSetParametersRequest withDeviceVendor(String deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
     ...
     * The device vendor
     */
    public PlayerSetParametersRequest withDeviceVendor(Optional<String> deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
        this.deviceVendor = deviceVendor;
        return this;
    }
     ...
     * A friendly name for the client
     */
    public PlayerSetParametersRequest withDeviceName(String deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
     ...
     * A friendly name for the client
     */
    public PlayerSetParametersRequest withDeviceName(Optional<String> deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
        this.deviceName = deviceName;
        return this;
    }
     ...
     * The marketplace on which the client application is distributed
     */
    public PlayerSetParametersRequest withMarketplace(String marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
     ...
     * The marketplace on which the client application is distributed
     */
    public PlayerSetParametersRequest withMarketplace(Optional<String> marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
        this.marketplace = marketplace;
        return this;
    }
     ...
     * default/active client.
     */
    public PlayerSetParametersRequest withXPlexTargetClientIdentifier(String xPlexTargetClientIdentifier) {
        Utils.checkNotNull(xPlexTargetClientIdentifier, "xPlexTargetClientIdentifier");
     ...
     * default/active client.
     */
    public PlayerSetParametersRequest withXPlexTargetClientIdentifier(Optional<String> xPlexTargetClientIdentifier) {
        Utils.checkNotNull(xPlexTargetClientIdentifier, "xPlexTargetClientIdentifier");
        this.xPlexTargetClientIdentifier = xPlexTargetClientIdentifier;
        return this;
    }
     ...
     * Whether to enable shuffle mode
     */
    public PlayerSetParametersRequest withShuffle(Shuffle shuffle) {
        Utils.checkNotNull(shuffle, "shuffle");
     ...
     * Whether to enable shuffle mode
     */
    public PlayerSetParametersRequest withShuffle(Optional<? extends Shuffle> shuffle) {
        Utils.checkNotNull(shuffle, "shuffle");
        this.shuffle = shuffle;
        return this;
    }
     ...
     * The repeat mode to set
     */
    public PlayerSetParametersRequest withRepeat(Repeat repeat) {
        Utils.checkNotNull(repeat, "repeat");
     ...
     * The repeat mode to set
     */
    public PlayerSetParametersRequest withRepeat(Optional<? extends Repeat> repeat) {
        Utils.checkNotNull(repeat, "repeat");
        this.repeat = repeat;
        return this;
    }
     ...
     * The volume level to set
     */
    public PlayerSetParametersRequest withVolume(long volume) {
        Utils.checkNotNull(volume, "volume");
     ...
     * The volume level to set
     */
    public PlayerSetParametersRequest withVolume(Optional<Long> volume) {
        Utils.checkNotNull(volume, "volume");
        this.volume = volume;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PlayerSetParametersRequest other = (PlayerSetParametersRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PlayerSetParametersRequest.class,
                "accepts", accepts,
    ...
    public final static class Builder {
        ...
        private Optional<? extends Shuffle> shuffle = Optional.empty();

        private Optional<? extends Repeat> repeat = Optional.empty();

        private Optional<Long> volume = Optional.empty();
         ...
         * Whether to enable shuffle mode
         */
        public Builder shuffle(Optional<? extends Shuffle> shuffle) {
            Utils.checkNotNull(shuffle, "shuffle");
            this.shuffle = shuffle;
            return this;
        }
         ...
         * The repeat mode to set
         */
        public Builder repeat(Optional<? extends Repeat> repeat) {
            Utils.checkNotNull(repeat, "repeat");
            this.repeat = repeat;
            return this;
        }
         ...
         * The volume level to set
         */
        public Builder volume(Optional<Long> volume) {
            Utils.checkNotNull(volume, "volume");
            this.volume = volume;
            return this;
        }

        public PlayerSetParametersRequest build() {
            if (accepts == null) {
                accepts = _SINGLETON_VALUE_Accepts.value();
            }

            return new PlayerSetParametersRequest(
                accepts, clientIdentifier, product,
                version, platform, platformVersion,
                device, model, deviceVendor,
                deviceName, marketplace, xPlexTargetClientIdentifier,
