...
public class EditMarker {
    ...
    public static class Sync extends Base
            implements RequestOperation<EditMarkerRequest, EditMarkerResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(EditMarkerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EditMarkerRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(EditMarkerRequest request) {
        ...
        @Override
        public EditMarkerResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            EditMarkerResponse.Builder resBuilder =
                    EditMarkerResponse
                            .builder()
            ...
            EditMarkerResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPostResponses200(Utils.unmarshal(response, new TypeReference<PostResponses200>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<EditMarkerRequest, dev.plexapi.sdk.models.operations.async.EditMarkerResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(EditMarkerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EditMarkerRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(EditMarkerRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.EditMarkerResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.EditMarkerResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.EditMarkerResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.EditMarkerResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PostResponses200>() {})
                            .thenApply(res::withPostResponses200);
                } else {
