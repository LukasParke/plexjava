...
import dev.plexapi.sdk.models.operations.GetAvailableGrabbersResponseBody;
...
public class GetAvailableGrabbers {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAvailableGrabbersRequest, GetAvailableGrabbersResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetAvailableGrabbersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAvailableGrabbersRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAvailableGrabbersRequest request) {
        ...
        @Override
        public GetAvailableGrabbersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAvailableGrabbersResponse.Builder resBuilder =
            ...
            GetAvailableGrabbersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<GetAvailableGrabbersResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAvailableGrabbersRequest, dev.plexapi.sdk.models.operations.async.GetAvailableGrabbersResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetAvailableGrabbersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAvailableGrabbersRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAvailableGrabbersRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetAvailableGrabbersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetAvailableGrabbersResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetAvailableGrabbersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetAvailableGrabbersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetAvailableGrabbersResponseBody>() {})
