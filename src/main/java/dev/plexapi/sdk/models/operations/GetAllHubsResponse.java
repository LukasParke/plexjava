...
public class GetAllHubsResponse implements Response {
    /**
     ...
     * HTTP response content type for this operation
     */
    public GetAllHubsResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetAllHubsResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetAllHubsResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public GetAllHubsResponse withMediaContainerWithHubs(MediaContainerWithHubs mediaContainerWithHubs) {
        Utils.checkNotNull(mediaContainerWithHubs, "mediaContainerWithHubs");
     ...
     * OK
     */
    public GetAllHubsResponse withMediaContainerWithHubs(Optional<? extends MediaContainerWithHubs> mediaContainerWithHubs) {
        Utils.checkNotNull(mediaContainerWithHubs, "mediaContainerWithHubs");
        this.mediaContainerWithHubs = mediaContainerWithHubs;
        return this;
    }

    public GetAllHubsResponse withHeaders(Map<String, List<String>> headers) {
        Utils.checkNotNull(headers, "headers");
        this.headers = headers;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetAllHubsResponse other = (GetAllHubsResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetAllHubsResponse.class,
    ...
    public final static class Builder {
        ...
        public GetAllHubsResponse build() {

            return new GetAllHubsResponse(
                contentType, statusCode, rawResponse,
                mediaContainerWithHubs, headers);
        }
