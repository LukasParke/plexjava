...
import dev.plexapi.sdk.models.operations.ListPlaybackHistoryResponseBody;
...
public class ListPlaybackHistory {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListPlaybackHistoryRequest, ListPlaybackHistoryResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListPlaybackHistoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPlaybackHistoryRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListPlaybackHistoryRequest request) {
        ...
        @Override
        public ListPlaybackHistoryResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListPlaybackHistoryResponse.Builder resBuilder =
            ...
            ListPlaybackHistoryResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<ListPlaybackHistoryResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListPlaybackHistoryRequest, dev.plexapi.sdk.models.operations.async.ListPlaybackHistoryResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListPlaybackHistoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPlaybackHistoryRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListPlaybackHistoryRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.ListPlaybackHistoryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.ListPlaybackHistoryResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.ListPlaybackHistoryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.ListPlaybackHistoryResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListPlaybackHistoryResponseBody>() {})
