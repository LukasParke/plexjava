...
public class ResetPlayQueue {
    ...
    public static class Sync extends Base
            implements RequestOperation<ResetPlayQueueRequest, ResetPlayQueueResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ResetPlayQueueRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ResetPlayQueueRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ResetPlayQueueRequest request) {
        ...
        @Override
        public ResetPlayQueueResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ResetPlayQueueResponse.Builder resBuilder =
            ...
            ResetPlayQueueResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ResetPlayQueueRequest, dev.plexapi.sdk.models.operations.async.ResetPlayQueueResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ResetPlayQueueRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ResetPlayQueueRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ResetPlayQueueRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.ResetPlayQueueResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.ResetPlayQueueResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.ResetPlayQueueResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.ResetPlayQueueResponse res = resBuilder.build();
