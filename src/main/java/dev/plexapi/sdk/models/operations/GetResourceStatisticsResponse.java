...
public class GetResourceStatisticsResponse implements Response {
    /**
    ...
    @JsonCreator
    public GetResourceStatisticsResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public GetResourceStatisticsResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetResourceStatisticsResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetResourceStatisticsResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public GetResourceStatisticsResponse withMediaContainerWithDirectory(MediaContainerWithDirectory mediaContainerWithDirectory) {
        Utils.checkNotNull(mediaContainerWithDirectory, "mediaContainerWithDirectory");
     ...
     * OK
     */
    public GetResourceStatisticsResponse withMediaContainerWithDirectory(Optional<? extends MediaContainerWithDirectory> mediaContainerWithDirectory) {
        Utils.checkNotNull(mediaContainerWithDirectory, "mediaContainerWithDirectory");
        this.mediaContainerWithDirectory = mediaContainerWithDirectory;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetResourceStatisticsResponse other = (GetResourceStatisticsResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetResourceStatisticsResponse.class,
    ...
    public final static class Builder {
        ...
        public GetResourceStatisticsResponse build() {
            ...
            return new GetResourceStatisticsResponse(
                contentType, statusCode, rawResponse,
                mediaContainerWithDirectory);
        }
