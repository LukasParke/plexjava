...
public class GetSectionAgentsResponse implements Response {
    /**
    ...
    @JsonCreator
    public GetSectionAgentsResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public GetSectionAgentsResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetSectionAgentsResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetSectionAgentsResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public GetSectionAgentsResponse withMediaContainerWithDirectory(MediaContainerWithDirectory mediaContainerWithDirectory) {
        Utils.checkNotNull(mediaContainerWithDirectory, "mediaContainerWithDirectory");
     ...
     * OK
     */
    public GetSectionAgentsResponse withMediaContainerWithDirectory(Optional<? extends MediaContainerWithDirectory> mediaContainerWithDirectory) {
        Utils.checkNotNull(mediaContainerWithDirectory, "mediaContainerWithDirectory");
        this.mediaContainerWithDirectory = mediaContainerWithDirectory;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetSectionAgentsResponse other = (GetSectionAgentsResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetSectionAgentsResponse.class,
    ...
    public final static class Builder {
        ...
        public GetSectionAgentsResponse build() {

            return new GetSectionAgentsResponse(
                contentType, statusCode, rawResponse,
                mediaContainerWithDirectory);
        }
