...
public class BrowseFilesystemPathRequest {
    ...
    @JsonCreator
    public BrowseFilesystemPathRequest(
        ...
        Utils.checkNotNull(base64path, "base64path");
    ...
    public BrowseFilesystemPathRequest(
        ...
        this(Optional.empty(), Optional.empty(), Optional.empty(),
            ...
            Optional.empty(), Optional.empty(), Optional.empty(),
            Optional.empty(), Optional.empty(), base64path);
    }
     ...
     * Indicates the client accepts the indicated media types
     */
    public BrowseFilesystemPathRequest withAccepts(Accepts accepts) {
        Utils.checkNotNull(accepts, "accepts");
     ...
     * Indicates the client accepts the indicated media types
     */
    public BrowseFilesystemPathRequest withAccepts(Optional<? extends Accepts> accepts) {
        Utils.checkNotNull(accepts, "accepts");
        this.accepts = accepts;
        return this;
    }
     ...
     * An opaque identifier unique to the client
     */
    public BrowseFilesystemPathRequest withClientIdentifier(String clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
     ...
     * An opaque identifier unique to the client
     */
    public BrowseFilesystemPathRequest withClientIdentifier(Optional<String> clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
        this.clientIdentifier = clientIdentifier;
        return this;
    }
     ...
     * The name of the client product
     */
    public BrowseFilesystemPathRequest withProduct(String product) {
        Utils.checkNotNull(product, "product");
     ...
     * The name of the client product
     */
    public BrowseFilesystemPathRequest withProduct(Optional<String> product) {
        Utils.checkNotNull(product, "product");
        this.product = product;
        return this;
    }
     ...
     * The version of the client application
     */
    public BrowseFilesystemPathRequest withVersion(String version) {
        Utils.checkNotNull(version, "version");
     ...
     * The version of the client application
     */
    public BrowseFilesystemPathRequest withVersion(Optional<String> version) {
        Utils.checkNotNull(version, "version");
        this.version = version;
        return this;
    }
     ...
     * The platform of the client
     */
    public BrowseFilesystemPathRequest withPlatform(String platform) {
        Utils.checkNotNull(platform, "platform");
     ...
     * The platform of the client
     */
    public BrowseFilesystemPathRequest withPlatform(Optional<String> platform) {
        Utils.checkNotNull(platform, "platform");
        this.platform = platform;
        return this;
    }
     ...
     * The version of the platform
     */
    public BrowseFilesystemPathRequest withPlatformVersion(String platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
     ...
     * The version of the platform
     */
    public BrowseFilesystemPathRequest withPlatformVersion(Optional<String> platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
        this.platformVersion = platformVersion;
        return this;
    }
     ...
     * A relatively friendly name for the client device
     */
    public BrowseFilesystemPathRequest withDevice(String device) {
        Utils.checkNotNull(device, "device");
     ...
     * A relatively friendly name for the client device
     */
    public BrowseFilesystemPathRequest withDevice(Optional<String> device) {
        Utils.checkNotNull(device, "device");
        this.device = device;
        return this;
    }
     ...
     * A potentially less friendly identifier for the device model
     */
    public BrowseFilesystemPathRequest withModel(String model) {
        Utils.checkNotNull(model, "model");
     ...
     * A potentially less friendly identifier for the device model
     */
    public BrowseFilesystemPathRequest withModel(Optional<String> model) {
        Utils.checkNotNull(model, "model");
        this.model = model;
        return this;
    }
     ...
     * The device vendor
     */
    public BrowseFilesystemPathRequest withDeviceVendor(String deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
     ...
     * The device vendor
     */
    public BrowseFilesystemPathRequest withDeviceVendor(Optional<String> deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
        this.deviceVendor = deviceVendor;
        return this;
    }
     ...
     * A friendly name for the client
     */
    public BrowseFilesystemPathRequest withDeviceName(String deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
     ...
     * A friendly name for the client
     */
    public BrowseFilesystemPathRequest withDeviceName(Optional<String> deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
        this.deviceName = deviceName;
        return this;
    }
     ...
     * The marketplace on which the client application is distributed
     */
    public BrowseFilesystemPathRequest withMarketplace(String marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
     ...
     * The marketplace on which the client application is distributed
     */
    public BrowseFilesystemPathRequest withMarketplace(Optional<String> marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
        this.marketplace = marketplace;
        return this;
    }
     ...
     * The base64path
     */
    public BrowseFilesystemPathRequest withBase64path(String base64path) {
        Utils.checkNotNull(base64path, "base64path");
        this.base64path = base64path;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        BrowseFilesystemPathRequest other = (BrowseFilesystemPathRequest) o;
        return 
            ...
            Utils.enhancedDeepEquals(this.base64path, other.base64path);
    }
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            deviceName, marketplace, base64path);
    }
    
    @Override
    public String toString() {
        return Utils.toString(BrowseFilesystemPathRequest.class,
                "accepts", accepts,
    ...
    public final static class Builder {
         ...
         * The base64path
         */
        public Builder base64path(String base64path) {
            Utils.checkNotNull(base64path, "base64path");
            this.base64path = base64path;
            return this;
        }

        public BrowseFilesystemPathRequest build() {
            if (accepts == null) {
                accepts = _SINGLETON_VALUE_Accepts.value();
            }

            return new BrowseFilesystemPathRequest(
                accepts, clientIdentifier, product,
                version, platform, platformVersion,
                device, model, deviceVendor,
                deviceName, marketplace, base64path);
