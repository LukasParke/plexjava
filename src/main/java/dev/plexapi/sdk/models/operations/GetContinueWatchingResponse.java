...
public class GetContinueWatchingResponse implements Response {
    /**
    ...
    @JsonCreator
    public GetContinueWatchingResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public GetContinueWatchingResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetContinueWatchingResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetContinueWatchingResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public GetContinueWatchingResponse withMediaContainerWithHubs(MediaContainerWithHubs mediaContainerWithHubs) {
        Utils.checkNotNull(mediaContainerWithHubs, "mediaContainerWithHubs");
     ...
     * OK
     */
    public GetContinueWatchingResponse withMediaContainerWithHubs(Optional<? extends MediaContainerWithHubs> mediaContainerWithHubs) {
        Utils.checkNotNull(mediaContainerWithHubs, "mediaContainerWithHubs");
        this.mediaContainerWithHubs = mediaContainerWithHubs;
        return this;
    }

    public GetContinueWatchingResponse withHeaders(Map<String, List<String>> headers) {
        Utils.checkNotNull(headers, "headers");
        this.headers = headers;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetContinueWatchingResponse other = (GetContinueWatchingResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetContinueWatchingResponse.class,
    ...
    public final static class Builder {
        ...
        public GetContinueWatchingResponse build() {

            return new GetContinueWatchingResponse(
                contentType, statusCode, rawResponse,
                mediaContainerWithHubs, headers);
        }
