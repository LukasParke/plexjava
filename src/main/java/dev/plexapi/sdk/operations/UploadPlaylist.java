...
public class UploadPlaylist {
    ...
    public static class Sync extends Base
            implements RequestOperation<UploadPlaylistRequest, UploadPlaylistResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UploadPlaylistRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UploadPlaylistRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UploadPlaylistRequest request) {
        ...
        @Override
        public UploadPlaylistResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UploadPlaylistResponse.Builder resBuilder =
            ...
            UploadPlaylistResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UploadPlaylistRequest, dev.plexapi.sdk.models.operations.async.UploadPlaylistResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UploadPlaylistRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UploadPlaylistRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UploadPlaylistRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.UploadPlaylistResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.UploadPlaylistResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.UploadPlaylistResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.UploadPlaylistResponse res = resBuilder.build();
