...
public class GetSectionImage {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSectionImageRequest, GetSectionImageResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetSectionImageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSectionImageRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSectionImageRequest request) {
        ...
        @Override
        public GetSectionImageResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSectionImageResponse.Builder resBuilder =
            ...
            GetSectionImageResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSectionImageRequest, dev.plexapi.sdk.models.operations.async.GetSectionImageResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSectionImageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSectionImageRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSectionImageRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetSectionImageResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetSectionImageResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetSectionImageResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetSectionImageResponse res = resBuilder.build();
