...
public class GetSectionTagsResponse implements Response {
    /**
     ...
     * HTTP response content type for this operation
     */
    public GetSectionTagsResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetSectionTagsResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetSectionTagsResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public GetSectionTagsResponse withMediaContainerWithTags(MediaContainerWithTags mediaContainerWithTags) {
        Utils.checkNotNull(mediaContainerWithTags, "mediaContainerWithTags");
     ...
     * OK
     */
    public GetSectionTagsResponse withMediaContainerWithTags(Optional<? extends MediaContainerWithTags> mediaContainerWithTags) {
        Utils.checkNotNull(mediaContainerWithTags, "mediaContainerWithTags");
        this.mediaContainerWithTags = mediaContainerWithTags;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetSectionTagsResponse other = (GetSectionTagsResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetSectionTagsResponse.class,
    ...
    public final static class Builder {
        ...
        public GetSectionTagsResponse build() {

            return new GetSectionTagsResponse(
                contentType, statusCode, rawResponse,
                mediaContainerWithTags);
        }
