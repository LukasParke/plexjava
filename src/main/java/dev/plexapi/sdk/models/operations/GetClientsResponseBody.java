...
public class GetClientsResponseBody {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("Server")
    private Optional<? extends List<PlexDevice>> server;
    ...
    public GetClientsResponseBody(
            ...
            @JsonProperty("Server") Optional<? extends List<PlexDevice>> server) {
    ...
    @JsonIgnore
    public Optional<List<PlexDevice>> server() {
        return (Optional<List<PlexDevice>>) server;
    }
    ...
    public GetClientsResponseBody withIdentifier(String identifier) {
        Utils.checkNotNull(identifier, "identifier");
    ...
    public GetClientsResponseBody withIdentifier(Optional<String> identifier) {
        Utils.checkNotNull(identifier, "identifier");
        this.identifier = identifier;
        return this;
    }
     ...
     * the `X-Plex-Container-Start` header.
     */
    public GetClientsResponseBody withOffset(long offset) {
        Utils.checkNotNull(offset, "offset");
     ...
     * the `X-Plex-Container-Start` header.
     */
    public GetClientsResponseBody withOffset(Optional<Long> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }

    public GetClientsResponseBody withSize(long size) {
        Utils.checkNotNull(size, "size");
    ...
    public GetClientsResponseBody withSize(Optional<Long> size) {
        Utils.checkNotNull(size, "size");
        this.size = size;
        return this;
    }
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public GetClientsResponseBody withTotalSize(long totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public GetClientsResponseBody withTotalSize(Optional<Long> totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
        this.totalSize = totalSize;
        return this;
    }

    public GetClientsResponseBody withServer(List<PlexDevice> server) {
        Utils.checkNotNull(server, "server");
    ...
    public GetClientsResponseBody withServer(Optional<? extends List<PlexDevice>> server) {
        Utils.checkNotNull(server, "server");
        this.server = server;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetClientsResponseBody other = (GetClientsResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetClientsResponseBody.class,
    ...
    public final static class Builder {
        ...
        private Optional<? extends List<PlexDevice>> server = Optional.empty();
        ...
        public Builder server(List<PlexDevice> server) {
            Utils.checkNotNull(server, "server");
            this.server = Optional.ofNullable(server);
            return this;
        }

        public Builder server(Optional<? extends List<PlexDevice>> server) {
            Utils.checkNotNull(server, "server");
            this.server = server;
            return this;
        }

        public GetClientsResponseBody build() {

            return new GetClientsResponseBody(
                identifier, offset, size,
                totalSize, server);
        }
