...
public class GetPromotedHubs {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPromotedHubsRequest, GetPromotedHubsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetPromotedHubsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPromotedHubsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPromotedHubsRequest request) {
        ...
        @Override
        public GetPromotedHubsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetPromotedHubsResponse.Builder resBuilder =
            ...
            GetPromotedHubsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetPromotedHubsRequest, dev.plexapi.sdk.models.operations.async.GetPromotedHubsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetPromotedHubsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPromotedHubsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetPromotedHubsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetPromotedHubsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetPromotedHubsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetPromotedHubsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetPromotedHubsResponse res = resBuilder.build();
