...
public class PlayerRefreshplayqueueRequest {
    ...
    @JsonCreator
    public PlayerRefreshplayqueueRequest(
     ...
     * Indicates the client accepts the indicated media types
     */
    public PlayerRefreshplayqueueRequest withAccepts(Accepts accepts) {
        Utils.checkNotNull(accepts, "accepts");
     ...
     * Indicates the client accepts the indicated media types
     */
    public PlayerRefreshplayqueueRequest withAccepts(Optional<? extends Accepts> accepts) {
        Utils.checkNotNull(accepts, "accepts");
        this.accepts = accepts;
        return this;
    }
     ...
     * An opaque identifier unique to the client
     */
    public PlayerRefreshplayqueueRequest withClientIdentifier(String clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
     ...
     * An opaque identifier unique to the client
     */
    public PlayerRefreshplayqueueRequest withClientIdentifier(Optional<String> clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
        this.clientIdentifier = clientIdentifier;
        return this;
    }
     ...
     * The name of the client product
     */
    public PlayerRefreshplayqueueRequest withProduct(String product) {
        Utils.checkNotNull(product, "product");
     ...
     * The name of the client product
     */
    public PlayerRefreshplayqueueRequest withProduct(Optional<String> product) {
        Utils.checkNotNull(product, "product");
        this.product = product;
        return this;
    }
     ...
     * The version of the client application
     */
    public PlayerRefreshplayqueueRequest withVersion(String version) {
        Utils.checkNotNull(version, "version");
     ...
     * The version of the client application
     */
    public PlayerRefreshplayqueueRequest withVersion(Optional<String> version) {
        Utils.checkNotNull(version, "version");
        this.version = version;
        return this;
    }
     ...
     * The platform of the client
     */
    public PlayerRefreshplayqueueRequest withPlatform(String platform) {
        Utils.checkNotNull(platform, "platform");
     ...
     * The platform of the client
     */
    public PlayerRefreshplayqueueRequest withPlatform(Optional<String> platform) {
        Utils.checkNotNull(platform, "platform");
        this.platform = platform;
        return this;
    }
     ...
     * The version of the platform
     */
    public PlayerRefreshplayqueueRequest withPlatformVersion(String platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
     ...
     * The version of the platform
     */
    public PlayerRefreshplayqueueRequest withPlatformVersion(Optional<String> platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
        this.platformVersion = platformVersion;
        return this;
    }
     ...
     * A relatively friendly name for the client device
     */
    public PlayerRefreshplayqueueRequest withDevice(String device) {
        Utils.checkNotNull(device, "device");
     ...
     * A relatively friendly name for the client device
     */
    public PlayerRefreshplayqueueRequest withDevice(Optional<String> device) {
        Utils.checkNotNull(device, "device");
        this.device = device;
        return this;
    }
     ...
     * A potentially less friendly identifier for the device model
     */
    public PlayerRefreshplayqueueRequest withModel(String model) {
        Utils.checkNotNull(model, "model");
     ...
     * A potentially less friendly identifier for the device model
     */
    public PlayerRefreshplayqueueRequest withModel(Optional<String> model) {
        Utils.checkNotNull(model, "model");
        this.model = model;
        return this;
    }
     ...
     * The device vendor
     */
    public PlayerRefreshplayqueueRequest withDeviceVendor(String deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
     ...
     * The device vendor
     */
    public PlayerRefreshplayqueueRequest withDeviceVendor(Optional<String> deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
        this.deviceVendor = deviceVendor;
        return this;
    }
     ...
     * A friendly name for the client
     */
    public PlayerRefreshplayqueueRequest withDeviceName(String deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
     ...
     * A friendly name for the client
     */
    public PlayerRefreshplayqueueRequest withDeviceName(Optional<String> deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
        this.deviceName = deviceName;
        return this;
    }
     ...
     * The marketplace on which the client application is distributed
     */
    public PlayerRefreshplayqueueRequest withMarketplace(String marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
     ...
     * The marketplace on which the client application is distributed
     */
    public PlayerRefreshplayqueueRequest withMarketplace(Optional<String> marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
        this.marketplace = marketplace;
        return this;
    }
     ...
     * default/active client.
     */
    public PlayerRefreshplayqueueRequest withXPlexTargetClientIdentifier(String xPlexTargetClientIdentifier) {
        Utils.checkNotNull(xPlexTargetClientIdentifier, "xPlexTargetClientIdentifier");
     ...
     * default/active client.
     */
    public PlayerRefreshplayqueueRequest withXPlexTargetClientIdentifier(Optional<String> xPlexTargetClientIdentifier) {
        Utils.checkNotNull(xPlexTargetClientIdentifier, "xPlexTargetClientIdentifier");
        this.xPlexTargetClientIdentifier = xPlexTargetClientIdentifier;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PlayerRefreshplayqueueRequest other = (PlayerRefreshplayqueueRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PlayerRefreshplayqueueRequest.class,
                "accepts", accepts,
    ...
    public final static class Builder {
        ...
        public PlayerRefreshplayqueueRequest build() {
            if (accepts == null) {
                accepts = _SINGLETON_VALUE_Accepts.value();
            }

            return new PlayerRefreshplayqueueRequest(
                accepts, clientIdentifier, product,
                version, platform, platformVersion,
                device, model, deviceVendor,
                deviceName, marketplace, xPlexTargetClientIdentifier);
