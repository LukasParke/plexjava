...
import dev.plexapi.sdk.models.shared.GetResponses200;
...
public class MoveHub {
    ...
    public static class Sync extends Base
            implements RequestOperation<MoveHubRequest, MoveHubResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(MoveHubRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MoveHubRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MoveHubRequest request) {
        ...
        @Override
        public MoveHubResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            MoveHubResponse.Builder resBuilder =
                    MoveHubResponse
                            .builder()
            ...
            MoveHubResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetResponses200(Utils.unmarshal(response, new TypeReference<GetResponses200>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MoveHubRequest, dev.plexapi.sdk.models.operations.async.MoveHubResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(MoveHubRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MoveHubRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(MoveHubRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.MoveHubResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.MoveHubResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.MoveHubResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.MoveHubResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetResponses200>() {})
                            .thenApply(res::withGetResponses200);
                } else {
