...
public class CancelGrab {
    ...
    public static class Sync extends Base
            implements RequestOperation<CancelGrabRequest, CancelGrabResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CancelGrabRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CancelGrabRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CancelGrabRequest request) {
        ...
        @Override
        public CancelGrabResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CancelGrabResponse.Builder resBuilder =
                    CancelGrabResponse
                            .builder()
            ...
            CancelGrabResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CancelGrabRequest, dev.plexapi.sdk.models.operations.async.CancelGrabResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CancelGrabRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CancelGrabRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CancelGrabRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.CancelGrabResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.CancelGrabResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.CancelGrabResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.CancelGrabResponse res = resBuilder.build();
