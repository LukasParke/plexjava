...
import dev.plexapi.sdk.models.shared.ManagedHub;
...
public class ListHubsMediaContainer {
    ...
    public ListHubsMediaContainer withIdentifier(String identifier) {
        Utils.checkNotNull(identifier, "identifier");
    ...
    public ListHubsMediaContainer withIdentifier(Optional<String> identifier) {
        Utils.checkNotNull(identifier, "identifier");
        this.identifier = identifier;
        return this;
    }
     ...
     * the `X-Plex-Container-Start` header.
     */
    public ListHubsMediaContainer withOffset(long offset) {
        Utils.checkNotNull(offset, "offset");
     ...
     * the `X-Plex-Container-Start` header.
     */
    public ListHubsMediaContainer withOffset(Optional<Long> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }

    public ListHubsMediaContainer withSize(long size) {
        Utils.checkNotNull(size, "size");
    ...
    public ListHubsMediaContainer withSize(Optional<Long> size) {
        Utils.checkNotNull(size, "size");
        this.size = size;
        return this;
    }
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public ListHubsMediaContainer withTotalSize(long totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public ListHubsMediaContainer withTotalSize(Optional<Long> totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
        this.totalSize = totalSize;
        return this;
    }

    public ListHubsMediaContainer withHub(List<ManagedHub> hub) {
        Utils.checkNotNull(hub, "hub");
    ...
    public ListHubsMediaContainer withHub(Optional<? extends List<ManagedHub>> hub) {
        Utils.checkNotNull(hub, "hub");
        this.hub = hub;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListHubsMediaContainer other = (ListHubsMediaContainer) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListHubsMediaContainer.class,
    ...
    public final static class Builder {
        ...
        public ListHubsMediaContainer build() {

            return new ListHubsMediaContainer(
                identifier, offset, size,
                totalSize, hub);
        }
