...
import dev.plexapi.sdk.models.shared.HistoryAllGetResponses200;
...
public class GetHistoryItem {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetHistoryItemRequest, GetHistoryItemResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetHistoryItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHistoryItemRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetHistoryItemRequest request) {
        ...
        @Override
        public GetHistoryItemResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetHistoryItemResponse.Builder resBuilder =
            ...
            GetHistoryItemResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHistoryAllGetResponses200(Utils.unmarshal(response, new TypeReference<HistoryAllGetResponses200>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetHistoryItemRequest, dev.plexapi.sdk.models.operations.async.GetHistoryItemResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetHistoryItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHistoryItemRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetHistoryItemRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetHistoryItemResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetHistoryItemResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetHistoryItemResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetHistoryItemResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<HistoryAllGetResponses200>() {})
                            .thenApply(res::withHistoryAllGetResponses200);
                } else {
