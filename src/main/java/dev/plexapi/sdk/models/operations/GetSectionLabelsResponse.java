...
public class GetSectionLabelsResponse implements Response {
    /**
    ...
    @JsonCreator
    public GetSectionLabelsResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public GetSectionLabelsResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetSectionLabelsResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetSectionLabelsResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public GetSectionLabelsResponse withMediaContainerWithTags(MediaContainerWithTags mediaContainerWithTags) {
        Utils.checkNotNull(mediaContainerWithTags, "mediaContainerWithTags");
     ...
     * OK
     */
    public GetSectionLabelsResponse withMediaContainerWithTags(Optional<? extends MediaContainerWithTags> mediaContainerWithTags) {
        Utils.checkNotNull(mediaContainerWithTags, "mediaContainerWithTags");
        this.mediaContainerWithTags = mediaContainerWithTags;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetSectionLabelsResponse other = (GetSectionLabelsResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetSectionLabelsResponse.class,
    ...
    public final static class Builder {
        ...
        public GetSectionLabelsResponse build() {

            return new GetSectionLabelsResponse(
                contentType, statusCode, rawResponse,
                mediaContainerWithTags);
        }
