...
public class AddProvider {
    ...
    public static class Sync extends Base
            implements RequestOperation<AddProviderRequest, AddProviderResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AddProviderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddProviderRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddProviderRequest request) {
        ...
        @Override
        public AddProviderResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AddProviderResponse.Builder resBuilder =
                    AddProviderResponse
                            .builder()
            ...
            AddProviderResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AddProviderRequest, dev.plexapi.sdk.models.operations.async.AddProviderResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AddProviderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddProviderRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AddProviderRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.AddProviderResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.AddProviderResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.AddProviderResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.AddProviderResponse res = resBuilder.build();
