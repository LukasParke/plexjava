...
public class MediaContainerWithStatusMediaContainer {
    ...
    @JsonCreator
    public MediaContainerWithStatusMediaContainer(
    ...
    public MediaContainerWithStatusMediaContainer withIdentifier(String identifier) {
        Utils.checkNotNull(identifier, "identifier");
    ...
    public MediaContainerWithStatusMediaContainer withIdentifier(Optional<String> identifier) {
        Utils.checkNotNull(identifier, "identifier");
        this.identifier = identifier;
        return this;
    }
     ...
     * the `X-Plex-Container-Start` header.
     */
    public MediaContainerWithStatusMediaContainer withOffset(long offset) {
        Utils.checkNotNull(offset, "offset");
     ...
     * the `X-Plex-Container-Start` header.
     */
    public MediaContainerWithStatusMediaContainer withOffset(Optional<Long> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }

    public MediaContainerWithStatusMediaContainer withSize(long size) {
        Utils.checkNotNull(size, "size");
    ...
    public MediaContainerWithStatusMediaContainer withSize(Optional<Long> size) {
        Utils.checkNotNull(size, "size");
        this.size = size;
        return this;
    }
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public MediaContainerWithStatusMediaContainer withTotalSize(long totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public MediaContainerWithStatusMediaContainer withTotalSize(Optional<Long> totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
        this.totalSize = totalSize;
        return this;
    }
     ...
     * A status indicator. If present and non-zero, indicates an error
     */
    public MediaContainerWithStatusMediaContainer withStatus(long status) {
        Utils.checkNotNull(status, "status");
     ...
     * A status indicator. If present and non-zero, indicates an error
     */
    public MediaContainerWithStatusMediaContainer withStatus(Optional<Long> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        MediaContainerWithStatusMediaContainer other = (MediaContainerWithStatusMediaContainer) o;
        return 
    ...
    public String toString() {
        return Utils.toString(MediaContainerWithStatusMediaContainer.class,
    ...
    public final static class Builder {
        ...
        public MediaContainerWithStatusMediaContainer build() {

            return new MediaContainerWithStatusMediaContainer(
                identifier, offset, size,
                totalSize, status);
        }
