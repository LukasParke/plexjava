...
public class GetSectionHubsResponse implements Response {
    /**
     ...
     * HTTP response content type for this operation
     */
    public GetSectionHubsResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetSectionHubsResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetSectionHubsResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public GetSectionHubsResponse withMediaContainerWithHubs(MediaContainerWithHubs mediaContainerWithHubs) {
        Utils.checkNotNull(mediaContainerWithHubs, "mediaContainerWithHubs");
     ...
     * OK
     */
    public GetSectionHubsResponse withMediaContainerWithHubs(Optional<? extends MediaContainerWithHubs> mediaContainerWithHubs) {
        Utils.checkNotNull(mediaContainerWithHubs, "mediaContainerWithHubs");
        this.mediaContainerWithHubs = mediaContainerWithHubs;
        return this;
    }

    public GetSectionHubsResponse withHeaders(Map<String, List<String>> headers) {
        Utils.checkNotNull(headers, "headers");
        this.headers = headers;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetSectionHubsResponse other = (GetSectionHubsResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetSectionHubsResponse.class,
    ...
    public final static class Builder {
        ...
        public GetSectionHubsResponse build() {

            return new GetSectionHubsResponse(
                contentType, statusCode, rawResponse,
                mediaContainerWithHubs, headers);
        }
