...
public class GetMetadataAgentDetails {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetMetadataAgentDetailsRequest, GetMetadataAgentDetailsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetMetadataAgentDetailsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMetadataAgentDetailsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetMetadataAgentDetailsRequest request) {
        ...
        @Override
        public GetMetadataAgentDetailsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetMetadataAgentDetailsResponse.Builder resBuilder =
            ...
            GetMetadataAgentDetailsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMediaContainerWithDirectory(Utils.unmarshal(response, new TypeReference<MediaContainerWithDirectory>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetMetadataAgentDetailsRequest, dev.plexapi.sdk.models.operations.async.GetMetadataAgentDetailsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetMetadataAgentDetailsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMetadataAgentDetailsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetMetadataAgentDetailsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetMetadataAgentDetailsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetMetadataAgentDetailsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetMetadataAgentDetailsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetMetadataAgentDetailsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MediaContainerWithDirectory>() {})
                            .thenApply(res::withMediaContainerWithDirectory);
                } else {
