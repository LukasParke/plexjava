...
public class EditLibrarySection {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/library/sections/{sectionId}/edit",
    ...
    public static class Sync extends Base
            implements RequestOperation<EditLibrarySectionRequest, EditLibrarySectionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(EditLibrarySectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EditLibrarySectionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(EditLibrarySectionRequest request) {
        ...
        @Override
        public EditLibrarySectionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            EditLibrarySectionResponse.Builder resBuilder =
            ...
            EditLibrarySectionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<EditLibrarySectionRequest, dev.plexapi.sdk.models.operations.async.EditLibrarySectionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(EditLibrarySectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EditLibrarySectionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(EditLibrarySectionRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.EditLibrarySectionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.EditLibrarySectionResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.EditLibrarySectionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.EditLibrarySectionResponse res = resBuilder.build();
