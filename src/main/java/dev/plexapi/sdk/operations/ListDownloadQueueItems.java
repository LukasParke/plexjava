...
import dev.plexapi.sdk.models.operations.ListDownloadQueueItemsResponseBody;
...
public class ListDownloadQueueItems {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListDownloadQueueItemsRequest, ListDownloadQueueItemsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListDownloadQueueItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListDownloadQueueItemsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListDownloadQueueItemsRequest request) {
        ...
        @Override
        public ListDownloadQueueItemsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListDownloadQueueItemsResponse.Builder resBuilder =
            ...
            ListDownloadQueueItemsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<ListDownloadQueueItemsResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListDownloadQueueItemsRequest, dev.plexapi.sdk.models.operations.async.ListDownloadQueueItemsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListDownloadQueueItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListDownloadQueueItemsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListDownloadQueueItemsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.ListDownloadQueueItemsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.ListDownloadQueueItemsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.ListDownloadQueueItemsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.ListDownloadQueueItemsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListDownloadQueueItemsResponseBody>() {})
