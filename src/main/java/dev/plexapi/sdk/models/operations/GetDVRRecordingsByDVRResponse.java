...
public class GetDVRRecordingsByDVRResponse implements Response {
    /**
    ...
    @JsonCreator
    public GetDVRRecordingsByDVRResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public GetDVRRecordingsByDVRResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetDVRRecordingsByDVRResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetDVRRecordingsByDVRResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public GetDVRRecordingsByDVRResponse withMediaContainerWithMetadata(MediaContainerWithMetadata mediaContainerWithMetadata) {
        Utils.checkNotNull(mediaContainerWithMetadata, "mediaContainerWithMetadata");
     ...
     * OK
     */
    public GetDVRRecordingsByDVRResponse withMediaContainerWithMetadata(Optional<? extends MediaContainerWithMetadata> mediaContainerWithMetadata) {
        Utils.checkNotNull(mediaContainerWithMetadata, "mediaContainerWithMetadata");
        this.mediaContainerWithMetadata = mediaContainerWithMetadata;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetDVRRecordingsByDVRResponse other = (GetDVRRecordingsByDVRResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetDVRRecordingsByDVRResponse.class,
    ...
    public final static class Builder {
        ...
        public GetDVRRecordingsByDVRResponse build() {

            return new GetDVRRecordingsByDVRResponse(
                contentType, statusCode, rawResponse,
                mediaContainerWithMetadata);
        }
