...
public class AddSection {
    ...
    public static class Sync extends Base
            implements RequestOperation<AddSectionRequest, AddSectionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AddSectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddSectionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddSectionRequest request) {
        ...
        @Override
        public AddSectionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AddSectionResponse.Builder resBuilder =
                    AddSectionResponse
                            .builder()
            ...
            AddSectionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSlashGetResponses200(Utils.unmarshal(response, new TypeReference<SlashGetResponses200>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AddSectionRequest, dev.plexapi.sdk.models.operations.async.AddSectionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AddSectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddSectionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AddSectionRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.AddSectionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.AddSectionResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.AddSectionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.AddSectionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<SlashGetResponses200>() {})
                            .thenApply(res::withSlashGetResponses200);
                } else {
