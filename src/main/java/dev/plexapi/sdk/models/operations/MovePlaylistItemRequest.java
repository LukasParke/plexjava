...
public class MovePlaylistItemRequest {
    ...
    public MovePlaylistItemRequest(
        ...
        this(Optional.empty(), Optional.empty(), Optional.empty(),
            ...
            Optional.empty(), Optional.empty(), Optional.empty(),
            Optional.empty(), Optional.empty(), playlistId,
            playlistItemId, Optional.empty());
    }
     ...
     * Indicates the client accepts the indicated media types
     */
    public MovePlaylistItemRequest withAccepts(Accepts accepts) {
        Utils.checkNotNull(accepts, "accepts");
     ...
     * Indicates the client accepts the indicated media types
     */
    public MovePlaylistItemRequest withAccepts(Optional<? extends Accepts> accepts) {
        Utils.checkNotNull(accepts, "accepts");
        this.accepts = accepts;
        return this;
    }
     ...
     * An opaque identifier unique to the client
     */
    public MovePlaylistItemRequest withClientIdentifier(String clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
     ...
     * An opaque identifier unique to the client
     */
    public MovePlaylistItemRequest withClientIdentifier(Optional<String> clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
        this.clientIdentifier = clientIdentifier;
        return this;
    }
     ...
     * The name of the client product
     */
    public MovePlaylistItemRequest withProduct(String product) {
        Utils.checkNotNull(product, "product");
     ...
     * The name of the client product
     */
    public MovePlaylistItemRequest withProduct(Optional<String> product) {
        Utils.checkNotNull(product, "product");
        this.product = product;
        return this;
    }
     ...
     * The version of the client application
     */
    public MovePlaylistItemRequest withVersion(String version) {
        Utils.checkNotNull(version, "version");
     ...
     * The version of the client application
     */
    public MovePlaylistItemRequest withVersion(Optional<String> version) {
        Utils.checkNotNull(version, "version");
        this.version = version;
        return this;
    }
     ...
     * The platform of the client
     */
    public MovePlaylistItemRequest withPlatform(String platform) {
        Utils.checkNotNull(platform, "platform");
     ...
     * The platform of the client
     */
    public MovePlaylistItemRequest withPlatform(Optional<String> platform) {
        Utils.checkNotNull(platform, "platform");
        this.platform = platform;
        return this;
    }
     ...
     * The version of the platform
     */
    public MovePlaylistItemRequest withPlatformVersion(String platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
     ...
     * The version of the platform
     */
    public MovePlaylistItemRequest withPlatformVersion(Optional<String> platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
        this.platformVersion = platformVersion;
        return this;
    }
     ...
     * A relatively friendly name for the client device
     */
    public MovePlaylistItemRequest withDevice(String device) {
        Utils.checkNotNull(device, "device");
     ...
     * A relatively friendly name for the client device
     */
    public MovePlaylistItemRequest withDevice(Optional<String> device) {
        Utils.checkNotNull(device, "device");
        this.device = device;
        return this;
    }
     ...
     * A potentially less friendly identifier for the device model
     */
    public MovePlaylistItemRequest withModel(String model) {
        Utils.checkNotNull(model, "model");
     ...
     * A potentially less friendly identifier for the device model
     */
    public MovePlaylistItemRequest withModel(Optional<String> model) {
        Utils.checkNotNull(model, "model");
        this.model = model;
        return this;
    }
     ...
     * The device vendor
     */
    public MovePlaylistItemRequest withDeviceVendor(String deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
     ...
     * The device vendor
     */
    public MovePlaylistItemRequest withDeviceVendor(Optional<String> deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
        this.deviceVendor = deviceVendor;
        return this;
    }
     ...
     * A friendly name for the client
     */
    public MovePlaylistItemRequest withDeviceName(String deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
     ...
     * A friendly name for the client
     */
    public MovePlaylistItemRequest withDeviceName(Optional<String> deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
        this.deviceName = deviceName;
        return this;
    }
     ...
     * The marketplace on which the client application is distributed
     */
    public MovePlaylistItemRequest withMarketplace(String marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
     ...
     * The marketplace on which the client application is distributed
     */
    public MovePlaylistItemRequest withMarketplace(Optional<String> marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
        this.marketplace = marketplace;
        return this;
    }
     ...
     * The ID of the playlist
     */
    public MovePlaylistItemRequest withPlaylistId(long playlistId) {
        Utils.checkNotNull(playlistId, "playlistId");
        this.playlistId = playlistId;
        return this;
    }
     ...
     * The playlist item ID to move.
     */
    public MovePlaylistItemRequest withPlaylistItemId(long playlistItemId) {
        Utils.checkNotNull(playlistItemId, "playlistItemId");
        this.playlistItemId = playlistItemId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        MovePlaylistItemRequest other = (MovePlaylistItemRequest) o;
        return 
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            playlistItemId, after);
    }
    
    @Override
    public String toString() {
        return Utils.toString(MovePlaylistItemRequest.class,
                "accepts", accepts,
    ...
    public final static class Builder {
        ...
        public MovePlaylistItemRequest build() {
            if (accepts == null) {
                accepts = _SINGLETON_VALUE_Accepts.value();
            }

            return new MovePlaylistItemRequest(
                accepts, clientIdentifier, product,
                version, platform, platformVersion,
                device, model, deviceVendor,
                deviceName, marketplace, playlistId,
