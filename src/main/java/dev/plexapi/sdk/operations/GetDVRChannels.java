...
public class GetDVRChannels {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetDVRChannelsRequest, GetDVRChannelsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetDVRChannelsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDVRChannelsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetDVRChannelsRequest request) {
        ...
        @Override
        public GetDVRChannelsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetDVRChannelsResponse.Builder resBuilder =
            ...
            GetDVRChannelsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetDVRChannelsRequest, dev.plexapi.sdk.models.operations.async.GetDVRChannelsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetDVRChannelsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDVRChannelsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetDVRChannelsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetDVRChannelsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetDVRChannelsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetDVRChannelsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetDVRChannelsResponse res = resBuilder.build();
