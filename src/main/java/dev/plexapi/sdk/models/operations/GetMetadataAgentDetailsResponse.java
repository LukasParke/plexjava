...
public class GetMetadataAgentDetailsResponse implements Response {
    /**
    ...
    @JsonCreator
    public GetMetadataAgentDetailsResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public GetMetadataAgentDetailsResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetMetadataAgentDetailsResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetMetadataAgentDetailsResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public GetMetadataAgentDetailsResponse withMediaContainerWithDirectory(MediaContainerWithDirectory mediaContainerWithDirectory) {
        Utils.checkNotNull(mediaContainerWithDirectory, "mediaContainerWithDirectory");
     ...
     * OK
     */
    public GetMetadataAgentDetailsResponse withMediaContainerWithDirectory(Optional<? extends MediaContainerWithDirectory> mediaContainerWithDirectory) {
        Utils.checkNotNull(mediaContainerWithDirectory, "mediaContainerWithDirectory");
        this.mediaContainerWithDirectory = mediaContainerWithDirectory;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetMetadataAgentDetailsResponse other = (GetMetadataAgentDetailsResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetMetadataAgentDetailsResponse.class,
    ...
    public final static class Builder {
        ...
        public GetMetadataAgentDetailsResponse build() {

            return new GetMetadataAgentDetailsResponse(
                contentType, statusCode, rawResponse,
                mediaContainerWithDirectory);
        }
