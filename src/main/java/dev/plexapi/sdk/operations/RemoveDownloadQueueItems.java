...
public class RemoveDownloadQueueItems {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveDownloadQueueItemsRequest, RemoveDownloadQueueItemsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(RemoveDownloadQueueItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveDownloadQueueItemsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveDownloadQueueItemsRequest request) {
        ...
        @Override
        public RemoveDownloadQueueItemsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveDownloadQueueItemsResponse.Builder resBuilder =
            ...
            RemoveDownloadQueueItemsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveDownloadQueueItemsRequest, dev.plexapi.sdk.models.operations.async.RemoveDownloadQueueItemsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(RemoveDownloadQueueItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveDownloadQueueItemsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveDownloadQueueItemsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.RemoveDownloadQueueItemsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.RemoveDownloadQueueItemsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.RemoveDownloadQueueItemsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.RemoveDownloadQueueItemsResponse res = resBuilder.build();
