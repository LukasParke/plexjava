...
public class GetContinueWatching {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetContinueWatchingRequest, GetContinueWatchingResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetContinueWatchingRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetContinueWatchingRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetContinueWatchingRequest request) {
        ...
        @Override
        public GetContinueWatchingResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetContinueWatchingResponse.Builder resBuilder =
            ...
            GetContinueWatchingResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetContinueWatchingRequest, dev.plexapi.sdk.models.operations.async.GetContinueWatchingResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetContinueWatchingRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetContinueWatchingRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetContinueWatchingRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetContinueWatchingResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetContinueWatchingResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetContinueWatchingResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetContinueWatchingResponse res = resBuilder.build();
