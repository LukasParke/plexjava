...
public class GetByFolder {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/library/sections/{sectionId}/byFolder",
    ...
    public static class Sync extends Base
            implements RequestOperation<GetByFolderRequest, GetByFolderResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetByFolderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetByFolderRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetByFolderRequest request) {
        ...
        @Override
        public GetByFolderResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetByFolderResponse.Builder resBuilder =
                    GetByFolderResponse
                            .builder()
            ...
            GetByFolderResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetByFolderRequest, dev.plexapi.sdk.models.operations.async.GetByFolderResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetByFolderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetByFolderRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetByFolderRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetByFolderResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetByFolderResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetByFolderResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetByFolderResponse res = resBuilder.build();
