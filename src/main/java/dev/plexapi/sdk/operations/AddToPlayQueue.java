...
public class AddToPlayQueue {
    ...
    public static class Sync extends Base
            implements RequestOperation<AddToPlayQueueRequest, AddToPlayQueueResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AddToPlayQueueRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddToPlayQueueRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddToPlayQueueRequest request) {
        ...
        @Override
        public AddToPlayQueueResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AddToPlayQueueResponse.Builder resBuilder =
            ...
            AddToPlayQueueResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AddToPlayQueueRequest, dev.plexapi.sdk.models.operations.async.AddToPlayQueueResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AddToPlayQueueRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddToPlayQueueRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AddToPlayQueueRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.AddToPlayQueueResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.AddToPlayQueueResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.AddToPlayQueueResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.AddToPlayQueueResponse res = resBuilder.build();
