...
public class GetDiagnostics {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetDiagnosticsRequest, GetDiagnosticsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetDiagnosticsRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetDiagnosticsRequest request) {
        ...
        @Override
        public GetDiagnosticsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetDiagnosticsResponse.Builder resBuilder =
            ...
            GetDiagnosticsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetDiagnosticsRequest, dev.plexapi.sdk.models.operations.async.GetDiagnosticsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetDiagnosticsRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetDiagnosticsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetDiagnosticsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetDiagnosticsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetDiagnosticsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetDiagnosticsResponse res = resBuilder.build();
