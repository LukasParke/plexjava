...
public class GetMetadataGrandchildren {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/library/metadata/{id}/grandchildren",
    ...
    public static class Sync extends Base
            implements RequestOperation<GetMetadataGrandchildrenRequest, GetMetadataGrandchildrenResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetMetadataGrandchildrenRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMetadataGrandchildrenRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetMetadataGrandchildrenRequest request) {
        ...
        @Override
        public GetMetadataGrandchildrenResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetMetadataGrandchildrenResponse.Builder resBuilder =
            ...
            GetMetadataGrandchildrenResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetMetadataGrandchildrenRequest, dev.plexapi.sdk.models.operations.async.GetMetadataGrandchildrenResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetMetadataGrandchildrenRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMetadataGrandchildrenRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetMetadataGrandchildrenRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetMetadataGrandchildrenResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetMetadataGrandchildrenResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetMetadataGrandchildrenResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetMetadataGrandchildrenResponse res = resBuilder.build();
