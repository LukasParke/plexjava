...
public class RefreshSectionsMetadata {
    ...
    public static class Sync extends Base
            implements RequestOperation<RefreshSectionsMetadataRequest, RefreshSectionsMetadataResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(RefreshSectionsMetadataRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RefreshSectionsMetadataRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RefreshSectionsMetadataRequest request) {
        ...
        @Override
        public RefreshSectionsMetadataResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RefreshSectionsMetadataResponse.Builder resBuilder =
            ...
            RefreshSectionsMetadataResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "503", "5XX")) {
                // no content
                throw SDKError.from("API error occurred", response);
            }
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RefreshSectionsMetadataRequest, dev.plexapi.sdk.models.operations.async.RefreshSectionsMetadataResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(RefreshSectionsMetadataRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RefreshSectionsMetadataRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RefreshSectionsMetadataRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.RefreshSectionsMetadataResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.RefreshSectionsMetadataResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.RefreshSectionsMetadataResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.RefreshSectionsMetadataResponse res = resBuilder.build();
