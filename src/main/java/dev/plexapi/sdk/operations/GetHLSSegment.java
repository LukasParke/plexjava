...
public class GetHLSSegment {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            ...
            req.addHeader("Accept", "video/mp2t")
    ...
    public static class Sync extends Base
            implements RequestOperation<GetHLSSegmentRequest, GetHLSSegmentResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetHLSSegmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHLSSegmentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetHLSSegmentRequest request) {
        ...
        @Override
        public GetHLSSegmentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetHLSSegmentResponse.Builder resBuilder =
                    GetHLSSegmentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            if (Utils.statusCodeMatches(response.statusCode(), "200") && Utils.contentTypeMatches(contentType, "video/mp2t")) {
                resBuilder.responseStream(response.body());
            }

            GetHLSSegmentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "video/mp2t")) {
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetHLSSegmentRequest, dev.plexapi.sdk.models.operations.async.GetHLSSegmentResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetHLSSegmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHLSSegmentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetHLSSegmentRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetHLSSegmentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetHLSSegmentResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetHLSSegmentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            dev.plexapi.sdk.models.operations.async.GetHLSSegmentResponse res = resBuilder.build();
