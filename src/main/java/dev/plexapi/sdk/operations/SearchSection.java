...
public class SearchSection {
    ...
    public static class Sync extends Base
            implements RequestOperation<SearchSectionRequest, SearchSectionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(SearchSectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SearchSectionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(SearchSectionRequest request) {
        ...
        @Override
        public SearchSectionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            SearchSectionResponse.Builder resBuilder =
            ...
            SearchSectionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SearchSectionRequest, dev.plexapi.sdk.models.operations.async.SearchSectionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(SearchSectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SearchSectionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(SearchSectionRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.SearchSectionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.SearchSectionResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.SearchSectionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.SearchSectionResponse res = resBuilder.build();
