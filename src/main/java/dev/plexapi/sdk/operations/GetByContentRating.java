...
public class GetByContentRating {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/library/sections/{sectionId}/byContentRating",
    ...
    public static class Sync extends Base
            implements RequestOperation<GetByContentRatingRequest, GetByContentRatingResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetByContentRatingRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetByContentRatingRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetByContentRatingRequest request) {
        ...
        @Override
        public GetByContentRatingResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetByContentRatingResponse.Builder resBuilder =
            ...
            GetByContentRatingResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetByContentRatingRequest, dev.plexapi.sdk.models.operations.async.GetByContentRatingResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetByContentRatingRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetByContentRatingRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetByContentRatingRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetByContentRatingResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetByContentRatingResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetByContentRatingResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetByContentRatingResponse res = resBuilder.build();
