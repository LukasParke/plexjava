...
public class PlayerSeek {
    ...
    public static class Sync extends Base
            implements RequestOperation<PlayerSeekRequest, PlayerSeekResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(PlayerSeekRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlayerSeekRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlayerSeekRequest request) {
        ...
        @Override
        public PlayerSeekResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlayerSeekResponse.Builder resBuilder =
                    PlayerSeekResponse
                            .builder()
            ...
            PlayerSeekResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlayerSeekRequest, dev.plexapi.sdk.models.operations.async.PlayerSeekResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(PlayerSeekRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlayerSeekRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlayerSeekRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.PlayerSeekResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.PlayerSeekResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.PlayerSeekResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.PlayerSeekResponse res = resBuilder.build();
