...
public class GetSectionPlaylists {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/library/sections/{sectionId}/playlists",
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSectionPlaylistsRequest, GetSectionPlaylistsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetSectionPlaylistsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSectionPlaylistsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSectionPlaylistsRequest request) {
        ...
        @Override
        public GetSectionPlaylistsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSectionPlaylistsResponse.Builder resBuilder =
            ...
            GetSectionPlaylistsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMediaContainerWithPlaylistMetadata(Utils.unmarshal(response, new TypeReference<MediaContainerWithPlaylistMetadata>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSectionPlaylistsRequest, dev.plexapi.sdk.models.operations.async.GetSectionPlaylistsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSectionPlaylistsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSectionPlaylistsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSectionPlaylistsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetSectionPlaylistsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetSectionPlaylistsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetSectionPlaylistsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetSectionPlaylistsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MediaContainerWithPlaylistMetadata>() {})
                            .thenApply(res::withMediaContainerWithPlaylistMetadata);
                } else {
