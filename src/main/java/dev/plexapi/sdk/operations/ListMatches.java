...
public class ListMatches {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListMatchesRequest, ListMatchesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListMatchesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListMatchesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListMatchesRequest request) {
        ...
        @Override
        public ListMatchesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListMatchesResponse.Builder resBuilder =
                    ListMatchesResponse
                            .builder()
            ...
            ListMatchesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListMatchesRequest, dev.plexapi.sdk.models.operations.async.ListMatchesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListMatchesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListMatchesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListMatchesRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.ListMatchesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.ListMatchesResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.ListMatchesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.ListMatchesResponse res = resBuilder.build();
