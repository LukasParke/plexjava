...
public class GetConversionQueue {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetConversionQueueRequest, GetConversionQueueResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetConversionQueueRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetConversionQueueRequest request) {
        ...
        @Override
        public GetConversionQueueResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetConversionQueueResponse.Builder resBuilder =
            ...
            GetConversionQueueResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMediaContainerWithPlayQueue(Utils.unmarshal(response, new TypeReference<MediaContainerWithPlayQueue>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetConversionQueueRequest, dev.plexapi.sdk.models.operations.async.GetConversionQueueResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetConversionQueueRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetConversionQueueRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetConversionQueueResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetConversionQueueResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetConversionQueueResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetConversionQueueResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MediaContainerWithPlayQueue>() {})
                            .thenApply(res::withMediaContainerWithPlayQueue);
                } else {
