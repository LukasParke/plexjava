...
public class PlayerAudioStream {
    ...
    public static class Sync extends Base
            implements RequestOperation<PlayerAudioStreamRequest, PlayerAudioStreamResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(PlayerAudioStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlayerAudioStreamRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlayerAudioStreamRequest request) {
        ...
        @Override
        public PlayerAudioStreamResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlayerAudioStreamResponse.Builder resBuilder =
            ...
            PlayerAudioStreamResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlayerAudioStreamRequest, dev.plexapi.sdk.models.operations.async.PlayerAudioStreamResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(PlayerAudioStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlayerAudioStreamRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlayerAudioStreamRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.PlayerAudioStreamResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.PlayerAudioStreamResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.PlayerAudioStreamResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            dev.plexapi.sdk.models.operations.async.PlayerAudioStreamResponse res = resBuilder.build();
