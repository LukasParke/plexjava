...
import dev.plexapi.sdk.models.shared.MediaContainerWithNestedMetadata;
...
public class GetItemTree {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetItemTreeRequest, GetItemTreeResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetItemTreeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetItemTreeRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetItemTreeRequest request) {
        ...
        @Override
        public GetItemTreeResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetItemTreeResponse.Builder resBuilder =
                    GetItemTreeResponse
                            .builder()
            ...
            GetItemTreeResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMediaContainerWithNestedMetadata(Utils.unmarshal(response, new TypeReference<MediaContainerWithNestedMetadata>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetItemTreeRequest, dev.plexapi.sdk.models.operations.async.GetItemTreeResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetItemTreeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetItemTreeRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetItemTreeRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetItemTreeResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetItemTreeResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetItemTreeResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetItemTreeResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MediaContainerWithNestedMetadata>() {})
                            .thenApply(res::withMediaContainerWithNestedMetadata);
                } else {
