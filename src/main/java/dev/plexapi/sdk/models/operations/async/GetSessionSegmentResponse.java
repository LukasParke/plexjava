...
public class GetSessionSegmentResponse implements AsyncResponse {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetSessionSegmentResponse withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * MPEG-TS segment for playing HLS content
     */
    public GetSessionSegmentResponse withBinaryResponse(Blob binaryResponse) {
        Utils.checkNotNull(binaryResponse, "binaryResponse");
     ...
     * MPEG-TS segment for playing HLS content
     */
    public GetSessionSegmentResponse withBinaryResponse(Optional<? extends Blob> binaryResponse) {
        Utils.checkNotNull(binaryResponse, "binaryResponse");
        this.binaryResponse = binaryResponse;
        return this;
    }
