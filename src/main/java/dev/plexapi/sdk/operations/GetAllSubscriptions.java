...
public class GetAllSubscriptions {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAllSubscriptionsRequest, GetAllSubscriptionsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetAllSubscriptionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAllSubscriptionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAllSubscriptionsRequest request) {
        ...
        @Override
        public GetAllSubscriptionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAllSubscriptionsResponse.Builder resBuilder =
            ...
            GetAllSubscriptionsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAllSubscriptionsRequest, dev.plexapi.sdk.models.operations.async.GetAllSubscriptionsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetAllSubscriptionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAllSubscriptionsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAllSubscriptionsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetAllSubscriptionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetAllSubscriptionsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetAllSubscriptionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetAllSubscriptionsResponse res = resBuilder.build();
