...
public class GetSectionMovies {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/library/sections/{sectionId}/movies",
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSectionMoviesRequest, GetSectionMoviesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetSectionMoviesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSectionMoviesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSectionMoviesRequest request) {
        ...
        @Override
        public GetSectionMoviesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSectionMoviesResponse.Builder resBuilder =
            ...
            GetSectionMoviesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSectionMoviesRequest, dev.plexapi.sdk.models.operations.async.GetSectionMoviesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSectionMoviesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSectionMoviesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSectionMoviesRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetSectionMoviesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetSectionMoviesResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetSectionMoviesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetSectionMoviesResponse res = resBuilder.build();
