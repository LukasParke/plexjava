...
public class OptimizeDatabase {
    ...
    public static class Sync extends Base
            implements RequestOperation<OptimizeDatabaseRequest, OptimizeDatabaseResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(OptimizeDatabaseRequest request) throws Exception {
            HttpRequest req = buildRequest(request, OptimizeDatabaseRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(OptimizeDatabaseRequest request) {
        ...
        @Override
        public OptimizeDatabaseResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            OptimizeDatabaseResponse.Builder resBuilder =
            ...
            OptimizeDatabaseResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<OptimizeDatabaseRequest, dev.plexapi.sdk.models.operations.async.OptimizeDatabaseResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(OptimizeDatabaseRequest request) throws Exception {
            HttpRequest req = buildRequest(request, OptimizeDatabaseRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(OptimizeDatabaseRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.OptimizeDatabaseResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.OptimizeDatabaseResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.OptimizeDatabaseResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.OptimizeDatabaseResponse res = resBuilder.build();
