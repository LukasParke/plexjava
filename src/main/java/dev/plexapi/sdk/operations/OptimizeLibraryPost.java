...
public class OptimizeLibraryPost {
    ...
    public static class Sync extends Base
            implements RequestOperation<OptimizeLibraryPostRequest, OptimizeLibraryPostResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(OptimizeLibraryPostRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(OptimizeLibraryPostRequest request) {
        ...
        @Override
        public OptimizeLibraryPostResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            OptimizeLibraryPostResponse.Builder resBuilder =
            ...
            OptimizeLibraryPostResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<OptimizeLibraryPostRequest, dev.plexapi.sdk.models.operations.async.OptimizeLibraryPostResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(OptimizeLibraryPostRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(OptimizeLibraryPostRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.OptimizeLibraryPostResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.OptimizeLibraryPostResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.OptimizeLibraryPostResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.OptimizeLibraryPostResponse res = resBuilder.build();
