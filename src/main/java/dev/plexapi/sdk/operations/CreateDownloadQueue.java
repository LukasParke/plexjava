...
import dev.plexapi.sdk.models.operations.CreateDownloadQueueResponseBody;
...
public class CreateDownloadQueue {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<CreateDownloadQueueResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        @Override
        public CreateDownloadQueueResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateDownloadQueueResponse.Builder resBuilder =
            ...
            CreateDownloadQueueResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<CreateDownloadQueueResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<dev.plexapi.sdk.models.operations.async.CreateDownloadQueueResponse> {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.CreateDownloadQueueResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.CreateDownloadQueueResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.CreateDownloadQueueResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.CreateDownloadQueueResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateDownloadQueueResponseBody>() {})
