...
public class RefreshReachability {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<RefreshReachabilityResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        @Override
        public RefreshReachabilityResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RefreshReachabilityResponse.Builder resBuilder =
            ...
            RefreshReachabilityResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<dev.plexapi.sdk.models.operations.async.RefreshReachabilityResponse> {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.RefreshReachabilityResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.RefreshReachabilityResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.RefreshReachabilityResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.RefreshReachabilityResponse res = resBuilder.build();
