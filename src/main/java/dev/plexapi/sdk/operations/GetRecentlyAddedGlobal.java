...
public class GetRecentlyAddedGlobal {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetRecentlyAddedGlobalRequest, GetRecentlyAddedGlobalResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetRecentlyAddedGlobalRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetRecentlyAddedGlobalRequest request) {
        ...
        @Override
        public GetRecentlyAddedGlobalResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetRecentlyAddedGlobalResponse.Builder resBuilder =
            ...
            GetRecentlyAddedGlobalResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetRecentlyAddedGlobalRequest, dev.plexapi.sdk.models.operations.async.GetRecentlyAddedGlobalResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetRecentlyAddedGlobalRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetRecentlyAddedGlobalRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetRecentlyAddedGlobalResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetRecentlyAddedGlobalResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetRecentlyAddedGlobalResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetRecentlyAddedGlobalResponse res = resBuilder.build();
