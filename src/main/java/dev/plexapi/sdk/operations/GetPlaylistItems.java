...
public class GetPlaylistItems {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPlaylistItemsRequest, GetPlaylistItemsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetPlaylistItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPlaylistItemsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPlaylistItemsRequest request) {
        ...
        @Override
        public GetPlaylistItemsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetPlaylistItemsResponse.Builder resBuilder =
            ...
            GetPlaylistItemsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetPlaylistItemsRequest, dev.plexapi.sdk.models.operations.async.GetPlaylistItemsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetPlaylistItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPlaylistItemsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetPlaylistItemsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetPlaylistItemsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetPlaylistItemsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetPlaylistItemsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetPlaylistItemsResponse res = resBuilder.build();
