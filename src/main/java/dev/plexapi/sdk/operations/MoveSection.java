...
public class MoveSection {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/library/sections/{sectionId}/move",
    ...
    public static class Sync extends Base
            implements RequestOperation<MoveSectionRequest, MoveSectionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(MoveSectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MoveSectionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MoveSectionRequest request) {
        ...
        @Override
        public MoveSectionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            MoveSectionResponse.Builder resBuilder =
                    MoveSectionResponse
                            .builder()
            ...
            MoveSectionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MoveSectionRequest, dev.plexapi.sdk.models.operations.async.MoveSectionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(MoveSectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MoveSectionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(MoveSectionRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.MoveSectionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.MoveSectionResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.MoveSectionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.MoveSectionResponse res = resBuilder.build();
