...
public class MovePlaylistItemResponse implements Response {
    /**
    ...
    @JsonCreator
    public MovePlaylistItemResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public MovePlaylistItemResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public MovePlaylistItemResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public MovePlaylistItemResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Successfully updated moving items in a playlist
     */
    public MovePlaylistItemResponse withMediaContainerWithPlaylistMetadata(MediaContainerWithPlaylistMetadata mediaContainerWithPlaylistMetadata) {
        Utils.checkNotNull(mediaContainerWithPlaylistMetadata, "mediaContainerWithPlaylistMetadata");
     ...
     * Successfully updated moving items in a playlist
     */
    public MovePlaylistItemResponse withMediaContainerWithPlaylistMetadata(Optional<? extends MediaContainerWithPlaylistMetadata> mediaContainerWithPlaylistMetadata) {
        Utils.checkNotNull(mediaContainerWithPlaylistMetadata, "mediaContainerWithPlaylistMetadata");
        this.mediaContainerWithPlaylistMetadata = mediaContainerWithPlaylistMetadata;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        MovePlaylistItemResponse other = (MovePlaylistItemResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(MovePlaylistItemResponse.class,
    ...
    public final static class Builder {
        ...
        public MovePlaylistItemResponse build() {

            return new MovePlaylistItemResponse(
                contentType, statusCode, rawResponse,
                mediaContainerWithPlaylistMetadata);
        }
