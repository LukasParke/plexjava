...
public class GetAllLeaves {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAllLeavesRequest, GetAllLeavesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetAllLeavesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAllLeavesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAllLeavesRequest request) {
        ...
        @Override
        public GetAllLeavesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAllLeavesResponse.Builder resBuilder =
            ...
            GetAllLeavesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAllLeavesRequest, dev.plexapi.sdk.models.operations.async.GetAllLeavesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetAllLeavesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAllLeavesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAllLeavesRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetAllLeavesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetAllLeavesResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetAllLeavesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetAllLeavesResponse res = resBuilder.build();
