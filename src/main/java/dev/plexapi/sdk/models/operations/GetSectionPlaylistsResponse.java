...
public class GetSectionPlaylistsResponse implements Response {
    /**
    ...
    @JsonCreator
    public GetSectionPlaylistsResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public GetSectionPlaylistsResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetSectionPlaylistsResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetSectionPlaylistsResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public GetSectionPlaylistsResponse withMediaContainerWithPlaylistMetadata(MediaContainerWithPlaylistMetadata mediaContainerWithPlaylistMetadata) {
        Utils.checkNotNull(mediaContainerWithPlaylistMetadata, "mediaContainerWithPlaylistMetadata");
     ...
     * OK
     */
    public GetSectionPlaylistsResponse withMediaContainerWithPlaylistMetadata(Optional<? extends MediaContainerWithPlaylistMetadata> mediaContainerWithPlaylistMetadata) {
        Utils.checkNotNull(mediaContainerWithPlaylistMetadata, "mediaContainerWithPlaylistMetadata");
        this.mediaContainerWithPlaylistMetadata = mediaContainerWithPlaylistMetadata;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetSectionPlaylistsResponse other = (GetSectionPlaylistsResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetSectionPlaylistsResponse.class,
    ...
    public final static class Builder {
        ...
        public GetSectionPlaylistsResponse build() {

            return new GetSectionPlaylistsResponse(
                contentType, statusCode, rawResponse,
                mediaContainerWithPlaylistMetadata);
        }
