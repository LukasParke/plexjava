...
public class GetSectionFilters {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSectionFiltersRequest, GetSectionFiltersResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetSectionFiltersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSectionFiltersRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSectionFiltersRequest request) {
        ...
        @Override
        public GetSectionFiltersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSectionFiltersResponse.Builder resBuilder =
            ...
            GetSectionFiltersResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSectionFiltersRequest, dev.plexapi.sdk.models.operations.async.GetSectionFiltersResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSectionFiltersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSectionFiltersRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSectionFiltersRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetSectionFiltersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetSectionFiltersResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetSectionFiltersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetSectionFiltersResponse res = resBuilder.build();
