...
public class ModifyDeviceMediaContainer {
    ...
    @JsonCreator
    public ModifyDeviceMediaContainer(
    ...
    public ModifyDeviceMediaContainer withIdentifier(String identifier) {
        Utils.checkNotNull(identifier, "identifier");
    ...
    public ModifyDeviceMediaContainer withIdentifier(Optional<String> identifier) {
        Utils.checkNotNull(identifier, "identifier");
        this.identifier = identifier;
        return this;
    }
     ...
     * the `X-Plex-Container-Start` header.
     */
    public ModifyDeviceMediaContainer withOffset(long offset) {
        Utils.checkNotNull(offset, "offset");
     ...
     * the `X-Plex-Container-Start` header.
     */
    public ModifyDeviceMediaContainer withOffset(Optional<Long> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }

    public ModifyDeviceMediaContainer withSize(long size) {
        Utils.checkNotNull(size, "size");
    ...
    public ModifyDeviceMediaContainer withSize(Optional<Long> size) {
        Utils.checkNotNull(size, "size");
        this.size = size;
        return this;
    }
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public ModifyDeviceMediaContainer withTotalSize(long totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public ModifyDeviceMediaContainer withTotalSize(Optional<Long> totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
        this.totalSize = totalSize;
        return this;
    }

    public ModifyDeviceMediaContainer withMessage(String message) {
        Utils.checkNotNull(message, "message");
    ...
    public ModifyDeviceMediaContainer withMessage(Optional<String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }

    public ModifyDeviceMediaContainer withStatus(long status) {
        Utils.checkNotNull(status, "status");
    ...
    public ModifyDeviceMediaContainer withStatus(Optional<Long> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ModifyDeviceMediaContainer other = (ModifyDeviceMediaContainer) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ModifyDeviceMediaContainer.class,
    ...
    public final static class Builder {
        ...
        public ModifyDeviceMediaContainer build() {

            return new ModifyDeviceMediaContainer(
                identifier, offset, size,
                totalSize, message, status);
        }
