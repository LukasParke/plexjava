...
import dev.plexapi.sdk.models.shared.EPGRegion;
...
public class GetCountryRegionsMediaContainer {
    ...
    private Optional<? extends List<EPGRegion>> country;

    @JsonCreator
    public GetCountryRegionsMediaContainer(
            ...
            @JsonProperty("Country") Optional<? extends List<EPGRegion>> country) {
    ...
    @JsonIgnore
    public Optional<List<EPGRegion>> country() {
        return (Optional<List<EPGRegion>>) country;
    }
    ...
    public GetCountryRegionsMediaContainer withIdentifier(String identifier) {
        Utils.checkNotNull(identifier, "identifier");
    ...
    public GetCountryRegionsMediaContainer withIdentifier(Optional<String> identifier) {
        Utils.checkNotNull(identifier, "identifier");
        this.identifier = identifier;
        return this;
    }
     ...
     * the `X-Plex-Container-Start` header.
     */
    public GetCountryRegionsMediaContainer withOffset(long offset) {
        Utils.checkNotNull(offset, "offset");
     ...
     * the `X-Plex-Container-Start` header.
     */
    public GetCountryRegionsMediaContainer withOffset(Optional<Long> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }

    public GetCountryRegionsMediaContainer withSize(long size) {
        Utils.checkNotNull(size, "size");
    ...
    public GetCountryRegionsMediaContainer withSize(Optional<Long> size) {
        Utils.checkNotNull(size, "size");
        this.size = size;
        return this;
    }
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public GetCountryRegionsMediaContainer withTotalSize(long totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public GetCountryRegionsMediaContainer withTotalSize(Optional<Long> totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
        this.totalSize = totalSize;
        return this;
    }

    public GetCountryRegionsMediaContainer withCountry(List<EPGRegion> country) {
        Utils.checkNotNull(country, "country");
    ...
    public GetCountryRegionsMediaContainer withCountry(Optional<? extends List<EPGRegion>> country) {
        Utils.checkNotNull(country, "country");
        this.country = country;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetCountryRegionsMediaContainer other = (GetCountryRegionsMediaContainer) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetCountryRegionsMediaContainer.class,
    ...
    public final static class Builder {
        ...
        private Optional<? extends List<EPGRegion>> country = Optional.empty();
        ...
        public Builder country(List<EPGRegion> country) {
            Utils.checkNotNull(country, "country");
            this.country = Optional.ofNullable(country);
            return this;
        }

        public Builder country(Optional<? extends List<EPGRegion>> country) {
            Utils.checkNotNull(country, "country");
            this.country = country;
            return this;
        }

        public GetCountryRegionsMediaContainer build() {

            return new GetCountryRegionsMediaContainer(
                identifier, offset, size,
                totalSize, country);
        }
