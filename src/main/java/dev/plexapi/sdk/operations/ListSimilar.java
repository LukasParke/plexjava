...
public class ListSimilar {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListSimilarRequest, ListSimilarResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListSimilarRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSimilarRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSimilarRequest request) {
        ...
        @Override
        public ListSimilarResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListSimilarResponse.Builder resBuilder =
                    ListSimilarResponse
                            .builder()
            ...
            ListSimilarResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListSimilarRequest, dev.plexapi.sdk.models.operations.async.ListSimilarResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListSimilarRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSimilarRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListSimilarRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.ListSimilarResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.ListSimilarResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.ListSimilarResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.ListSimilarResponse res = resBuilder.build();
