...
public class GetItemDecision {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetItemDecisionRequest, GetItemDecisionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetItemDecisionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetItemDecisionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetItemDecisionRequest request) {
        ...
        @Override
        public GetItemDecisionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetItemDecisionResponse.Builder resBuilder =
            ...
            GetItemDecisionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMediaContainerWithDecision(Utils.unmarshal(response, new TypeReference<MediaContainerWithDecision>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetItemDecisionRequest, dev.plexapi.sdk.models.operations.async.GetItemDecisionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetItemDecisionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetItemDecisionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetItemDecisionRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetItemDecisionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetItemDecisionResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetItemDecisionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetItemDecisionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MediaContainerWithDecision>() {})
                            .thenApply(res::withMediaContainerWithDecision);
                } else {
