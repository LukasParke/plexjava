...
public class CheckUpdates {
    ...
    public static class Sync extends Base
            implements RequestOperation<CheckUpdatesRequest, CheckUpdatesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CheckUpdatesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CheckUpdatesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CheckUpdatesRequest request) {
        ...
        @Override
        public CheckUpdatesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CheckUpdatesResponse.Builder resBuilder =
            ...
            CheckUpdatesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CheckUpdatesRequest, dev.plexapi.sdk.models.operations.async.CheckUpdatesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CheckUpdatesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CheckUpdatesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CheckUpdatesRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.CheckUpdatesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.CheckUpdatesResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.CheckUpdatesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.CheckUpdatesResponse res = resBuilder.build();
