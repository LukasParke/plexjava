...
public class GetLiveTVSession {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetLiveTVSessionRequest, GetLiveTVSessionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetLiveTVSessionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLiveTVSessionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetLiveTVSessionRequest request) {
        ...
        @Override
        public GetLiveTVSessionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetLiveTVSessionResponse.Builder resBuilder =
            ...
            GetLiveTVSessionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetLiveTVSessionRequest, dev.plexapi.sdk.models.operations.async.GetLiveTVSessionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetLiveTVSessionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLiveTVSessionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetLiveTVSessionRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetLiveTVSessionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetLiveTVSessionResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetLiveTVSessionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetLiveTVSessionResponse res = resBuilder.build();
