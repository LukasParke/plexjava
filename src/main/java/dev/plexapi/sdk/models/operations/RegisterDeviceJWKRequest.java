...
import dev.plexapi.sdk.models.shared.JWKRegistrationRequest;
...
public class RegisterDeviceJWKRequest {
    ...
    private Optional<? extends JWKRegistrationRequest> jwkRegistrationRequest;

    @JsonCreator
    public RegisterDeviceJWKRequest(
            ...
            Optional<? extends JWKRegistrationRequest> jwkRegistrationRequest) {
        ...
        Utils.checkNotNull(jwkRegistrationRequest, "jwkRegistrationRequest");
        ...
        this.jwkRegistrationRequest = jwkRegistrationRequest;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<JWKRegistrationRequest> jwkRegistrationRequest() {
        return (Optional<JWKRegistrationRequest>) jwkRegistrationRequest;
    }
     ...
     * Indicates the client accepts the indicated media types
     */
    public RegisterDeviceJWKRequest withAccepts(Accepts accepts) {
        Utils.checkNotNull(accepts, "accepts");
     ...
     * Indicates the client accepts the indicated media types
     */
    public RegisterDeviceJWKRequest withAccepts(Optional<? extends Accepts> accepts) {
        Utils.checkNotNull(accepts, "accepts");
        this.accepts = accepts;
        return this;
    }
     ...
     * An opaque identifier unique to the client
     */
    public RegisterDeviceJWKRequest withClientIdentifier(String clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
     ...
     * An opaque identifier unique to the client
     */
    public RegisterDeviceJWKRequest withClientIdentifier(Optional<String> clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
        this.clientIdentifier = clientIdentifier;
        return this;
    }
     ...
     * The name of the client product
     */
    public RegisterDeviceJWKRequest withProduct(String product) {
        Utils.checkNotNull(product, "product");
     ...
     * The name of the client product
     */
    public RegisterDeviceJWKRequest withProduct(Optional<String> product) {
        Utils.checkNotNull(product, "product");
        this.product = product;
        return this;
    }
     ...
     * The version of the client application
     */
    public RegisterDeviceJWKRequest withVersion(String version) {
        Utils.checkNotNull(version, "version");
     ...
     * The version of the client application
     */
    public RegisterDeviceJWKRequest withVersion(Optional<String> version) {
        Utils.checkNotNull(version, "version");
        this.version = version;
        return this;
    }
     ...
     * The platform of the client
     */
    public RegisterDeviceJWKRequest withPlatform(String platform) {
        Utils.checkNotNull(platform, "platform");
     ...
     * The platform of the client
     */
    public RegisterDeviceJWKRequest withPlatform(Optional<String> platform) {
        Utils.checkNotNull(platform, "platform");
        this.platform = platform;
        return this;
    }
     ...
     * The version of the platform
     */
    public RegisterDeviceJWKRequest withPlatformVersion(String platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
     ...
     * The version of the platform
     */
    public RegisterDeviceJWKRequest withPlatformVersion(Optional<String> platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
        this.platformVersion = platformVersion;
        return this;
    }
     ...
     * A relatively friendly name for the client device
     */
    public RegisterDeviceJWKRequest withDevice(String device) {
        Utils.checkNotNull(device, "device");
     ...
     * A relatively friendly name for the client device
     */
    public RegisterDeviceJWKRequest withDevice(Optional<String> device) {
        Utils.checkNotNull(device, "device");
        this.device = device;
        return this;
    }
     ...
     * A potentially less friendly identifier for the device model
     */
    public RegisterDeviceJWKRequest withModel(String model) {
        Utils.checkNotNull(model, "model");
     ...
     * A potentially less friendly identifier for the device model
     */
    public RegisterDeviceJWKRequest withModel(Optional<String> model) {
        Utils.checkNotNull(model, "model");
        this.model = model;
        return this;
    }
     ...
     * The device vendor
     */
    public RegisterDeviceJWKRequest withDeviceVendor(String deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
     ...
     * The device vendor
     */
    public RegisterDeviceJWKRequest withDeviceVendor(Optional<String> deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
        this.deviceVendor = deviceVendor;
        return this;
    }
     ...
     * A friendly name for the client
     */
    public RegisterDeviceJWKRequest withDeviceName(String deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
     ...
     * A friendly name for the client
     */
    public RegisterDeviceJWKRequest withDeviceName(Optional<String> deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
        this.deviceName = deviceName;
        return this;
    }
     ...
     * The marketplace on which the client application is distributed
     */
    public RegisterDeviceJWKRequest withMarketplace(String marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
     ...
     * The marketplace on which the client application is distributed
     */
    public RegisterDeviceJWKRequest withMarketplace(Optional<String> marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
        this.marketplace = marketplace;
        return this;
    }

    public RegisterDeviceJWKRequest withJWKRegistrationRequest(JWKRegistrationRequest jwkRegistrationRequest) {
        Utils.checkNotNull(jwkRegistrationRequest, "jwkRegistrationRequest");
        this.jwkRegistrationRequest = Optional.ofNullable(jwkRegistrationRequest);
        return this;
    }


    public RegisterDeviceJWKRequest withJWKRegistrationRequest(Optional<? extends JWKRegistrationRequest> jwkRegistrationRequest) {
        Utils.checkNotNull(jwkRegistrationRequest, "jwkRegistrationRequest");
        this.jwkRegistrationRequest = jwkRegistrationRequest;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        RegisterDeviceJWKRequest other = (RegisterDeviceJWKRequest) o;
        return 
            ...
            Utils.enhancedDeepEquals(this.jwkRegistrationRequest, other.jwkRegistrationRequest);
    }
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            deviceName, marketplace, jwkRegistrationRequest);
    }
    
    @Override
    public String toString() {
        return Utils.toString(RegisterDeviceJWKRequest.class,
                "accepts", accepts,
    ...
    public final static class Builder {
        ...
        private Optional<? extends JWKRegistrationRequest> jwkRegistrationRequest = Optional.empty();
        ...
        public Builder jwkRegistrationRequest(JWKRegistrationRequest jwkRegistrationRequest) {
            Utils.checkNotNull(jwkRegistrationRequest, "jwkRegistrationRequest");
            this.jwkRegistrationRequest = Optional.ofNullable(jwkRegistrationRequest);
            return this;
        }

        public Builder jwkRegistrationRequest(Optional<? extends JWKRegistrationRequest> jwkRegistrationRequest) {
            Utils.checkNotNull(jwkRegistrationRequest, "jwkRegistrationRequest");
            this.jwkRegistrationRequest = jwkRegistrationRequest;
            return this;
        }

        public RegisterDeviceJWKRequest build() {
            if (accepts == null) {
                accepts = _SINGLETON_VALUE_Accepts.value();
            }

            return new RegisterDeviceJWKRequest(
                accepts, clientIdentifier, product,
                version, platform, platformVersion,
                device, model, deviceVendor,
                deviceName, marketplace, jwkRegistrationRequest);
