...
public class CreateCollection {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(CreateCollectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCollectionRequest.class);
        ...
        @Override
        public CreateCollectionResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCollection(Utils.unmarshal(response, new TypeReference<Collection>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCollectionRequest, dev.plexapi.sdk.models.operations.async.CreateCollectionResponse> {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.CreateCollectionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.CreateCollectionResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.CreateCollectionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.CreateCollectionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Collection>() {})
                            .thenApply(res::withCollection);
                } else {
