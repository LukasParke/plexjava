...
public class Unshuffle {
    ...
    public static class Sync extends Base
            implements RequestOperation<UnshuffleRequest, UnshuffleResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UnshuffleRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UnshuffleRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UnshuffleRequest request) {
        ...
        @Override
        public UnshuffleResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UnshuffleResponse.Builder resBuilder =
                    UnshuffleResponse
                            .builder()
            ...
            UnshuffleResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UnshuffleRequest, dev.plexapi.sdk.models.operations.async.UnshuffleResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UnshuffleRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UnshuffleRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UnshuffleRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.UnshuffleResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.UnshuffleResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.UnshuffleResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.UnshuffleResponse res = resBuilder.build();
