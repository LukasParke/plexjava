...
public class GetSectionHubs {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSectionHubsRequest, GetSectionHubsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetSectionHubsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSectionHubsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSectionHubsRequest request) {
        ...
        @Override
        public GetSectionHubsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSectionHubsResponse.Builder resBuilder =
            ...
            GetSectionHubsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSectionHubsRequest, dev.plexapi.sdk.models.operations.async.GetSectionHubsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSectionHubsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSectionHubsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSectionHubsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetSectionHubsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetSectionHubsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetSectionHubsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetSectionHubsResponse res = resBuilder.build();
