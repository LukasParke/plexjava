...
public class GetSubscription {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSubscriptionRequest, GetSubscriptionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetSubscriptionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSubscriptionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSubscriptionRequest request) {
        ...
        @Override
        public GetSubscriptionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSubscriptionResponse.Builder resBuilder =
            ...
            GetSubscriptionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSubscriptionRequest, dev.plexapi.sdk.models.operations.async.GetSubscriptionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSubscriptionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSubscriptionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSubscriptionRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetSubscriptionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetSubscriptionResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetSubscriptionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetSubscriptionResponse res = resBuilder.build();
