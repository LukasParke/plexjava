...
public class GetSectionsPrefs {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSectionsPrefsRequest, GetSectionsPrefsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetSectionsPrefsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSectionsPrefsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSectionsPrefsRequest request) {
        ...
        @Override
        public GetSectionsPrefsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSectionsPrefsResponse.Builder resBuilder =
            ...
            GetSectionsPrefsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withLibrarySections(Utils.unmarshal(response, new TypeReference<LibrarySections>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSectionsPrefsRequest, dev.plexapi.sdk.models.operations.async.GetSectionsPrefsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSectionsPrefsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSectionsPrefsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSectionsPrefsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetSectionsPrefsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetSectionsPrefsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetSectionsPrefsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetSectionsPrefsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<LibrarySections>() {})
                            .thenApply(res::withLibrarySections);
                } else {
