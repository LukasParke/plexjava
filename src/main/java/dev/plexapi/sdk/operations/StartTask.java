...
public class StartTask {
    ...
    public static class Sync extends Base
            implements RequestOperation<StartTaskRequest, StartTaskResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(StartTaskRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StartTaskRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(StartTaskRequest request) {
        ...
        @Override
        public StartTaskResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            StartTaskResponse.Builder resBuilder =
                    StartTaskResponse
                            .builder()
            ...
            StartTaskResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<StartTaskRequest, dev.plexapi.sdk.models.operations.async.StartTaskResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(StartTaskRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StartTaskRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(StartTaskRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.StartTaskResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.StartTaskResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.StartTaskResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.StartTaskResponse res = resBuilder.build();
