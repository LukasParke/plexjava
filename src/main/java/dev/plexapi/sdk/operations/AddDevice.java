...
public class AddDevice {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(AddDeviceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddDeviceRequest.class);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AddDeviceRequest, dev.plexapi.sdk.models.operations.async.AddDeviceResponse> {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.AddDeviceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.AddDeviceResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.AddDeviceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.AddDeviceResponse res = resBuilder.build();
