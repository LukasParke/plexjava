...
public class GetRecentlyAddedForSectionResponse implements Response {
    /**
    ...
    @JsonCreator
    public GetRecentlyAddedForSectionResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public GetRecentlyAddedForSectionResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetRecentlyAddedForSectionResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetRecentlyAddedForSectionResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Recently added items
     */
    public GetRecentlyAddedForSectionResponse withMediaContainerWithMetadata(MediaContainerWithMetadata mediaContainerWithMetadata) {
        Utils.checkNotNull(mediaContainerWithMetadata, "mediaContainerWithMetadata");
     ...
     * Recently added items
     */
    public GetRecentlyAddedForSectionResponse withMediaContainerWithMetadata(Optional<? extends MediaContainerWithMetadata> mediaContainerWithMetadata) {
        Utils.checkNotNull(mediaContainerWithMetadata, "mediaContainerWithMetadata");
        this.mediaContainerWithMetadata = mediaContainerWithMetadata;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetRecentlyAddedForSectionResponse other = (GetRecentlyAddedForSectionResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetRecentlyAddedForSectionResponse.class,
    ...
    public final static class Builder {
        ...
        public GetRecentlyAddedForSectionResponse build() {

            return new GetRecentlyAddedForSectionResponse(
                contentType, statusCode, rawResponse,
                mediaContainerWithMetadata);
        }
