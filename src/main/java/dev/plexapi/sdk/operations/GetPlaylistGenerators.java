...
import dev.plexapi.sdk.models.operations.GetPlaylistGeneratorsResponseBody;
...
public class GetPlaylistGenerators {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPlaylistGeneratorsRequest, GetPlaylistGeneratorsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetPlaylistGeneratorsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPlaylistGeneratorsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPlaylistGeneratorsRequest request) {
        ...
        @Override
        public GetPlaylistGeneratorsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetPlaylistGeneratorsResponse.Builder resBuilder =
            ...
            GetPlaylistGeneratorsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<GetPlaylistGeneratorsResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetPlaylistGeneratorsRequest, dev.plexapi.sdk.models.operations.async.GetPlaylistGeneratorsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetPlaylistGeneratorsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPlaylistGeneratorsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetPlaylistGeneratorsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetPlaylistGeneratorsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetPlaylistGeneratorsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetPlaylistGeneratorsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetPlaylistGeneratorsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetPlaylistGeneratorsResponseBody>() {})
