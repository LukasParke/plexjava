...
public class DeleteMediaProvider {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteMediaProviderRequest, DeleteMediaProviderResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeleteMediaProviderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteMediaProviderRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteMediaProviderRequest request) {
        ...
        @Override
        public DeleteMediaProviderResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteMediaProviderResponse.Builder resBuilder =
            ...
            DeleteMediaProviderResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteMediaProviderRequest, dev.plexapi.sdk.models.operations.async.DeleteMediaProviderResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeleteMediaProviderRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteMediaProviderRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteMediaProviderRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.DeleteMediaProviderResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.DeleteMediaProviderResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.DeleteMediaProviderResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.DeleteMediaProviderResponse res = resBuilder.build();
