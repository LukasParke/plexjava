...
public class StopAllRefreshes {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<StopAllRefreshesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        @Override
        public StopAllRefreshesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            StopAllRefreshesResponse.Builder resBuilder =
            ...
            StopAllRefreshesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<dev.plexapi.sdk.models.operations.async.StopAllRefreshesResponse> {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.StopAllRefreshesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.StopAllRefreshesResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.StopAllRefreshesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.StopAllRefreshesResponse res = resBuilder.build();
