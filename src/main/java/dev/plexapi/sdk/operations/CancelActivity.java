...
public class CancelActivity {
    ...
    public static class Sync extends Base
            implements RequestOperation<CancelActivityRequest, CancelActivityResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CancelActivityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CancelActivityRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CancelActivityRequest request) {
        ...
        @Override
        public CancelActivityResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CancelActivityResponse.Builder resBuilder =
            ...
            CancelActivityResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CancelActivityRequest, dev.plexapi.sdk.models.operations.async.CancelActivityResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CancelActivityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CancelActivityRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CancelActivityRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.CancelActivityResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.CancelActivityResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.CancelActivityResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.CancelActivityResponse res = resBuilder.build();
