...
public class GetSubtitles {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSubtitlesRequest, GetSubtitlesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetSubtitlesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSubtitlesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSubtitlesRequest request) {
        ...
        @Override
        public GetSubtitlesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSubtitlesResponse.Builder resBuilder =
            ...
            GetSubtitlesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSubtitlesRequest, dev.plexapi.sdk.models.operations.async.GetSubtitlesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSubtitlesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSubtitlesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSubtitlesRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetSubtitlesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetSubtitlesResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetSubtitlesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetSubtitlesResponse res = resBuilder.build();
