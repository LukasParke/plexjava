...
public class GetByResolution {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/library/sections/{sectionId}/byResolution",
    ...
    public static class Sync extends Base
            implements RequestOperation<GetByResolutionRequest, GetByResolutionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetByResolutionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetByResolutionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetByResolutionRequest request) {
        ...
        @Override
        public GetByResolutionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetByResolutionResponse.Builder resBuilder =
            ...
            GetByResolutionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetByResolutionRequest, dev.plexapi.sdk.models.operations.async.GetByResolutionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetByResolutionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetByResolutionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetByResolutionRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetByResolutionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetByResolutionResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetByResolutionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetByResolutionResponse res = resBuilder.build();
