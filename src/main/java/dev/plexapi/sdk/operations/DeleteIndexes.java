...
public class DeleteIndexes {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteIndexesRequest, DeleteIndexesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeleteIndexesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteIndexesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteIndexesRequest request) {
        ...
        @Override
        public DeleteIndexesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteIndexesResponse.Builder resBuilder =
            ...
            DeleteIndexesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteIndexesRequest, dev.plexapi.sdk.models.operations.async.DeleteIndexesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeleteIndexesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteIndexesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteIndexesRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.DeleteIndexesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.DeleteIndexesResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.DeleteIndexesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.DeleteIndexesResponse res = resBuilder.build();
