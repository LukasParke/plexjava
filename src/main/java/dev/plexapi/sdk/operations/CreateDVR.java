...
public class CreateDVR {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateDVRRequest, CreateDVRResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CreateDVRRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateDVRRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateDVRRequest request) {
        ...
        @Override
        public CreateDVRResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateDVRResponse.Builder resBuilder =
                    CreateDVRResponse
                            .builder()
            ...
            CreateDVRResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDvrRequestHandlerSlashGetResponses200(Utils.unmarshal(response, new TypeReference<DvrRequestHandlerSlashGetResponses200>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateDVRRequest, dev.plexapi.sdk.models.operations.async.CreateDVRResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CreateDVRRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateDVRRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateDVRRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.CreateDVRResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.CreateDVRResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.CreateDVRResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.CreateDVRResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DvrRequestHandlerSlashGetResponses200>() {})
                            .thenApply(res::withDvrRequestHandlerSlashGetResponses200);
                } else {
