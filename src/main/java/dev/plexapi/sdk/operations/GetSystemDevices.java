...
public class GetSystemDevices {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSystemDevicesRequest, GetSystemDevicesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetSystemDevicesRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSystemDevicesRequest request) {
        ...
        @Override
        public GetSystemDevicesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSystemDevicesResponse.Builder resBuilder =
            ...
            GetSystemDevicesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSystemDevicesRequest, dev.plexapi.sdk.models.operations.async.GetSystemDevicesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSystemDevicesRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSystemDevicesRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetSystemDevicesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetSystemDevicesResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetSystemDevicesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetSystemDevicesResponse res = resBuilder.build();
