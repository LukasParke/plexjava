...
public class EnablePapertrail {
    ...
    public static class Sync extends Base
            implements RequestOperation<EnablePapertrailRequest, EnablePapertrailResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(EnablePapertrailRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EnablePapertrailRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(EnablePapertrailRequest request) {
        ...
        @Override
        public EnablePapertrailResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            EnablePapertrailResponse.Builder resBuilder =
            ...
            EnablePapertrailResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<EnablePapertrailRequest, dev.plexapi.sdk.models.operations.async.EnablePapertrailResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(EnablePapertrailRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EnablePapertrailRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(EnablePapertrailRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.EnablePapertrailResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.EnablePapertrailResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.EnablePapertrailResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.EnablePapertrailResponse res = resBuilder.build();
