...
public class GetMetadataAgents {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetMetadataAgentsRequest, GetMetadataAgentsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetMetadataAgentsRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetMetadataAgentsRequest request) {
        ...
        @Override
        public GetMetadataAgentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetMetadataAgentsResponse.Builder resBuilder =
            ...
            GetMetadataAgentsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetMetadataAgentsRequest, dev.plexapi.sdk.models.operations.async.GetMetadataAgentsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetMetadataAgentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetMetadataAgentsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetMetadataAgentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetMetadataAgentsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetMetadataAgentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetMetadataAgentsResponse res = resBuilder.build();
