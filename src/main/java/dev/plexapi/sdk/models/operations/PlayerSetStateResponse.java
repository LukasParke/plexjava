...
public class PlayerSetStateResponse implements Response {
    /**
     ...
     * HTTP response content type for this operation
     */
    public PlayerSetStateResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public PlayerSetStateResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public PlayerSetStateResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public PlayerSetStateResponse withSuccessResponse(SuccessResponse successResponse) {
        Utils.checkNotNull(successResponse, "successResponse");
     ...
     * OK
     */
    public PlayerSetStateResponse withSuccessResponse(Optional<? extends SuccessResponse> successResponse) {
        Utils.checkNotNull(successResponse, "successResponse");
        this.successResponse = successResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PlayerSetStateResponse other = (PlayerSetStateResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PlayerSetStateResponse.class,
    ...
    public final static class Builder {
        ...
        public PlayerSetStateResponse build() {

            return new PlayerSetStateResponse(
                contentType, statusCode, rawResponse,
                successResponse);
        }
