...
public class AnalyzeMetadata {
    ...
    public static class Sync extends Base
            implements RequestOperation<AnalyzeMetadataRequest, AnalyzeMetadataResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AnalyzeMetadataRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AnalyzeMetadataRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AnalyzeMetadataRequest request) {
        ...
        @Override
        public AnalyzeMetadataResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AnalyzeMetadataResponse.Builder resBuilder =
            ...
            AnalyzeMetadataResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AnalyzeMetadataRequest, dev.plexapi.sdk.models.operations.async.AnalyzeMetadataResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AnalyzeMetadataRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AnalyzeMetadataRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AnalyzeMetadataRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.AnalyzeMetadataResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.AnalyzeMetadataResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.AnalyzeMetadataResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.AnalyzeMetadataResponse res = resBuilder.build();
