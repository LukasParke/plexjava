...
public class GetLibraryItems {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetLibraryItemsRequest, GetLibraryItemsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetLibraryItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLibraryItemsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetLibraryItemsRequest request) {
        ...
        @Override
        public GetLibraryItemsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetLibraryItemsResponse.Builder resBuilder =
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetLibraryItemsRequest, dev.plexapi.sdk.models.operations.async.GetLibraryItemsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetLibraryItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLibraryItemsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetLibraryItemsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetLibraryItemsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetLibraryItemsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetLibraryItemsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
