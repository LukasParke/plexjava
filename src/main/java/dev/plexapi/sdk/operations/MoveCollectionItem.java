...
public class MoveCollectionItem {
    ...
    public static class Sync extends Base
            implements RequestOperation<MoveCollectionItemRequest, MoveCollectionItemResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(MoveCollectionItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MoveCollectionItemRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MoveCollectionItemRequest request) {
        ...
        @Override
        public MoveCollectionItemResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            MoveCollectionItemResponse.Builder resBuilder =
            ...
            MoveCollectionItemResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MoveCollectionItemRequest, dev.plexapi.sdk.models.operations.async.MoveCollectionItemResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(MoveCollectionItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MoveCollectionItemRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(MoveCollectionItemRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.MoveCollectionItemResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.MoveCollectionItemResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.MoveCollectionItemResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.MoveCollectionItemResponse res = resBuilder.build();
