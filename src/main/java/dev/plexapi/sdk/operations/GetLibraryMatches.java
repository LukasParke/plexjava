...
public class GetLibraryMatches {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetLibraryMatchesRequest, GetLibraryMatchesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetLibraryMatchesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLibraryMatchesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetLibraryMatchesRequest request) {
        ...
        @Override
        public GetLibraryMatchesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetLibraryMatchesResponse.Builder resBuilder =
            ...
            GetLibraryMatchesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetLibraryMatchesRequest, dev.plexapi.sdk.models.operations.async.GetLibraryMatchesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetLibraryMatchesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLibraryMatchesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetLibraryMatchesRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetLibraryMatchesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetLibraryMatchesResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetLibraryMatchesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetLibraryMatchesResponse res = resBuilder.build();
