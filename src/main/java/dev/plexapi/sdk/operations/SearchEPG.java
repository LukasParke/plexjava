...
public class SearchEPG {
    ...
    public static class Sync extends Base
            implements RequestOperation<SearchEPGRequest, SearchEPGResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(SearchEPGRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(SearchEPGRequest request) {
        ...
        @Override
        public SearchEPGResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            SearchEPGResponse.Builder resBuilder =
                    SearchEPGResponse
                            .builder()
            ...
            SearchEPGResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SearchEPGRequest, dev.plexapi.sdk.models.operations.async.SearchEPGResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(SearchEPGRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(SearchEPGRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.SearchEPGResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.SearchEPGResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.SearchEPGResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.SearchEPGResponse res = resBuilder.build();
