...
public class GenerateThumbs {
    ...
    public static class Sync extends Base
            implements RequestOperation<GenerateThumbsRequest, GenerateThumbsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GenerateThumbsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GenerateThumbsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GenerateThumbsRequest request) {
        ...
        @Override
        public GenerateThumbsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GenerateThumbsResponse.Builder resBuilder =
            ...
            GenerateThumbsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GenerateThumbsRequest, dev.plexapi.sdk.models.operations.async.GenerateThumbsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GenerateThumbsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GenerateThumbsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GenerateThumbsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GenerateThumbsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GenerateThumbsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GenerateThumbsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GenerateThumbsResponse res = resBuilder.build();
