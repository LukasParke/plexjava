...
public class GetSectionTimeline {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/library/sections/{sectionId}/timeline",
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSectionTimelineRequest, GetSectionTimelineResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetSectionTimelineRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSectionTimelineRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSectionTimelineRequest request) {
        ...
        @Override
        public GetSectionTimelineResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSectionTimelineResponse.Builder resBuilder =
            ...
            GetSectionTimelineResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSectionTimelineRequest, dev.plexapi.sdk.models.operations.async.GetSectionTimelineResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSectionTimelineRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSectionTimelineRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSectionTimelineRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetSectionTimelineResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetSectionTimelineResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetSectionTimelineResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetSectionTimelineResponse res = resBuilder.build();
