...
public class GetSonicPath {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSonicPathRequest, GetSonicPathResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetSonicPathRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSonicPathRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSonicPathRequest request) {
        ...
        @Override
        public GetSonicPathResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSonicPathResponse.Builder resBuilder =
            ...
            GetSonicPathResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSonicPathRequest, dev.plexapi.sdk.models.operations.async.GetSonicPathResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSonicPathRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSonicPathRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSonicPathRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetSonicPathResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetSonicPathResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetSonicPathResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetSonicPathResponse res = resBuilder.build();
