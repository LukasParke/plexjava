...
public class GetMetadataChildren {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetMetadataChildrenRequest, GetMetadataChildrenResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetMetadataChildrenRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMetadataChildrenRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetMetadataChildrenRequest request) {
        ...
        @Override
        public GetMetadataChildrenResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetMetadataChildrenResponse.Builder resBuilder =
            ...
            GetMetadataChildrenResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetMetadataChildrenRequest, dev.plexapi.sdk.models.operations.async.GetMetadataChildrenResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetMetadataChildrenRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMetadataChildrenRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetMetadataChildrenRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetMetadataChildrenResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetMetadataChildrenResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetMetadataChildrenResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetMetadataChildrenResponse res = resBuilder.build();
