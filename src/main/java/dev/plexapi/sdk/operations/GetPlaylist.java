...
public class GetPlaylist {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPlaylistRequest, GetPlaylistResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetPlaylistRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPlaylistRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPlaylistRequest request) {
        ...
        @Override
        public GetPlaylistResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetPlaylistResponse.Builder resBuilder =
                    GetPlaylistResponse
                            .builder()
            ...
            GetPlaylistResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetPlaylistRequest, dev.plexapi.sdk.models.operations.async.GetPlaylistResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetPlaylistRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPlaylistRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetPlaylistRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetPlaylistResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetPlaylistResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetPlaylistResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetPlaylistResponse res = resBuilder.build();
