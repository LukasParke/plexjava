...
public class Unmatch {
    ...
    public static class Sync extends Base
            implements RequestOperation<UnmatchRequest, UnmatchResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UnmatchRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UnmatchRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UnmatchRequest request) {
        ...
        @Override
        public UnmatchResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UnmatchResponse.Builder resBuilder =
                    UnmatchResponse
                            .builder()
            ...
            UnmatchResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UnmatchRequest, dev.plexapi.sdk.models.operations.async.UnmatchResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UnmatchRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UnmatchRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UnmatchRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.UnmatchResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.UnmatchResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.UnmatchResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.UnmatchResponse res = resBuilder.build();
