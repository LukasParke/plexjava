...
public class RefreshProviders {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<RefreshProvidersResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        @Override
        public RefreshProvidersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RefreshProvidersResponse.Builder resBuilder =
            ...
            RefreshProvidersResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<dev.plexapi.sdk.models.operations.async.RefreshProvidersResponse> {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.RefreshProvidersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.RefreshProvidersResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.RefreshProvidersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.RefreshProvidersResponse res = resBuilder.build();
