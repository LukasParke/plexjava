...
public class MediaContainerWithPlaylistMetadataSkipChildren {
     ...
     * <ul>
     * <li>{@code boolean}</li>
     * <li>{@code dev.plexapi.sdk.models.shared.MediaContainerWithPlaylistMetadataSkipChildren2}</li>
     * </ul>
     * 
    ...
    public static final class _Deserializer extends OneOfDeserializer<MediaContainerWithPlaylistMetadataSkipChildren> {
