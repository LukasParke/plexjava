...
public class UploadPoster {
    ...
    public static class Sync extends Base
            implements RequestOperation<UploadPosterRequest, UploadPosterResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UploadPosterRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UploadPosterRequest.class, new TypeReference<UploadPosterRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UploadPosterRequest request) {
        ...
        @Override
        public UploadPosterResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UploadPosterResponse.Builder resBuilder =
            ...
            UploadPosterResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UploadPosterRequest, dev.plexapi.sdk.models.operations.async.UploadPosterResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UploadPosterRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UploadPosterRequest.class, new TypeReference<UploadPosterRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UploadPosterRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.UploadPosterResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.UploadPosterResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.UploadPosterResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.UploadPosterResponse res = resBuilder.build();
