...
public class RemoveFromContinueWatching {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveFromContinueWatchingRequest, RemoveFromContinueWatchingResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(RemoveFromContinueWatchingRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveFromContinueWatchingRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveFromContinueWatchingRequest request) {
        ...
        @Override
        public RemoveFromContinueWatchingResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveFromContinueWatchingResponse.Builder resBuilder =
            ...
            RemoveFromContinueWatchingResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveFromContinueWatchingRequest, dev.plexapi.sdk.models.operations.async.RemoveFromContinueWatchingResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(RemoveFromContinueWatchingRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveFromContinueWatchingRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveFromContinueWatchingRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.RemoveFromContinueWatchingResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.RemoveFromContinueWatchingResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.RemoveFromContinueWatchingResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.RemoveFromContinueWatchingResponse res = resBuilder.build();
