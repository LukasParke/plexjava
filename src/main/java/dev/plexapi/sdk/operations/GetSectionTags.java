...
public class GetSectionTags {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/library/sections/{sectionId}/tags",
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSectionTagsRequest, GetSectionTagsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetSectionTagsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSectionTagsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSectionTagsRequest request) {
        ...
        @Override
        public GetSectionTagsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSectionTagsResponse.Builder resBuilder =
            ...
            GetSectionTagsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSectionTagsRequest, dev.plexapi.sdk.models.operations.async.GetSectionTagsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSectionTagsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSectionTagsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSectionTagsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetSectionTagsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetSectionTagsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetSectionTagsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetSectionTagsResponse res = resBuilder.build();
