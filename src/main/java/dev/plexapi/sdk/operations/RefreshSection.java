...
public class RefreshSection {
    ...
    public static class Sync extends Base
            implements RequestOperation<RefreshSectionRequest, RefreshSectionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(RefreshSectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RefreshSectionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RefreshSectionRequest request) {
        ...
        @Override
        public RefreshSectionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RefreshSectionResponse.Builder resBuilder =
            ...
            RefreshSectionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RefreshSectionRequest, dev.plexapi.sdk.models.operations.async.RefreshSectionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(RefreshSectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RefreshSectionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RefreshSectionRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.RefreshSectionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.RefreshSectionResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.RefreshSectionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.RefreshSectionResponse res = resBuilder.build();
