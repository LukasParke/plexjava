...
public class StopScan {
    ...
    public static class Sync extends Base
            implements RequestOperation<StopScanRequest, StopScanResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(StopScanRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StopScanRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(StopScanRequest request) {
        ...
        @Override
        public StopScanResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            StopScanResponse.Builder resBuilder =
                    StopScanResponse
                            .builder()
            ...
            StopScanResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<StopScanRequest, dev.plexapi.sdk.models.operations.async.StopScanResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(StopScanRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StopScanRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(StopScanRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.StopScanResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.StopScanResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.StopScanResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.StopScanResponse res = resBuilder.build();
