...
public class GetTagsMediaContainer {
    ...
    public GetTagsMediaContainer withIdentifier(String identifier) {
        Utils.checkNotNull(identifier, "identifier");
    ...
    public GetTagsMediaContainer withIdentifier(Optional<String> identifier) {
        Utils.checkNotNull(identifier, "identifier");
        this.identifier = identifier;
        return this;
    }
     ...
     * the `X-Plex-Container-Start` header.
     */
    public GetTagsMediaContainer withOffset(long offset) {
        Utils.checkNotNull(offset, "offset");
     ...
     * the `X-Plex-Container-Start` header.
     */
    public GetTagsMediaContainer withOffset(Optional<Long> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }

    public GetTagsMediaContainer withSize(long size) {
        Utils.checkNotNull(size, "size");
    ...
    public GetTagsMediaContainer withSize(Optional<Long> size) {
        Utils.checkNotNull(size, "size");
        this.size = size;
        return this;
    }
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public GetTagsMediaContainer withTotalSize(long totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public GetTagsMediaContainer withTotalSize(Optional<Long> totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
        this.totalSize = totalSize;
        return this;
    }

    public GetTagsMediaContainer withDirectory(List<Directory> directory) {
        Utils.checkNotNull(directory, "directory");
    ...
    public GetTagsMediaContainer withDirectory(Optional<? extends List<Directory>> directory) {
        Utils.checkNotNull(directory, "directory");
        this.directory = directory;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetTagsMediaContainer other = (GetTagsMediaContainer) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetTagsMediaContainer.class,
    ...
    public final static class Builder {
        ...
        public GetTagsMediaContainer build() {

            return new GetTagsMediaContainer(
                identifier, offset, size,
                totalSize, directory);
        }
