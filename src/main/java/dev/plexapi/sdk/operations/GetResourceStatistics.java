...
public class GetResourceStatistics {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetResourceStatisticsRequest, GetResourceStatisticsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetResourceStatisticsRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetResourceStatisticsRequest request) {
        ...
        @Override
        public GetResourceStatisticsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetResourceStatisticsResponse.Builder resBuilder =
            ...
            GetResourceStatisticsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetResourceStatisticsRequest, dev.plexapi.sdk.models.operations.async.GetResourceStatisticsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetResourceStatisticsRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetResourceStatisticsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetResourceStatisticsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetResourceStatisticsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetResourceStatisticsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetResourceStatisticsResponse res = resBuilder.build();
