...
public class GetChannels {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetChannelsRequest, GetChannelsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetChannelsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetChannelsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetChannelsRequest request) {
        ...
        @Override
        public GetChannelsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetChannelsResponse.Builder resBuilder =
                    GetChannelsResponse
                            .builder()
            ...
            GetChannelsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withChannelResponse(Utils.unmarshal(response, new TypeReference<ChannelResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetChannelsRequest, dev.plexapi.sdk.models.operations.async.GetChannelsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetChannelsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetChannelsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetChannelsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetChannelsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetChannelsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetChannelsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetChannelsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ChannelResponse>() {})
                            .thenApply(res::withChannelResponse);
                } else {
