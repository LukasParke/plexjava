...
public class ComputeSonicPathResponse implements Response {
    /**
    ...
    @JsonCreator
    public ComputeSonicPathResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public ComputeSonicPathResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public ComputeSonicPathResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ComputeSonicPathResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public ComputeSonicPathResponse withMediaContainerWithMetadata(MediaContainerWithMetadata mediaContainerWithMetadata) {
        Utils.checkNotNull(mediaContainerWithMetadata, "mediaContainerWithMetadata");
     ...
     * OK
     */
    public ComputeSonicPathResponse withMediaContainerWithMetadata(Optional<? extends MediaContainerWithMetadata> mediaContainerWithMetadata) {
        Utils.checkNotNull(mediaContainerWithMetadata, "mediaContainerWithMetadata");
        this.mediaContainerWithMetadata = mediaContainerWithMetadata;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ComputeSonicPathResponse other = (ComputeSonicPathResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ComputeSonicPathResponse.class,
    ...
    public final static class Builder {
        ...
        public ComputeSonicPathResponse build() {

            return new ComputeSonicPathResponse(
                contentType, statusCode, rawResponse,
                mediaContainerWithMetadata);
        }
