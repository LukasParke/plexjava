...
public class AddDeviceToDVRDVRsMediaContainer {
    ...
    @JsonCreator
    public AddDeviceToDVRDVRsMediaContainer(
    ...
    public AddDeviceToDVRDVRsMediaContainer withIdentifier(String identifier) {
        Utils.checkNotNull(identifier, "identifier");
    ...
    public AddDeviceToDVRDVRsMediaContainer withIdentifier(Optional<String> identifier) {
        Utils.checkNotNull(identifier, "identifier");
        this.identifier = identifier;
        return this;
    }
     ...
     * the `X-Plex-Container-Start` header.
     */
    public AddDeviceToDVRDVRsMediaContainer withOffset(long offset) {
        Utils.checkNotNull(offset, "offset");
     ...
     * the `X-Plex-Container-Start` header.
     */
    public AddDeviceToDVRDVRsMediaContainer withOffset(Optional<Long> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }

    public AddDeviceToDVRDVRsMediaContainer withSize(long size) {
        Utils.checkNotNull(size, "size");
    ...
    public AddDeviceToDVRDVRsMediaContainer withSize(Optional<Long> size) {
        Utils.checkNotNull(size, "size");
        this.size = size;
        return this;
    }
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public AddDeviceToDVRDVRsMediaContainer withTotalSize(long totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public AddDeviceToDVRDVRsMediaContainer withTotalSize(Optional<Long> totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
        this.totalSize = totalSize;
        return this;
    }
     ...
     * A status indicator. If present and non-zero, indicates an error
     */
    public AddDeviceToDVRDVRsMediaContainer withStatus(long status) {
        Utils.checkNotNull(status, "status");
     ...
     * A status indicator. If present and non-zero, indicates an error
     */
    public AddDeviceToDVRDVRsMediaContainer withStatus(Optional<Long> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AddDeviceToDVRDVRsMediaContainer other = (AddDeviceToDVRDVRsMediaContainer) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AddDeviceToDVRDVRsMediaContainer.class,
    ...
    public final static class Builder {
        ...
        public AddDeviceToDVRDVRsMediaContainer build() {

            return new AddDeviceToDVRDVRsMediaContainer(
                identifier, offset, size,
                totalSize, status);
        }
