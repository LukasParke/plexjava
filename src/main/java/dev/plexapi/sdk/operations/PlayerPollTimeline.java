...
public class PlayerPollTimeline {
    ...
    public static class Sync extends Base
            implements RequestOperation<PlayerPollTimelineRequest, PlayerPollTimelineResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(PlayerPollTimelineRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlayerPollTimelineRequest request) {
        ...
        @Override
        public PlayerPollTimelineResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlayerPollTimelineResponse.Builder resBuilder =
            ...
            PlayerPollTimelineResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlayerPollTimelineRequest, dev.plexapi.sdk.models.operations.async.PlayerPollTimelineResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(PlayerPollTimelineRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlayerPollTimelineRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.PlayerPollTimelineResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.PlayerPollTimelineResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.PlayerPollTimelineResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.PlayerPollTimelineResponse res = resBuilder.build();
