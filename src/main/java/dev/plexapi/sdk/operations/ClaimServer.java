...
public class ClaimServer {
    ...
    public static class Sync extends Base
            implements RequestOperation<ClaimServerRequest, ClaimServerResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ClaimServerRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ClaimServerRequest request) {
        ...
        @Override
        public ClaimServerResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ClaimServerResponse.Builder resBuilder =
                    ClaimServerResponse
                            .builder()
            ...
            ClaimServerResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ClaimServerRequest, dev.plexapi.sdk.models.operations.async.ClaimServerResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ClaimServerRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ClaimServerRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.ClaimServerResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.ClaimServerResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.ClaimServerResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.ClaimServerResponse res = resBuilder.build();
