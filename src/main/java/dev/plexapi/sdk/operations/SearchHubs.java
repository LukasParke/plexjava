...
public class SearchHubs {
    ...
    public static class Sync extends Base
            implements RequestOperation<SearchHubsRequest, SearchHubsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(SearchHubsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SearchHubsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(SearchHubsRequest request) {
        ...
        @Override
        public SearchHubsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            SearchHubsResponse.Builder resBuilder =
                    SearchHubsResponse
                            .builder()
            ...
            SearchHubsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SearchHubsRequest, dev.plexapi.sdk.models.operations.async.SearchHubsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(SearchHubsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SearchHubsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(SearchHubsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.SearchHubsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.SearchHubsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.SearchHubsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.SearchHubsResponse res = resBuilder.build();
