...
public class MatchSectionItems {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/library/sections/{sectionId}/match",
    ...
    public static class Sync extends Base
            implements RequestOperation<MatchSectionItemsRequest, MatchSectionItemsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(MatchSectionItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MatchSectionItemsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MatchSectionItemsRequest request) {
        ...
        @Override
        public MatchSectionItemsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            MatchSectionItemsResponse.Builder resBuilder =
            ...
            MatchSectionItemsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MatchSectionItemsRequest, dev.plexapi.sdk.models.operations.async.MatchSectionItemsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(MatchSectionItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MatchSectionItemsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(MatchSectionItemsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.MatchSectionItemsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.MatchSectionItemsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.MatchSectionItemsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.MatchSectionItemsResponse res = resBuilder.build();
