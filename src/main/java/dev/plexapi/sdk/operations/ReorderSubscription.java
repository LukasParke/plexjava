...
public class ReorderSubscription {
    ...
    public static class Sync extends Base
            implements RequestOperation<ReorderSubscriptionRequest, ReorderSubscriptionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ReorderSubscriptionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ReorderSubscriptionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ReorderSubscriptionRequest request) {
        ...
        @Override
        public ReorderSubscriptionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ReorderSubscriptionResponse.Builder resBuilder =
            ...
            ReorderSubscriptionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ReorderSubscriptionRequest, dev.plexapi.sdk.models.operations.async.ReorderSubscriptionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ReorderSubscriptionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ReorderSubscriptionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ReorderSubscriptionRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.ReorderSubscriptionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.ReorderSubscriptionResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.ReorderSubscriptionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.ReorderSubscriptionResponse res = resBuilder.build();
