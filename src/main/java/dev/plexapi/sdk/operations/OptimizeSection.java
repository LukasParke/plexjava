...
public class OptimizeSection {
    ...
    public static class Sync extends Base
            implements RequestOperation<OptimizeSectionRequest, OptimizeSectionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(OptimizeSectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, OptimizeSectionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(OptimizeSectionRequest request) {
        ...
        @Override
        public OptimizeSectionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            OptimizeSectionResponse.Builder resBuilder =
            ...
            OptimizeSectionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<OptimizeSectionRequest, dev.plexapi.sdk.models.operations.async.OptimizeSectionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(OptimizeSectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, OptimizeSectionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(OptimizeSectionRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.OptimizeSectionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.OptimizeSectionResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.OptimizeSectionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.OptimizeSectionResponse res = resBuilder.build();
