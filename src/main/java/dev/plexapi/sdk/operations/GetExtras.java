...
public class GetExtras {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetExtrasRequest, GetExtrasResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetExtrasRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetExtrasRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetExtrasRequest request) {
        ...
        @Override
        public GetExtrasResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetExtrasResponse.Builder resBuilder =
                    GetExtrasResponse
                            .builder()
            ...
            GetExtrasResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetExtrasRequest, dev.plexapi.sdk.models.operations.async.GetExtrasResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetExtrasRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetExtrasRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetExtrasRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetExtrasResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetExtrasResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetExtrasResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetExtrasResponse res = resBuilder.build();
