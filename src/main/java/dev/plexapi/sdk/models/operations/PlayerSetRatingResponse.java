...
public class PlayerSetRatingResponse implements Response {
    /**
    ...
    @JsonCreator
    public PlayerSetRatingResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public PlayerSetRatingResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public PlayerSetRatingResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public PlayerSetRatingResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public PlayerSetRatingResponse withSuccessResponse(SuccessResponse successResponse) {
        Utils.checkNotNull(successResponse, "successResponse");
     ...
     * OK
     */
    public PlayerSetRatingResponse withSuccessResponse(Optional<? extends SuccessResponse> successResponse) {
        Utils.checkNotNull(successResponse, "successResponse");
        this.successResponse = successResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PlayerSetRatingResponse other = (PlayerSetRatingResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PlayerSetRatingResponse.class,
    ...
    public final static class Builder {
        ...
        public PlayerSetRatingResponse build() {

            return new PlayerSetRatingResponse(
                contentType, statusCode, rawResponse,
                successResponse);
        }
