...
public class DeleteLibrarySection {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteLibrarySectionRequest, DeleteLibrarySectionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeleteLibrarySectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteLibrarySectionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteLibrarySectionRequest request) {
        ...
        @Override
        public DeleteLibrarySectionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteLibrarySectionResponse.Builder resBuilder =
            ...
            DeleteLibrarySectionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteLibrarySectionRequest, dev.plexapi.sdk.models.operations.async.DeleteLibrarySectionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeleteLibrarySectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteLibrarySectionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteLibrarySectionRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.DeleteLibrarySectionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.DeleteLibrarySectionResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.DeleteLibrarySectionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.DeleteLibrarySectionResponse res = resBuilder.build();
