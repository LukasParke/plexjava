...
public class UpdatePlaylist {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdatePlaylistRequest, UpdatePlaylistResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UpdatePlaylistRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdatePlaylistRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdatePlaylistRequest request) {
        ...
        @Override
        public UpdatePlaylistResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdatePlaylistResponse.Builder resBuilder =
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdatePlaylistRequest, dev.plexapi.sdk.models.operations.async.UpdatePlaylistResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdatePlaylistRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdatePlaylistRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdatePlaylistRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.UpdatePlaylistResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.UpdatePlaylistResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.UpdatePlaylistResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
