...
public class GetMediaPart {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetMediaPartRequest, GetMediaPartResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetMediaPartRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMediaPartRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetMediaPartRequest request) {
        ...
        @Override
        public GetMediaPartResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetMediaPartResponse.Builder resBuilder =
            ...
            GetMediaPartResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "503", "509", "5XX")) {
                // no content
                throw SDKError.from("API error occurred", response);
            }
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetMediaPartRequest, dev.plexapi.sdk.models.operations.async.GetMediaPartResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetMediaPartRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMediaPartRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetMediaPartRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetMediaPartResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetMediaPartResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetMediaPartResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            dev.plexapi.sdk.models.operations.async.GetMediaPartResponse res = resBuilder.build();
