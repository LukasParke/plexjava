...
public class TriggerFallback {
    ...
    public static class Sync extends Base
            implements RequestOperation<TriggerFallbackRequest, TriggerFallbackResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(TriggerFallbackRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TriggerFallbackRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TriggerFallbackRequest request) {
        ...
        @Override
        public TriggerFallbackResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            TriggerFallbackResponse.Builder resBuilder =
            ...
            TriggerFallbackResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                // no content
                return res;
            }
            if (Utils.statusCodeMatches(response.statusCode(), "404", "412", "4XX")) {
                // no content
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<TriggerFallbackRequest, dev.plexapi.sdk.models.operations.async.TriggerFallbackResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(TriggerFallbackRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TriggerFallbackRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(TriggerFallbackRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.TriggerFallbackResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.TriggerFallbackResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.TriggerFallbackResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.TriggerFallbackResponse res = resBuilder.build();
