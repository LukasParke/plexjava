...
public class GetSessionPlaylistIndex {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            ...
            req.addHeader("Accept", "application/vnd.apple.mpegurl")
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSessionPlaylistIndexRequest, GetSessionPlaylistIndexResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetSessionPlaylistIndexRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSessionPlaylistIndexRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSessionPlaylistIndexRequest request) {
        ...
        @Override
        public GetSessionPlaylistIndexResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSessionPlaylistIndexResponse.Builder resBuilder =
            ...
            GetSessionPlaylistIndexResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSessionPlaylistIndexRequest, dev.plexapi.sdk.models.operations.async.GetSessionPlaylistIndexResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSessionPlaylistIndexRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSessionPlaylistIndexRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSessionPlaylistIndexRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetSessionPlaylistIndexResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetSessionPlaylistIndexResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetSessionPlaylistIndexResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            dev.plexapi.sdk.models.operations.async.GetSessionPlaylistIndexResponse res = resBuilder.build();
