...
public class ReloadGuide {
    ...
    public static class Sync extends Base
            implements RequestOperation<ReloadGuideRequest, ReloadGuideResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ReloadGuideRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ReloadGuideRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ReloadGuideRequest request) {
        ...
        @Override
        public ReloadGuideResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ReloadGuideResponse.Builder resBuilder =
                    ReloadGuideResponse
                            .builder()
            ...
            ReloadGuideResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ReloadGuideRequest, dev.plexapi.sdk.models.operations.async.ReloadGuideResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ReloadGuideRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ReloadGuideRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ReloadGuideRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.ReloadGuideResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.ReloadGuideResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.ReloadGuideResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.ReloadGuideResponse res = resBuilder.build();
