...
public class GetUnwatchedForSection {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/library/sections/{sectionId}/unwatched",
    ...
    public static class Sync extends Base
            implements RequestOperation<GetUnwatchedForSectionRequest, GetUnwatchedForSectionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetUnwatchedForSectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetUnwatchedForSectionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetUnwatchedForSectionRequest request) {
        ...
        @Override
        public GetUnwatchedForSectionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetUnwatchedForSectionResponse.Builder resBuilder =
            ...
            GetUnwatchedForSectionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetUnwatchedForSectionRequest, dev.plexapi.sdk.models.operations.async.GetUnwatchedForSectionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetUnwatchedForSectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetUnwatchedForSectionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetUnwatchedForSectionRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetUnwatchedForSectionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetUnwatchedForSectionResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetUnwatchedForSectionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetUnwatchedForSectionResponse res = resBuilder.build();
