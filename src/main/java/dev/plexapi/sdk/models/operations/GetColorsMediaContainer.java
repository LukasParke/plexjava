...
import dev.plexapi.sdk.models.shared.UltraBlurColors;
...
public class GetColorsMediaContainer {
    ...
    private Optional<? extends List<UltraBlurColors>> ultraBlurColors;
    ...
    public GetColorsMediaContainer(
            ...
            @JsonProperty("UltraBlurColors") Optional<? extends List<UltraBlurColors>> ultraBlurColors) {
    ...
    @JsonIgnore
    public Optional<List<UltraBlurColors>> ultraBlurColors() {
        return (Optional<List<UltraBlurColors>>) ultraBlurColors;
    }
    ...
    public GetColorsMediaContainer withIdentifier(String identifier) {
        Utils.checkNotNull(identifier, "identifier");
    ...
    public GetColorsMediaContainer withIdentifier(Optional<String> identifier) {
        Utils.checkNotNull(identifier, "identifier");
        this.identifier = identifier;
        return this;
    }
     ...
     * the `X-Plex-Container-Start` header.
     */
    public GetColorsMediaContainer withOffset(long offset) {
        Utils.checkNotNull(offset, "offset");
     ...
     * the `X-Plex-Container-Start` header.
     */
    public GetColorsMediaContainer withOffset(Optional<Long> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }

    public GetColorsMediaContainer withSize(long size) {
        Utils.checkNotNull(size, "size");
    ...
    public GetColorsMediaContainer withSize(Optional<Long> size) {
        Utils.checkNotNull(size, "size");
        this.size = size;
        return this;
    }
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public GetColorsMediaContainer withTotalSize(long totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public GetColorsMediaContainer withTotalSize(Optional<Long> totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
        this.totalSize = totalSize;
        return this;
    }

    public GetColorsMediaContainer withUltraBlurColors(List<UltraBlurColors> ultraBlurColors) {
        Utils.checkNotNull(ultraBlurColors, "ultraBlurColors");
    ...
    public GetColorsMediaContainer withUltraBlurColors(Optional<? extends List<UltraBlurColors>> ultraBlurColors) {
        Utils.checkNotNull(ultraBlurColors, "ultraBlurColors");
        this.ultraBlurColors = ultraBlurColors;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetColorsMediaContainer other = (GetColorsMediaContainer) o;
        return 
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            totalSize, ultraBlurColors);
    }
    
    @Override
    public String toString() {
        return Utils.toString(GetColorsMediaContainer.class,
    ...
    public final static class Builder {
        ...
        private Optional<? extends List<UltraBlurColors>> ultraBlurColors = Optional.empty();
        ...
        public Builder ultraBlurColors(List<UltraBlurColors> ultraBlurColors) {
            Utils.checkNotNull(ultraBlurColors, "ultraBlurColors");
            this.ultraBlurColors = Optional.ofNullable(ultraBlurColors);
            return this;
        }

        public Builder ultraBlurColors(Optional<? extends List<UltraBlurColors>> ultraBlurColors) {
            Utils.checkNotNull(ultraBlurColors, "ultraBlurColors");
            this.ultraBlurColors = ultraBlurColors;
            return this;
        }

        public GetColorsMediaContainer build() {

            return new GetColorsMediaContainer(
                identifier, offset, size,
                totalSize, ultraBlurColors);
        }
