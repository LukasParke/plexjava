...
public class OptimizeSectionPost {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/library/sections/{sectionId}/optimize",
    ...
    public static class Sync extends Base
            implements RequestOperation<OptimizeSectionPostRequest, OptimizeSectionPostResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(OptimizeSectionPostRequest request) throws Exception {
            HttpRequest req = buildRequest(request, OptimizeSectionPostRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(OptimizeSectionPostRequest request) {
        ...
        @Override
        public OptimizeSectionPostResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            OptimizeSectionPostResponse.Builder resBuilder =
            ...
            OptimizeSectionPostResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<OptimizeSectionPostRequest, dev.plexapi.sdk.models.operations.async.OptimizeSectionPostResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(OptimizeSectionPostRequest request) throws Exception {
            HttpRequest req = buildRequest(request, OptimizeSectionPostRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(OptimizeSectionPostRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.OptimizeSectionPostResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.OptimizeSectionPostResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.OptimizeSectionPostResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.OptimizeSectionPostResponse res = resBuilder.build();
