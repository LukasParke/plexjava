...
public class MediaContainerWithMetadataMediaContainer {
    ...
    @JsonCreator
    public MediaContainerWithMetadataMediaContainer(
    ...
    public MediaContainerWithMetadataMediaContainer withIdentifier(String identifier) {
        Utils.checkNotNull(identifier, "identifier");
    ...
    public MediaContainerWithMetadataMediaContainer withIdentifier(Optional<String> identifier) {
        Utils.checkNotNull(identifier, "identifier");
        this.identifier = identifier;
        return this;
    }
     ...
     * the `X-Plex-Container-Start` header.
     */
    public MediaContainerWithMetadataMediaContainer withOffset(long offset) {
        Utils.checkNotNull(offset, "offset");
     ...
     * the `X-Plex-Container-Start` header.
     */
    public MediaContainerWithMetadataMediaContainer withOffset(Optional<Long> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }

    public MediaContainerWithMetadataMediaContainer withSize(long size) {
        Utils.checkNotNull(size, "size");
    ...
    public MediaContainerWithMetadataMediaContainer withSize(Optional<Long> size) {
        Utils.checkNotNull(size, "size");
        this.size = size;
        return this;
    }
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public MediaContainerWithMetadataMediaContainer withTotalSize(long totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public MediaContainerWithMetadataMediaContainer withTotalSize(Optional<Long> totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
        this.totalSize = totalSize;
        return this;
    }

    public MediaContainerWithMetadataMediaContainer withMetadata(List<Metadata> metadata) {
        Utils.checkNotNull(metadata, "metadata");
    ...
    public MediaContainerWithMetadataMediaContainer withMetadata(Optional<? extends List<Metadata>> metadata) {
        Utils.checkNotNull(metadata, "metadata");
        this.metadata = metadata;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        MediaContainerWithMetadataMediaContainer other = (MediaContainerWithMetadataMediaContainer) o;
        return 
    ...
    public String toString() {
        return Utils.toString(MediaContainerWithMetadataMediaContainer.class,
    ...
    public final static class Builder {
        ...
        public MediaContainerWithMetadataMediaContainer build() {

            return new MediaContainerWithMetadataMediaContainer(
                identifier, offset, size,
                totalSize, metadata);
        }
