...
public class PlayerSetStreams {
    ...
    public static class Sync extends Base
            implements RequestOperation<PlayerSetStreamsRequest, PlayerSetStreamsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(PlayerSetStreamsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlayerSetStreamsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlayerSetStreamsRequest request) {
        ...
        @Override
        public PlayerSetStreamsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlayerSetStreamsResponse.Builder resBuilder =
            ...
            PlayerSetStreamsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlayerSetStreamsRequest, dev.plexapi.sdk.models.operations.async.PlayerSetStreamsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(PlayerSetStreamsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlayerSetStreamsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlayerSetStreamsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.PlayerSetStreamsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.PlayerSetStreamsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.PlayerSetStreamsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            dev.plexapi.sdk.models.operations.async.PlayerSetStreamsResponse res = resBuilder.build();
