...
public class PlayerSetTextStreamRequest {
    ...
    @JsonCreator
    public PlayerSetTextStreamRequest(
     ...
     * Indicates the client accepts the indicated media types
     */
    public PlayerSetTextStreamRequest withAccepts(Accepts accepts) {
        Utils.checkNotNull(accepts, "accepts");
     ...
     * Indicates the client accepts the indicated media types
     */
    public PlayerSetTextStreamRequest withAccepts(Optional<? extends Accepts> accepts) {
        Utils.checkNotNull(accepts, "accepts");
        this.accepts = accepts;
        return this;
    }
     ...
     * An opaque identifier unique to the client
     */
    public PlayerSetTextStreamRequest withClientIdentifier(String clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
     ...
     * An opaque identifier unique to the client
     */
    public PlayerSetTextStreamRequest withClientIdentifier(Optional<String> clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
        this.clientIdentifier = clientIdentifier;
        return this;
    }
     ...
     * The name of the client product
     */
    public PlayerSetTextStreamRequest withProduct(String product) {
        Utils.checkNotNull(product, "product");
     ...
     * The name of the client product
     */
    public PlayerSetTextStreamRequest withProduct(Optional<String> product) {
        Utils.checkNotNull(product, "product");
        this.product = product;
        return this;
    }
     ...
     * The version of the client application
     */
    public PlayerSetTextStreamRequest withVersion(String version) {
        Utils.checkNotNull(version, "version");
     ...
     * The version of the client application
     */
    public PlayerSetTextStreamRequest withVersion(Optional<String> version) {
        Utils.checkNotNull(version, "version");
        this.version = version;
        return this;
    }
     ...
     * The platform of the client
     */
    public PlayerSetTextStreamRequest withPlatform(String platform) {
        Utils.checkNotNull(platform, "platform");
     ...
     * The platform of the client
     */
    public PlayerSetTextStreamRequest withPlatform(Optional<String> platform) {
        Utils.checkNotNull(platform, "platform");
        this.platform = platform;
        return this;
    }
     ...
     * The version of the platform
     */
    public PlayerSetTextStreamRequest withPlatformVersion(String platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
     ...
     * The version of the platform
     */
    public PlayerSetTextStreamRequest withPlatformVersion(Optional<String> platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
        this.platformVersion = platformVersion;
        return this;
    }
     ...
     * A relatively friendly name for the client device
     */
    public PlayerSetTextStreamRequest withDevice(String device) {
        Utils.checkNotNull(device, "device");
     ...
     * A relatively friendly name for the client device
     */
    public PlayerSetTextStreamRequest withDevice(Optional<String> device) {
        Utils.checkNotNull(device, "device");
        this.device = device;
        return this;
    }
     ...
     * A potentially less friendly identifier for the device model
     */
    public PlayerSetTextStreamRequest withModel(String model) {
        Utils.checkNotNull(model, "model");
     ...
     * A potentially less friendly identifier for the device model
     */
    public PlayerSetTextStreamRequest withModel(Optional<String> model) {
        Utils.checkNotNull(model, "model");
        this.model = model;
        return this;
    }
     ...
     * The device vendor
     */
    public PlayerSetTextStreamRequest withDeviceVendor(String deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
     ...
     * The device vendor
     */
    public PlayerSetTextStreamRequest withDeviceVendor(Optional<String> deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
        this.deviceVendor = deviceVendor;
        return this;
    }
     ...
     * A friendly name for the client
     */
    public PlayerSetTextStreamRequest withDeviceName(String deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
     ...
     * A friendly name for the client
     */
    public PlayerSetTextStreamRequest withDeviceName(Optional<String> deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
        this.deviceName = deviceName;
        return this;
    }
     ...
     * The marketplace on which the client application is distributed
     */
    public PlayerSetTextStreamRequest withMarketplace(String marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
     ...
     * The marketplace on which the client application is distributed
     */
    public PlayerSetTextStreamRequest withMarketplace(Optional<String> marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
        this.marketplace = marketplace;
        return this;
    }
     ...
     * default/active client.
     */
    public PlayerSetTextStreamRequest withXPlexTargetClientIdentifier(String xPlexTargetClientIdentifier) {
        Utils.checkNotNull(xPlexTargetClientIdentifier, "xPlexTargetClientIdentifier");
     ...
     * default/active client.
     */
    public PlayerSetTextStreamRequest withXPlexTargetClientIdentifier(Optional<String> xPlexTargetClientIdentifier) {
        Utils.checkNotNull(xPlexTargetClientIdentifier, "xPlexTargetClientIdentifier");
        this.xPlexTargetClientIdentifier = xPlexTargetClientIdentifier;
        return this;
    }
     ...
     * The unique identifier of the stream
     */
    public PlayerSetTextStreamRequest withStreamID(long streamID) {
        Utils.checkNotNull(streamID, "streamID");
     ...
     * The unique identifier of the stream
     */
    public PlayerSetTextStreamRequest withStreamID(Optional<Long> streamID) {
        Utils.checkNotNull(streamID, "streamID");
        this.streamID = streamID;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PlayerSetTextStreamRequest other = (PlayerSetTextStreamRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PlayerSetTextStreamRequest.class,
                "accepts", accepts,
    ...
    public final static class Builder {
        ...
        public PlayerSetTextStreamRequest build() {
            if (accepts == null) {
                accepts = _SINGLETON_VALUE_Accepts.value();
            }

            return new PlayerSetTextStreamRequest(
                accepts, clientIdentifier, product,
                version, platform, platformVersion,
                device, model, deviceVendor,
                deviceName, marketplace, xPlexTargetClientIdentifier,
