...
public class GetMetadataChildrenResponse implements Response {
    /**
     ...
     * HTTP response status code for this operation
     */
    public GetMetadataChildrenResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetMetadataChildrenResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public GetMetadataChildrenResponse withMediaContainerWithMetadata(MediaContainerWithMetadata mediaContainerWithMetadata) {
        Utils.checkNotNull(mediaContainerWithMetadata, "mediaContainerWithMetadata");
     ...
     * OK
     */
    public GetMetadataChildrenResponse withMediaContainerWithMetadata(Optional<? extends MediaContainerWithMetadata> mediaContainerWithMetadata) {
        Utils.checkNotNull(mediaContainerWithMetadata, "mediaContainerWithMetadata");
        this.mediaContainerWithMetadata = mediaContainerWithMetadata;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetMetadataChildrenResponse other = (GetMetadataChildrenResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetMetadataChildrenResponse.class,
    ...
    public final static class Builder {
        ...
        public GetMetadataChildrenResponse build() {

            return new GetMetadataChildrenResponse(
                contentType, statusCode, rawResponse,
                mediaContainerWithMetadata);
        }
