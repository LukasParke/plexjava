...
public class GetSonicallySimilarRequest {
    ...
    @JsonCreator
    public GetSonicallySimilarRequest(
    ...
    public GetSonicallySimilarRequest(
        ...
        this(Optional.empty(), Optional.empty(), Optional.empty(),
            ...
            Optional.empty(), values, Optional.empty(),
            Optional.empty());
    }
     ...
     * Indicates the client accepts the indicated media types
     */
    public GetSonicallySimilarRequest withAccepts(Accepts accepts) {
        Utils.checkNotNull(accepts, "accepts");
     ...
     * Indicates the client accepts the indicated media types
     */
    public GetSonicallySimilarRequest withAccepts(Optional<? extends Accepts> accepts) {
        Utils.checkNotNull(accepts, "accepts");
        this.accepts = accepts;
        return this;
    }
     ...
     * An opaque identifier unique to the client
     */
    public GetSonicallySimilarRequest withClientIdentifier(String clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
     ...
     * An opaque identifier unique to the client
     */
    public GetSonicallySimilarRequest withClientIdentifier(Optional<String> clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
        this.clientIdentifier = clientIdentifier;
        return this;
    }
     ...
     * The name of the client product
     */
    public GetSonicallySimilarRequest withProduct(Optional<String> product) {
        Utils.checkNotNull(product, "product");
        this.product = product;
        return this;
    }
     ...
     * The version of the client application
     */
    public GetSonicallySimilarRequest withVersion(String version) {
        Utils.checkNotNull(version, "version");
     ...
     * The version of the client application
     */
    public GetSonicallySimilarRequest withVersion(Optional<String> version) {
        Utils.checkNotNull(version, "version");
        this.version = version;
        return this;
    }
     ...
     * The platform of the client
     */
    public GetSonicallySimilarRequest withPlatform(String platform) {
        Utils.checkNotNull(platform, "platform");
     ...
     * The platform of the client
     */
    public GetSonicallySimilarRequest withPlatform(Optional<String> platform) {
        Utils.checkNotNull(platform, "platform");
        this.platform = platform;
        return this;
    }
     ...
     * The version of the platform
     */
    public GetSonicallySimilarRequest withPlatformVersion(String platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
     ...
     * The version of the platform
     */
    public GetSonicallySimilarRequest withPlatformVersion(Optional<String> platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
        this.platformVersion = platformVersion;
        return this;
    }
     ...
     * A relatively friendly name for the client device
     */
    public GetSonicallySimilarRequest withDevice(String device) {
        Utils.checkNotNull(device, "device");
     ...
     * A relatively friendly name for the client device
     */
    public GetSonicallySimilarRequest withDevice(Optional<String> device) {
        Utils.checkNotNull(device, "device");
        this.device = device;
        return this;
    }
     ...
     * A potentially less friendly identifier for the device model
     */
    public GetSonicallySimilarRequest withModel(String model) {
        Utils.checkNotNull(model, "model");
     ...
     * A potentially less friendly identifier for the device model
     */
    public GetSonicallySimilarRequest withModel(Optional<String> model) {
        Utils.checkNotNull(model, "model");
        this.model = model;
        return this;
    }
     ...
     * The device vendor
     */
    public GetSonicallySimilarRequest withDeviceVendor(String deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
     ...
     * The device vendor
     */
    public GetSonicallySimilarRequest withDeviceVendor(Optional<String> deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
        this.deviceVendor = deviceVendor;
        return this;
    }
     ...
     * A friendly name for the client
     */
    public GetSonicallySimilarRequest withDeviceName(String deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
     ...
     * A friendly name for the client
     */
    public GetSonicallySimilarRequest withDeviceName(Optional<String> deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
        this.deviceName = deviceName;
        return this;
    }
     ...
     * The marketplace on which the client application is distributed
     */
    public GetSonicallySimilarRequest withMarketplace(String marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
     ...
     * The marketplace on which the client application is distributed
     */
    public GetSonicallySimilarRequest withMarketplace(Optional<String> marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
        this.marketplace = marketplace;
        return this;
    }
     ...
     * Section identifier
     */
    public GetSonicallySimilarRequest withSectionId(long sectionId) {
        Utils.checkNotNull(sectionId, "sectionId");
        this.sectionId = sectionId;
        return this;
    }
     ...
     * The limit of the number of items to fetch; defaults to 50
     */
    public GetSonicallySimilarRequest withLimit(long limit) {
        Utils.checkNotNull(limit, "limit");
     ...
     * The limit of the number of items to fetch; defaults to 50
     */
    public GetSonicallySimilarRequest withLimit(Optional<Long> limit) {
        Utils.checkNotNull(limit, "limit");
        this.limit = limit;
        return this;
    }
     ...
     * The maximum distance to search, defaults to 0.25
     */
    public GetSonicallySimilarRequest withMaxDistance(double maxDistance) {
        Utils.checkNotNull(maxDistance, "maxDistance");
     ...
     * The maximum distance to search, defaults to 0.25
     */
    public GetSonicallySimilarRequest withMaxDistance(Optional<Double> maxDistance) {
        Utils.checkNotNull(maxDistance, "maxDistance");
        this.maxDistance = maxDistance;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetSonicallySimilarRequest other = (GetSonicallySimilarRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetSonicallySimilarRequest.class,
                "accepts", accepts,
    ...
    public final static class Builder {
        ...
        public GetSonicallySimilarRequest build() {
            if (accepts == null) {
                accepts = _SINGLETON_VALUE_Accepts.value();
            }

            return new GetSonicallySimilarRequest(
                accepts, clientIdentifier, product,
                version, platform, platformVersion,
                device, model, deviceVendor,
                deviceName, marketplace, sectionId,
