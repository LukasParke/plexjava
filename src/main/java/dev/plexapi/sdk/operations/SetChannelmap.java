...
public class SetChannelmap {
    ...
    public static class Sync extends Base
            implements RequestOperation<SetChannelmapRequest, SetChannelmapResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(SetChannelmapRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SetChannelmapRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(SetChannelmapRequest request) {
        ...
        @Override
        public SetChannelmapResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            SetChannelmapResponse.Builder resBuilder =
            ...
            SetChannelmapResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SetChannelmapRequest, dev.plexapi.sdk.models.operations.async.SetChannelmapResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(SetChannelmapRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SetChannelmapRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(SetChannelmapRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.SetChannelmapResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.SetChannelmapResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.SetChannelmapResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.SetChannelmapResponse res = resBuilder.build();
