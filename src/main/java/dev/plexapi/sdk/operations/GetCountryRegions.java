...
import dev.plexapi.sdk.models.operations.GetCountryRegionsResponseBody;
...
public class GetCountryRegions {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCountryRegionsRequest, GetCountryRegionsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetCountryRegionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCountryRegionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCountryRegionsRequest request) {
        ...
        @Override
        public GetCountryRegionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCountryRegionsResponse.Builder resBuilder =
            ...
            GetCountryRegionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<GetCountryRegionsResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCountryRegionsRequest, dev.plexapi.sdk.models.operations.async.GetCountryRegionsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetCountryRegionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCountryRegionsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCountryRegionsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetCountryRegionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetCountryRegionsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetCountryRegionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetCountryRegionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetCountryRegionsResponseBody>() {})
