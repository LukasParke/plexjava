...
import dev.plexapi.sdk.models.operations.GetBackgroundTasksResponseBody;
...
public class GetBackgroundTasks {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<GetBackgroundTasksResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        @Override
        public GetBackgroundTasksResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetBackgroundTasksResponse.Builder resBuilder =
            ...
            GetBackgroundTasksResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<GetBackgroundTasksResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<dev.plexapi.sdk.models.operations.async.GetBackgroundTasksResponse> {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetBackgroundTasksResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetBackgroundTasksResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetBackgroundTasksResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetBackgroundTasksResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetBackgroundTasksResponseBody>() {})
