...
public class StopTask {
    ...
    public static class Sync extends Base
            implements RequestOperation<StopTaskRequest, StopTaskResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(StopTaskRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StopTaskRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(StopTaskRequest request) {
        ...
        @Override
        public StopTaskResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            StopTaskResponse.Builder resBuilder =
                    StopTaskResponse
                            .builder()
            ...
            StopTaskResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<StopTaskRequest, dev.plexapi.sdk.models.operations.async.StopTaskResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(StopTaskRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StopTaskRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(StopTaskRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.StopTaskResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.StopTaskResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.StopTaskResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.StopTaskResponse res = resBuilder.build();
