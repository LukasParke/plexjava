...
public class PlayerSkipTo {
    ...
    public static class Sync extends Base
            implements RequestOperation<PlayerSkipToRequest, PlayerSkipToResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(PlayerSkipToRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlayerSkipToRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlayerSkipToRequest request) {
        ...
        @Override
        public PlayerSkipToResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlayerSkipToResponse.Builder resBuilder =
            ...
            PlayerSkipToResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlayerSkipToRequest, dev.plexapi.sdk.models.operations.async.PlayerSkipToResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(PlayerSkipToRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlayerSkipToRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlayerSkipToRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.PlayerSkipToResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.PlayerSkipToResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.PlayerSkipToResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.PlayerSkipToResponse res = resBuilder.build();
