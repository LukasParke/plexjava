...
public class PlayerRefreshplayqueue {
    ...
    public static class Sync extends Base
            implements RequestOperation<PlayerRefreshplayqueueRequest, PlayerRefreshplayqueueResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(PlayerRefreshplayqueueRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlayerRefreshplayqueueRequest request) {
        ...
        @Override
        public PlayerRefreshplayqueueResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlayerRefreshplayqueueResponse.Builder resBuilder =
            ...
            PlayerRefreshplayqueueResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlayerRefreshplayqueueRequest, dev.plexapi.sdk.models.operations.async.PlayerRefreshplayqueueResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(PlayerRefreshplayqueueRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlayerRefreshplayqueueRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.PlayerRefreshplayqueueResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.PlayerRefreshplayqueueResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.PlayerRefreshplayqueueResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.PlayerRefreshplayqueueResponse res = resBuilder.build();
