...
public class DownloadLogBundle {
    ...
    public static class Sync extends Base
            implements RequestOperation<DownloadLogBundleRequest, DownloadLogBundleResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DownloadLogBundleRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DownloadLogBundleRequest request) {
        ...
        @Override
        public DownloadLogBundleResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DownloadLogBundleResponse.Builder resBuilder =
            ...
            DownloadLogBundleResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DownloadLogBundleRequest, dev.plexapi.sdk.models.operations.async.DownloadLogBundleResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DownloadLogBundleRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DownloadLogBundleRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.DownloadLogBundleResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.DownloadLogBundleResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.DownloadLogBundleResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            dev.plexapi.sdk.models.operations.async.DownloadLogBundleResponse res = resBuilder.build();
