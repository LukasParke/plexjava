...
public class GetNewestForSection {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/library/sections/{sectionId}/newest",
    ...
    public static class Sync extends Base
            implements RequestOperation<GetNewestForSectionRequest, GetNewestForSectionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetNewestForSectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetNewestForSectionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetNewestForSectionRequest request) {
        ...
        @Override
        public GetNewestForSectionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetNewestForSectionResponse.Builder resBuilder =
            ...
            GetNewestForSectionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetNewestForSectionRequest, dev.plexapi.sdk.models.operations.async.GetNewestForSectionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetNewestForSectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetNewestForSectionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetNewestForSectionRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetNewestForSectionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetNewestForSectionResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetNewestForSectionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetNewestForSectionResponse res = resBuilder.build();
