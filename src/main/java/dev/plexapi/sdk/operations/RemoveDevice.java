...
import dev.plexapi.sdk.models.operations.RemoveDeviceResponseBody;
...
public class RemoveDevice {
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveDeviceRequest, RemoveDeviceResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(RemoveDeviceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveDeviceRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveDeviceRequest request) {
        ...
        @Override
        public RemoveDeviceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveDeviceResponse.Builder resBuilder =
            ...
            RemoveDeviceResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<RemoveDeviceResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveDeviceRequest, dev.plexapi.sdk.models.operations.async.RemoveDeviceResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(RemoveDeviceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveDeviceRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveDeviceRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.RemoveDeviceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.RemoveDeviceResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.RemoveDeviceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.RemoveDeviceResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<RemoveDeviceResponseBody>() {})
