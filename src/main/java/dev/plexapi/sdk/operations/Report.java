...
import dev.plexapi.sdk.models.operations.ReportResponseBody;
...
public class Report {
    ...
    public static class Sync extends Base
            implements RequestOperation<ReportRequest, ReportResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ReportRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ReportRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ReportRequest request) {
        ...
        @Override
        public ReportResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ReportResponse.Builder resBuilder =
                    ReportResponse
                            .builder()
            ...
            ReportResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<ReportResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ReportRequest, dev.plexapi.sdk.models.operations.async.ReportResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ReportRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ReportRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ReportRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.ReportResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.ReportResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.ReportResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.ReportResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ReportResponseBody>() {})
