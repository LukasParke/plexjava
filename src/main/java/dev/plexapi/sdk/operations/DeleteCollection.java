...
public class DeleteCollection {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(DeleteCollectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteCollectionRequest.class);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteCollectionRequest, dev.plexapi.sdk.models.operations.async.DeleteCollectionResponse> {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.DeleteCollectionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.DeleteCollectionResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.DeleteCollectionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.DeleteCollectionResponse res = resBuilder.build();
