...
public class GetAugmentationStatus {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAugmentationStatusRequest, GetAugmentationStatusResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetAugmentationStatusRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAugmentationStatusRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAugmentationStatusRequest request) {
        ...
        @Override
        public GetAugmentationStatusResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAugmentationStatusResponse.Builder resBuilder =
            ...
            GetAugmentationStatusResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "204")) {
                // no content
                return res;
            }
            if (Utils.statusCodeMatches(response.statusCode(), "401", "404", "4XX")) {
                // no content
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAugmentationStatusRequest, dev.plexapi.sdk.models.operations.async.GetAugmentationStatusResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetAugmentationStatusRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAugmentationStatusRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAugmentationStatusRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetAugmentationStatusResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetAugmentationStatusResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetAugmentationStatusResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetAugmentationStatusResponse res = resBuilder.build();
