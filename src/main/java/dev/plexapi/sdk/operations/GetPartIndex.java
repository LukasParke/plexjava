...
public class GetPartIndex {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPartIndexRequest, GetPartIndexResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetPartIndexRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPartIndexRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPartIndexRequest request) {
        ...
        @Override
        public GetPartIndexResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetPartIndexResponse.Builder resBuilder =
            ...
            GetPartIndexResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetPartIndexRequest, dev.plexapi.sdk.models.operations.async.GetPartIndexResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetPartIndexRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPartIndexRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetPartIndexRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetPartIndexResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetPartIndexResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetPartIndexResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            dev.plexapi.sdk.models.operations.async.GetPartIndexResponse res = resBuilder.build();
