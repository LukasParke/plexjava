...
public class ChannelResponseMediaContainer {
    ...
    @JsonCreator
    public ChannelResponseMediaContainer(
    ...
    public ChannelResponseMediaContainer withIdentifier(String identifier) {
        Utils.checkNotNull(identifier, "identifier");
    ...
    public ChannelResponseMediaContainer withIdentifier(Optional<String> identifier) {
        Utils.checkNotNull(identifier, "identifier");
        this.identifier = identifier;
        return this;
    }
     ...
     * the `X-Plex-Container-Start` header.
     */
    public ChannelResponseMediaContainer withOffset(long offset) {
        Utils.checkNotNull(offset, "offset");
     ...
     * the `X-Plex-Container-Start` header.
     */
    public ChannelResponseMediaContainer withOffset(Optional<Long> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }

    public ChannelResponseMediaContainer withSize(long size) {
        Utils.checkNotNull(size, "size");
    ...
    public ChannelResponseMediaContainer withSize(Optional<Long> size) {
        Utils.checkNotNull(size, "size");
        this.size = size;
        return this;
    }
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public ChannelResponseMediaContainer withTotalSize(long totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public ChannelResponseMediaContainer withTotalSize(Optional<Long> totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
        this.totalSize = totalSize;
        return this;
    }

    public ChannelResponseMediaContainer withChannel(List<Channel> channel) {
        Utils.checkNotNull(channel, "channel");
    ...
    public ChannelResponseMediaContainer withChannel(Optional<? extends List<Channel>> channel) {
        Utils.checkNotNull(channel, "channel");
        this.channel = channel;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ChannelResponseMediaContainer other = (ChannelResponseMediaContainer) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ChannelResponseMediaContainer.class,
    ...
    public final static class Builder {
        ...
        public ChannelResponseMediaContainer build() {

            return new ChannelResponseMediaContainer(
                identifier, offset, size,
                totalSize, channel);
        }
