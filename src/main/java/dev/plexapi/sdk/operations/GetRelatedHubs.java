...
public class GetRelatedHubs {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetRelatedHubsRequest, GetRelatedHubsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetRelatedHubsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRelatedHubsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetRelatedHubsRequest request) {
        ...
        @Override
        public GetRelatedHubsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetRelatedHubsResponse.Builder resBuilder =
            ...
            GetRelatedHubsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetRelatedHubsRequest, dev.plexapi.sdk.models.operations.async.GetRelatedHubsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetRelatedHubsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRelatedHubsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetRelatedHubsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetRelatedHubsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetRelatedHubsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetRelatedHubsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetRelatedHubsResponse res = resBuilder.build();
