...
public class Autocomplete {
    ...
    public static class Sync extends Base
            implements RequestOperation<AutocompleteRequest, AutocompleteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AutocompleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AutocompleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AutocompleteRequest request) {
        ...
        @Override
        public AutocompleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AutocompleteResponse.Builder resBuilder =
            ...
            AutocompleteResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AutocompleteRequest, dev.plexapi.sdk.models.operations.async.AutocompleteResponse> {
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AutocompleteRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.AutocompleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.AutocompleteResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.AutocompleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.AutocompleteResponse res = resBuilder.build();
