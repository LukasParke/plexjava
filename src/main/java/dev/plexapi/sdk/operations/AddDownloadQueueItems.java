...
public class AddDownloadQueueItems {
    ...
    public static class Sync extends Base
            implements RequestOperation<AddDownloadQueueItemsRequest, AddDownloadQueueItemsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AddDownloadQueueItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddDownloadQueueItemsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddDownloadQueueItemsRequest request) {
        ...
        @Override
        public AddDownloadQueueItemsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AddDownloadQueueItemsResponse.Builder resBuilder =
            ...
            AddDownloadQueueItemsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<AddDownloadQueueItemsResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AddDownloadQueueItemsRequest, dev.plexapi.sdk.models.operations.async.AddDownloadQueueItemsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AddDownloadQueueItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddDownloadQueueItemsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AddDownloadQueueItemsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.AddDownloadQueueItemsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.AddDownloadQueueItemsResponse.Builder resBuilder =
            ...
            dev.plexapi.sdk.models.operations.async.AddDownloadQueueItemsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AddDownloadQueueItemsResponseBody>() {})
