...
public class ConnectWebSocket {
    ...
    public static class Sync extends Base
            implements RequestOperation<ConnectWebSocketRequest, ConnectWebSocketResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ConnectWebSocketRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ConnectWebSocketRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ConnectWebSocketRequest request) {
        ...
        @Override
        public ConnectWebSocketResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ConnectWebSocketResponse.Builder resBuilder =
            ...
            ConnectWebSocketResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ConnectWebSocketRequest, dev.plexapi.sdk.models.operations.async.ConnectWebSocketResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ConnectWebSocketRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ConnectWebSocketRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ConnectWebSocketRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.ConnectWebSocketResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.ConnectWebSocketResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.ConnectWebSocketResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            dev.plexapi.sdk.models.operations.async.ConnectWebSocketResponse res = resBuilder.build();
