...
public class UnshuffleResponse implements Response {
    /**
     ...
     * HTTP response content type for this operation
     */
    public UnshuffleResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public UnshuffleResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public UnshuffleResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Successfully updated unshuffle a play queue
     */
    public UnshuffleResponse withMediaContainerWithPlaylistMetadata(MediaContainerWithPlaylistMetadata mediaContainerWithPlaylistMetadata) {
        Utils.checkNotNull(mediaContainerWithPlaylistMetadata, "mediaContainerWithPlaylistMetadata");
     ...
     * Successfully updated unshuffle a play queue
     */
    public UnshuffleResponse withMediaContainerWithPlaylistMetadata(Optional<? extends MediaContainerWithPlaylistMetadata> mediaContainerWithPlaylistMetadata) {
        Utils.checkNotNull(mediaContainerWithPlaylistMetadata, "mediaContainerWithPlaylistMetadata");
        this.mediaContainerWithPlaylistMetadata = mediaContainerWithPlaylistMetadata;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UnshuffleResponse other = (UnshuffleResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UnshuffleResponse.class,
    ...
    public final static class Builder {
        ...
        public UnshuffleResponse build() {

            return new UnshuffleResponse(
                contentType, statusCode, rawResponse,
                mediaContainerWithPlaylistMetadata);
        }
