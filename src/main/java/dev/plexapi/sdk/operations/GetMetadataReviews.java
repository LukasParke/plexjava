...
public class GetMetadataReviews {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetMetadataReviewsRequest, GetMetadataReviewsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetMetadataReviewsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMetadataReviewsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetMetadataReviewsRequest request) {
        ...
        @Override
        public GetMetadataReviewsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetMetadataReviewsResponse.Builder resBuilder =
            ...
            GetMetadataReviewsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetMetadataReviewsRequest, dev.plexapi.sdk.models.operations.async.GetMetadataReviewsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetMetadataReviewsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMetadataReviewsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetMetadataReviewsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetMetadataReviewsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetMetadataReviewsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetMetadataReviewsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetMetadataReviewsResponse res = resBuilder.build();
