...
public class RemoveFromWatchlistResponse implements Response {
    /**
     ...
     * HTTP response content type for this operation
     */
    public RemoveFromWatchlistResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public RemoveFromWatchlistResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public RemoveFromWatchlistResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public RemoveFromWatchlistResponse withSuccessResponse(SuccessResponse successResponse) {
        Utils.checkNotNull(successResponse, "successResponse");
     ...
     * OK
     */
    public RemoveFromWatchlistResponse withSuccessResponse(Optional<? extends SuccessResponse> successResponse) {
        Utils.checkNotNull(successResponse, "successResponse");
        this.successResponse = successResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        RemoveFromWatchlistResponse other = (RemoveFromWatchlistResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(RemoveFromWatchlistResponse.class,
    ...
    public final static class Builder {
        ...
        public RemoveFromWatchlistResponse build() {
