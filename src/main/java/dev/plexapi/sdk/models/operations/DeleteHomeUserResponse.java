...
public class DeleteHomeUserResponse implements Response {
    /**
     ...
     * HTTP response content type for this operation
     */
    public DeleteHomeUserResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public DeleteHomeUserResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public DeleteHomeUserResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public DeleteHomeUserResponse withSuccessResponse(SuccessResponse successResponse) {
        Utils.checkNotNull(successResponse, "successResponse");
     ...
     * OK
     */
    public DeleteHomeUserResponse withSuccessResponse(Optional<? extends SuccessResponse> successResponse) {
        Utils.checkNotNull(successResponse, "successResponse");
        this.successResponse = successResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DeleteHomeUserResponse other = (DeleteHomeUserResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DeleteHomeUserResponse.class,
    ...
    public final static class Builder {
        ...
        public DeleteHomeUserResponse build() {
