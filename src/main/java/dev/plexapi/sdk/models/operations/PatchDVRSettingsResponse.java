...
public class PatchDVRSettingsResponse implements Response {
    /**
    ...
    @JsonCreator
    public PatchDVRSettingsResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public PatchDVRSettingsResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public PatchDVRSettingsResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public PatchDVRSettingsResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public PatchDVRSettingsResponse withSuccessResponse(SuccessResponse successResponse) {
        Utils.checkNotNull(successResponse, "successResponse");
     ...
     * OK
     */
    public PatchDVRSettingsResponse withSuccessResponse(Optional<? extends SuccessResponse> successResponse) {
        Utils.checkNotNull(successResponse, "successResponse");
        this.successResponse = successResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PatchDVRSettingsResponse other = (PatchDVRSettingsResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PatchDVRSettingsResponse.class,
    ...
    public final static class Builder {
        ...
        public PatchDVRSettingsResponse build() {

            return new PatchDVRSettingsResponse(
                contentType, statusCode, rawResponse,
                successResponse);
        }
