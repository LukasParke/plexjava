...
public class GetSyncTranscodeQueue {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSyncTranscodeQueueRequest, GetSyncTranscodeQueueResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetSyncTranscodeQueueRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSyncTranscodeQueueRequest request) {
        ...
        @Override
        public GetSyncTranscodeQueueResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSyncTranscodeQueueResponse.Builder resBuilder =
            ...
            GetSyncTranscodeQueueResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSyncTranscodeQueueRequest, dev.plexapi.sdk.models.operations.async.GetSyncTranscodeQueueResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSyncTranscodeQueueRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSyncTranscodeQueueRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetSyncTranscodeQueueResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetSyncTranscodeQueueResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetSyncTranscodeQueueResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetSyncTranscodeQueueResponse res = resBuilder.build();
