...
public class ApplyUpdates {
    ...
    public static class Sync extends Base
            implements RequestOperation<ApplyUpdatesRequest, ApplyUpdatesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ApplyUpdatesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ApplyUpdatesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ApplyUpdatesRequest request) {
        ...
        @Override
        public ApplyUpdatesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ApplyUpdatesResponse.Builder resBuilder =
            ...
            ApplyUpdatesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ApplyUpdatesRequest, dev.plexapi.sdk.models.operations.async.ApplyUpdatesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ApplyUpdatesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ApplyUpdatesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ApplyUpdatesRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.ApplyUpdatesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.ApplyUpdatesResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.ApplyUpdatesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.ApplyUpdatesResponse res = resBuilder.build();
