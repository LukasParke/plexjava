...
public class DiscoverDevices {
    ...
    public static class Sync extends Base
            implements RequestOperation<DiscoverDevicesRequest, DiscoverDevicesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DiscoverDevicesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DiscoverDevicesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DiscoverDevicesRequest request) {
        ...
        @Override
        public DiscoverDevicesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DiscoverDevicesResponse.Builder resBuilder =
            ...
            DiscoverDevicesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DiscoverDevicesRequest, dev.plexapi.sdk.models.operations.async.DiscoverDevicesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DiscoverDevicesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DiscoverDevicesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DiscoverDevicesRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.DiscoverDevicesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.DiscoverDevicesResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.DiscoverDevicesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.DiscoverDevicesResponse res = resBuilder.build();
