...
public class GetMetadataGrandchildrenResponse implements Response {
    /**
    ...
    @JsonCreator
    public GetMetadataGrandchildrenResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public GetMetadataGrandchildrenResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetMetadataGrandchildrenResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetMetadataGrandchildrenResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public GetMetadataGrandchildrenResponse withMediaContainerWithMetadata(MediaContainerWithMetadata mediaContainerWithMetadata) {
        Utils.checkNotNull(mediaContainerWithMetadata, "mediaContainerWithMetadata");
     ...
     * OK
     */
    public GetMetadataGrandchildrenResponse withMediaContainerWithMetadata(Optional<? extends MediaContainerWithMetadata> mediaContainerWithMetadata) {
        Utils.checkNotNull(mediaContainerWithMetadata, "mediaContainerWithMetadata");
        this.mediaContainerWithMetadata = mediaContainerWithMetadata;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetMetadataGrandchildrenResponse other = (GetMetadataGrandchildrenResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetMetadataGrandchildrenResponse.class,
    ...
    public final static class Builder {
        ...
        public GetMetadataGrandchildrenResponse build() {

            return new GetMetadataGrandchildrenResponse(
                contentType, statusCode, rawResponse,
                mediaContainerWithMetadata);
        }
