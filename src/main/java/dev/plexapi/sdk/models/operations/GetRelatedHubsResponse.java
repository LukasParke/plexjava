...
public class GetRelatedHubsResponse implements Response {
    /**
     ...
     * HTTP response content type for this operation
     */
    public GetRelatedHubsResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetRelatedHubsResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetRelatedHubsResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public GetRelatedHubsResponse withHeaders(Map<String, List<String>> headers) {
        Utils.checkNotNull(headers, "headers");
        this.headers = headers;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetRelatedHubsResponse other = (GetRelatedHubsResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetRelatedHubsResponse.class,
    ...
    public final static class Builder {
        ...
        public GetRelatedHubsResponse build() {

            return new GetRelatedHubsResponse(
                contentType, statusCode, rawResponse,
                mediaContainerWithHubs, headers);
        }
