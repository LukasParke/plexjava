...
public class CreateDownloadQueueMediaContainer {
    ...
    public CreateDownloadQueueMediaContainer withIdentifier(String identifier) {
        Utils.checkNotNull(identifier, "identifier");
    ...
    public CreateDownloadQueueMediaContainer withIdentifier(Optional<String> identifier) {
        Utils.checkNotNull(identifier, "identifier");
        this.identifier = identifier;
        return this;
    }
     ...
     * the `X-Plex-Container-Start` header.
     */
    public CreateDownloadQueueMediaContainer withOffset(long offset) {
        Utils.checkNotNull(offset, "offset");
     ...
     * the `X-Plex-Container-Start` header.
     */
    public CreateDownloadQueueMediaContainer withOffset(Optional<Long> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }

    public CreateDownloadQueueMediaContainer withSize(long size) {
        Utils.checkNotNull(size, "size");
    ...
    public CreateDownloadQueueMediaContainer withSize(Optional<Long> size) {
        Utils.checkNotNull(size, "size");
        this.size = size;
        return this;
    }
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public CreateDownloadQueueMediaContainer withTotalSize(long totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public CreateDownloadQueueMediaContainer withTotalSize(Optional<Long> totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
        this.totalSize = totalSize;
        return this;
    }

    public CreateDownloadQueueMediaContainer withDownloadQueue(List<DownloadQueue> downloadQueue) {
        Utils.checkNotNull(downloadQueue, "downloadQueue");
    ...
    public CreateDownloadQueueMediaContainer withDownloadQueue(Optional<? extends List<DownloadQueue>> downloadQueue) {
        Utils.checkNotNull(downloadQueue, "downloadQueue");
        this.downloadQueue = downloadQueue;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateDownloadQueueMediaContainer other = (CreateDownloadQueueMediaContainer) o;
        return 
            ...
            Utils.enhancedDeepEquals(this.downloadQueue, other.downloadQueue);
    }
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            totalSize, downloadQueue);
    }
    
    @Override
    public String toString() {
        return Utils.toString(CreateDownloadQueueMediaContainer.class,
    ...
    public final static class Builder {
        ...
        public CreateDownloadQueueMediaContainer build() {

            return new CreateDownloadQueueMediaContainer(
                identifier, offset, size,
                totalSize, downloadQueue);
        }
