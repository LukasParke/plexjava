...
public class GetEPGGuide {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<GetEPGGuideResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        @Override
        public GetEPGGuideResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetEPGGuideResponse.Builder resBuilder =
                    GetEPGGuideResponse
                            .builder()
            ...
            GetEPGGuideResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<dev.plexapi.sdk.models.operations.async.GetEPGGuideResponse> {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetEPGGuideResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetEPGGuideResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetEPGGuideResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetEPGGuideResponse res = resBuilder.build();
