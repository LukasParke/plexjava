...
public class RefreshSyncContent {
    ...
    public static class Sync extends Base
            implements RequestOperation<RefreshSyncContentRequest, RefreshSyncContentResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(RefreshSyncContentRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RefreshSyncContentRequest request) {
        ...
        @Override
        public RefreshSyncContentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RefreshSyncContentResponse.Builder resBuilder =
            ...
            RefreshSyncContentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RefreshSyncContentRequest, dev.plexapi.sdk.models.operations.async.RefreshSyncContentResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(RefreshSyncContentRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RefreshSyncContentRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.RefreshSyncContentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.RefreshSyncContentResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.RefreshSyncContentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.RefreshSyncContentResponse res = resBuilder.build();
