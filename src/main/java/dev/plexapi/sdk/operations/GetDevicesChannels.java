...
public class GetDevicesChannels {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetDevicesChannelsRequest, GetDevicesChannelsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetDevicesChannelsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDevicesChannelsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetDevicesChannelsRequest request) {
        ...
        @Override
        public GetDevicesChannelsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetDevicesChannelsResponse.Builder resBuilder =
            ...
            GetDevicesChannelsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<GetDevicesChannelsResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetDevicesChannelsRequest, dev.plexapi.sdk.models.operations.async.GetDevicesChannelsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetDevicesChannelsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDevicesChannelsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetDevicesChannelsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetDevicesChannelsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetDevicesChannelsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetDevicesChannelsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetDevicesChannelsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetDevicesChannelsResponseBody>() {})
