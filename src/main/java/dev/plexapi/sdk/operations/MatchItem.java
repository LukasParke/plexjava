...
public class MatchItem {
    ...
    public static class Sync extends Base
            implements RequestOperation<MatchItemRequest, MatchItemResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(MatchItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MatchItemRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MatchItemRequest request) {
        ...
        @Override
        public MatchItemResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            MatchItemResponse.Builder resBuilder =
                    MatchItemResponse
                            .builder()
            ...
            MatchItemResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MatchItemRequest, dev.plexapi.sdk.models.operations.async.MatchItemResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(MatchItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MatchItemRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(MatchItemRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.MatchItemResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.MatchItemResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.MatchItemResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.MatchItemResponse res = resBuilder.build();
