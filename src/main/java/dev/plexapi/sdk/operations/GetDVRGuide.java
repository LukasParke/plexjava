...
public class GetDVRGuide {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetDVRGuideRequest, GetDVRGuideResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetDVRGuideRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDVRGuideRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetDVRGuideRequest request) {
        ...
        @Override
        public GetDVRGuideResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetDVRGuideResponse.Builder resBuilder =
                    GetDVRGuideResponse
                            .builder()
            ...
            GetDVRGuideResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetDVRGuideRequest, dev.plexapi.sdk.models.operations.async.GetDVRGuideResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetDVRGuideRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDVRGuideRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetDVRGuideRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetDVRGuideResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetDVRGuideResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetDVRGuideResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetDVRGuideResponse res = resBuilder.build();
