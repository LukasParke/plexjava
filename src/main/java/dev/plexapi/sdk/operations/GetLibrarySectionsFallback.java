...
public class GetLibrarySectionsFallback {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<GetLibrarySectionsFallbackResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        @Override
        public GetLibrarySectionsFallbackResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetLibrarySectionsFallbackResponse.Builder resBuilder =
            ...
            GetLibrarySectionsFallbackResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<dev.plexapi.sdk.models.operations.async.GetLibrarySectionsFallbackResponse> {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetLibrarySectionsFallbackResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetLibrarySectionsFallbackResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetLibrarySectionsFallbackResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetLibrarySectionsFallbackResponse res = resBuilder.build();
