...
public class PlayerVolume {
    ...
    public static class Sync extends Base
            implements RequestOperation<PlayerVolumeRequest, PlayerVolumeResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(PlayerVolumeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlayerVolumeRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlayerVolumeRequest request) {
        ...
        @Override
        public PlayerVolumeResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlayerVolumeResponse.Builder resBuilder =
            ...
            PlayerVolumeResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlayerVolumeRequest, dev.plexapi.sdk.models.operations.async.PlayerVolumeResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(PlayerVolumeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlayerVolumeRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlayerVolumeRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.PlayerVolumeResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.PlayerVolumeResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.PlayerVolumeResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.PlayerVolumeResponse res = resBuilder.build();
