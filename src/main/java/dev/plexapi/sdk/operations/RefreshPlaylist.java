...
public class RefreshPlaylist {
    ...
    public static class Sync extends Base
            implements RequestOperation<RefreshPlaylistRequest, RefreshPlaylistResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(RefreshPlaylistRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RefreshPlaylistRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RefreshPlaylistRequest request) {
        ...
        @Override
        public RefreshPlaylistResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RefreshPlaylistResponse.Builder resBuilder =
            ...
            RefreshPlaylistResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RefreshPlaylistRequest, dev.plexapi.sdk.models.operations.async.RefreshPlaylistResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(RefreshPlaylistRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RefreshPlaylistRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RefreshPlaylistRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.RefreshPlaylistResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.RefreshPlaylistResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.RefreshPlaylistResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.RefreshPlaylistResponse res = resBuilder.build();
