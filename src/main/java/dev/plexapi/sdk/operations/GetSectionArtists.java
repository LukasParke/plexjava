...
public class GetSectionArtists {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/library/sections/{sectionId}/artists",
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSectionArtistsRequest, GetSectionArtistsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetSectionArtistsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSectionArtistsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSectionArtistsRequest request) {
        ...
        @Override
        public GetSectionArtistsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSectionArtistsResponse.Builder resBuilder =
            ...
            GetSectionArtistsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSectionArtistsRequest, dev.plexapi.sdk.models.operations.async.GetSectionArtistsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSectionArtistsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSectionArtistsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSectionArtistsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetSectionArtistsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetSectionArtistsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetSectionArtistsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetSectionArtistsResponse res = resBuilder.build();
