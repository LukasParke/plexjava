...
public class UpdateDVRSettings {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateDVRSettingsRequest, UpdateDVRSettingsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UpdateDVRSettingsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateDVRSettingsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateDVRSettingsRequest request) {
        ...
        @Override
        public UpdateDVRSettingsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateDVRSettingsResponse.Builder resBuilder =
            ...
            UpdateDVRSettingsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateDVRSettingsRequest, dev.plexapi.sdk.models.operations.async.UpdateDVRSettingsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdateDVRSettingsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateDVRSettingsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateDVRSettingsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.UpdateDVRSettingsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.UpdateDVRSettingsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.UpdateDVRSettingsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.UpdateDVRSettingsResponse res = resBuilder.build();
