...
public class GetSourceConnectionInformation {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSourceConnectionInformationRequest, GetSourceConnectionInformationResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetSourceConnectionInformationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSourceConnectionInformationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSourceConnectionInformationRequest request) {
        ...
        @Override
        public GetSourceConnectionInformationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSourceConnectionInformationResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<GetSourceConnectionInformationResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSourceConnectionInformationRequest, dev.plexapi.sdk.models.operations.async.GetSourceConnectionInformationResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSourceConnectionInformationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSourceConnectionInformationRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSourceConnectionInformationRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetSourceConnectionInformationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetSourceConnectionInformationResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetSourceConnectionInformationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetSourceConnectionInformationResponseBody>() {})
