...
public class GetLineup {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetLineupRequest, GetLineupResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetLineupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLineupRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetLineupRequest request) {
        ...
        @Override
        public GetLineupResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetLineupResponse.Builder resBuilder =
                    GetLineupResponse
                            .builder()
            ...
            GetLineupResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetLineupRequest, dev.plexapi.sdk.models.operations.async.GetLineupResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetLineupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLineupRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetLineupRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetLineupResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetLineupResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetLineupResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetLineupResponse res = resBuilder.build();
