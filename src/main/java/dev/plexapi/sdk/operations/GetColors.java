...
import dev.plexapi.sdk.models.operations.GetColorsResponseBody;
...
public class GetColors {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetColorsRequest, GetColorsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetColorsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetColorsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetColorsRequest request) {
        ...
        @Override
        public GetColorsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetColorsResponse.Builder resBuilder =
                    GetColorsResponse
                            .builder()
            ...
            GetColorsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<GetColorsResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetColorsRequest, dev.plexapi.sdk.models.operations.async.GetColorsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetColorsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetColorsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetColorsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetColorsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetColorsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetColorsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetColorsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetColorsResponseBody>() {})
