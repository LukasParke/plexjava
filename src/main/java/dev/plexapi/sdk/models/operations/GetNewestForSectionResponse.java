...
public class GetNewestForSectionResponse implements Response {
    /**
    ...
    @JsonCreator
    public GetNewestForSectionResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public GetNewestForSectionResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetNewestForSectionResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetNewestForSectionResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public GetNewestForSectionResponse withMediaContainerWithMetadata(MediaContainerWithMetadata mediaContainerWithMetadata) {
        Utils.checkNotNull(mediaContainerWithMetadata, "mediaContainerWithMetadata");
     ...
     * OK
     */
    public GetNewestForSectionResponse withMediaContainerWithMetadata(Optional<? extends MediaContainerWithMetadata> mediaContainerWithMetadata) {
        Utils.checkNotNull(mediaContainerWithMetadata, "mediaContainerWithMetadata");
        this.mediaContainerWithMetadata = mediaContainerWithMetadata;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetNewestForSectionResponse other = (GetNewestForSectionResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetNewestForSectionResponse.class,
    ...
    public final static class Builder {
        ...
        public GetNewestForSectionResponse build() {

            return new GetNewestForSectionResponse(
                contentType, statusCode, rawResponse,
                mediaContainerWithMetadata);
        }
