...
public class GetAllItemLeaves {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAllItemLeavesRequest, GetAllItemLeavesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetAllItemLeavesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAllItemLeavesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAllItemLeavesRequest request) {
        ...
        @Override
        public GetAllItemLeavesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAllItemLeavesResponse.Builder resBuilder =
            ...
            GetAllItemLeavesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAllItemLeavesRequest, dev.plexapi.sdk.models.operations.async.GetAllItemLeavesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetAllItemLeavesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAllItemLeavesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAllItemLeavesRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetAllItemLeavesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetAllItemLeavesResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetAllItemLeavesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetAllItemLeavesResponse res = resBuilder.build();
