...
public class DeleteDVR {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteDVRRequest, DeleteDVRResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeleteDVRRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteDVRRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteDVRRequest request) {
        ...
        @Override
        public DeleteDVRResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteDVRResponse.Builder resBuilder =
                    DeleteDVRResponse
                            .builder()
            ...
            DeleteDVRResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteDVRRequest, dev.plexapi.sdk.models.operations.async.DeleteDVRResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeleteDVRRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteDVRRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteDVRRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.DeleteDVRResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.DeleteDVRResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.DeleteDVRResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.DeleteDVRResponse res = resBuilder.build();
