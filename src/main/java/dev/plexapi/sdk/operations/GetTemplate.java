...
import dev.plexapi.sdk.models.operations.GetTemplateResponseBody;
...
public class GetTemplate {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTemplateRequest, GetTemplateResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTemplateRequest request) {
        ...
        @Override
        public GetTemplateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetTemplateResponse.Builder resBuilder =
                    GetTemplateResponse
                            .builder()
            ...
            GetTemplateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<GetTemplateResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTemplateRequest, dev.plexapi.sdk.models.operations.async.GetTemplateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetTemplateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTemplateRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTemplateRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetTemplateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetTemplateResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetTemplateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetTemplateResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetTemplateResponseBody>() {})
