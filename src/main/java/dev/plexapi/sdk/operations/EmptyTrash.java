...
public class EmptyTrash {
    ...
    public static class Sync extends Base
            implements RequestOperation<EmptyTrashRequest, EmptyTrashResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(EmptyTrashRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EmptyTrashRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(EmptyTrashRequest request) {
        ...
        @Override
        public EmptyTrashResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            EmptyTrashResponse.Builder resBuilder =
                    EmptyTrashResponse
                            .builder()
            ...
            EmptyTrashResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<EmptyTrashRequest, dev.plexapi.sdk.models.operations.async.EmptyTrashResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(EmptyTrashRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EmptyTrashRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(EmptyTrashRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.EmptyTrashResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.EmptyTrashResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.EmptyTrashResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.EmptyTrashResponse res = resBuilder.build();
