...
public class GetMetadataGrandparentResponse implements Response {
    /**
    ...
    @JsonCreator
    public GetMetadataGrandparentResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public GetMetadataGrandparentResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetMetadataGrandparentResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetMetadataGrandparentResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public GetMetadataGrandparentResponse withMediaContainerWithMetadata(MediaContainerWithMetadata mediaContainerWithMetadata) {
        Utils.checkNotNull(mediaContainerWithMetadata, "mediaContainerWithMetadata");
     ...
     * OK
     */
    public GetMetadataGrandparentResponse withMediaContainerWithMetadata(Optional<? extends MediaContainerWithMetadata> mediaContainerWithMetadata) {
        Utils.checkNotNull(mediaContainerWithMetadata, "mediaContainerWithMetadata");
        this.mediaContainerWithMetadata = mediaContainerWithMetadata;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetMetadataGrandparentResponse other = (GetMetadataGrandparentResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetMetadataGrandparentResponse.class,
    ...
    public final static class Builder {
        ...
        public GetMetadataGrandparentResponse build() {

            return new GetMetadataGrandparentResponse(
                contentType, statusCode, rawResponse,
                mediaContainerWithMetadata);
        }
