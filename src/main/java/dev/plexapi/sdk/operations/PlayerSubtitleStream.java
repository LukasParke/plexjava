...
public class PlayerSubtitleStream {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    this.baseUrl,
                    "/player/playback/subtitleStream");
    ...
    public static class Sync extends Base
            implements RequestOperation<PlayerSubtitleStreamRequest, PlayerSubtitleStreamResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(PlayerSubtitleStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlayerSubtitleStreamRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlayerSubtitleStreamRequest request) {
        ...
        @Override
        public PlayerSubtitleStreamResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlayerSubtitleStreamResponse.Builder resBuilder =
            ...
            PlayerSubtitleStreamResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlayerSubtitleStreamRequest, dev.plexapi.sdk.models.operations.async.PlayerSubtitleStreamResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(PlayerSubtitleStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlayerSubtitleStreamRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlayerSubtitleStreamRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.PlayerSubtitleStreamResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.PlayerSubtitleStreamResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.PlayerSubtitleStreamResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            dev.plexapi.sdk.models.operations.async.PlayerSubtitleStreamResponse res = resBuilder.build();
