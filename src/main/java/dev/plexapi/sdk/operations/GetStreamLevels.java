...
public class GetStreamLevels {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetStreamLevelsRequest, GetStreamLevelsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetStreamLevelsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetStreamLevelsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetStreamLevelsRequest request) {
        ...
        @Override
        public GetStreamLevelsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetStreamLevelsResponse.Builder resBuilder =
            ...
            GetStreamLevelsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<GetStreamLevelsResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetStreamLevelsRequest, dev.plexapi.sdk.models.operations.async.GetStreamLevelsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetStreamLevelsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetStreamLevelsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetStreamLevelsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetStreamLevelsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetStreamLevelsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetStreamLevelsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetStreamLevelsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetStreamLevelsResponseBody>() {})
