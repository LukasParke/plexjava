...
public class CleanBundles {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<CleanBundlesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        @Override
        public CleanBundlesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CleanBundlesResponse.Builder resBuilder =
            ...
            CleanBundlesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<dev.plexapi.sdk.models.operations.async.CleanBundlesResponse> {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.CleanBundlesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.CleanBundlesResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.CleanBundlesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.CleanBundlesResponse res = resBuilder.build();
