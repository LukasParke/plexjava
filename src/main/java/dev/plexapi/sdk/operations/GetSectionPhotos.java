...
public class GetSectionPhotos {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/library/sections/{sectionId}/photos",
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSectionPhotosRequest, GetSectionPhotosResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetSectionPhotosRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSectionPhotosRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSectionPhotosRequest request) {
        ...
        @Override
        public GetSectionPhotosResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSectionPhotosResponse.Builder resBuilder =
            ...
            GetSectionPhotosResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSectionPhotosRequest, dev.plexapi.sdk.models.operations.async.GetSectionPhotosResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSectionPhotosRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSectionPhotosRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSectionPhotosRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetSectionPhotosResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetSectionPhotosResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetSectionPhotosResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetSectionPhotosResponse res = resBuilder.build();
