...
public class DeleteCustomHub {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteCustomHubRequest, DeleteCustomHubResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeleteCustomHubRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteCustomHubRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteCustomHubRequest request) {
        ...
        @Override
        public DeleteCustomHubResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteCustomHubResponse.Builder resBuilder =
            ...
            DeleteCustomHubResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteCustomHubRequest, dev.plexapi.sdk.models.operations.async.DeleteCustomHubResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeleteCustomHubRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteCustomHubRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteCustomHubRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.DeleteCustomHubResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.DeleteCustomHubResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.DeleteCustomHubResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.DeleteCustomHubResponse res = resBuilder.build();
