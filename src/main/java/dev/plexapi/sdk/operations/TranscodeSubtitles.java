...
public class TranscodeSubtitles {
    ...
    public static class Sync extends Base
            implements RequestOperation<TranscodeSubtitlesRequest, TranscodeSubtitlesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(TranscodeSubtitlesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TranscodeSubtitlesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TranscodeSubtitlesRequest request) {
        ...
        @Override
        public TranscodeSubtitlesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            TranscodeSubtitlesResponse.Builder resBuilder =
                    TranscodeSubtitlesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            if (Utils.statusCodeMatches(response.statusCode(), "200") && Utils.contentTypeMatches(contentType, "text/srt")) {
                resBuilder.binaryResponse(response.body());
            }

            TranscodeSubtitlesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "text/srt")) {
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<TranscodeSubtitlesRequest, dev.plexapi.sdk.models.operations.async.TranscodeSubtitlesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(TranscodeSubtitlesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TranscodeSubtitlesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(TranscodeSubtitlesRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.TranscodeSubtitlesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.TranscodeSubtitlesResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.TranscodeSubtitlesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            dev.plexapi.sdk.models.operations.async.TranscodeSubtitlesResponse res = resBuilder.build();
