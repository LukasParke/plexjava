...
public class DeleteLineup {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteLineupRequest, DeleteLineupResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeleteLineupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteLineupRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteLineupRequest request) {
        ...
        @Override
        public DeleteLineupResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteLineupResponse.Builder resBuilder =
            ...
            DeleteLineupResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteLineupRequest, dev.plexapi.sdk.models.operations.async.DeleteLineupResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeleteLineupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteLineupRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteLineupRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.DeleteLineupResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.DeleteLineupResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.DeleteLineupResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.DeleteLineupResponse res = resBuilder.build();
