...
public class DeletePlayQueueItem {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeletePlayQueueItemRequest, DeletePlayQueueItemResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeletePlayQueueItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeletePlayQueueItemRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeletePlayQueueItemRequest request) {
        ...
        @Override
        public DeletePlayQueueItemResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeletePlayQueueItemResponse.Builder resBuilder =
            ...
            DeletePlayQueueItemResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeletePlayQueueItemRequest, dev.plexapi.sdk.models.operations.async.DeletePlayQueueItemResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeletePlayQueueItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeletePlayQueueItemRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeletePlayQueueItemRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.DeletePlayQueueItemResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.DeletePlayQueueItemResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.DeletePlayQueueItemResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.DeletePlayQueueItemResponse res = resBuilder.build();
