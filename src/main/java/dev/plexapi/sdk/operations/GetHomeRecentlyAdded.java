...
public class GetHomeRecentlyAdded {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetHomeRecentlyAddedRequest, GetHomeRecentlyAddedResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetHomeRecentlyAddedRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetHomeRecentlyAddedRequest request) {
        ...
        @Override
        public GetHomeRecentlyAddedResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetHomeRecentlyAddedResponse.Builder resBuilder =
            ...
            GetHomeRecentlyAddedResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetHomeRecentlyAddedRequest, dev.plexapi.sdk.models.operations.async.GetHomeRecentlyAddedResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetHomeRecentlyAddedRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetHomeRecentlyAddedRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetHomeRecentlyAddedResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetHomeRecentlyAddedResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetHomeRecentlyAddedResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetHomeRecentlyAddedResponse res = resBuilder.build();
