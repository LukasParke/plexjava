...
public class TuneChannel {
    ...
    public static class Sync extends Base
            implements RequestOperation<TuneChannelRequest, TuneChannelResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(TuneChannelRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TuneChannelRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TuneChannelRequest request) {
        ...
        @Override
        public TuneChannelResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            TuneChannelResponse.Builder resBuilder =
                    TuneChannelResponse
                            .builder()
            ...
            TuneChannelResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<TuneChannelRequest, dev.plexapi.sdk.models.operations.async.TuneChannelResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(TuneChannelRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TuneChannelRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(TuneChannelRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.TuneChannelResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.TuneChannelResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.TuneChannelResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.TuneChannelResponse res = resBuilder.build();
