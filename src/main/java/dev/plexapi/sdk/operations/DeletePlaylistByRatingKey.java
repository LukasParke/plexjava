...
public class DeletePlaylistByRatingKey {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeletePlaylistByRatingKeyRequest, DeletePlaylistByRatingKeyResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeletePlaylistByRatingKeyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeletePlaylistByRatingKeyRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeletePlaylistByRatingKeyRequest request) {
        ...
        @Override
        public DeletePlaylistByRatingKeyResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeletePlaylistByRatingKeyResponse.Builder resBuilder =
            ...
            DeletePlaylistByRatingKeyResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeletePlaylistByRatingKeyRequest, dev.plexapi.sdk.models.operations.async.DeletePlaylistByRatingKeyResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeletePlaylistByRatingKeyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeletePlaylistByRatingKeyRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeletePlaylistByRatingKeyRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.DeletePlaylistByRatingKeyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.DeletePlaylistByRatingKeyResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.DeletePlaylistByRatingKeyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.DeletePlaylistByRatingKeyResponse res = resBuilder.build();
