...
public class DeleteStream {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteStreamRequest, DeleteStreamResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeleteStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteStreamRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteStreamRequest request) {
        ...
        @Override
        public DeleteStreamResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteStreamResponse.Builder resBuilder =
            ...
            DeleteStreamResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteStreamRequest, dev.plexapi.sdk.models.operations.async.DeleteStreamResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeleteStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteStreamRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteStreamRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.DeleteStreamResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.DeleteStreamResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.DeleteStreamResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.DeleteStreamResponse res = resBuilder.build();
