...
public class UpdateHubVisibility {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateHubVisibilityRequest, UpdateHubVisibilityResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UpdateHubVisibilityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHubVisibilityRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateHubVisibilityRequest request) {
        ...
        @Override
        public UpdateHubVisibilityResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateHubVisibilityResponse.Builder resBuilder =
            ...
            UpdateHubVisibilityResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateHubVisibilityRequest, dev.plexapi.sdk.models.operations.async.UpdateHubVisibilityResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdateHubVisibilityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHubVisibilityRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateHubVisibilityRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.UpdateHubVisibilityResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.UpdateHubVisibilityResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.UpdateHubVisibilityResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.UpdateHubVisibilityResponse res = resBuilder.build();
