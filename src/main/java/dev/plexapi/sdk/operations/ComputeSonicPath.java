...
public class ComputeSonicPath {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/library/metadata/{id}/computePath",
    ...
    public static class Sync extends Base
            implements RequestOperation<ComputeSonicPathRequest, ComputeSonicPathResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ComputeSonicPathRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ComputeSonicPathRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ComputeSonicPathRequest request) {
        ...
        @Override
        public ComputeSonicPathResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ComputeSonicPathResponse.Builder resBuilder =
            ...
            ComputeSonicPathResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ComputeSonicPathRequest, dev.plexapi.sdk.models.operations.async.ComputeSonicPathResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ComputeSonicPathRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ComputeSonicPathRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ComputeSonicPathRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.ComputeSonicPathResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.ComputeSonicPathResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.ComputeSonicPathResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.ComputeSonicPathResponse res = resBuilder.build();
