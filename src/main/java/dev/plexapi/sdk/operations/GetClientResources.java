...
public class GetClientResources {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetClientResourcesRequest, GetClientResourcesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetClientResourcesRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetClientResourcesRequest request) {
        ...
        @Override
        public GetClientResourcesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetClientResourcesResponse.Builder resBuilder =
            ...
            GetClientResourcesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetClientResourcesRequest, dev.plexapi.sdk.models.operations.async.GetClientResourcesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetClientResourcesRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetClientResourcesRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetClientResourcesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetClientResourcesResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetClientResourcesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetClientResourcesResponse res = resBuilder.build();
