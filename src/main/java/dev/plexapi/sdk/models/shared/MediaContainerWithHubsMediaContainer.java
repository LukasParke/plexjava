...
public class MediaContainerWithHubsMediaContainer {
    ...
    @JsonCreator
    public MediaContainerWithHubsMediaContainer(
    ...
    public MediaContainerWithHubsMediaContainer withIdentifier(String identifier) {
        Utils.checkNotNull(identifier, "identifier");
    ...
    public MediaContainerWithHubsMediaContainer withIdentifier(Optional<String> identifier) {
        Utils.checkNotNull(identifier, "identifier");
        this.identifier = identifier;
        return this;
    }
     ...
     * the `X-Plex-Container-Start` header.
     */
    public MediaContainerWithHubsMediaContainer withOffset(long offset) {
        Utils.checkNotNull(offset, "offset");
     ...
     * the `X-Plex-Container-Start` header.
     */
    public MediaContainerWithHubsMediaContainer withOffset(Optional<Long> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }

    public MediaContainerWithHubsMediaContainer withSize(long size) {
        Utils.checkNotNull(size, "size");
    ...
    public MediaContainerWithHubsMediaContainer withSize(Optional<Long> size) {
        Utils.checkNotNull(size, "size");
        this.size = size;
        return this;
    }
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public MediaContainerWithHubsMediaContainer withTotalSize(long totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public MediaContainerWithHubsMediaContainer withTotalSize(Optional<Long> totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
        this.totalSize = totalSize;
        return this;
    }

    public MediaContainerWithHubsMediaContainer withHub(List<Hub> hub) {
        Utils.checkNotNull(hub, "hub");
    ...
    public MediaContainerWithHubsMediaContainer withHub(Optional<? extends List<Hub>> hub) {
        Utils.checkNotNull(hub, "hub");
        this.hub = hub;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        MediaContainerWithHubsMediaContainer other = (MediaContainerWithHubsMediaContainer) o;
        return 
    ...
    public String toString() {
        return Utils.toString(MediaContainerWithHubsMediaContainer.class,
    ...
    public final static class Builder {
        ...
        public MediaContainerWithHubsMediaContainer build() {

            return new MediaContainerWithHubsMediaContainer(
                identifier, offset, size,
                totalSize, hub);
        }
