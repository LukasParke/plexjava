...
public class GetOnDeckForSectionResponse implements Response {
    /**
    ...
    @JsonCreator
    public GetOnDeckForSectionResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public GetOnDeckForSectionResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetOnDeckForSectionResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetOnDeckForSectionResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * On Deck items
     */
    public GetOnDeckForSectionResponse withMediaContainerWithMetadata(MediaContainerWithMetadata mediaContainerWithMetadata) {
        Utils.checkNotNull(mediaContainerWithMetadata, "mediaContainerWithMetadata");
     ...
     * On Deck items
     */
    public GetOnDeckForSectionResponse withMediaContainerWithMetadata(Optional<? extends MediaContainerWithMetadata> mediaContainerWithMetadata) {
        Utils.checkNotNull(mediaContainerWithMetadata, "mediaContainerWithMetadata");
        this.mediaContainerWithMetadata = mediaContainerWithMetadata;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetOnDeckForSectionResponse other = (GetOnDeckForSectionResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetOnDeckForSectionResponse.class,
    ...
    public final static class Builder {
        ...
        public GetOnDeckForSectionResponse build() {

            return new GetOnDeckForSectionResponse(
                contentType, statusCode, rawResponse,
                mediaContainerWithMetadata);
        }
