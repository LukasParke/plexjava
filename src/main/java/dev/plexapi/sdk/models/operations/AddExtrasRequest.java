...
public class AddExtrasRequest {
    ...
    private Optional<Long> extraType;
     ...
     */
    @JsonIgnore
    public Optional<Long> extraType() {
        return extraType;
    }
     ...
     * Indicates the client accepts the indicated media types
     */
    public AddExtrasRequest withAccepts(Accepts accepts) {
        Utils.checkNotNull(accepts, "accepts");
     ...
     * Indicates the client accepts the indicated media types
     */
    public AddExtrasRequest withAccepts(Optional<? extends Accepts> accepts) {
        Utils.checkNotNull(accepts, "accepts");
        this.accepts = accepts;
        return this;
    }
     ...
     * An opaque identifier unique to the client
     */
    public AddExtrasRequest withClientIdentifier(String clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
     ...
     * An opaque identifier unique to the client
     */
    public AddExtrasRequest withClientIdentifier(Optional<String> clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
        this.clientIdentifier = clientIdentifier;
        return this;
    }
     ...
     * The name of the client product
     */
    public AddExtrasRequest withProduct(Optional<String> product) {
        Utils.checkNotNull(product, "product");
        this.product = product;
        return this;
    }
     ...
     * The version of the client application
     */
    public AddExtrasRequest withVersion(String version) {
        Utils.checkNotNull(version, "version");
     ...
     * The version of the client application
     */
    public AddExtrasRequest withVersion(Optional<String> version) {
        Utils.checkNotNull(version, "version");
        this.version = version;
        return this;
    }
     ...
     * The platform of the client
     */
    public AddExtrasRequest withPlatform(String platform) {
        Utils.checkNotNull(platform, "platform");
     ...
     * The platform of the client
     */
    public AddExtrasRequest withPlatform(Optional<String> platform) {
        Utils.checkNotNull(platform, "platform");
        this.platform = platform;
        return this;
    }
     ...
     * The version of the platform
     */
    public AddExtrasRequest withPlatformVersion(String platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
     ...
     * The version of the platform
     */
    public AddExtrasRequest withPlatformVersion(Optional<String> platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
        this.platformVersion = platformVersion;
        return this;
    }
     ...
     * A relatively friendly name for the client device
     */
    public AddExtrasRequest withDevice(String device) {
        Utils.checkNotNull(device, "device");
     ...
     * A relatively friendly name for the client device
     */
    public AddExtrasRequest withDevice(Optional<String> device) {
        Utils.checkNotNull(device, "device");
        this.device = device;
        return this;
    }
     ...
     * A potentially less friendly identifier for the device model
     */
    public AddExtrasRequest withModel(String model) {
        Utils.checkNotNull(model, "model");
     ...
     * A potentially less friendly identifier for the device model
     */
    public AddExtrasRequest withModel(Optional<String> model) {
        Utils.checkNotNull(model, "model");
        this.model = model;
        return this;
    }
     ...
     * The device vendor
     */
    public AddExtrasRequest withDeviceVendor(String deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
     ...
     * The device vendor
     */
    public AddExtrasRequest withDeviceVendor(Optional<String> deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
        this.deviceVendor = deviceVendor;
        return this;
    }
     ...
     * A friendly name for the client
     */
    public AddExtrasRequest withDeviceName(String deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
     ...
     * A friendly name for the client
     */
    public AddExtrasRequest withDeviceName(Optional<String> deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
        this.deviceName = deviceName;
        return this;
    }
     ...
     * The marketplace on which the client application is distributed
     */
    public AddExtrasRequest withMarketplace(String marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
     ...
     * The marketplace on which the client application is distributed
     */
    public AddExtrasRequest withMarketplace(Optional<String> marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
        this.marketplace = marketplace;
        return this;
    }
     ...
     * The metadata type of the extra
     */
    public AddExtrasRequest withExtraType(long extraType) {
        Utils.checkNotNull(extraType, "extraType");
        this.extraType = Optional.ofNullable(extraType);
        return this;
    }
     ...
     * The metadata type of the extra
     */
    public AddExtrasRequest withExtraType(Optional<Long> extraType) {
        Utils.checkNotNull(extraType, "extraType");
        this.extraType = extraType;
        return this;
    }
     ...
     * The URL of the extra
     */
    public AddExtrasRequest withUrl(String url) {
        Utils.checkNotNull(url, "url");
        this.url = url;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AddExtrasRequest other = (AddExtrasRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AddExtrasRequest.class,
                "accepts", accepts,
    ...
    public final static class Builder {
         ...
         * The metadata type of the extra
         */
        public Builder extraType(long extraType) {
            Utils.checkNotNull(extraType, "extraType");
            this.extraType = Optional.ofNullable(extraType);
            return this;
        }
         ...
         * The metadata type of the extra
         */
        public Builder extraType(Optional<Long> extraType) {
            Utils.checkNotNull(extraType, "extraType");
            this.extraType = extraType;
            return this;
        }
