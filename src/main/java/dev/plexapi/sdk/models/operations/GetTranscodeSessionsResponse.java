...
public class GetTranscodeSessionsResponse implements Response {
    /**
    ...
    @JsonCreator
    public GetTranscodeSessionsResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response status code for this operation
     */
    public GetTranscodeSessionsResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetTranscodeSessionsResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public GetTranscodeSessionsResponse withMediaContainerWithMetadata(MediaContainerWithMetadata mediaContainerWithMetadata) {
        Utils.checkNotNull(mediaContainerWithMetadata, "mediaContainerWithMetadata");
     ...
     * OK
     */
    public GetTranscodeSessionsResponse withMediaContainerWithMetadata(Optional<? extends MediaContainerWithMetadata> mediaContainerWithMetadata) {
        Utils.checkNotNull(mediaContainerWithMetadata, "mediaContainerWithMetadata");
        this.mediaContainerWithMetadata = mediaContainerWithMetadata;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetTranscodeSessionsResponse other = (GetTranscodeSessionsResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetTranscodeSessionsResponse.class,
    ...
    public final static class Builder {
        ...
        public GetTranscodeSessionsResponse build() {
            ...
            return new GetTranscodeSessionsResponse(
                contentType, statusCode, rawResponse,
                mediaContainerWithMetadata);
        }
