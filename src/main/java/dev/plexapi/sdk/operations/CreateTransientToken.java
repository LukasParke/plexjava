...
import dev.plexapi.sdk.models.operations.CreateTransientTokenResponseBody;
...
public class CreateTransientToken {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateTransientTokenRequest, CreateTransientTokenResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CreateTransientTokenRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateTransientTokenRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateTransientTokenRequest request) {
        ...
        @Override
        public CreateTransientTokenResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateTransientTokenResponse.Builder resBuilder =
            ...
            CreateTransientTokenResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<CreateTransientTokenResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateTransientTokenRequest, dev.plexapi.sdk.models.operations.async.CreateTransientTokenResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CreateTransientTokenRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateTransientTokenRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateTransientTokenRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.CreateTransientTokenResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.CreateTransientTokenResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.CreateTransientTokenResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.CreateTransientTokenResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateTransientTokenResponseBody>() {})
