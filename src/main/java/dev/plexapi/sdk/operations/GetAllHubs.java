...
public class GetAllHubs {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAllHubsRequest, GetAllHubsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetAllHubsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAllHubsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAllHubsRequest request) {
        ...
        @Override
        public GetAllHubsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAllHubsResponse.Builder resBuilder =
                    GetAllHubsResponse
                            .builder()
            ...
            GetAllHubsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAllHubsRequest, dev.plexapi.sdk.models.operations.async.GetAllHubsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetAllHubsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAllHubsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAllHubsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetAllHubsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetAllHubsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetAllHubsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetAllHubsResponse res = resBuilder.build();
