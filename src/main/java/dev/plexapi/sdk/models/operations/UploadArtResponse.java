...
public class UploadArtResponse implements Response {
    /**
     ...
     * HTTP response content type for this operation
     */
    public UploadArtResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public UploadArtResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public UploadArtResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public UploadArtResponse withSuccessResponse(SuccessResponse successResponse) {
        Utils.checkNotNull(successResponse, "successResponse");
     ...
     * OK
     */
    public UploadArtResponse withSuccessResponse(Optional<? extends SuccessResponse> successResponse) {
        Utils.checkNotNull(successResponse, "successResponse");
        this.successResponse = successResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UploadArtResponse other = (UploadArtResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UploadArtResponse.class,
    ...
    public final static class Builder {
        ...
        public UploadArtResponse build() {

            return new UploadArtResponse(
                contentType, statusCode, rawResponse,
                successResponse);
        }
