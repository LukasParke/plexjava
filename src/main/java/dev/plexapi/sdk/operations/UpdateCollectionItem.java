...
public class UpdateCollectionItem {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCollectionItemRequest, UpdateCollectionItemResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UpdateCollectionItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCollectionItemRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCollectionItemRequest request) {
        ...
        @Override
        public UpdateCollectionItemResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateCollectionItemResponse.Builder resBuilder =
            ...
            UpdateCollectionItemResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCollectionItemRequest, dev.plexapi.sdk.models.operations.async.UpdateCollectionItemResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCollectionItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCollectionItemRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCollectionItemRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.UpdateCollectionItemResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.UpdateCollectionItemResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.UpdateCollectionItemResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.UpdateCollectionItemResponse res = resBuilder.build();
