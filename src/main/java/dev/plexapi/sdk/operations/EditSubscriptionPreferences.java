...
public class EditSubscriptionPreferences {
    ...
    public static class Sync extends Base
            implements RequestOperation<EditSubscriptionPreferencesRequest, EditSubscriptionPreferencesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(EditSubscriptionPreferencesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EditSubscriptionPreferencesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(EditSubscriptionPreferencesRequest request) {
        ...
        @Override
        public EditSubscriptionPreferencesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            EditSubscriptionPreferencesResponse.Builder resBuilder =
            ...
            EditSubscriptionPreferencesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMediaContainerWithSubscription(Utils.unmarshal(response, new TypeReference<MediaContainerWithSubscription>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<EditSubscriptionPreferencesRequest, dev.plexapi.sdk.models.operations.async.EditSubscriptionPreferencesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(EditSubscriptionPreferencesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EditSubscriptionPreferencesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(EditSubscriptionPreferencesRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.EditSubscriptionPreferencesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.EditSubscriptionPreferencesResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.EditSubscriptionPreferencesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.EditSubscriptionPreferencesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MediaContainerWithSubscription>() {})
                            .thenApply(res::withMediaContainerWithSubscription);
                } else {
