...
public class DetectAds {
    ...
    public static class Sync extends Base
            implements RequestOperation<DetectAdsRequest, DetectAdsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DetectAdsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DetectAdsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DetectAdsRequest request) {
        ...
        @Override
        public DetectAdsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DetectAdsResponse.Builder resBuilder =
                    DetectAdsResponse
                            .builder()
            ...
            DetectAdsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DetectAdsRequest, dev.plexapi.sdk.models.operations.async.DetectAdsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DetectAdsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DetectAdsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DetectAdsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.DetectAdsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.DetectAdsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.DetectAdsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.DetectAdsResponse res = resBuilder.build();
