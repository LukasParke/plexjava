...
public class StopTasks {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<StopTasksResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        @Override
        public StopTasksResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            StopTasksResponse.Builder resBuilder =
                    StopTasksResponse
                            .builder()
            ...
            StopTasksResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<dev.plexapi.sdk.models.operations.async.StopTasksResponse> {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.StopTasksResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.StopTasksResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.StopTasksResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.StopTasksResponse res = resBuilder.build();
