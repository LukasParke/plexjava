...
public class AddCollectionItems {
    ...
    public static class Sync extends Base
            implements RequestOperation<AddCollectionItemsRequest, AddCollectionItemsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AddCollectionItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddCollectionItemsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddCollectionItemsRequest request) {
        ...
        @Override
        public AddCollectionItemsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AddCollectionItemsResponse.Builder resBuilder =
            ...
            AddCollectionItemsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AddCollectionItemsRequest, dev.plexapi.sdk.models.operations.async.AddCollectionItemsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AddCollectionItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddCollectionItemsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AddCollectionItemsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.AddCollectionItemsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.AddCollectionItemsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.AddCollectionItemsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.AddCollectionItemsResponse res = resBuilder.build();
