...
public class ClearPlayQueue {
    ...
    public static class Sync extends Base
            implements RequestOperation<ClearPlayQueueRequest, ClearPlayQueueResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ClearPlayQueueRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ClearPlayQueueRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ClearPlayQueueRequest request) {
        ...
        @Override
        public ClearPlayQueueResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ClearPlayQueueResponse.Builder resBuilder =
            ...
            ClearPlayQueueResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ClearPlayQueueRequest, dev.plexapi.sdk.models.operations.async.ClearPlayQueueResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ClearPlayQueueRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ClearPlayQueueRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ClearPlayQueueRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.ClearPlayQueueResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.ClearPlayQueueResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.ClearPlayQueueResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.ClearPlayQueueResponse res = resBuilder.build();
