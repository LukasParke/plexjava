...
public class DeletePlaylist {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeletePlaylistRequest, DeletePlaylistResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeletePlaylistRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeletePlaylistRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeletePlaylistRequest request) {
        ...
        @Override
        public DeletePlaylistResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeletePlaylistResponse.Builder resBuilder =
            ...
            DeletePlaylistResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeletePlaylistRequest, dev.plexapi.sdk.models.operations.async.DeletePlaylistResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeletePlaylistRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeletePlaylistRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeletePlaylistRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.DeletePlaylistResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.DeletePlaylistResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.DeletePlaylistResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.DeletePlaylistResponse res = resBuilder.build();
