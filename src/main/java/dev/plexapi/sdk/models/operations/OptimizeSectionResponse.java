...
public class OptimizeSectionResponse implements Response {
    /**
    ...
    @JsonCreator
    public OptimizeSectionResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public OptimizeSectionResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public OptimizeSectionResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public OptimizeSectionResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public OptimizeSectionResponse withSuccessResponse(SuccessResponse successResponse) {
        Utils.checkNotNull(successResponse, "successResponse");
     ...
     * OK
     */
    public OptimizeSectionResponse withSuccessResponse(Optional<? extends SuccessResponse> successResponse) {
        Utils.checkNotNull(successResponse, "successResponse");
        this.successResponse = successResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        OptimizeSectionResponse other = (OptimizeSectionResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(OptimizeSectionResponse.class,
    ...
    public final static class Builder {
        ...
        public OptimizeSectionResponse build() {

            return new OptimizeSectionResponse(
                contentType, statusCode, rawResponse,
                successResponse);
        }
