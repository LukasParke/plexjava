...
public class UpdateItemArtwork {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateItemArtworkRequest, UpdateItemArtworkResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UpdateItemArtworkRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateItemArtworkRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateItemArtworkRequest request) {
        ...
        @Override
        public UpdateItemArtworkResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateItemArtworkResponse.Builder resBuilder =
            ...
            UpdateItemArtworkResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateItemArtworkRequest, dev.plexapi.sdk.models.operations.async.UpdateItemArtworkResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdateItemArtworkRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateItemArtworkRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateItemArtworkRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.UpdateItemArtworkResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.UpdateItemArtworkResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.UpdateItemArtworkResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.UpdateItemArtworkResponse res = resBuilder.build();
