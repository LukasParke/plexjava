...
public class SetPreferences {
    ...
    public static class Sync extends Base
            implements RequestOperation<SetPreferencesRequest, SetPreferencesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(SetPreferencesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SetPreferencesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(SetPreferencesRequest request) {
        ...
        @Override
        public SetPreferencesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            SetPreferencesResponse.Builder resBuilder =
            ...
            SetPreferencesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SetPreferencesRequest, dev.plexapi.sdk.models.operations.async.SetPreferencesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(SetPreferencesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SetPreferencesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(SetPreferencesRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.SetPreferencesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.SetPreferencesResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.SetPreferencesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.SetPreferencesResponse res = resBuilder.build();
