...
public class GetDVRRecordings {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetDVRRecordingsRequest, GetDVRRecordingsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetDVRRecordingsRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetDVRRecordingsRequest request) {
        ...
        @Override
        public GetDVRRecordingsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetDVRRecordingsResponse.Builder resBuilder =
            ...
            GetDVRRecordingsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetDVRRecordingsRequest, dev.plexapi.sdk.models.operations.async.GetDVRRecordingsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetDVRRecordingsRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetDVRRecordingsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetDVRRecordingsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetDVRRecordingsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetDVRRecordingsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetDVRRecordingsResponse res = resBuilder.build();
