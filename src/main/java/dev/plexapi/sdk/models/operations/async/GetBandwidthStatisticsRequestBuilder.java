...
public class GetBandwidthStatisticsRequestBuilder {
    ...
    private GetBandwidthStatisticsRequest request;
    ...
    public GetBandwidthStatisticsRequestBuilder request(GetBandwidthStatisticsRequest request) {
    ...
    public CompletableFuture<GetBandwidthStatisticsResponse> call() {
