...
import dev.plexapi.sdk.models.operations.CreateMarkerResponseBody;
...
public class CreateMarker {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateMarkerRequest, CreateMarkerResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CreateMarkerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateMarkerRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateMarkerRequest request) {
        ...
        @Override
        public CreateMarkerResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateMarkerResponse.Builder resBuilder =
            ...
            CreateMarkerResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<CreateMarkerResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateMarkerRequest, dev.plexapi.sdk.models.operations.async.CreateMarkerResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CreateMarkerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateMarkerRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateMarkerRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.CreateMarkerResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.CreateMarkerResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.CreateMarkerResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.CreateMarkerResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateMarkerResponseBody>() {})
