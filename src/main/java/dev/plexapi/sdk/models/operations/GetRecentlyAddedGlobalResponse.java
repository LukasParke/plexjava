...
public class GetRecentlyAddedGlobalResponse implements Response {
    /**
    ...
    @JsonCreator
    public GetRecentlyAddedGlobalResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public GetRecentlyAddedGlobalResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetRecentlyAddedGlobalResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetRecentlyAddedGlobalResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Recently added items
     */
    public GetRecentlyAddedGlobalResponse withMediaContainerWithMetadata(MediaContainerWithMetadata mediaContainerWithMetadata) {
        Utils.checkNotNull(mediaContainerWithMetadata, "mediaContainerWithMetadata");
     ...
     * Recently added items
     */
    public GetRecentlyAddedGlobalResponse withMediaContainerWithMetadata(Optional<? extends MediaContainerWithMetadata> mediaContainerWithMetadata) {
        Utils.checkNotNull(mediaContainerWithMetadata, "mediaContainerWithMetadata");
        this.mediaContainerWithMetadata = mediaContainerWithMetadata;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetRecentlyAddedGlobalResponse other = (GetRecentlyAddedGlobalResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetRecentlyAddedGlobalResponse.class,
    ...
    public final static class Builder {
        ...
        public GetRecentlyAddedGlobalResponse build() {

            return new GetRecentlyAddedGlobalResponse(
                contentType, statusCode, rawResponse,
                mediaContainerWithMetadata);
        }
