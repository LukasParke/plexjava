...
public class PlayerMute {
    ...
    public static class Sync extends Base
            implements RequestOperation<PlayerMuteRequest, PlayerMuteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(PlayerMuteRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlayerMuteRequest request) {
        ...
        @Override
        public PlayerMuteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlayerMuteResponse.Builder resBuilder =
                    PlayerMuteResponse
                            .builder()
            ...
            PlayerMuteResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlayerMuteRequest, dev.plexapi.sdk.models.operations.async.PlayerMuteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(PlayerMuteRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlayerMuteRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.PlayerMuteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.PlayerMuteResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.PlayerMuteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.PlayerMuteResponse res = resBuilder.build();
