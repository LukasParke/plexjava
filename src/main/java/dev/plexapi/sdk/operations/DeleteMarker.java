...
public class DeleteMarker {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteMarkerRequest, DeleteMarkerResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeleteMarkerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteMarkerRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteMarkerRequest request) {
        ...
        @Override
        public DeleteMarkerResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteMarkerResponse.Builder resBuilder =
            ...
            DeleteMarkerResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteMarkerRequest, dev.plexapi.sdk.models.operations.async.DeleteMarkerResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeleteMarkerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteMarkerRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteMarkerRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.DeleteMarkerResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.DeleteMarkerResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.DeleteMarkerResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.DeleteMarkerResponse res = resBuilder.build();
