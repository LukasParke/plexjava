...
public class BrowseFilesystemPathResponse implements Response {
    /**
    ...
    @JsonCreator
    public BrowseFilesystemPathResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public BrowseFilesystemPathResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public BrowseFilesystemPathResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public BrowseFilesystemPathResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public BrowseFilesystemPathResponse withMediaContainerWithDirectory(MediaContainerWithDirectory mediaContainerWithDirectory) {
        Utils.checkNotNull(mediaContainerWithDirectory, "mediaContainerWithDirectory");
     ...
     * OK
     */
    public BrowseFilesystemPathResponse withMediaContainerWithDirectory(Optional<? extends MediaContainerWithDirectory> mediaContainerWithDirectory) {
        Utils.checkNotNull(mediaContainerWithDirectory, "mediaContainerWithDirectory");
        this.mediaContainerWithDirectory = mediaContainerWithDirectory;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        BrowseFilesystemPathResponse other = (BrowseFilesystemPathResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(BrowseFilesystemPathResponse.class,
    ...
    public final static class Builder {
        ...
        public BrowseFilesystemPathResponse build() {

            return new BrowseFilesystemPathResponse(
                contentType, statusCode, rawResponse,
                mediaContainerWithDirectory);
        }
