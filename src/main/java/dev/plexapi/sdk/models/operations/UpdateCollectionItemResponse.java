...
public class UpdateCollectionItemResponse implements Response {
    /**
    ...
    @JsonCreator
    public UpdateCollectionItemResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public UpdateCollectionItemResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public UpdateCollectionItemResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public UpdateCollectionItemResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public UpdateCollectionItemResponse withMediaContainerWithMetadata(MediaContainerWithMetadata mediaContainerWithMetadata) {
        Utils.checkNotNull(mediaContainerWithMetadata, "mediaContainerWithMetadata");
     ...
     * OK
     */
    public UpdateCollectionItemResponse withMediaContainerWithMetadata(Optional<? extends MediaContainerWithMetadata> mediaContainerWithMetadata) {
        Utils.checkNotNull(mediaContainerWithMetadata, "mediaContainerWithMetadata");
        this.mediaContainerWithMetadata = mediaContainerWithMetadata;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateCollectionItemResponse other = (UpdateCollectionItemResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdateCollectionItemResponse.class,
    ...
    public final static class Builder {
        ...
        public UpdateCollectionItemResponse build() {
