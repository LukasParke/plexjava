...
public class CreateTransientTokenMediaContainer {
    ...
    @JsonCreator
    public CreateTransientTokenMediaContainer(
    ...
    public CreateTransientTokenMediaContainer withIdentifier(String identifier) {
        Utils.checkNotNull(identifier, "identifier");
    ...
    public CreateTransientTokenMediaContainer withIdentifier(Optional<String> identifier) {
        Utils.checkNotNull(identifier, "identifier");
        this.identifier = identifier;
        return this;
    }
     ...
     * the `X-Plex-Container-Start` header.
     */
    public CreateTransientTokenMediaContainer withOffset(long offset) {
        Utils.checkNotNull(offset, "offset");
     ...
     * the `X-Plex-Container-Start` header.
     */
    public CreateTransientTokenMediaContainer withOffset(Optional<Long> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }

    public CreateTransientTokenMediaContainer withSize(long size) {
        Utils.checkNotNull(size, "size");
    ...
    public CreateTransientTokenMediaContainer withSize(Optional<Long> size) {
        Utils.checkNotNull(size, "size");
        this.size = size;
        return this;
    }
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public CreateTransientTokenMediaContainer withTotalSize(long totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public CreateTransientTokenMediaContainer withTotalSize(Optional<Long> totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
        this.totalSize = totalSize;
        return this;
    }
     ...
     * The transient token
     */
    public CreateTransientTokenMediaContainer withToken(String token) {
        Utils.checkNotNull(token, "token");
     ...
     * The transient token
     */
    public CreateTransientTokenMediaContainer withToken(Optional<String> token) {
        Utils.checkNotNull(token, "token");
        this.token = token;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateTransientTokenMediaContainer other = (CreateTransientTokenMediaContainer) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateTransientTokenMediaContainer.class,
    ...
    public final static class Builder {
        ...
        public CreateTransientTokenMediaContainer build() {

            return new CreateTransientTokenMediaContainer(
                identifier, offset, size,
                totalSize, token);
        }
