...
public class StartAnalysis {
    ...
    public static class Sync extends Base
            implements RequestOperation<StartAnalysisRequest, StartAnalysisResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(StartAnalysisRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StartAnalysisRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(StartAnalysisRequest request) {
        ...
        @Override
        public StartAnalysisResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            StartAnalysisResponse.Builder resBuilder =
            ...
            StartAnalysisResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<StartAnalysisRequest, dev.plexapi.sdk.models.operations.async.StartAnalysisResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(StartAnalysisRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StartAnalysisRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(StartAnalysisRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.StartAnalysisResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.StartAnalysisResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.StartAnalysisResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.StartAnalysisResponse res = resBuilder.build();
