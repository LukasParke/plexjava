...
public class GetArts {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetArtsRequest, GetArtsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetArtsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetArtsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetArtsRequest request) {
        ...
        @Override
        public GetArtsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetArtsResponse.Builder resBuilder =
                    GetArtsResponse
                            .builder()
            ...
            GetArtsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetArtsRequest, dev.plexapi.sdk.models.operations.async.GetArtsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetArtsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetArtsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetArtsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetArtsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetArtsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetArtsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetArtsResponse res = resBuilder.build();
