...
public class GetDeviceDetails {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetDeviceDetailsRequest, GetDeviceDetailsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetDeviceDetailsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDeviceDetailsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetDeviceDetailsRequest request) {
        ...
        @Override
        public GetDeviceDetailsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetDeviceDetailsResponse.Builder resBuilder =
            ...
            GetDeviceDetailsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMediaContainerWithDevice(Utils.unmarshal(response, new TypeReference<MediaContainerWithDevice>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetDeviceDetailsRequest, dev.plexapi.sdk.models.operations.async.GetDeviceDetailsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetDeviceDetailsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDeviceDetailsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetDeviceDetailsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetDeviceDetailsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetDeviceDetailsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetDeviceDetailsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetDeviceDetailsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MediaContainerWithDevice>() {})
                            .thenApply(res::withMediaContainerWithDevice);
                } else {
