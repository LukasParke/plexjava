...
public class UnmatchSectionItems {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/library/sections/{sectionId}/unmatch",
    ...
    public static class Sync extends Base
            implements RequestOperation<UnmatchSectionItemsRequest, UnmatchSectionItemsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UnmatchSectionItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UnmatchSectionItemsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UnmatchSectionItemsRequest request) {
        ...
        @Override
        public UnmatchSectionItemsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UnmatchSectionItemsResponse.Builder resBuilder =
            ...
            UnmatchSectionItemsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UnmatchSectionItemsRequest, dev.plexapi.sdk.models.operations.async.UnmatchSectionItemsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UnmatchSectionItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UnmatchSectionItemsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UnmatchSectionItemsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.UnmatchSectionItemsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.UnmatchSectionItemsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.UnmatchSectionItemsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.UnmatchSectionItemsResponse res = resBuilder.build();
