...
public class PlayerPlayMediaResponse implements Response {
    /**
    ...
    @JsonCreator
    public PlayerPlayMediaResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public PlayerPlayMediaResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public PlayerPlayMediaResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public PlayerPlayMediaResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public PlayerPlayMediaResponse withSuccessResponse(SuccessResponse successResponse) {
        Utils.checkNotNull(successResponse, "successResponse");
     ...
     * OK
     */
    public PlayerPlayMediaResponse withSuccessResponse(Optional<? extends SuccessResponse> successResponse) {
        Utils.checkNotNull(successResponse, "successResponse");
        this.successResponse = successResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PlayerPlayMediaResponse other = (PlayerPlayMediaResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PlayerPlayMediaResponse.class,
    ...
    public final static class Builder {
        ...
        public PlayerPlayMediaResponse build() {

            return new PlayerPlayMediaResponse(
                contentType, statusCode, rawResponse,
                successResponse);
        }
