...
public class UploadArt {
    ...
    public static class Sync extends Base
            implements RequestOperation<UploadArtRequest, UploadArtResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UploadArtRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UploadArtRequest.class, new TypeReference<UploadArtRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UploadArtRequest request) {
        ...
        @Override
        public UploadArtResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UploadArtResponse.Builder resBuilder =
                    UploadArtResponse
                            .builder()
            ...
            UploadArtResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UploadArtRequest, dev.plexapi.sdk.models.operations.async.UploadArtResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UploadArtRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UploadArtRequest.class, new TypeReference<UploadArtRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UploadArtRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.UploadArtResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.UploadArtResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.UploadArtResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.UploadArtResponse res = resBuilder.build();
