...
public class GetSystemSettings {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSystemSettingsRequest, GetSystemSettingsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetSystemSettingsRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSystemSettingsRequest request) {
        ...
        @Override
        public GetSystemSettingsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSystemSettingsResponse.Builder resBuilder =
            ...
            GetSystemSettingsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSystemSettingsRequest, dev.plexapi.sdk.models.operations.async.GetSystemSettingsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSystemSettingsRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSystemSettingsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetSystemSettingsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetSystemSettingsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetSystemSettingsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetSystemSettingsResponse res = resBuilder.build();
