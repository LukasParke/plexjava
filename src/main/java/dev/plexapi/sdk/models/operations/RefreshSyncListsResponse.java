...
public class RefreshSyncListsResponse implements Response {
    /**
    ...
    @JsonCreator
    public RefreshSyncListsResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public RefreshSyncListsResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public RefreshSyncListsResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public RefreshSyncListsResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public RefreshSyncListsResponse withSuccessResponse(SuccessResponse successResponse) {
        Utils.checkNotNull(successResponse, "successResponse");
     ...
     * OK
     */
    public RefreshSyncListsResponse withSuccessResponse(Optional<? extends SuccessResponse> successResponse) {
        Utils.checkNotNull(successResponse, "successResponse");
        this.successResponse = successResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        RefreshSyncListsResponse other = (RefreshSyncListsResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(RefreshSyncListsResponse.class,
    ...
    public final static class Builder {
        ...
        public RefreshSyncListsResponse build() {

            return new RefreshSyncListsResponse(
                contentType, statusCode, rawResponse,
                successResponse);
        }
