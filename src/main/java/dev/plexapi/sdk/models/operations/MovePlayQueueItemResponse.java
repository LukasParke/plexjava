...
public class MovePlayQueueItemResponse implements Response {
    /**
    ...
    @JsonCreator
    public MovePlayQueueItemResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public MovePlayQueueItemResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public MovePlayQueueItemResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public MovePlayQueueItemResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Successfully updated move an item in a play queue
     */
    public MovePlayQueueItemResponse withMediaContainerWithPlaylistMetadata(MediaContainerWithPlaylistMetadata mediaContainerWithPlaylistMetadata) {
        Utils.checkNotNull(mediaContainerWithPlaylistMetadata, "mediaContainerWithPlaylistMetadata");
     ...
     * Successfully updated move an item in a play queue
     */
    public MovePlayQueueItemResponse withMediaContainerWithPlaylistMetadata(Optional<? extends MediaContainerWithPlaylistMetadata> mediaContainerWithPlaylistMetadata) {
        Utils.checkNotNull(mediaContainerWithPlaylistMetadata, "mediaContainerWithPlaylistMetadata");
        this.mediaContainerWithPlaylistMetadata = mediaContainerWithPlaylistMetadata;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        MovePlayQueueItemResponse other = (MovePlayQueueItemResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(MovePlayQueueItemResponse.class,
    ...
    public final static class Builder {
        ...
        public MovePlayQueueItemResponse build() {

            return new MovePlayQueueItemResponse(
                contentType, statusCode, rawResponse,
                mediaContainerWithPlaylistMetadata);
        }
