...
import dev.plexapi.sdk.models.operations.GetTagsResponseBody;
...
public class GetTags {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTagsRequest, GetTagsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetTagsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTagsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTagsRequest request) {
        ...
        @Override
        public GetTagsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetTagsResponse.Builder resBuilder =
                    GetTagsResponse
                            .builder()
            ...
            GetTagsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<GetTagsResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTagsRequest, dev.plexapi.sdk.models.operations.async.GetTagsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetTagsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTagsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTagsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetTagsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetTagsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetTagsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetTagsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetTagsResponseBody>() {})
