...
public class GetSonicallySimilar {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSonicallySimilarRequest, GetSonicallySimilarResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetSonicallySimilarRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSonicallySimilarRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSonicallySimilarRequest request) {
        ...
        @Override
        public GetSonicallySimilarResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSonicallySimilarResponse.Builder resBuilder =
            ...
            GetSonicallySimilarResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSonicallySimilarRequest, dev.plexapi.sdk.models.operations.async.GetSonicallySimilarResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSonicallySimilarRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSonicallySimilarRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSonicallySimilarRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetSonicallySimilarResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetSonicallySimilarResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetSonicallySimilarResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetSonicallySimilarResponse res = resBuilder.build();
