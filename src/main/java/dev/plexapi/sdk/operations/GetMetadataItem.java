...
public class GetMetadataItem {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetMetadataItemRequest, GetMetadataItemResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetMetadataItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMetadataItemRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetMetadataItemRequest request) {
        ...
        @Override
        public GetMetadataItemResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetMetadataItemResponse.Builder resBuilder =
            ...
            GetMetadataItemResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetMetadataItemRequest, dev.plexapi.sdk.models.operations.async.GetMetadataItemResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetMetadataItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMetadataItemRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetMetadataItemRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetMetadataItemResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetMetadataItemResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetMetadataItemResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetMetadataItemResponse res = resBuilder.build();
