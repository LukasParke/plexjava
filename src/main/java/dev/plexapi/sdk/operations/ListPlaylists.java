...
public class ListPlaylists {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListPlaylistsRequest, ListPlaylistsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListPlaylistsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPlaylistsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListPlaylistsRequest request) {
        ...
        @Override
        public ListPlaylistsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListPlaylistsResponse.Builder resBuilder =
            ...
            ListPlaylistsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListPlaylistsRequest, dev.plexapi.sdk.models.operations.async.ListPlaylistsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListPlaylistsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPlaylistsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListPlaylistsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.ListPlaylistsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.ListPlaylistsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.ListPlaylistsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.ListPlaylistsResponse res = resBuilder.build();
