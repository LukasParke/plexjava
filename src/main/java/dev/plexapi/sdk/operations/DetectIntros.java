...
public class DetectIntros {
    ...
    public static class Sync extends Base
            implements RequestOperation<DetectIntrosRequest, DetectIntrosResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DetectIntrosRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DetectIntrosRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DetectIntrosRequest request) {
        ...
        @Override
        public DetectIntrosResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DetectIntrosResponse.Builder resBuilder =
            ...
            DetectIntrosResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DetectIntrosRequest, dev.plexapi.sdk.models.operations.async.DetectIntrosResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DetectIntrosRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DetectIntrosRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DetectIntrosRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.DetectIntrosResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.DetectIntrosResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.DetectIntrosResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.DetectIntrosResponse res = resBuilder.build();
