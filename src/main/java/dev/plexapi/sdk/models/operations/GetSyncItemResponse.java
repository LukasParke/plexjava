...
public class GetSyncItemResponse implements Response {
    /**
     ...
     * HTTP response content type for this operation
     */
    public GetSyncItemResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetSyncItemResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetSyncItemResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public GetSyncItemResponse withMediaContainerWithDirectory(MediaContainerWithDirectory mediaContainerWithDirectory) {
        Utils.checkNotNull(mediaContainerWithDirectory, "mediaContainerWithDirectory");
     ...
     * OK
     */
    public GetSyncItemResponse withMediaContainerWithDirectory(Optional<? extends MediaContainerWithDirectory> mediaContainerWithDirectory) {
        Utils.checkNotNull(mediaContainerWithDirectory, "mediaContainerWithDirectory");
        this.mediaContainerWithDirectory = mediaContainerWithDirectory;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetSyncItemResponse other = (GetSyncItemResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetSyncItemResponse.class,
    ...
    public final static class Builder {
        ...
        public GetSyncItemResponse build() {

            return new GetSyncItemResponse(
                contentType, statusCode, rawResponse,
                mediaContainerWithDirectory);
        }
