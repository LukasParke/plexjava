...
public class DVRResponseMediaContainerMediaContainer {
    ...
    @JsonCreator
    public DVRResponseMediaContainerMediaContainer(
    ...
    public DVRResponseMediaContainerMediaContainer withIdentifier(String identifier) {
        Utils.checkNotNull(identifier, "identifier");
    ...
    public DVRResponseMediaContainerMediaContainer withIdentifier(Optional<String> identifier) {
        Utils.checkNotNull(identifier, "identifier");
        this.identifier = identifier;
        return this;
    }
     ...
     * the `X-Plex-Container-Start` header.
     */
    public DVRResponseMediaContainerMediaContainer withOffset(long offset) {
        Utils.checkNotNull(offset, "offset");
     ...
     * the `X-Plex-Container-Start` header.
     */
    public DVRResponseMediaContainerMediaContainer withOffset(Optional<Long> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }

    public DVRResponseMediaContainerMediaContainer withSize(long size) {
        Utils.checkNotNull(size, "size");
    ...
    public DVRResponseMediaContainerMediaContainer withSize(Optional<Long> size) {
        Utils.checkNotNull(size, "size");
        this.size = size;
        return this;
    }
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public DVRResponseMediaContainerMediaContainer withTotalSize(long totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public DVRResponseMediaContainerMediaContainer withTotalSize(Optional<Long> totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
        this.totalSize = totalSize;
        return this;
    }
     ...
     * A status indicator. If present and non-zero, indicates an error
     */
    public DVRResponseMediaContainerMediaContainer withStatus(long status) {
        Utils.checkNotNull(status, "status");
     ...
     * A status indicator. If present and non-zero, indicates an error
     */
    public DVRResponseMediaContainerMediaContainer withStatus(Optional<Long> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DVRResponseMediaContainerMediaContainer other = (DVRResponseMediaContainerMediaContainer) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DVRResponseMediaContainerMediaContainer.class,
    ...
    public final static class Builder {
        ...
        public DVRResponseMediaContainerMediaContainer build() {

            return new DVRResponseMediaContainerMediaContainer(
                identifier, offset, size,
                totalSize, status);
        }
