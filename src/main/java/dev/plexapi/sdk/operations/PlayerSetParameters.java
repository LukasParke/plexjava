...
public class PlayerSetParameters {
    ...
    public static class Sync extends Base
            implements RequestOperation<PlayerSetParametersRequest, PlayerSetParametersResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(PlayerSetParametersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlayerSetParametersRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlayerSetParametersRequest request) {
        ...
        @Override
        public PlayerSetParametersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlayerSetParametersResponse.Builder resBuilder =
            ...
            PlayerSetParametersResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlayerSetParametersRequest, dev.plexapi.sdk.models.operations.async.PlayerSetParametersResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(PlayerSetParametersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlayerSetParametersRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlayerSetParametersRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.PlayerSetParametersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.PlayerSetParametersResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.PlayerSetParametersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.PlayerSetParametersResponse res = resBuilder.build();
