...
public class WriteMessage {
    ...
    public static class Sync extends Base
            implements RequestOperation<WriteMessageRequest, WriteMessageResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(WriteMessageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, WriteMessageRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(WriteMessageRequest request) {
        ...
        @Override
        public WriteMessageResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            WriteMessageResponse.Builder resBuilder =
            ...
            WriteMessageResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<WriteMessageRequest, dev.plexapi.sdk.models.operations.async.WriteMessageResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(WriteMessageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, WriteMessageRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(WriteMessageRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.WriteMessageResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.WriteMessageResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.WriteMessageResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.WriteMessageResponse res = resBuilder.build();
