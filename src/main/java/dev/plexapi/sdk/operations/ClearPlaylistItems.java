...
public class ClearPlaylistItems {
    ...
    public static class Sync extends Base
            implements RequestOperation<ClearPlaylistItemsRequest, ClearPlaylistItemsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ClearPlaylistItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ClearPlaylistItemsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ClearPlaylistItemsRequest request) {
        ...
        @Override
        public ClearPlaylistItemsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ClearPlaylistItemsResponse.Builder resBuilder =
            ...
            ClearPlaylistItemsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ClearPlaylistItemsRequest, dev.plexapi.sdk.models.operations.async.ClearPlaylistItemsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ClearPlaylistItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ClearPlaylistItemsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ClearPlaylistItemsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.ClearPlaylistItemsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.ClearPlaylistItemsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.ClearPlaylistItemsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.ClearPlaylistItemsResponse res = resBuilder.build();
