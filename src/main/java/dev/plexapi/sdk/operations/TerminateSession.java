...
public class TerminateSession {
    ...
    public static class Sync extends Base
            implements RequestOperation<TerminateSessionRequest, TerminateSessionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(TerminateSessionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TerminateSessionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TerminateSessionRequest request) {
        ...
        @Override
        public TerminateSessionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            TerminateSessionResponse.Builder resBuilder =
            ...
            TerminateSessionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                // no content
                return res;
            }
            if (Utils.statusCodeMatches(response.statusCode(), "401", "403", "404", "4XX")) {
                // no content
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<TerminateSessionRequest, dev.plexapi.sdk.models.operations.async.TerminateSessionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(TerminateSessionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TerminateSessionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(TerminateSessionRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.TerminateSessionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.TerminateSessionResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.TerminateSessionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.TerminateSessionResponse res = resBuilder.build();
