...
public class PlayerSetViewOffset {
    ...
    public static class Sync extends Base
            implements RequestOperation<PlayerSetViewOffsetRequest, PlayerSetViewOffsetResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(PlayerSetViewOffsetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlayerSetViewOffsetRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlayerSetViewOffsetRequest request) {
        ...
        @Override
        public PlayerSetViewOffsetResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlayerSetViewOffsetResponse.Builder resBuilder =
            ...
            PlayerSetViewOffsetResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlayerSetViewOffsetRequest, dev.plexapi.sdk.models.operations.async.PlayerSetViewOffsetResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(PlayerSetViewOffsetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlayerSetViewOffsetRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlayerSetViewOffsetRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.PlayerSetViewOffsetResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.PlayerSetViewOffsetResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.PlayerSetViewOffsetResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.PlayerSetViewOffsetResponse res = resBuilder.build();
