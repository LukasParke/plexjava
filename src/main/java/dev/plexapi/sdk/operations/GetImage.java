...
public class GetImage {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetImageRequest, GetImageResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetImageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetImageRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetImageRequest request) {
        ...
        @Override
        public GetImageResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetImageResponse.Builder resBuilder =
                    GetImageResponse
                            .builder()
            ...
            GetImageResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetImageRequest, dev.plexapi.sdk.models.operations.async.GetImageResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetImageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetImageRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetImageRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetImageResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetImageResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetImageResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
            ...
            dev.plexapi.sdk.models.operations.async.GetImageResponse res = resBuilder.build();
