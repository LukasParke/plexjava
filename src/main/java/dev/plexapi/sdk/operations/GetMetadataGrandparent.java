...
public class GetMetadataGrandparent {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/library/metadata/{id}/grandparent",
    ...
    public static class Sync extends Base
            implements RequestOperation<GetMetadataGrandparentRequest, GetMetadataGrandparentResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetMetadataGrandparentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMetadataGrandparentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetMetadataGrandparentRequest request) {
        ...
        @Override
        public GetMetadataGrandparentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetMetadataGrandparentResponse.Builder resBuilder =
            ...
            GetMetadataGrandparentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetMetadataGrandparentRequest, dev.plexapi.sdk.models.operations.async.GetMetadataGrandparentResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetMetadataGrandparentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMetadataGrandparentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetMetadataGrandparentRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetMetadataGrandparentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetMetadataGrandparentResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetMetadataGrandparentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetMetadataGrandparentResponse res = resBuilder.build();
