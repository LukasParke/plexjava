...
public class PatchDVRSettings {
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchDVRSettingsRequest, PatchDVRSettingsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(PatchDVRSettingsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchDVRSettingsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchDVRSettingsRequest request) {
        ...
        @Override
        public PatchDVRSettingsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PatchDVRSettingsResponse.Builder resBuilder =
            ...
            PatchDVRSettingsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchDVRSettingsRequest, dev.plexapi.sdk.models.operations.async.PatchDVRSettingsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(PatchDVRSettingsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PatchDVRSettingsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchDVRSettingsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.PatchDVRSettingsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.PatchDVRSettingsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.PatchDVRSettingsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.PatchDVRSettingsResponse res = resBuilder.build();
