...
public class RestartProcessingDownloadQueueItems {
    ...
    public static class Sync extends Base
            implements RequestOperation<RestartProcessingDownloadQueueItemsRequest, RestartProcessingDownloadQueueItemsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(RestartProcessingDownloadQueueItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RestartProcessingDownloadQueueItemsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RestartProcessingDownloadQueueItemsRequest request) {
        ...
        @Override
        public RestartProcessingDownloadQueueItemsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RestartProcessingDownloadQueueItemsResponse.Builder resBuilder =
            ...
            RestartProcessingDownloadQueueItemsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RestartProcessingDownloadQueueItemsRequest, dev.plexapi.sdk.models.operations.async.RestartProcessingDownloadQueueItemsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(RestartProcessingDownloadQueueItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RestartProcessingDownloadQueueItemsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RestartProcessingDownloadQueueItemsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.RestartProcessingDownloadQueueItemsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.RestartProcessingDownloadQueueItemsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.RestartProcessingDownloadQueueItemsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.RestartProcessingDownloadQueueItemsResponse res = resBuilder.build();
