...
public class DetectVoiceActivity {
    ...
    public static class Sync extends Base
            implements RequestOperation<DetectVoiceActivityRequest, DetectVoiceActivityResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DetectVoiceActivityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DetectVoiceActivityRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DetectVoiceActivityRequest request) {
        ...
        @Override
        public DetectVoiceActivityResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DetectVoiceActivityResponse.Builder resBuilder =
            ...
            DetectVoiceActivityResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DetectVoiceActivityRequest, dev.plexapi.sdk.models.operations.async.DetectVoiceActivityResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DetectVoiceActivityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DetectVoiceActivityRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DetectVoiceActivityRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.DetectVoiceActivityResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.DetectVoiceActivityResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.DetectVoiceActivityResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.DetectVoiceActivityResponse res = resBuilder.build();
