...
public class RefreshSectionPost {
    ...
    public static class Sync extends Base
            implements RequestOperation<RefreshSectionPostRequest, RefreshSectionPostResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(RefreshSectionPostRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RefreshSectionPostRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RefreshSectionPostRequest request) {
        ...
        @Override
        public RefreshSectionPostResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RefreshSectionPostResponse.Builder resBuilder =
            ...
            RefreshSectionPostResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RefreshSectionPostRequest, dev.plexapi.sdk.models.operations.async.RefreshSectionPostResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(RefreshSectionPostRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RefreshSectionPostRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RefreshSectionPostRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.RefreshSectionPostResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.RefreshSectionPostResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.RefreshSectionPostResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.RefreshSectionPostResponse res = resBuilder.build();
