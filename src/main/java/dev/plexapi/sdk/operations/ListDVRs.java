...
public class ListDVRs {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListDVRsRequest, ListDVRsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListDVRsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListDVRsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListDVRsRequest request) {
        ...
        @Override
        public ListDVRsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListDVRsResponse.Builder resBuilder =
                    ListDVRsResponse
                            .builder()
            ...
            ListDVRsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListDVRsRequest, dev.plexapi.sdk.models.operations.async.ListDVRsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListDVRsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListDVRsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListDVRsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.ListDVRsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.ListDVRsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.ListDVRsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.ListDVRsResponse res = resBuilder.build();
