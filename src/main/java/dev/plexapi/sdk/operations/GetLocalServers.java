...
public class GetLocalServers {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetLocalServersRequest, GetLocalServersResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetLocalServersRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetLocalServersRequest request) {
        ...
        @Override
        public GetLocalServersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetLocalServersResponse.Builder resBuilder =
            ...
            GetLocalServersResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetLocalServersRequest, dev.plexapi.sdk.models.operations.async.GetLocalServersResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetLocalServersRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetLocalServersRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetLocalServersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetLocalServersResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetLocalServersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetLocalServersResponse res = resBuilder.build();
