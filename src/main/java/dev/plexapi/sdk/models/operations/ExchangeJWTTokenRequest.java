...
public class ExchangeJWTTokenRequest {
    ...
    private Optional<? extends TokenExchangeRequest> tokenExchangeRequest;

    @JsonCreator
    public ExchangeJWTTokenRequest(
            ...
            Optional<? extends TokenExchangeRequest> tokenExchangeRequest) {
        ...
        Utils.checkNotNull(tokenExchangeRequest, "tokenExchangeRequest");
        ...
        this.tokenExchangeRequest = tokenExchangeRequest;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<TokenExchangeRequest> tokenExchangeRequest() {
        return (Optional<TokenExchangeRequest>) tokenExchangeRequest;
    }
     ...
     * Indicates the client accepts the indicated media types
     */
    public ExchangeJWTTokenRequest withAccepts(Accepts accepts) {
        Utils.checkNotNull(accepts, "accepts");
     ...
     * Indicates the client accepts the indicated media types
     */
    public ExchangeJWTTokenRequest withAccepts(Optional<? extends Accepts> accepts) {
        Utils.checkNotNull(accepts, "accepts");
        this.accepts = accepts;
        return this;
    }
     ...
     * An opaque identifier unique to the client
     */
    public ExchangeJWTTokenRequest withClientIdentifier(String clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
     ...
     * An opaque identifier unique to the client
     */
    public ExchangeJWTTokenRequest withClientIdentifier(Optional<String> clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
        this.clientIdentifier = clientIdentifier;
        return this;
    }
     ...
     * The name of the client product
     */
    public ExchangeJWTTokenRequest withProduct(String product) {
        Utils.checkNotNull(product, "product");
     ...
     * The name of the client product
     */
    public ExchangeJWTTokenRequest withProduct(Optional<String> product) {
        Utils.checkNotNull(product, "product");
        this.product = product;
        return this;
    }
     ...
     * The version of the client application
     */
    public ExchangeJWTTokenRequest withVersion(String version) {
        Utils.checkNotNull(version, "version");
     ...
     * The version of the client application
     */
    public ExchangeJWTTokenRequest withVersion(Optional<String> version) {
        Utils.checkNotNull(version, "version");
        this.version = version;
        return this;
    }
     ...
     * The platform of the client
     */
    public ExchangeJWTTokenRequest withPlatform(String platform) {
        Utils.checkNotNull(platform, "platform");
     ...
     * The platform of the client
     */
    public ExchangeJWTTokenRequest withPlatform(Optional<String> platform) {
        Utils.checkNotNull(platform, "platform");
        this.platform = platform;
        return this;
    }
     ...
     * The version of the platform
     */
    public ExchangeJWTTokenRequest withPlatformVersion(String platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
     ...
     * The version of the platform
     */
    public ExchangeJWTTokenRequest withPlatformVersion(Optional<String> platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
        this.platformVersion = platformVersion;
        return this;
    }
     ...
     * A relatively friendly name for the client device
     */
    public ExchangeJWTTokenRequest withDevice(String device) {
        Utils.checkNotNull(device, "device");
     ...
     * A relatively friendly name for the client device
     */
    public ExchangeJWTTokenRequest withDevice(Optional<String> device) {
        Utils.checkNotNull(device, "device");
        this.device = device;
        return this;
    }
     ...
     * A potentially less friendly identifier for the device model
     */
    public ExchangeJWTTokenRequest withModel(String model) {
        Utils.checkNotNull(model, "model");
     ...
     * A potentially less friendly identifier for the device model
     */
    public ExchangeJWTTokenRequest withModel(Optional<String> model) {
        Utils.checkNotNull(model, "model");
        this.model = model;
        return this;
    }
     ...
     * The device vendor
     */
    public ExchangeJWTTokenRequest withDeviceVendor(String deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
     ...
     * The device vendor
     */
    public ExchangeJWTTokenRequest withDeviceVendor(Optional<String> deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
        this.deviceVendor = deviceVendor;
        return this;
    }
     ...
     * A friendly name for the client
     */
    public ExchangeJWTTokenRequest withDeviceName(String deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
     ...
     * A friendly name for the client
     */
    public ExchangeJWTTokenRequest withDeviceName(Optional<String> deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
        this.deviceName = deviceName;
        return this;
    }
     ...
     * The marketplace on which the client application is distributed
     */
    public ExchangeJWTTokenRequest withMarketplace(String marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
     ...
     * The marketplace on which the client application is distributed
     */
    public ExchangeJWTTokenRequest withMarketplace(Optional<String> marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
        this.marketplace = marketplace;
        return this;
    }

    public ExchangeJWTTokenRequest withTokenExchangeRequest(TokenExchangeRequest tokenExchangeRequest) {
        Utils.checkNotNull(tokenExchangeRequest, "tokenExchangeRequest");
        this.tokenExchangeRequest = Optional.ofNullable(tokenExchangeRequest);
        return this;
    }


    public ExchangeJWTTokenRequest withTokenExchangeRequest(Optional<? extends TokenExchangeRequest> tokenExchangeRequest) {
        Utils.checkNotNull(tokenExchangeRequest, "tokenExchangeRequest");
        this.tokenExchangeRequest = tokenExchangeRequest;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ExchangeJWTTokenRequest other = (ExchangeJWTTokenRequest) o;
        return 
            ...
            Utils.enhancedDeepEquals(this.tokenExchangeRequest, other.tokenExchangeRequest);
    }
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            deviceName, marketplace, tokenExchangeRequest);
    }
    
    @Override
    public String toString() {
        return Utils.toString(ExchangeJWTTokenRequest.class,
                "accepts", accepts,
    ...
    public final static class Builder {
        ...
        private Optional<? extends TokenExchangeRequest> tokenExchangeRequest = Optional.empty();
        ...
        public Builder tokenExchangeRequest(TokenExchangeRequest tokenExchangeRequest) {
            Utils.checkNotNull(tokenExchangeRequest, "tokenExchangeRequest");
            this.tokenExchangeRequest = Optional.ofNullable(tokenExchangeRequest);
            return this;
        }

        public Builder tokenExchangeRequest(Optional<? extends TokenExchangeRequest> tokenExchangeRequest) {
            Utils.checkNotNull(tokenExchangeRequest, "tokenExchangeRequest");
            this.tokenExchangeRequest = tokenExchangeRequest;
            return this;
        }

        public ExchangeJWTTokenRequest build() {
            if (accepts == null) {
                accepts = _SINGLETON_VALUE_Accepts.value();
            }

            return new ExchangeJWTTokenRequest(
                accepts, clientIdentifier, product,
                version, platform, platformVersion,
                device, model, deviceVendor,
                deviceName, marketplace, tokenExchangeRequest);
