...
public class DetectCredits {
    ...
    public static class Sync extends Base
            implements RequestOperation<DetectCreditsRequest, DetectCreditsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DetectCreditsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DetectCreditsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DetectCreditsRequest request) {
        ...
        @Override
        public DetectCreditsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DetectCreditsResponse.Builder resBuilder =
            ...
            DetectCreditsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DetectCreditsRequest, dev.plexapi.sdk.models.operations.async.DetectCreditsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DetectCreditsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DetectCreditsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DetectCreditsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.DetectCreditsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.DetectCreditsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.DetectCreditsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.DetectCreditsResponse res = resBuilder.build();
