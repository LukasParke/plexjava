...
public class GetSyncItems {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSyncItemsRequest, GetSyncItemsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetSyncItemsRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSyncItemsRequest request) {
        ...
        @Override
        public GetSyncItemsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSyncItemsResponse.Builder resBuilder =
            ...
            GetSyncItemsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSyncItemsRequest, dev.plexapi.sdk.models.operations.async.GetSyncItemsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSyncItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSyncItemsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetSyncItemsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetSyncItemsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetSyncItemsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetSyncItemsResponse res = resBuilder.build();
