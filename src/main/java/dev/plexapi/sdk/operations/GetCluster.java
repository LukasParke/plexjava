...
public class GetCluster {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetClusterRequest, GetClusterResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetClusterRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetClusterRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetClusterRequest request) {
        ...
        @Override
        public GetClusterResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetClusterResponse.Builder resBuilder =
                    GetClusterResponse
                            .builder()
            ...
            GetClusterResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetClusterRequest, dev.plexapi.sdk.models.operations.async.GetClusterResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetClusterRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetClusterRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetClusterRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetClusterResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetClusterResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetClusterResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetClusterResponse res = resBuilder.build();
