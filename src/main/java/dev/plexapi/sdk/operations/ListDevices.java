...
public class ListDevices {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<ListDevicesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        @Override
        public ListDevicesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListDevicesResponse.Builder resBuilder =
                    ListDevicesResponse
                            .builder()
            ...
            ListDevicesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<dev.plexapi.sdk.models.operations.async.ListDevicesResponse> {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.ListDevicesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.ListDevicesResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.ListDevicesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.ListDevicesResponse res = resBuilder.build();
