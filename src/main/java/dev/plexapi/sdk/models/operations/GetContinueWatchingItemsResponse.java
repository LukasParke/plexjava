...
public class GetContinueWatchingItemsResponse implements Response {
    /**
    ...
    @JsonCreator
    public GetContinueWatchingItemsResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public GetContinueWatchingItemsResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetContinueWatchingItemsResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetContinueWatchingItemsResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public GetContinueWatchingItemsResponse withMediaContainerWithMetadata(MediaContainerWithMetadata mediaContainerWithMetadata) {
        Utils.checkNotNull(mediaContainerWithMetadata, "mediaContainerWithMetadata");
     ...
     * OK
     */
    public GetContinueWatchingItemsResponse withMediaContainerWithMetadata(Optional<? extends MediaContainerWithMetadata> mediaContainerWithMetadata) {
        Utils.checkNotNull(mediaContainerWithMetadata, "mediaContainerWithMetadata");
        this.mediaContainerWithMetadata = mediaContainerWithMetadata;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetContinueWatchingItemsResponse other = (GetContinueWatchingItemsResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetContinueWatchingItemsResponse.class,
    ...
    public final static class Builder {
        ...
        public GetContinueWatchingItemsResponse build() {

            return new GetContinueWatchingItemsResponse(
                contentType, statusCode, rawResponse,
                mediaContainerWithMetadata);
        }
