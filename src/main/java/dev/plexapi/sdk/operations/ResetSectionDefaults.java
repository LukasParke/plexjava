...
public class ResetSectionDefaults {
    ...
    public static class Sync extends Base
            implements RequestOperation<ResetSectionDefaultsRequest, ResetSectionDefaultsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ResetSectionDefaultsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ResetSectionDefaultsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ResetSectionDefaultsRequest request) {
        ...
        @Override
        public ResetSectionDefaultsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ResetSectionDefaultsResponse.Builder resBuilder =
            ...
            ResetSectionDefaultsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ResetSectionDefaultsRequest, dev.plexapi.sdk.models.operations.async.ResetSectionDefaultsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ResetSectionDefaultsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ResetSectionDefaultsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ResetSectionDefaultsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.ResetSectionDefaultsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.ResetSectionDefaultsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.ResetSectionDefaultsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.ResetSectionDefaultsResponse res = resBuilder.build();
