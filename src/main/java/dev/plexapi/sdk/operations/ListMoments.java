...
public class ListMoments {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListMomentsRequest, ListMomentsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListMomentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListMomentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListMomentsRequest request) {
        ...
        @Override
        public ListMomentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListMomentsResponse.Builder resBuilder =
                    ListMomentsResponse
                            .builder()
            ...
            ListMomentsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListMomentsRequest, dev.plexapi.sdk.models.operations.async.ListMomentsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListMomentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListMomentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListMomentsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.ListMomentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.ListMomentsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.ListMomentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.ListMomentsResponse res = resBuilder.build();
