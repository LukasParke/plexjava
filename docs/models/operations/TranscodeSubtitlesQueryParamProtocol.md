...
```java
import dev.plexapi.sdk.models.operations.TranscodeSubtitlesQueryParamProtocol;

TranscodeSubtitlesQueryParamProtocol value = TranscodeSubtitlesQueryParamProtocol.HTTP;
```
