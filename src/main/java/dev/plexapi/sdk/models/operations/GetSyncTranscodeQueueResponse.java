...
public class GetSyncTranscodeQueueResponse implements Response {
    /**
    ...
    @JsonCreator
    public GetSyncTranscodeQueueResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public GetSyncTranscodeQueueResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetSyncTranscodeQueueResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetSyncTranscodeQueueResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public GetSyncTranscodeQueueResponse withMediaContainerWithDirectory(MediaContainerWithDirectory mediaContainerWithDirectory) {
        Utils.checkNotNull(mediaContainerWithDirectory, "mediaContainerWithDirectory");
     ...
     * OK
     */
    public GetSyncTranscodeQueueResponse withMediaContainerWithDirectory(Optional<? extends MediaContainerWithDirectory> mediaContainerWithDirectory) {
        Utils.checkNotNull(mediaContainerWithDirectory, "mediaContainerWithDirectory");
        this.mediaContainerWithDirectory = mediaContainerWithDirectory;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetSyncTranscodeQueueResponse other = (GetSyncTranscodeQueueResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetSyncTranscodeQueueResponse.class,
    ...
    public final static class Builder {
        ...
        public GetSyncTranscodeQueueResponse build() {

            return new GetSyncTranscodeQueueResponse(
                contentType, statusCode, rawResponse,
                mediaContainerWithDirectory);
        }
