...
public class GetSectionAgents {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/library/sections/{sectionId}/agents",
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSectionAgentsRequest, GetSectionAgentsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetSectionAgentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSectionAgentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSectionAgentsRequest request) {
        ...
        @Override
        public GetSectionAgentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSectionAgentsResponse.Builder resBuilder =
            ...
            GetSectionAgentsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSectionAgentsRequest, dev.plexapi.sdk.models.operations.async.GetSectionAgentsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSectionAgentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSectionAgentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSectionAgentsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetSectionAgentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetSectionAgentsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetSectionAgentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetSectionAgentsResponse res = resBuilder.build();
