...
public class GetAlbums {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAlbumsRequest, GetAlbumsResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetAlbumsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAlbumsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAlbumsRequest request) {
        ...
        @Override
        public GetAlbumsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAlbumsResponse.Builder resBuilder =
                    GetAlbumsResponse
                            .builder()
            ...
            GetAlbumsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAlbumsRequest, dev.plexapi.sdk.models.operations.async.GetAlbumsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetAlbumsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAlbumsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAlbumsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetAlbumsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetAlbumsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetAlbumsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetAlbumsResponse res = resBuilder.build();
