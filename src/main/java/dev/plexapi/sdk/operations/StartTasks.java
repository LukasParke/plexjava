...
public class StartTasks {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<StartTasksResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        @Override
        public StartTasksResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            StartTasksResponse.Builder resBuilder =
                    StartTasksResponse
                            .builder()
            ...
            StartTasksResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<dev.plexapi.sdk.models.operations.async.StartTasksResponse> {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.StartTasksResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.StartTasksResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.StartTasksResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.StartTasksResponse res = resBuilder.build();
