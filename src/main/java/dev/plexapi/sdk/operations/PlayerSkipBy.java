...
public class PlayerSkipBy {
    ...
    public static class Sync extends Base
            implements RequestOperation<PlayerSkipByRequest, PlayerSkipByResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(PlayerSkipByRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlayerSkipByRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlayerSkipByRequest request) {
        ...
        @Override
        public PlayerSkipByResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlayerSkipByResponse.Builder resBuilder =
            ...
            PlayerSkipByResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlayerSkipByRequest, dev.plexapi.sdk.models.operations.async.PlayerSkipByResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(PlayerSkipByRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlayerSkipByRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlayerSkipByRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.PlayerSkipByResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.PlayerSkipByResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.PlayerSkipByResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.PlayerSkipByResponse res = resBuilder.build();
