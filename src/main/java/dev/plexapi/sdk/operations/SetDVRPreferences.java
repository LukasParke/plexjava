...
public class SetDVRPreferences {
    ...
    public static class Sync extends Base
            implements RequestOperation<SetDVRPreferencesRequest, SetDVRPreferencesResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(SetDVRPreferencesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SetDVRPreferencesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(SetDVRPreferencesRequest request) {
        ...
        @Override
        public SetDVRPreferencesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            SetDVRPreferencesResponse.Builder resBuilder =
            ...
            SetDVRPreferencesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDVRResponse(Utils.unmarshal(response, new TypeReference<DVRResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SetDVRPreferencesRequest, dev.plexapi.sdk.models.operations.async.SetDVRPreferencesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(SetDVRPreferencesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SetDVRPreferencesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(SetDVRPreferencesRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.SetDVRPreferencesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.SetDVRPreferencesResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.SetDVRPreferencesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.SetDVRPreferencesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DVRResponse>() {})
                            .thenApply(res::withDVRResponse);
                } else {
