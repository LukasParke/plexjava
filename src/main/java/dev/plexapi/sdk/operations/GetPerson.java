...
public class GetPerson {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPersonRequest, GetPersonResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetPersonRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPersonRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPersonRequest request) {
        ...
        @Override
        public GetPersonResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetPersonResponse.Builder resBuilder =
                    GetPersonResponse
                            .builder()
            ...
            GetPersonResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetPersonRequest, dev.plexapi.sdk.models.operations.async.GetPersonResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetPersonRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPersonRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetPersonRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetPersonResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetPersonResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetPersonResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetPersonResponse res = resBuilder.build();
