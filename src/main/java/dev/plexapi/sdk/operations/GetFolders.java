...
public class GetFolders {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetFoldersRequest, GetFoldersResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetFoldersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetFoldersRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetFoldersRequest request) {
        ...
        @Override
        public GetFoldersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetFoldersResponse.Builder resBuilder =
                    GetFoldersResponse
                            .builder()
            ...
            GetFoldersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<GetFoldersResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetFoldersRequest, dev.plexapi.sdk.models.operations.async.GetFoldersResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetFoldersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetFoldersRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetFoldersRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetFoldersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetFoldersResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetFoldersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetFoldersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetFoldersResponseBody>() {})
