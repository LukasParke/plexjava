...
public class PlayerUnmute {
    ...
    public static class Sync extends Base
            implements RequestOperation<PlayerUnmuteRequest, PlayerUnmuteResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(PlayerUnmuteRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlayerUnmuteRequest request) {
        ...
        @Override
        public PlayerUnmuteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlayerUnmuteResponse.Builder resBuilder =
            ...
            PlayerUnmuteResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlayerUnmuteRequest, dev.plexapi.sdk.models.operations.async.PlayerUnmuteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(PlayerUnmuteRequest request) throws Exception {
            HttpRequest req = buildRequest(request);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlayerUnmuteRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.PlayerUnmuteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.PlayerUnmuteResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.PlayerUnmuteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.PlayerUnmuteResponse res = resBuilder.build();
