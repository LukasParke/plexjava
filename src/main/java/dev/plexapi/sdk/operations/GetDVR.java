...
public class GetDVR {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetDVRRequest, GetDVRResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetDVRRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDVRRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetDVRRequest request) {
        ...
        @Override
        public GetDVRResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetDVRResponse.Builder resBuilder =
                    GetDVRResponse
                            .builder()
            ...
            GetDVRResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetDVRRequest, dev.plexapi.sdk.models.operations.async.GetDVRResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetDVRRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDVRRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetDVRRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetDVRResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetDVRResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetDVRResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetDVRResponse res = resBuilder.build();
