...
```java
import dev.plexapi.sdk.models.operations.StartTranscodeSessionQueryParamSubtitles;

StartTranscodeSessionQueryParamSubtitles value = StartTranscodeSessionQueryParamSubtitles.AUTO;
```
