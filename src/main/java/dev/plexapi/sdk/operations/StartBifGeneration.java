...
public class StartBifGeneration {
    ...
    public static class Sync extends Base
            implements RequestOperation<StartBifGenerationRequest, StartBifGenerationResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(StartBifGenerationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StartBifGenerationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(StartBifGenerationRequest request) {
        ...
        @Override
        public StartBifGenerationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            StartBifGenerationResponse.Builder resBuilder =
            ...
            StartBifGenerationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<StartBifGenerationRequest, dev.plexapi.sdk.models.operations.async.StartBifGenerationResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(StartBifGenerationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StartBifGenerationRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(StartBifGenerationRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.StartBifGenerationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.StartBifGenerationResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.StartBifGenerationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.StartBifGenerationResponse res = resBuilder.build();
