...
public class PlayerPlayMedia {
    ...
    public static class Sync extends Base
            implements RequestOperation<PlayerPlayMediaRequest, PlayerPlayMediaResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(PlayerPlayMediaRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlayerPlayMediaRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PlayerPlayMediaRequest request) {
        ...
        @Override
        public PlayerPlayMediaResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlayerPlayMediaResponse.Builder resBuilder =
            ...
            PlayerPlayMediaResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PlayerPlayMediaRequest, dev.plexapi.sdk.models.operations.async.PlayerPlayMediaResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(PlayerPlayMediaRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PlayerPlayMediaRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PlayerPlayMediaRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.PlayerPlayMediaResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.PlayerPlayMediaResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.PlayerPlayMediaResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.PlayerPlayMediaResponse res = resBuilder.build();
