...
public class EmptyTrashPost {
    ...
    public static class Sync extends Base
            implements RequestOperation<EmptyTrashPostRequest, EmptyTrashPostResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(EmptyTrashPostRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EmptyTrashPostRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(EmptyTrashPostRequest request) {
        ...
        @Override
        public EmptyTrashPostResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            EmptyTrashPostResponse.Builder resBuilder =
            ...
            EmptyTrashPostResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<EmptyTrashPostRequest, dev.plexapi.sdk.models.operations.async.EmptyTrashPostResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(EmptyTrashPostRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EmptyTrashPostRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(EmptyTrashPostRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.EmptyTrashPostResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.EmptyTrashPostResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.EmptyTrashPostResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.EmptyTrashPostResponse res = resBuilder.build();
