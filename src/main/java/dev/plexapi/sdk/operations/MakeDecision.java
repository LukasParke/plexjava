...
public class MakeDecision {
    ...
    public static class Sync extends Base
            implements RequestOperation<MakeDecisionRequest, MakeDecisionResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(MakeDecisionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MakeDecisionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MakeDecisionRequest request) {
        ...
        @Override
        public MakeDecisionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            MakeDecisionResponse.Builder resBuilder =
            ...
            MakeDecisionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<MakeDecisionRequest, dev.plexapi.sdk.models.operations.async.MakeDecisionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(MakeDecisionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, MakeDecisionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(MakeDecisionRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.MakeDecisionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.MakeDecisionResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.MakeDecisionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.MakeDecisionResponse res = resBuilder.build();
