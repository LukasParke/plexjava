...
public class GetFoldersMediaContainer {
    ...
    private Optional<? extends List<GetFoldersDirectory>> directory;

    @JsonCreator
    public GetFoldersMediaContainer(
            ...
            @JsonProperty("Directory") Optional<? extends List<GetFoldersDirectory>> directory) {
    ...
    @JsonIgnore
    public Optional<List<GetFoldersDirectory>> directory() {
        return (Optional<List<GetFoldersDirectory>>) directory;
    }
    ...
    public GetFoldersMediaContainer withIdentifier(String identifier) {
        Utils.checkNotNull(identifier, "identifier");
    ...
    public GetFoldersMediaContainer withIdentifier(Optional<String> identifier) {
        Utils.checkNotNull(identifier, "identifier");
        this.identifier = identifier;
        return this;
    }
     ...
     * the `X-Plex-Container-Start` header.
     */
    public GetFoldersMediaContainer withOffset(long offset) {
        Utils.checkNotNull(offset, "offset");
     ...
     * the `X-Plex-Container-Start` header.
     */
    public GetFoldersMediaContainer withOffset(Optional<Long> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }

    public GetFoldersMediaContainer withSize(long size) {
        Utils.checkNotNull(size, "size");
    ...
    public GetFoldersMediaContainer withSize(Optional<Long> size) {
        Utils.checkNotNull(size, "size");
        this.size = size;
        return this;
    }
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public GetFoldersMediaContainer withTotalSize(long totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public GetFoldersMediaContainer withTotalSize(Optional<Long> totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
        this.totalSize = totalSize;
        return this;
    }

    public GetFoldersMediaContainer withDirectory(List<GetFoldersDirectory> directory) {
        Utils.checkNotNull(directory, "directory");
    ...
    public GetFoldersMediaContainer withDirectory(Optional<? extends List<GetFoldersDirectory>> directory) {
        Utils.checkNotNull(directory, "directory");
        this.directory = directory;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetFoldersMediaContainer other = (GetFoldersMediaContainer) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetFoldersMediaContainer.class,
    ...
    public final static class Builder {
        ...
        private Optional<? extends List<GetFoldersDirectory>> directory = Optional.empty();
        ...
        public Builder directory(List<GetFoldersDirectory> directory) {
            Utils.checkNotNull(directory, "directory");
            this.directory = Optional.ofNullable(directory);
            return this;
        }

        public Builder directory(Optional<? extends List<GetFoldersDirectory>> directory) {
            Utils.checkNotNull(directory, "directory");
            this.directory = directory;
            return this;
        }

        public GetFoldersMediaContainer build() {

            return new GetFoldersMediaContainer(
                identifier, offset, size,
                totalSize, directory);
        }
