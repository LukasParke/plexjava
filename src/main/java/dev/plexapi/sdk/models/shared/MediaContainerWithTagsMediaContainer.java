...
public class MediaContainerWithTagsMediaContainer {
    ...
    private Optional<? extends List<Tag>> directory;

    @JsonCreator
    public MediaContainerWithTagsMediaContainer(
            ...
            @JsonProperty("Directory") Optional<? extends List<Tag>> directory) {
    ...
    @JsonIgnore
    public Optional<List<Tag>> directory() {
        return (Optional<List<Tag>>) directory;
    }
    ...
    public MediaContainerWithTagsMediaContainer withIdentifier(String identifier) {
        Utils.checkNotNull(identifier, "identifier");
    ...
    public MediaContainerWithTagsMediaContainer withIdentifier(Optional<String> identifier) {
        Utils.checkNotNull(identifier, "identifier");
        this.identifier = identifier;
        return this;
    }
     ...
     * the `X-Plex-Container-Start` header.
     */
    public MediaContainerWithTagsMediaContainer withOffset(long offset) {
        Utils.checkNotNull(offset, "offset");
     ...
     * the `X-Plex-Container-Start` header.
     */
    public MediaContainerWithTagsMediaContainer withOffset(Optional<Long> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }

    public MediaContainerWithTagsMediaContainer withSize(long size) {
        Utils.checkNotNull(size, "size");
    ...
    public MediaContainerWithTagsMediaContainer withSize(Optional<Long> size) {
        Utils.checkNotNull(size, "size");
        this.size = size;
        return this;
    }
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public MediaContainerWithTagsMediaContainer withTotalSize(long totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public MediaContainerWithTagsMediaContainer withTotalSize(Optional<Long> totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
        this.totalSize = totalSize;
        return this;
    }

    public MediaContainerWithTagsMediaContainer withDirectory(List<Tag> directory) {
        Utils.checkNotNull(directory, "directory");
    ...
    public MediaContainerWithTagsMediaContainer withDirectory(Optional<? extends List<Tag>> directory) {
        Utils.checkNotNull(directory, "directory");
        this.directory = directory;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        MediaContainerWithTagsMediaContainer other = (MediaContainerWithTagsMediaContainer) o;
        return 
    ...
    public String toString() {
        return Utils.toString(MediaContainerWithTagsMediaContainer.class,
    ...
    public final static class Builder {
        ...
        private Optional<? extends List<Tag>> directory = Optional.empty();
        ...
        public Builder directory(List<Tag> directory) {
            Utils.checkNotNull(directory, "directory");
            this.directory = Optional.ofNullable(directory);
            return this;
        }

        public Builder directory(Optional<? extends List<Tag>> directory) {
            Utils.checkNotNull(directory, "directory");
            this.directory = directory;
            return this;
        }

        public MediaContainerWithTagsMediaContainer build() {

            return new MediaContainerWithTagsMediaContainer(
                identifier, offset, size,
                totalSize, directory);
        }
