 ...
 */
@JsonDeserialize(using = MediaContainerWithDecisionCanAutoSync._Deserializer.class)
public class MediaContainerWithDecisionCanAutoSync {
     ...
     * <ul>
     * <li>{@code boolean}</li>
     * <li>{@code dev.plexapi.sdk.models.shared.MediaContainerWithDecisionCanAutoSync2}</li>
     * </ul>
     * 
    ...
    public static final class _Deserializer extends OneOfDeserializer<MediaContainerWithDecisionCanAutoSync> {
