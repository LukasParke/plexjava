...
public class EditMetadataItem {
    ...
    public static class Sync extends Base
            implements RequestOperation<EditMetadataItemRequest, EditMetadataItemResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(EditMetadataItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EditMetadataItemRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(EditMetadataItemRequest request) {
        ...
        @Override
        public EditMetadataItemResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            EditMetadataItemResponse.Builder resBuilder =
            ...
            EditMetadataItemResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<EditMetadataItemRequest, dev.plexapi.sdk.models.operations.async.EditMetadataItemResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(EditMetadataItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EditMetadataItemRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(EditMetadataItemRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.EditMetadataItemResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.EditMetadataItemResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.EditMetadataItemResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.EditMetadataItemResponse res = resBuilder.build();
