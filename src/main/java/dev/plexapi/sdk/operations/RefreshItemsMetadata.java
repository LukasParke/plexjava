...
public class RefreshItemsMetadata {
    ...
    public static class Sync extends Base
            implements RequestOperation<RefreshItemsMetadataRequest, RefreshItemsMetadataResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(RefreshItemsMetadataRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RefreshItemsMetadataRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RefreshItemsMetadataRequest request) {
        ...
        @Override
        public RefreshItemsMetadataResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RefreshItemsMetadataResponse.Builder resBuilder =
            ...
            RefreshItemsMetadataResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RefreshItemsMetadataRequest, dev.plexapi.sdk.models.operations.async.RefreshItemsMetadataResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(RefreshItemsMetadataRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RefreshItemsMetadataRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RefreshItemsMetadataRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.RefreshItemsMetadataResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.RefreshItemsMetadataResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.RefreshItemsMetadataResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.RefreshItemsMetadataResponse res = resBuilder.build();
