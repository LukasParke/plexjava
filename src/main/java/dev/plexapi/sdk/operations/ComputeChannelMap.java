...
public class ComputeChannelMap {
    ...
    public static class Sync extends Base
            implements RequestOperation<ComputeChannelMapRequest, ComputeChannelMapResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, Optional<Options> options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ComputeChannelMapRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ComputeChannelMapRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ComputeChannelMapRequest request) {
        ...
        @Override
        public ComputeChannelMapResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ComputeChannelMapResponse.Builder resBuilder =
            ...
            ComputeChannelMapResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<ComputeChannelMapResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ComputeChannelMapRequest, dev.plexapi.sdk.models.operations.async.ComputeChannelMapResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ComputeChannelMapRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ComputeChannelMapRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ComputeChannelMapRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.ComputeChannelMapResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.ComputeChannelMapResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.ComputeChannelMapResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.ComputeChannelMapResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ComputeChannelMapResponseBody>() {})
